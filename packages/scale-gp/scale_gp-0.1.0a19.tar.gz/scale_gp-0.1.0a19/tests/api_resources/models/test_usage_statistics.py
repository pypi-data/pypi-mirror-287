...
class TestUsageStatistics:
    ...
    def test_method_list(self, client: SGPClient) -> None:
        usage_statistic = client.models.usage_statistics.list(
    ...
    def test_raw_response_list(self, client: SGPClient) -> None:
        response = client.models.usage_statistics.with_raw_response.list(
            model_name="model_name",
            chunks=0,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    def test_streaming_response_list(self, client: SGPClient) -> None:
        with client.models.usage_statistics.with_streaming_response.list(
            model_name="model_name",
            chunks=0,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    def test_path_params_list(self, client: SGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_name` but received ''"):
            client.models.usage_statistics.with_raw_response.list(
                model_name="",
                chunks=0,
                end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
...
class TestAsyncUsageStatistics:
    ...
    async def test_method_list(self, async_client: AsyncSGPClient) -> None:
        usage_statistic = await async_client.models.usage_statistics.list(
            model_name="model_name",
            chunks=0,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_raw_response_list(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.models.usage_statistics.with_raw_response.list(
            model_name="model_name",
            chunks=0,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_streaming_response_list(self, async_client: AsyncSGPClient) -> None:
        async with async_client.models.usage_statistics.with_streaming_response.list(
            model_name="model_name",
            chunks=0,
            end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
            start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
    ...
    async def test_path_params_list(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_name` but received ''"):
            await async_client.models.usage_statistics.with_raw_response.list(
                model_name="",
                chunks=0,
                end_date=parse_datetime("2019-12-27T18:11:19.117Z"),
                start_date=parse_datetime("2019-12-27T18:11:19.117Z"),
