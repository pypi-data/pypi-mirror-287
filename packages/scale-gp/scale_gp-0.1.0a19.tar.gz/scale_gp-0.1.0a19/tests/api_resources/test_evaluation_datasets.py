...
class TestEvaluationDatasets:
    ...
    def test_method_list(self, client: SGPClient) -> None:
        ...
        assert_matches_type(SyncPageResponse[EvaluationDataset], evaluation_dataset, path=["response"])
...
class TestAsyncEvaluationDatasets:
    ...
    async def test_method_list(self, async_client: AsyncSGPClient) -> None:
        ...
        assert_matches_type(AsyncPageResponse[EvaluationDataset], evaluation_dataset, path=["response"])
