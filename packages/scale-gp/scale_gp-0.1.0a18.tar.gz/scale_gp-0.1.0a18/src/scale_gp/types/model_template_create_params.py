...
class ModelTemplateCreateParams(TypedDict, total=False):
    ...
    model_creation_parameters_schema: ModelCreationParametersSchema
    """
    The field names and types of available parameter fields which may be specified
    during model creation
    """

    model_request_parameters_schema: ModelRequestParametersSchema
    """
    The field names and types of available parameter fields which may be specified
...
class ModelCreationParametersSchemaParameter(TypedDict, total=False):
...
class ModelCreationParametersSchema(TypedDict, total=False):
    parameters: Required[Iterable[ModelCreationParametersSchemaParameter]]


class ModelRequestParametersSchemaParameter(TypedDict, total=False):
    description: Required[str]
...
class ModelRequestParametersSchema(TypedDict, total=False):
    parameters: Required[Iterable[ModelRequestParametersSchemaParameter]]
