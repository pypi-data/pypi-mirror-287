...
__all__ = [
    "DeploymentChatCompletionsParams",
    "ChatHistory",
    "ChatHistoryEgpAPIBackendServerInternalEntitiesUserMessage",
    "ChatHistoryEgpAPIBackendServerInternalEntitiesAssistantMessage",
    "ChatHistoryEgpAPIBackendServerInternalEntitiesSystemMessage",
    "ModelRequestParameters",
]


class DeploymentChatCompletionsParams(TypedDict, total=False):
    chat_history: Required[Iterable[ChatHistory]]
...
class ChatHistoryEgpAPIBackendServerInternalEntitiesUserMessage(TypedDict, total=False):
    content: Required[str]

    role: Literal["user"]


class ChatHistoryEgpAPIBackendServerInternalEntitiesAssistantMessage(TypedDict, total=False):
    content: Required[str]

    role: Literal["assistant"]


class ChatHistoryEgpAPIBackendServerInternalEntitiesSystemMessage(TypedDict, total=False):
    content: Required[str]
