...
from .model_group_response import ModelGroupResponse
from .models.model_deployment_response import ModelDeploymentResponse

__all__ = ["ModelInstanceResponseWithViews", "BaseModelMetadata", "BaseModelMetadataModelDetails"]
...
class ModelInstanceResponseWithViews(BaseModel):
    id: str
    ...
    deployments: Optional[List[ModelDeploymentResponse]] = None
    ...
    api_model_group: Optional[ModelGroupResponse] = FieldInfo(alias="model_group", default=None)
