...
from ..types.chunks_rank_response import ChunksRankResponse
...
class ChunksResource(SyncAPIResource):
    ...
    def rank(
        ...
        *,
        ...
        relevant_chunks: Iterable[chunk_rank_params.RelevantChunk],
        ...
        return self._post(
            ...
            cast_to=ChunksRankResponse,
        )

    def synthesis(
        self,
        *,
        chunks: Iterable[chunk_synthesis_params.Chunk],
        query: str,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
