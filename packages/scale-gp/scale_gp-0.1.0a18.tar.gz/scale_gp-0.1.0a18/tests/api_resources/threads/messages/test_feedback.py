...
class TestFeedback:
    ...
    def test_method_delete(self, client: SGPClient) -> None:
        feedback = client.threads.messages.feedback.delete(
    ...
    def test_raw_response_delete(self, client: SGPClient) -> None:
        response = client.threads.messages.feedback.with_raw_response.delete(
            application_interaction_id="application_interaction_id",
            thread_id="thread_id",
        )
    ...
    def test_streaming_response_delete(self, client: SGPClient) -> None:
        with client.threads.messages.feedback.with_streaming_response.delete(
            application_interaction_id="application_interaction_id",
            thread_id="thread_id",
        ) as response:
    ...
    def test_path_params_delete(self, client: SGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            client.threads.messages.feedback.with_raw_response.delete(
                application_interaction_id="application_interaction_id",
                thread_id="",
            )
...
class TestAsyncFeedback:
    ...
    async def test_method_delete(self, async_client: AsyncSGPClient) -> None:
        feedback = await async_client.threads.messages.feedback.delete(
            application_interaction_id="application_interaction_id",
            thread_id="thread_id",
        )
        assert_matches_type(object, feedback, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncSGPClient) -> None:
        response = await async_client.threads.messages.feedback.with_raw_response.delete(
            application_interaction_id="application_interaction_id",
            thread_id="thread_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncSGPClient) -> None:
        async with async_client.threads.messages.feedback.with_streaming_response.delete(
            application_interaction_id="application_interaction_id",
            thread_id="thread_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncSGPClient) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `thread_id` but received ''"):
            await async_client.threads.messages.feedback.with_raw_response.delete(
                application_interaction_id="application_interaction_id",
                thread_id="",
            )
