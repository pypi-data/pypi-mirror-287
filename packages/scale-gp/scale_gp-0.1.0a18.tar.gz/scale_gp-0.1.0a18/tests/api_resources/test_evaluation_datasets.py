...
class TestEvaluationDatasets:
    ...
    def test_method_create_overload_1(self, client: SGPClient) -> None:
        ...
        assert_matches_type(EvaluationDatasetResponse, evaluation_dataset, path=["response"])
    ...
    def test_method_list(self, client: SGPClient) -> None:
        ...
        assert_matches_type(PaginationResponseEvaluationDataset, evaluation_dataset, path=["response"])
    ...
    def test_method_delete(self, client: SGPClient) -> None:
        ...
        assert_matches_type(DeleteResponse, evaluation_dataset, path=["response"])
