...
from ...types.evaluation_dataset_response import EvaluationDatasetResponse
from ...types.pagination_response_evaluation_dataset import PaginationResponseEvaluationDataset
...
class EvaluationDatasetsResource(SyncAPIResource):
    ...
    @required_args(["account_id", "name", "schema_type"], ["account_id", "knowledge_base_id", "name", "schema_type"])
    def create(
        self,
        *,
        account_id: str,
        name: str,
        schema_type: Literal["GENERATION"],
        type: Literal["manual"] | Literal["autogenerated"] | NotGiven = NOT_GIVEN,
        ...
        return self._post(
            ...
            cast_to=EvaluationDatasetResponse,
        )
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=PaginationResponseEvaluationDataset,
        )
