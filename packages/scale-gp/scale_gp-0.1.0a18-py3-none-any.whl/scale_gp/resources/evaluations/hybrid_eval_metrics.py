...
from ...types.evaluations.hybrid_evaluation_metrics_response import HybridEvaluationMetricsResponse
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=HybridEvaluationMetricsResponse,
        )
