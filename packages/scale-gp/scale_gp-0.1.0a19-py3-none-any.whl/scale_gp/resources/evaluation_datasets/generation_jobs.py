...
from ...types.evaluation_datasets.evaluation_dataset_generation_jobs_list import EvaluationDatasetGenerationJobsList
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=EvaluationDatasetGenerationJobsList,
        )
