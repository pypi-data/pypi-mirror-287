...
from swarm_rqa_test.configs import get_cfg_defaults
...
class InferTelemetry:
  ...
  def predict(self, csv_dir):
    ...
    for conf in configs:
      ...
      inference_paths = [
        # '/home/saandeepaath-admin/projects/internship/SWARM/playground/data/tampa_0504'
        "/home/saandeepaath-admin/projects/internship/SWARM/exp1/data/tampa_0628_gt"
      ]
    ...
    output_save_path = os.path.join(f"./data/", f"{args.dir.split('/')[-1]}.csv")
