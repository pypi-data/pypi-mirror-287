...
def get_tickers(date: dtm.date = None, market: str = None):
    ...
    Examples:
        >>> tickers = get_tickers()
        >>> print(tickers)
               market    name    type  reference_price  upper_limit  lower_limit  previous_close listing_date
        code
        000020  KOSPI    동화약품  EQUITY             8020        10420         5620            8020     19760324
        000040  KOSPI   KR모터스  EQUITY              621          807          435             621     19760525
        000050  KOSPI      경방  EQUITY             7320         9510         5130            7320     19560303
        000070  KOSPI   삼양홀딩스  EQUITY            68800        89400        48200           68800     19681227
        000075  KOSPI  삼양홀딩스우  EQUITY            53800        69900        37700           53800     19920221
    """
    if market:
        assert market in [
            "KOSPI",
...
def get_ticker_info(code: str) -> Optional[pd.DataFrame]:
    ...
    Examples:
        ...
        >>> print(df)
                        isin  name market    type listing_date
        code
        005930  KR7005930003  삼성전자  KOSPI  EQUITY     19750611
    """
...
def find_ticker_info(name: str) -> Optional[pd.DataFrame]:
    ...
    Examples:
        ...
        >>> print(df.head())
                        isin   name market    type listing_date
        code
        000810  KR7000810002   삼성화재  KOSPI  EQUITY     19750630
        000815  KR7000811000  삼성화재우  KOSPI  EQUITY     19900410
        001360  KR7001360007   삼성제약  KOSPI  EQUITY     19750704
        005930  KR7005930003   삼성전자  KOSPI  EQUITY     19750611
        005935  KR7005931001  삼성전자우  KOSPI  EQUITY     19890925
    """
