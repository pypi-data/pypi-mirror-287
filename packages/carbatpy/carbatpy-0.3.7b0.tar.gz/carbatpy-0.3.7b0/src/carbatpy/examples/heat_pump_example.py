...
# The content of the (here: json) file is:
# It includes the wanted minimum seperation between fluid temperatures D_T_MIN, superheting before compressor. Isentropic efficiency (=const. at the moment)
# The pressures, fluids and their composition in both storages and the working fluid. If **P_Working["setting"] =="auto"** , the pressures will be determined , acording to the storage temperatures, but this can fail.
# Alternatively "setting" can be anything else, then the two pressures (p_low for the evaporator, p_high for the condenser, all in *Pa*) will be used together with the temperatures (and T-differences) listed.
# 
# 
# 
# 
...
#     }
# 
# ## Read the inputs from the file and create an input directory:
