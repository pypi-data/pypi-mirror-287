...
def create_online_learning(
   ...
   :param algorithm: The algorithm to use for the online learning configuration. Currently only "ecosystem_rewards" and "bayesian_probabilistic" are supported.
   ...
   :return: The UUID identifier for the online learning configuration which should be linked to the deployment for the project.
    ...
    if algorithm not in ["ecosystem_rewards","bayesian_probabilistic"]:
        raise ValueError("algorithm must be ecosystem_rewards algorithm or bayesian_probabilistic algorithm for other algorithms please use the "
