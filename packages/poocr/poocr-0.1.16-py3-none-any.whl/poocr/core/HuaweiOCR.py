...
def household2excel2(ak, sk, img_path: list, output_excel: str = r'./household2excel.xlsx'):
    ...
    """
    {'data': {'birthAddress': '中国云南省富民县', 'name': '杨利琼', 
    'relationship': '妻', 'cardNo': '530124196710280543', 'sex': '女', 'nation': '汉', 'belief': '无宗教信仰', 'career': '粮农', 
    'maritalStatus': '已婚', 'registerDate': '', 'birthday': '1967年10月28日', 'education': '初中', 'hometown': '中国云南省富民县', 
    'whenWhereToHere': '就地农转城派出所内移入20140520云南省富民县富民县公安局款庄派出所多宜甲村123号', 'whenWhereToCity': '年月日中国', 'householdNum': '',
     'formerName': '', 'otherAddress': '', 'height': '159厘米', 'bloodType': '不明', 'veteranStatus': '未服兵役', 'workAddress': '多宜办事处多宜甲村'},
      'msg': '成功', 'success': True, 'code': 200, 'taskNo': '280995649212629441046596'}
