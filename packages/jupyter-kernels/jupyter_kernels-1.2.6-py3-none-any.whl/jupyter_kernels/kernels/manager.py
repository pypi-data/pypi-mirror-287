...
from .utils import timestamp_to_local_date
...
class KernelManager(LoggingConfigurable):
    ...
    client_class = DottedObjectName("jupyter_kernels.kernels.client.KernelClient")
    client_factory = Type(klass="jupyter_kernels.kernels.client.KernelClient")
    ...
    def start_kernel(self, **kwargs):
        ...
        msg = f"KernelManager using existing kernel server {kernel_name}"
