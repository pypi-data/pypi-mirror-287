...
if len(sys.argv) > 1:
    ...
    (
        ...
        .add(GeminiAIEmbeddings(config={"google_api_key": "AIzaSyBBIHZgyqPKRrxzVMgBe2E044w_g58bvtY"}))
        .add(GeminiPro(config={"google_api_key": "AIzaSyBBIHZgyqPKRrxzVMgBe2E044w_g58bvtY"}))
        .add(
            Trace(
                config={
