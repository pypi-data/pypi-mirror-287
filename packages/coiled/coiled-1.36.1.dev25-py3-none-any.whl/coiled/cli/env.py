...
@click.option(
    "--enable-experimental-installer/--disable-experimental-installer",
    default=None,
    is_flag=True,
    help="Enable experimental usage of uv to install for a pypi packages.",
)
def create(
    name,
    container,
    ...
    try:
        create_software_environment(
            ...
            enable_experimental_installer=enable_experimental_installer,
