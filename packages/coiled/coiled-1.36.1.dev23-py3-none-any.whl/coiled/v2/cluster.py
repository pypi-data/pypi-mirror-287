...
class Cluster(DistributedCluster, Generic[IsAsynchronous]):
    ...
    def __init__(
        ...
        *,
        ...
        package_sync_enable_experimental_installer: Optional[bool] = None,
        ...
        self._package_sync_enable_experimental_installer = package_sync_enable_experimental_installer
        ...
        if self.package_sync:
            ...
            with live:
                ...
                package_sync_env_alias = await self.cloud._create_package_sync_env(
                    ...
                    enable_experimental_installer=self._package_sync_enable_experimental_installer,
                )
