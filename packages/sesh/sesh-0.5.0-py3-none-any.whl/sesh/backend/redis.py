...
Initial contribution to this code base came from a fork of
...
class RedisStore(SessionStore):
    def __init__(self: SessionStore, redis_dsn):
    ...
    async def create(self, state_data: KeyBase) -> None:
    ...
    async def read(self, key_id: str, state_data: KeyBase) -> Optional[KeyBase]:
