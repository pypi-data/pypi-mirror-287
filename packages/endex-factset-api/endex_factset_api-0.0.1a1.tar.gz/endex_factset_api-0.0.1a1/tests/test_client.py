...
from endex_factset_api._exceptions import (
    APIStatusError,
    APITimeoutError,
    EndexFactsetAPIError,
...
class TestEndexFactsetAPI:
    client = EndexFactsetAPI(base_url=base_url, username=username, password=password, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(EndexFactsetAPIError):
            client2 = EndexFactsetAPI(base_url=base_url, username=None, password=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_API_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetAPI(username=username, password=password, _strict_response_validation=True)
...
class TestAsyncEndexFactsetAPI:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetAPI(username=username, password=password, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
