...
from endex_factset_api import EndexFactsetAPI, AsyncEndexFactsetAPI, APIResponseValidationError
from endex_factset_api._models import BaseModel, FinalRequestOptions
from endex_factset_api._constants import RAW_RESPONSE_HEADER
from endex_factset_api._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from endex_factset_api._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: EndexFactsetAPI | AsyncEndexFactsetAPI) -> int:
...
class TestEndexFactsetAPI:
    client = EndexFactsetAPI(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "endex_factset_api/_legacy_response.py",
                        "endex_factset_api/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "endex_factset_api/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: EndexFactsetAPI) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_API_BASE_URL="http://localhost:5000/from/env"):
            client = EndexFactsetAPI(access_token=access_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: EndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: EndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: EndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = EndexFactsetAPI(base_url=base_url, access_token=access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = EndexFactsetAPI(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    @mock.patch("endex_factset_api._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/fundamentals").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/fundamentals").mock(return_value=httpx.Response(500))
...
class TestAsyncEndexFactsetAPI:
    client = AsyncEndexFactsetAPI(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEndexFactsetAPI) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(ENDEX_FACTSET_API_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncEndexFactsetAPI(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncEndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEndexFactsetAPI) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncEndexFactsetAPI(
        ...
        client = AsyncEndexFactsetAPI(base_url=base_url, access_token=access_token, _strict_response_validation=False)
