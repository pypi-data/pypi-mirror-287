...
class RestOptions(Dictionary):
    ...
    def __init__(self, params: dict or Serializable = None, data: list or dict or Serializable = None,
                 ...
                 proxies: dict or Serializable = None, hooks: dict or Serializable = None, stream: bool = None,
                 verify: bool = None, cert: str or tuple = None, json: list or dict or Serializable = None,
                 restful: dict or Serializable = None, **kwargs):
        super().__init__()
...
class Rest(BaseRest):
    ...
    def __init__(self, file: str = None, server_name: str = None, host: str = None, headers: dict or Serializable = None,
                 cookies: dict or Serializable = None, auth: tuple or Serializable = None,
                 hooks: dict[str, Callable] or Serializable = None, http2: bool = False,
                 ...
                 trust_env: bool = True, max_redirects: int = 30):
        """
        ...
        self.__hooks: Optional[dict[str, Callable], Serializable] = None
    ...
    def __initialize(self, file: str = None, server_name: str = None, host: str = None,
                     headers: dict[str, str] or Serializable = None,
                     cookies: dict[str, str] or Serializable = None, auth: tuple or Serializable = None,
                     hooks: dict[str, Callable] or Serializable = None,
        ...
        self.__proxies: dict or Serializable = serializer(proxies or {})
        self.__hooks: Optional[dict[str, Callable], Serializable] = serializer(hooks) or {}
        self.__cert: str or tuple or Serializable = serializer(cert) or ()
        self.__session: Session = Session()
    ...
    def __request(self, func: callable, kwargs: dict, api_name: str = None, server_name: str = None, host: str = None,
        ...
        for k, v in deepcopy(optional_args).items():
            if k in _OPTIONAL_ARGS_KEYS and v:
                optional_args_tmp[k] = serializer(v)
        resp = None
        rest_resp = RestResponse(None)
        url: str = url.format(**self.__restful_handler(restful, serializer(optional_args.get(_Constant.RESTFUL)),
                                                       serializer(kwargs.get(_Constant.RESTFUL))))
        # noinspection PyBroadException
        try:
            ...
            arguments = "".join([f'\t{k.ljust(20, " ")} => {v}\n' for k, v in optional_args_tmp.items() if v])
            try:
