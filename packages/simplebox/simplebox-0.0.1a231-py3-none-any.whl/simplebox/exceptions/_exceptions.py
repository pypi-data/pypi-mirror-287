...
__all__ = [BasicException, CallException, TimeoutExpiredException, HttpException, RestInternalException,
           ...
           NonePointerException, NotFountException, EmptyException, InstanceException, ValidatorException,
           CommandException, LengthException, SerializeException, raise_exception]
