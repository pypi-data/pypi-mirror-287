...
class RestOptions(Dictionary):
    ...
    def __init__(self, params: dict = None, data: list or dict or Serializable = None,
                 headers: dict = None,  cookies: dict = None, files: dict = None, auth: tuple = None,
                 timeout: float or tuple = None,  allow_redirects: bool = True, proxies: dict = None,
                 hooks: dict = None, stream: bool = None,  verify: bool = None, cert: str or tuple = None,
                 json: list or dict or Serializable = None, restful: dict = None, **kwargs):
        super().__init__()

        self.update(params=params, data=serializer(data), headers=headers, cookies=cookies, files=files,
                    auth=auth, timeout=timeout, allow_redirects=allow_redirects, proxies=proxies, hooks=hooks,
                    stream=stream, verify=verify, cert=cert, json=serializer(json), restful=restful, **kwargs)
