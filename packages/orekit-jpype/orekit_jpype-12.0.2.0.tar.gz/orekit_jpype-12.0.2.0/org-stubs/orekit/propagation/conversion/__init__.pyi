...
class NumericalPropagatorBuilder(AbstractPropagatorBuilder):
    ...
    """
    @typing.overload
    def __init__(self, orbit: org.orekit.orbits.Orbit, oDEIntegratorBuilder: typing.Union[ODEIntegratorBuilder, typing.Callable], positionAngleType: org.orekit.orbits.PositionAngleType, double: float): ...
    @typing.overload
    def __init__(self, orbit: org.orekit.orbits.Orbit, oDEIntegratorBuilder: typing.Union[ODEIntegratorBuilder, typing.Callable], positionAngleType: org.orekit.orbits.PositionAngleType, double: float, attitudeProvider: org.orekit.attitudes.AttitudeProvider): ...
