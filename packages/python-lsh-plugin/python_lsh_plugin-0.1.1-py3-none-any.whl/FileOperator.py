...
if __name__ == '__main__':
    ...
    json_file.write('test2.json', [{'name': 'test', 'age': 18}, {'name': 'test2', 'age': 20}, {'name': 'test3', 'age': 21}])
    json_file.write('test.json', {'name': 'test', 'age': 18})
    print(json_file.read('test.json'))

    # yaml_file = YamlFileOperator()
    # yaml_file.write('test.yaml', {'name': 'test', 'age': 18})
