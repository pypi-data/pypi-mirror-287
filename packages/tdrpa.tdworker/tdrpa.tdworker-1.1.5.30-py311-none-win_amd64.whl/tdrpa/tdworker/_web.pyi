...
class Web:
    @staticmethod
    def FindWebElement(tdstr: str, anchorsElement, searchDelay: int = 10000, continueOnError: bool = False) -> ElementHandle:
        """
        查找元素

        eh = Web.FindWebElement(tdstr, page, searchDelay=10000, continueOnError=False)
        ...
        """
    @staticmethod
    def Exists(tdstr: str, anchorsElement) -> bool:
        """
        元素是否存在（不可见归于不存在）

        Web.Exists(tdstr, page)
        ...
        """
    @staticmethod
    def Wait(tdstr: str, anchorsElement, waitType: str = 'show', searchDelay: int = 10000, continueOnError: bool = False) -> None:
        '''
        等待元素加载

        Web.Wait(tdstr, page, waitType=\'show\', searchDelay=10000, continueOnError=False)
    ...
    def PwStart() -> Page:
        ...
        """
    @staticmethod
    def OpenChrome(url: str = None, chromeExePath: str = None, isMaximize: bool = True, supportUia: bool = True, otherStartupParam: Incomplete | None = None, delayTime: int = 30000) -> None:
        '''
        启动谷歌浏览器

        Web.OpenChrome(url="www.baidu.com", chromeExePath=None, isMaximize=True, supportUia=True, otherStartupParam=None, delayTime=30000)
