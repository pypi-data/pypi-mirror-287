...
def predict(
    ...
    # 读取图像存放位置的文件夹，读取所有图像，并存入im_list
...
if __name__ == '__main__':
    ...
    #                     default=os.path.join('PROJECT_ROOT', 'dataset', 'predict', 'init_images'))
    parser.add_argument("--images_dir", type=str,
                        default=os.path.join(r'C:\Users\xuzhe\Desktop\First_task\v8_High_resolution\dataset\thin\init_images'))
    parser.add_argument("--outdir_slice_ims", type=str,
                        default=os.path.join(PROJECT_ROOT, 'dataset', 'thin', 'slice_images'))
    # parser.add_argument("--outdir_slice_ims", type=str,
    #                     default=os.path.join(PROJECT_ROOT, r'C:\Users\xuzhe\Desktop\First_task\v8_High_resolution\runs\detect\predict2'))
    parser.add_argument("--project_name", type=str, default="sensor_detect")
    parser.add_argument("--im_ext", type=str, default=".png")
    parser.add_argument("--sliceHeight", type=int, default=1280)
    parser.add_argument("--sliceWidth", type=int, default=1280)
    parser.add_argument("--overlap", type=float, default=0.3)
    parser.add_argument("--slice_sep", type=str, default="_")
    parser.add_argument("--overwrite", type=bool, default=False)
    parser.add_argument("--out_ext", type=str, default=".png")
    parser.add_argument("--model", type=str, default=r"weights\CellDetect0619.pt")
    ...
    parser.add_argument("--completed_output_path", type=str,
                        default=os.path.join(PROJECT_ROOT, 'results', 'completed_predict'))
    # parser.add_argument("--completed_output_path", type=str,
    #                     default=os.path.join(PROJECT_ROOT, r'C:\Users\xuzhe\Desktop\First_task\v8_High_resolution\runs\detect\predict2'))
