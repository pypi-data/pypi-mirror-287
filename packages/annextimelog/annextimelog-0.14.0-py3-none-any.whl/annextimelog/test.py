...
class TokenTest(TestCase):
    ...
    def test_from_strings_actions_conditions(self):
        for cmdline, (actions, conditions) in {
            ...
            "set @home if thistag": (
                {AddToField("location", {"home"})},
                {AddToField("tag", {"thistag"})},
            ),
    ...
    def test_split_by_trigger(self):
        ...
        self.assertEqual(
            ...
            [
                [SetField("a", {"b"})],
                [AddToField("tag", {"work"}), AddToField("location", {"home"})],
    ...
    def test_sort_into(self):
        ...
        self.assertSequenceEqual(
            modifiers, [SetField("bla", {"blubb"}), AddToField("location", {"home"})]
        )
