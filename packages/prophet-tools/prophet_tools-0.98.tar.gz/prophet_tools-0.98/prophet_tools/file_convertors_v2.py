...
def resize_folder(path, lim=2500):
    ...
    for file in files:
        if file.ext.lower() not in ['png', 'webp', 'jpg', 'jpg', 'cr2', 'avif']:
            continue
        old_path = file.path
...
if __name__ == "__main__":
    ...
    # resize_one_image(r"C:\Users\ProPHet\Pictures\пережатие\Sounds_Crispy Fried Cheese Sounds_CREDIT.avif", output=r"C:\Users\ProPHet\Pictures\пережатие\Sounds_Crispy Fried Cheese Sounds_CREDIT.jpg")