...
from categories.data.functor import Functor, FunctorIO, FunctorLambda, FunctorList, FunctorStream
from categories.type import Expr, IO, Lambda, Stream, Yield, _, hkt, typeclass
