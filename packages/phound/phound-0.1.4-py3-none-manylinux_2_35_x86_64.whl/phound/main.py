from typing import Any, Dict, Optional, List, Tuple, Set, cast
import threading
from uuid import uuid4

from phound.events import EventType, ChatType, PhoneNumberInfo, Message
...
class Phound:
    ...
    def send_message(
        ...
        self._client.send_message(from_persona_uid,
                                  ...
                                  app_meta=app_meta,
                                  wait_sent=True)
        return cast(Message, self._client.wait_event(EventType.CHAT_MESSAGE_SENT).body)
