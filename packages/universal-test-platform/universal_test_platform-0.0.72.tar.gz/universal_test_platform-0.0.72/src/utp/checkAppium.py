...
def checkAppium():
    ...
    handler= subprocess.Popen(["appium", "server", "-ka", "800",  "--use-plugins", "device-farm", "-pa", "/wd/hub", "--plugin-device-farm-platform","android"], shell=True, stdout=subprocess.DEVNULL, stderr=subprocess.STDOUT)
