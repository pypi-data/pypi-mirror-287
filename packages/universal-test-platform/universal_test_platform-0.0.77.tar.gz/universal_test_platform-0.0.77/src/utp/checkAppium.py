...
def checkAppium():
    ...
    click.secho("Check appium", bg='black', fg='gray')
    ...
    click.secho("Check Driver", bg='black', fg='gray')
    ...
    click.secho("Check Device farm", bg='black', fg='gray')
    ...
    click.secho("Run Appium", bg='black', fg='gray')
