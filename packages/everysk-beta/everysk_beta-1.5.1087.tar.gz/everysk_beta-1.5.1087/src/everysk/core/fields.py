...
class StrField(Field):
    ...
    def validate(self, attr_name: str, value: Any, attr_type: type | UnionType = None) -> None:
        ...
        Raises:
            FieldValueError:
                If the provided value does not meet the specified constraints.
                If the value does not match the regular expression pattern.
                If the length of the value is outside the specified range.
        """
