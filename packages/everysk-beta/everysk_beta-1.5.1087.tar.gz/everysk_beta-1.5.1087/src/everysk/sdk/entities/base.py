...
def _parser_out(obj: Any, with_internals: bool = True) -> Any:
    ...
    if hasattr(obj, 'to_legacy_dict'):
        ret = obj.to_legacy_dict(with_internals)

    elif isinstance(obj, (dict, BaseDict)):
        ret = {}
...
class BaseEntity(BaseSDK, BaseDict, metaclass=QueryMetaClass):
    ...
    def to_legacy_dict(self, with_internals: bool = True) -> dict: # pylint: disable=unused-argument
        """
