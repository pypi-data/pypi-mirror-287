...
class PrivateSecurityTestCase(TestCase):
    ...
    def test_validate(self):
        expected_data = compress({'class_name': 'PrivateSecurity', 'method_name': 'validate', 'self_obj': {'symbol': 'PRIVATE:SECURITY', 'name': 'SamplePrivateSecurity', 'tags': ['tag1', 'tag2'], 'description': 'Description', 'currency': 'USD', 'data': {'m2m_spread': 0, 'principal': 123.456, 'expiry_date': '20231117', 'starting_date': '20231108', 'issue_date': '20231108', 'method': 'PRIVATE', 'yield': 0, 'events': [{'date': '20231117', 'event_type': 'V', 'value': 123.03}]}, 'instrument_type': 'PrivateFixedIncome', 'version': '1.0', 'created_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, 'updated_on': {'__datetime__': '2023-09-09T09:09:09.000009+00:00'}, '__class_path__': 'everysk.sdk.entities.private_security.base.PrivateSecurity'}, 'params': {}}, protocol='gzip', serialize='json')
