...
mod.add_function('Slice_types_GroupParticipant_CTor', retval('int64_t'), [])
mod.add_function('Slice_types_GroupParticipant_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice_types_GroupParticipant_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice_types_GroupParticipant_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice_types_GroupParticipant_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice_types_GroupParticipant_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
...
mod.add_function('whatsapp_Attachment_Path_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('whatsapp_Attachment_Path_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
...
mod.add_function('whatsapp_Preview_ImagePath_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('whatsapp_Preview_ImagePath_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
...
add_checked_string_function(mod, 'whatsapp_Session_SetAvatar', retval('char*'), [param('int64_t', '_handle'), param('char*', 'resourceID'), param('char*', 'avatarPath')])
...
add_checked_function(mod, 'whatsapp_Session_SetAffiliation', retval('int64_t'), [param('int64_t', '_handle'), param('char*', 'groupID'), param('char*', 'participantID'), param('char*', 'change')])
...
add_checked_function(mod, 'whatsapp_Gateway_SetLogHandler', None, [param('int64_t', '_handle'), param('PyObject*', 'h', transfer_ownership=False), param('bool', 'goRun')])
...
mod.add_function('whatsapp_EventPayload_ConnectedJID_Get', retval('char*'), [param('int64_t', 'handle')])
mod.add_function('whatsapp_EventPayload_ConnectedJID_Set', None, [param('int64_t', 'handle'), param('char*', 'val')])
