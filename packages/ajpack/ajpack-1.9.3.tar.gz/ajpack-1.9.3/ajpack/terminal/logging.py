...
class Logger:
    ...
    def _init_log_file(self):
        # Initialize log file with rotation (5MB per file, keep 3 backups)
    ...
    def log_to_file(self, file_path):
    ...
    def enable_structured_logging(self, format='json'):
        self.structured_format = format

    def set_rate_limit(self, level, max_messages, interval):
