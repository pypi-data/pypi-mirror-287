...
v0.6 dd pH kinetic dedicated plot & interpolation update to follow Pandas
...
pd.core.base.PandasObject.cinacplot = plotph # monkey-patch the DataFrame class to add interpolation 
