...
class px_Plot():
    ...
    Notes:
        ...
        - Most common traces have been implemented using the 'add_*()' methods. Traces not implemented yet can be added using the 'add()' method.
    ...
    def add_trendline(self,
        ...
        match trendline:
            ...
            case "rolling":
                trendline_options = dict(function=rolling_function, window=rolling_window, min_periods=rolling_min_periods, center=rolling_center, win_type=rolling_win_type, on=rolling_on, axis=rolling_axis, closed=rolling_closed, step=rolling_step)
