...
class SqlTable(DataSet):
    """SqlTable's DataSet Class used for getting the required infomation for Pantomath
    ...
    def create(host, port, database, schema, name):
        """Static method for obtaining SqlTable's DataSet Class
        ...
        :type name: str
        ...
        :return: SqlTable class object
        :rtype: SqlTable
        """
        return SqlTable(host, port, database, schema, name)
    ...
    def get_type(self):
        ...
        :rtype: str
        """
        return DataSetTypes.SQL_TABLE.value
