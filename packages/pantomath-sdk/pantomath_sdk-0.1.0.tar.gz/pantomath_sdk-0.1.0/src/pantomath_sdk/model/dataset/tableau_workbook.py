...
class TableauWorkbook(DataSet):
    """TableauWorkbook's DataSet Class used for getting the required infomation for Pantomath
    ...
    def create(host, uri, name):
        """Static method for obtaining TableauWorkbook's DataSet Class
        ...
        :type name: str
        ...
        :return: TableauWorkbook class object
        :rtype: TableauWorkbook
        """
        return TableauWorkbook(host, uri, name)
    ...
    def get_type(self):
        ...
        :rtype: str
        """
        return DataSetTypes.TABLEAU_WORKBOOK.value
