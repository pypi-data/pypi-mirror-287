...
class DataikuProject(Job):
    ...
    def __init__(self, host_name, project_label, project_key):
        """Constructor method"""
    ...
    @staticmethod
    def create(host_name, project_label, project_key):
        ...
        """
        return DataikuProject(host_name, project_label, project_key)
