...
class SoraAudioFrame:
    def __getstate__(self) -> tuple[list[int], int, int, int, Optional[int]]: ...

    def __setstate__(self, arg: tuple[Sequence[int], int, int, int, Optional[int]], /) -> None: ...
    ...
    @property
    def absolute_capture_timestamp_ms(self) -> Optional[int]: ...
