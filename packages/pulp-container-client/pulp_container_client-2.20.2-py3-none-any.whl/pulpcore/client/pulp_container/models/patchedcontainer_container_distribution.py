...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, hidden=False, content_guard=None, name=None, pulp_labels=None, repository=None, base_path=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
