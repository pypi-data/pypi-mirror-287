...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, hidden=False, content_guard=None, pulp_href=None, name=None, pulp_labels=None, repository=None, pulp_last_updated=None, pulp_created=None, base_path=None, repository_version=None, registry_path=None, remote=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
