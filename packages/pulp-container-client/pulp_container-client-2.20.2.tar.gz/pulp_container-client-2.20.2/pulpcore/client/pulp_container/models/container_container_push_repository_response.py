...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_href=None, name=None, pulp_labels=None, retain_repo_versions=None, pulp_last_updated=None, description=None, pulp_created=None, latest_version_href=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
