...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, name=None, pulp_labels=None, retain_repo_versions=None, description=None, manifest_signing_service=None, local_vars_configuration=None):  # noqa: E501
