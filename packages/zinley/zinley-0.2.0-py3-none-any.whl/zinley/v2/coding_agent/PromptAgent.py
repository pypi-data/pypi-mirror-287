...
class PromptAgent:
    ...
    async def get_prompt_plan(self, session, all_file_contents, user_prompt):
        """
    ...
    async def get_prompt_plans(self, files, user_prompt):
        """
        ...
        async with aiohttp.ClientSession() as session:
            plan = await self.get_prompt_plan(session, all_file_contents, user_prompt)
