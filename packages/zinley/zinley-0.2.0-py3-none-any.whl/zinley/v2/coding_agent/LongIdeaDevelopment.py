...
class LongIdeaDevelopment:
    ...
    def initial_setup(self, prompt):
        ...
        system_prompt = (
            ...
            "- For each working file, list all related files to work together to provide enough context and prevent redeclaration or conflict.\n"
            "- Follow best coding practices by using as many files as possible for specific needs, aiming for clean code.\n\n"
            "- Do not rename files, only modify inside content. If file can't be used with that name, create a new file.\n"
            "2. **UX Workflow:**\n"
        ...
        self.conversation_history.append({"role": "user", "content": f"This is ultimate goal: {prompt}. I will provide what to do in each stage"})
