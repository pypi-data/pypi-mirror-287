...
int swat_api_configure_from_file(SWAT_API_CLIENT *swat_api_h, const char* IP_address, int telnum, const char* config_filename, bool disable_worker){
  ...
  return swat_api_configure(
    ...
    disable_worker == false ? SWAT_API_WORKER_THR_DEFAULT : SWAT_API_WORKER_THR_DISABLED
  );
