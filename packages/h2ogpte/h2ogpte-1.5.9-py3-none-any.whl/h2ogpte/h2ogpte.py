...
class H2OGPTE:
    ...
    def create_collection(
        ...
        Args:
            ...
            collection_settings:
                (Optional) Dictionary with key/value pairs to configure certain collection specific settings like pii_settings or max_tokens_per_chunk or chunk_overlap_tokens.
        Returns:
