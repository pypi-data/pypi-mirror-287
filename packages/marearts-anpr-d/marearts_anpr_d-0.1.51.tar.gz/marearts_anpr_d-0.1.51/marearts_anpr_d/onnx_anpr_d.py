...
import numpy as np
import onnxruntime
from onnx_utils import xywh2xyxy, nms, draw_detections
from imread_from_url import imread_from_url

class marearts_anpr_d:
    ...
    def prepare_input_old(self, image):
        self.img_height, self.img_width = image.shape[:2]
...
if __name__ == '__main__':
    ...
    anpr_d = marearts_anpr_d(model_path, conf_thres=0.3, iou_thres=0.5)
    ...
    # Draw detections
    combined_img = anpr_d.draw_detections(img)
