...
class selection():
    ...
    def module_selection(self):
        ...
        if self.method == "PTR":
            ...
            self.num_objectives, self.num_proposals, self.ptr_ranges, self.output_res, self.ptr_hard).select()
            return res
...
class analysis():
    ...
    def __init__(self, method, input_file, output_file, num_objectives = None, 
    ...
    def module_selection(self):
        ...
        res = 'False'
        if self.method == "WAM":
            res = nimo.ai_tools.ai_tool_slesa_WAM.SLESA_WAM(self.input_file, self.output_file, 
