...
FOOD_UNITS = {
    "egg": ("eggs", "whole egg", "whole eggs", "egg yolk", "egg yolks", "eggs yolk", "eggs yolks", "egg white", "egg whites", "eggs white", "eggs whites"),
    "tortilla": ("tortillas",),
    "rack": ("racks",),
    "bagel": ("bagels",),
    "cake": ("cakes",),
    ...
    "honeydew": ("honeydews", "honeydew melon", "honeydew melons"),
    "melon": ("melons",),
    ...
    "mushroom": ("mushrooms",),
    "parsnip": ("parsnips",),
    "pea": ("peas", "snow pea", "snow peas"),
    "potato": ("potatoes",),
    "spinach": ("spinaches",),
    "squash": ("squashes", "butternut squash"),
