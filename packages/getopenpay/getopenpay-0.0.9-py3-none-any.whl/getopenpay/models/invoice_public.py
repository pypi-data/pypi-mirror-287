...
class InvoicePublic(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    'id', 'paid_at', 'paid_amount_atom', 'tax_amount_atom', 'remaining_amount_atom',
    'total_discount_amount_atoms', 'billed_to', 'billing_address', 'card_type', 'last_four',
    'lines', 'branding', 'invoice_pdf_url', 'receipt_pdf_url', 'is_initial_invoice_for_trial_sub',
    'trial_start_for_sub', 'trial_end_for_sub'
  ]
