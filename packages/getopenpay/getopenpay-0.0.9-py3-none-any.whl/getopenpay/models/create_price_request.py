...
class CreatePriceRequest(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    'is_exclusive', 'listed_exclusively_for_customers', 'is_active', 'internal_description',
    'pricing_model', 'unit_amount_atom', 'transform_quantity_divide_by', 'price_tiers',
    ...
    'can_only_be_purchased_with', 'product_id', 'is_default'
  ]
