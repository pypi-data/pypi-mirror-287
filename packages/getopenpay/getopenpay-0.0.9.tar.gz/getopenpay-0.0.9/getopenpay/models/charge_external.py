...
class ChargeExternal(BaseModel):
  ...
  customer_id: StrictStr = Field(
    description='Unique Identifier of the customer associated with this charge.'
  )
  payment_method_id: StrictStr = Field(
    description='Unique Identifier of the payment method used for this charge.'
  )
  payment_intent_id: StrictStr = Field(
    description='Unique Identifier of the payment intent associated with this charge.'
  )
  ...
  __properties: ClassVar[List[str]] = [
    ...
    'refunded_amount_atom', 'disputed', 'failure_code', 'failure_message'
  ]
