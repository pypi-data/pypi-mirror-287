...
def test(exchangeName="", params={}):
    ...
    if "createLimitOrder" in params and params["createLimitOrder"]:
        ...
        try:
            resp = ttxtExchange.create_limit_order(symbol=tickerToTest, amount=300, side="buy", price=0.02)
    ...
    if "cancelOrder" in params and params["cancelOrder"]:
        ...
        try:
            resp = ttxtExchange.cancel_order(id='1805379317006748', symbol=tickerToTest)
...
if __name__ == "__main__":
    ...
    testingParams = {"ticker": False, 
                     ...
                     "myTrades": False,
                     "accountInfo": False}
    test(params=testingParams, exchangeName="coinbase")
