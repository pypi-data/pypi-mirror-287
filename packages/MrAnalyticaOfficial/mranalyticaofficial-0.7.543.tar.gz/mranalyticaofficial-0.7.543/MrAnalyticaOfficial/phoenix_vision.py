...
class PhoenixVision:
    ...
    def set_detection_mode(self, mode):
        ...
        :param mode: String, pode ser "face", "face_eyes", ou "face_full"
        """
    ...
    def _detect_and_draw(self, frame, gray):
        ...
        for (x, y, w, h) in faces:
            ...
            if self.detection_mode == "face_full":
                # Aqui você pode adicionar detecção de outros marcos faciais
                # Por exemplo, usando dlib ou outro detector de marcos faciais
                pass
    ...
    def enable_face_tracking(self, enable):
        """
        Ativa ou desativa o rastreamento de rostos.
        :param enable: Boolean, True para ativar, False para desativar
        """
    ...
    def set_camera(self, camera_index):
        ...
        :param camera_index: Índice da câmera (geralmente 0 para a câmera padrão)
        """
    ...
    def start(self):
        ...
        while True:
            ...
            if not self.face_tracking or not tracking_face:
                ...
                if faces and self.face_tracking:
                    x, y, w, h = faces[0]
                    self.tracker = cv2.TrackerKCF_create()
            ...
            self.total_faces_detected += len(faces) if 'faces' in locals() else 0
            ...
            if self.show_stats:
                stats_text = [
                    ...
                    f"FPS: {fps:.2f}",
                    f"Faces detectadas: {len(faces) if 'faces' in locals() else 0}",
