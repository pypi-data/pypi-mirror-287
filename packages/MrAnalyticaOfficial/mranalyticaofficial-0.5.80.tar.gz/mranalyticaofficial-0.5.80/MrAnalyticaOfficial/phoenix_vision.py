    ...
    def _carregar_fotos(self):
        for nome_pessoa in os.listdir(self.fotos_dir):
            ...
            for nome_imagem in os.listdir(pessoa_dir):
                ...
                imagem_rgb = cv2.cvtColor(imagem, cv2.COLOR_BGR2RGB)  # Certificar que a imagem está em RGB
                if len(face_recognition.face_encodings(imagem_rgb)) > 0:
                    encoding = face_recognition.face_encodings(imagem_rgb)[0]
