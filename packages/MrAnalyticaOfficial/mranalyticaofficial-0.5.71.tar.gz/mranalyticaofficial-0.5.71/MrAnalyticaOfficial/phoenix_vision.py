...
class PhoenixVision:
    def __init__(self, fotos_dir, show_certainty=False):
        self.fotos_dir = fotos_dir
        self.show_certainty = show_certainty
        self.rostos = []
        self.nomes = []
    ...
    def _carregar_fotos(self):
        for nome_pessoa in os.listdir(self.fotos_dir):
            for nome_imagem in os.listdir(os.path.join(self.fotos_dir, nome_pessoa)):
                ...
                imagem_preprocessada = self._preprocessar_imagem(imagem)
                self.rostos.append(imagem_preprocessada)
    ...
    def _preprocessar_imagem(self, imagem):
        ...
        # Reduz o ruído com filtro Gaussian
    ...
    def certainty(self, enable):
        self.show_certainty = enable
