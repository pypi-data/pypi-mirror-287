...
def landau_pdf(x, loc, scale):
    ...
    # Transform x with location and scale
    z = (x - loc) / scale

    # Calculation using the real part of the complex error function
    # The use of sp.wofz corresponds to Faddeeva function w(z)
