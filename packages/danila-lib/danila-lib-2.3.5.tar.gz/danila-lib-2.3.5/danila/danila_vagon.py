...
class Danila_vagon:
    def __init__(self, yolov5_dir, danila_vagon_params):
        self.danila_vagon_params = danila_vagon_params
        self.danila_vagon_text_detect = Danila_vagon_text_detect(yolov5_dir, self.danila_vagon_params.danila_vagon_text_detect_params)
        self.danila_vagon_text_recognize = Danila_vagon_text_recognize(yolov5_dir, self.danila_vagon_params.danila_vagon_text_recognize_params)
