...
class Danila_v11:
    def __init__(self, yolov5_dir, detail_classify_version = 1,
        ...
        self.danila_vagon = Danila_vagon(yolov5_dir, danila_vagon_params)
        ...
        danila_balka_params = Danila_balka_params(danila_balka_classify_params, danila_balka_text_detect_params)
