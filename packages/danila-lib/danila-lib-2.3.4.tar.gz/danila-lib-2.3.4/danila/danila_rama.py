...
class Danila_rama:
    def __init__(self, yolov5_dir, danila_rama_params):
        ...
        self.danila_rama_text_detect = Danila_rama_text_detect(yolov5_dir, self.danila_rama_params.danila_rama_text_detect_params)
        self.danila_rama_text_recognize = Danila_rama_text_recognize(yolov5_dir, self.danila_rama_params.danila_rama_text_recognize_params)
