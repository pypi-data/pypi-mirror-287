...
class Danila:
    ...
    def __init__(self, yolov5_dir, detail_classify_version = 1,
        ...
        self.danila = Danila_v11(yolov5_dir, detail_classify_version,
    ...
    def balka_classify(self, img, size = 256):
        return self.danila.balka_classify(img, size)

    def balka_text_detect(self, img, size = 256):
        return self.danila.balka_text_detect(img,size)

    def balka_text_recognize(self, img, size = 256):
        return self.danila.balka_text_recognize(img, size)