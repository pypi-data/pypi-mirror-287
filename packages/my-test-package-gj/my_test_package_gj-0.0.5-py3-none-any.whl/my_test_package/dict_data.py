...
get_instruments_type_dict = {
    # trading_hour 和 trading_hours重复 交易时间--从交易参数表获取TRADESECTION
    # commodity------PRODUCTCODE品种代码--从交易参数表获取（返回的数据中并没有该字段）
    "future": {
        "instrumentid": "order_book_id", "exchangeid": "exchange", "commodity": "commodity",
    ...
    # trading_hour 交易时间--从交易参数表获取
    # PRODUCTCODE品种代码--从交易参数表获取（返回的数据中并没有该字段）
    "option": {
        "instrumentid": "order_book_id", "exchangeid": "exchange", "": "commodity",
        ...
        "volumemultiple": "contract_multiplier", "trading_hour": "trading_hour"
    }
}
