...
from api.encryption.events.startup import register_encryption_keys_startup_events
...
def init_listeners(app_: FastAPI) -> None:
    ...
    async def unhandled_exception_handler(request: Request, exc: Exception):
        ...
        return JSONResponse(
            status_code=500,
            content={"error_code": 500, "success": False, "message": "An unexpected error occurred. Please try again later."}
        )
...
def create_app() -> FastAPI:
    ...
    # Add startup events
    register_encryption_keys_startup_events(app_)
