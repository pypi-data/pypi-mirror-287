...
class HttpAccountServiceClient(BaseRESTHttpClient, IAccountServiceClient):
    """
    ...
    def __new__(cls):
        """
        Ensure only one instance (singleton) of HttpAccountServiceClient exists.
        """
        if cls._instance is None:
            cls._instance = super(HttpAccountServiceClient, cls).__new__(cls)
            cls._instance.init_singleton()
        return cls._instance

    def init_singleton(self):
        """
        Initialize the singleton instance of the client with the base URL from configuration.
        """
