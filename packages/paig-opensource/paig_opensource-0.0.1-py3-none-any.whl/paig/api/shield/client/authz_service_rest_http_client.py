...
class HttpAuthzClient(BaseRESTHttpClient, IAuthzClient):
    """
    ...
    def post_authorize(self, authz_req: AuthzServiceRequest, tenant_id: str) -> AuthzServiceResponse:
        """
    ...
    def post_init_authz(self, tenant_id: str, user_role: str) -> None:
        """
    ...
    def post_authorize_vectordb(self, authz_req: AuthorizeVectorDBRequest, tenant_id: str) -> AuthorizeVectorDBResponse:
        """
