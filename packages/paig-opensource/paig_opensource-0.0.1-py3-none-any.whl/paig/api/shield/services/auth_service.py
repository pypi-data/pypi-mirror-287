...
class AuthService:
    ...
    def __init__(self, authz_service_client_factory=Depends(AuthzServiceClientFactory),
                 data_store_controller: DataStoreController = Depends(DataStoreController),
                 account_service_factory: AccountServiceFactory = Depends(AccountServiceFactory)):
        """
    ...
    def do_authz_authorize(self, auth_req: AuthorizeRequest, result_entities):
        """
        ...
        return self.authz_service_client.post_authorize(authz_service_req, auth_req.tenant_id)
