...
class AuthorizeRequestValidator:
    ...
    def __init__(self, paig_authorizer: PAIGAuthorizer = Depends(RDSBasedPaigAuthorizer)):
...
class PAIGAuthorizerService:
    ...
    def __init__(self, paig_authorizer: PAIGAuthorizer = Depends(RDSBasedPaigAuthorizer),
                 authorize_request_validator: AuthorizeRequestValidator = Depends(AuthorizeRequestValidator)):
        self.paig_authorizer = paig_authorizer
