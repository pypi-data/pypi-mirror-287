...
class GovServiceValidationUtil:
    ...
    def __init__(
            self,
            ai_app_config_service: AIAppConfigService = Depends(AIAppConfigService),
            ai_app_policy_service: AIAppPolicyService = Depends(AIAppPolicyService),
            vector_db_policy_service: VectorDBPolicyService = Depends(VectorDBPolicyService),
            tag_service: TagService = Depends(TagService),
            meta_data_service: MetadataKeyService = Depends(MetadataKeyService),
            meta_data_attr_service: MetadataValueService = Depends(MetadataValueService)):
