...
class AIApplicationView(BaseView):
    ...
    description: str = Field(default=None, description="The description of the AI application")
    application_key: str = Field(None, description="The application key", alias="applicationKey")
