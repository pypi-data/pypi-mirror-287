...
from core.exceptions.error_messages_parser import get_error_message, ERROR_RESOURCE_NOT_FOUND, \
    ERROR_RESOURCE_ALREADY_EXISTS, ERROR_FIELD_REQUIRED, ERROR_FIELD_VALUE_INVALID
from core.utils import validate_id, validate_string_data, validate_boolean
...
class AIAppPolicyRequestValidator:
    ...
    def __init__(self, ai_app_policy_repository: AIAppPolicyRepository = Depends(AIAppPolicyRepository), ai_app_repository: AIAppRepository = Depends(AIAppRepository)):
...
class AIAppPolicyService(BaseController[AIApplicationPolicyModel, AIApplicationPolicyView]):
    ...
    def __init__(self, ai_app_policy_repository: AIAppPolicyRepository = Depends(AIAppPolicyRepository), policy_request_validator: AIAppPolicyRequestValidator = Depends(AIAppPolicyRequestValidator)):
