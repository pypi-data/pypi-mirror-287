...
class AIAppRequestValidator:
    ...
    def __init__(self, ai_app_repository: AIAppRepository = Depends(AIAppRepository), vector_db_repository: VectorDBRepository = Depends(VectorDBRepository)):
...
class AIAppService(BaseController[AIApplicationModel, AIApplicationView]):
    ...
    def __init__(self, ai_app_repository: AIAppRepository = Depends(AIAppRepository),
                 ai_app_request_validator: AIAppRequestValidator = Depends(AIAppRequestValidator)):
        """
