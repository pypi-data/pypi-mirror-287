...
class AIAppConfigRequestValidator:
    ...
    def __init__(self, ai_app_repository: AIAppRepository = Depends(AIAppRepository)):
...
class AIAppConfigService(BaseController[AIApplicationConfigModel, AIApplicationConfigView]):
    ...
    def __init__(self, ai_app_config_repository: AIAppConfigRepository = Depends(AIAppConfigRepository), app_config_request_validator: AIAppConfigRequestValidator = Depends(AIAppConfigRequestValidator)):
