...
from core.utils import validate_id, validate_string_data
...
class MetadataValueRequestValidator:
    ...
    def __init__(self, metadata_value_repository: MetadataValueRepository = Depends(MetadataValueRepository)):
...
class MetadataValueService(BaseController[VectorDBMetaDataValueModel, MetadataValueView]):
    ...
    def __init__(self, metadata_attr_repository: MetadataValueRepository = Depends(MetadataValueRepository),
                 metadata_attr_request_validator: MetadataValueRequestValidator = Depends(MetadataValueRequestValidator)):
        """
