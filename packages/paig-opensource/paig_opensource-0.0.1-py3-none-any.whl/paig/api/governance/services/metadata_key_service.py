...
class MetadataKeyRequestValidator:
    ...
    def __init__(self, metadata_key_repository: MetadataKeyRepository = Depends(MetadataKeyRepository)):
...
class MetadataKeyService(BaseController[VectorDBMetaDataKeyModel, MetadataKeyView]):
    ...
    def __init__(self, metadata_repository: MetadataKeyRepository = Depends(MetadataKeyRepository),
                 metadata_request_validator: MetadataKeyRequestValidator = Depends(MetadataKeyRequestValidator)):
        """
