...
from core.utils import validate_string_data, validate_boolean, validate_id
...
class VectorDBRequestValidator:
    ...
    def __init__(self, vector_db_repository: VectorDBRepository = Depends(VectorDBRepository), ai_app_repository: AIAppRepository = Depends(AIAppRepository)):
...
class VectorDBService(BaseController[VectorDBModel, VectorDBView]):
    ...
    def __init__(self,
                 vector_db_repository: VectorDBRepository = Depends(VectorDBRepository),
                 ai_app_repository: AIAppRepository = Depends(AIAppRepository),
                 vector_db_request_validator: VectorDBRequestValidator = Depends(VectorDBRequestValidator)):
