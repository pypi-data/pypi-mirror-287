...
from core.utils import validate_string_data, validate_id, validate_boolean
...
class VectorDBPolicyRequestValidator:
    ...
    def __init__(self, vector_db_policy_repository: VectorDBPolicyRepository = Depends(VectorDBPolicyRepository), vector_db_repository: VectorDBRepository = Depends(VectorDBRepository)):
...
class VectorDBPolicyService(BaseController[VectorDBPolicyModel, VectorDBPolicyView]):
    ...
    def __init__(self,
                 vector_db_policy_repository: VectorDBPolicyRepository = Depends(VectorDBPolicyRepository),
                 vector_db_policy_request_validator: VectorDBPolicyRequestValidator = Depends(VectorDBPolicyRequestValidator)):
