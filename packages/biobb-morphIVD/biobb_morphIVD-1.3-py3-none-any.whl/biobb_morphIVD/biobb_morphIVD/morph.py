...
#*************************************************************************************************
#******    Program that morphs a source IVD mesh to a target, the patient-specific model    ******
...
# container folder
pathTemplate = pathSources + 'template'  # source folder: template mesh point cloud
...
pathInp = pathResults + 'inputs'  # .inp folder: folder that contains the .inp final files
...
if regCEP == 1:
    fileTargetCEPupper = "IVD_" + numberIVD + "_nodesOnSurface_CEPupper_" + patient + ".txt"
    fileTargetCEPlower = "IVD_" + numberIVD + "_nodesOnSurface_CEPlower_" + patient + ".txt"
    
    fileTargetCEPupper_up = "IVD_" + numberIVD + "_nodesOnSurface_CEPupper_up_" + patient + ".txt"
    fileTargetCEPupper_down = "IVD_" + numberIVD + "_nodesOnSurface_CEPupper_down_" + patient + ".txt"

    fileTargetCEPlower_up = "IVD_" + numberIVD + "_nodesOnSurface_CEPlower_up_" + patient + ".txt"
    fileTargetCEPlower_down = "IVD_" + numberIVD + "_nodesOnSurface_CEPlower_down_" + patient + ".txt"
...
if regCEP == 1:
    fileTemplateCEPupperRigid = "template_CEPupperRigid_" + numberIVD + "_" + patient + ".txt"
    fileTemplateCEPupperUpRigid = "template_CEPupperUpRigid_" + numberIVD + "_" + patient + ".txt"
    fileTemplateCEPupperDownRigid = "template_CEPupperDownRigid_" + numberIVD + "_" + patient + ".txt"
    
    fileTemplateCEPlowerRigid = "template_CEPlowerRigid_" + numberIVD + "_" + patient + ".txt"
    fileTemplateCEPlowerUpRigid = "template_CEPlowerUpRigid_" + numberIVD + "_" + patient + ".txt"
    fileTemplateCEPlowerDownRigid = "template_CEPlowerDownRigid_" + numberIVD + "_" + patient + ".txt"
...
outPutFileNodesOnSurfaceAFwoNodesCEP = 'nodesOnSurfaceAFwoNodesCEP_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceNPwoNodesCEP = 'nodesOnSurfaceNPwoNodesCEP_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceAFwNodesCEP = 'nodesOnSurfaceAFwNodesCEP_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceNPwNodesCEP = 'nodesOnSurfaceNPwNodesCEP_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPupper = 'nodesOnSurfaceCEPupper_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPupperUp = 'nodesOnSurfaceCEPupper_up_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPupperDown = 'nodesOnSurfaceCEPupper_down_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPlower = 'nodesOnSurfaceCEPlower_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPlowerUp = 'nodesOnSurfaceCEPlower_up_' + numberIVD + '_' + patient + '_'
outPutFileNodesOnSurfaceCEPlowerDown = 'nodesOnSurfaceCEPlower_down_' + numberIVD + '_' + patient + '_'
...
if interpo == 0:
    ...
    outPutFileNodesOnSurfaceAFwoNodesCEPE = outPutFileNodesOnSurfaceAFwoNodesCEP + "y.interpolated.txt"
    outPutFileNodesOnSurfaceNPwoNodesCEPE = outPutFileNodesOnSurfaceNPwoNodesCEP + "y.interpolated.txt"
    outPutFileNodesOnSurfaceAFwNodesCEPE = outPutFileNodesOnSurfaceAFwNodesCEP + "y.interpolated.txt"
    outPutFileNodesOnSurfaceNPwNodesCEPE = outPutFileNodesOnSurfaceNPwNodesCEP + "y.interpolated.txt"
    ...
    outPutFileNodesOnSurfaceCEPupperUpE = outPutFileNodesOnSurfaceCEPupperUp + "y.interpolated.txt"
    outPutFileNodesOnSurfaceCEPupperDownE = outPutFileNodesOnSurfaceCEPupperDown + "y.interpolated.txt"
    outPutFileNodesOnSurfaceCEPlowerE = outPutFileNodesOnSurfaceCEPlower + "y.interpolated.txt"
    outPutFileNodesOnSurfaceCEPlowerUpE = outPutFileNodesOnSurfaceCEPlowerUp + "y.interpolated.txt"
    outPutFileNodesOnSurfaceCEPlowerDownE = outPutFileNodesOnSurfaceCEPlowerDown + "y.interpolated.txt"
...
if regCEP == 1:
    fileTargetCEPupper = "IVD_" + numberIVD + "_nodesOnSurface_CEPupper_" + patient + "_newCoords.txt"
    fileTargetCEPlower = "IVD_" + numberIVD + "_nodesOnSurface_CEPlower_" + patient + "_newCoords.txt"
...
if surfRegCEP == 1:
    ...
    fileNodesOnSurfaceAFwoNodesCEP = "IVD_" + numberIVD + "_nodesOnSurfaceAFwoNodesCEP_" + patient + ".txt"
    fileNodesOnSurfaceNPwoNodesCEP = "IVD_" + numberIVD + "_nodesOnSurfaceNPwoNodesCEP_" + patient + ".txt"
    fileNodesOnSurfaceCEPupper = "IVD_" + numberIVD + "_nodesOnSurfaceCEPupper_" + patient + ".txt"
    fileNodesOnSurfaceCEPupperUp = "IVD_" + numberIVD + "_nodesOnSurfaceCEPupper_up_" + patient + ".txt"
    fileNodesOnSurfaceCEPupperDown = "IVD_" + numberIVD + "_nodesOnSurfaceCEPupper_down_" + patient + ".txt"
    fileNodesOnSurfaceCEPlower = "IVD_" + numberIVD + "_nodesOnSurfaceCEPlower_" + patient + ".txt"
    fileNodesOnSurfaceCEPlowerUp = "IVD_" + numberIVD + "_nodesOnSurfaceCEPlower_up_" + patient + ".txt"
    fileNodesOnSurfaceCEPlowerDown = "IVD_" + numberIVD + "_nodesOnSurfaceCEPlower_down_" + patient + ".txt"
    print('-------------------------------------------------------------------------------')
    print(' ')
    ...
    if regCEP == 1:
        ...
        funcNodesOnSurfaceCEPupperUP = defFuncNonRigid(pathTarget + "/" + fileTargetCEPupper_up, pathOutToInp + "/" + fileNodesOnSurfaceCEPupperUp, outPutFileNodesOnSurfaceCEPupperUp, 0.7, 2.0, 1000, line_count_CEPupperUp, len(nodesCEPupper_up))
        funcNodesOnSurfaceCEPupperDown = defFuncNonRigid(pathTarget + "/" + fileTargetCEPupper_down, pathOutToInp + "/" + fileNodesOnSurfaceCEPupperDown, outPutFileNodesOnSurfaceCEPupperDown, 0.7, 2.0, 1000, line_count_CEPupperDown, len(nodesCEPupper_down))

        funcNodesOnSurfaceCEPlowerUP = defFuncNonRigid(pathTarget + "/" + fileTargetCEPlower_up, pathOutToInp + "/" + fileNodesOnSurfaceCEPlowerUp, outPutFileNodesOnSurfaceCEPlowerUp, 0.7, 2.0, 1000, line_count_CEPlowerUp, len(nodesCEPlower_up))
        funcNodesOnSurfaceCEPlowerDown = defFuncNonRigid(pathTarget + "/" + fileTargetCEPlower_down, pathOutToInp + "/" + fileNodesOnSurfaceCEPlowerDown, outPutFileNodesOnSurfaceCEPlowerDown, 0.7, 2.0, 1000, line_count_CEPlowerDown, len(nodesCEPlower_down))
        
        
        funcNodesOnSurfaceCEPupper = defFuncNonRigid(pathTarget + "/" + fileTargetCEPupper, pathOutToInp + "/" + fileNodesOnSurfaceCEPupper, outPutFileNodesOnSurfaceCEPupper, 0.7, 2.0, 1000, line_count_CEPupper, len(nodesOnSurfaceCEPupper))

        funcNodesOnSurfaceCEPlower = defFuncNonRigid(pathTarget + "/" + fileTargetCEPlower, pathOutToInp + "/" + fileNodesOnSurfaceCEPlower, outPutFileNodesOnSurfaceCEPlower, 0.7, 2.0, 1000, line_count_CEPlower, len(nodesOnSurfaceCEPlower))

        #-------------------------------------------------------------------------------
        # CEP upper:

        defNonRigid("CEP upper Up:", numberIVD, patient, funcNodesOnSurfaceCEPupperUP, outPutFileNodesOnSurfaceCEPupperUp, pathOutToInp)
        defNonRigid("CEP upper Down:", numberIVD, patient, funcNodesOnSurfaceCEPupperDown, outPutFileNodesOnSurfaceCEPupperDown, pathOutToInp)
#        defNonRigid("CEP upper:", numberIVD, patient, funcNodesOnSurfaceCEPupper, outPutFileNodesOnSurfaceCEPupper, pathOutToInp)

        #-------------------------------------------------------------------------------
        # CEP lower:
        defNonRigid("CEP lower Up:", numberIVD, patient, funcNodesOnSurfaceCEPlowerUP, outPutFileNodesOnSurfaceCEPlowerUp, pathOutToInp)
        defNonRigid("CEP lower Down:", numberIVD, patient, funcNodesOnSurfaceCEPlowerDown, outPutFileNodesOnSurfaceCEPlowerDown, pathOutToInp)
...
# THIS PART IT IS JUST TO OBTAIN THE INTERNAL CEP NODES
    ...
    funcNodesOnSurfaceAFwNodesCEP = defFuncNonRigid(pathTarget + "/" + fileTargetAF, pathOutToInp + "/" + fileNodesOnSurfaceAFwNodesCEP,
                                                    outPutFileNodesOnSurfaceAFwNodesCEP, 1.0, 2.0, 1000, line_count_AF, len(nodesOnSurfaceAFwNodesCEP))

    funcNodesOnSurfaceNPwNodesCEP = defFuncNonRigid(pathTarget + "/" + fileTargetNP, pathOutToInp + "/" + fileNodesOnSurfaceNPwNodesCEP,
                                                    outPutFileNodesOnSurfaceNPwNodesCEP, 1.0, 2.0, 1000, line_count_NP, len(nodesOnSurfaceNPwNodesCEP))
...
funcAF = defFuncNonRigid(targetAF, templateAF, outPutFileAF,
                         3.0, 2.0, 1000, lenNodesTargetNumberAF, lenNodesTemplateNumberAF)
...
funcNP = defFuncNonRigid(targetNP, pathOutToInp + "/" + outPutFileNPE, outPutFileNP,
                         3.0, 2.0, 1000, lenNodesTargetNumberNP, lenNodesTemplateNumberNP)

funcMorphed = defFuncNonRigid(pathOutToInp + "/" + fileMorphed, templateMorphed, outPutFileMorphed,
                              3.0, 2.0, 1000, lenNodeMorphed, lenNodeMorphed)
...
if checkHaus == 1:
    ...
    print("")
    distAFscale, avgAFscale, medianAFscale = hausdorff(AFCoordToCheckPS, AFCoordToCheckScale)

    print("comparing the NP PS with the scaled one...")
    print("")
    distNPscale, avgNPscale, medianNPscale = hausdorff(NPCoordToCheckPS, NPCoordToCheckScale)
...
#-------------------------------------------------------------------------------------------------------------------------------------------------------------------
print("the file " + outPutFileEuclidean + " has been created in the folder " + pathCompleted)
print("")      
