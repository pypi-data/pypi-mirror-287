...
from biobb_morphIVD import morphIVD
from biobb_morphIVD.morphIVD import common
...
def main(args):
    ...
    global_log.info("step2_mesh: paths and prop {} ".format(global_prop["step2_mesh"]))

    global_log.info("step2_mesh: Running Simulation Model with Abaqus")
    common.morph(**global_paths["step2_mesh"], properties=global_prop["step2_mesh"])
