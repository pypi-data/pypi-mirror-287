...
def update_form_settings_details(req, form_id):
    ...
    if form_settings:
        ...
        if existing_gsheet_url:
            ...
            if gsheet_enabled == 'True':
                ...
                create_update_gsheet(req, form, form_gsheet_mapping_history, gsheet_type=gsheet_type,
                                     existing_gsheet_url=existing_gsheet_url)
        ...
        if recaptcha_enabled and gsheet_enabled == 'True':
            ...
            FormSettings.objects.create(form=form, gsheet_enabled=gsheet_enabled,
                                                        gsheet_type=gsheet_type)
...
def create_update_gsheet(req, form, form_gsheet_mapping_history, gsheet_type=GSHEET_TYPES[0][0],existing_gsheet_url=None, sheet_name=None):
    """
    ...
    if gsheet_type == GSHEET_TYPES[0][0]:
        ...
        gsheet = threading.Thread(target=update_existing_gsheet_url, args=(req, form, form_gsheet_mapping_history))
        gsheet.start()
...
def update_existing_gsheet_url(req, form, form_gsheet_mapping_history):
    """
    ...
    form.spreadsheet_id = spreadsheet_id
    form.sub_sheet_id = sub_sheet_id
    form.save()
