...
def create_gsheet_map_form(form, fields, gsheet_type):
    """
    ...
    if gc:
        ...
        try:
            ...
            if form.account.admin_email:
                ...
                add_field_labels_to_gsheet(fields, form, gsheet_type, spreadsheet.url, spreadsheet)
...
def create_spreadsheet_in_user_google_account(request, form, fields, gsheet_type):
    """
    ...
    try:
        ...
        add_field_labels_to_gsheet(fields, form, gsheet_type, spreadsheet_url, spreadsheet)
    ...
    if method == 'save':
        ...
        try:
            if worksheet:
                ...
                # Find the row with the form_submission_id
                form_submission_id_col = 1  # Assuming the first column contains the form_submission_id
