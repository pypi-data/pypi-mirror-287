        ...
        while True:
            ...
            for sub_list in sub_lists:
                if len(sub_list) > 0:
                    ...
                    #       len(target_list))
                    print("remaining_files: ", self.pending_file_queue.qsize(), " cache_queue_size: ", self.src_data_queue.qsize(),
                          " waiting_write_queue_size: ", self.tra_data_queue.qsize(), threading.current_thread().name, " translating_lists_size: ",
                          len(target_list))
