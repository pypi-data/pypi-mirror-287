...
class Tracker:
    ...
    def __len__(self) -> int:
        is_current_task = self.current_task is not None
        return len(self.history) + int(is_current_task)
    ...
    def update(self, new_task: Task | None = None, save_to_history: bool = True) -> None:
