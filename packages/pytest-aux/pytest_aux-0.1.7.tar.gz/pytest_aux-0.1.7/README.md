![Ver/TestedPython](https://img.shields.io/pypi/pyversions/pytest_aux)
...
# pytest_aux (current v0.1.7/![Ver/Pypi Latest](https://img.shields.io/pypi/v/pytest_aux?label=pypi%20latest))
