...
""",
    ...
    def list(
        ...
        **kwargs
        ...
        response = Util().request_apiv2(
            "GET", TESTS_URL, api_key, params=request_params
        )
        return response
    ...
    def _list(self):
        ...
        parser = argparse.ArgumentParser(
            description="List tests stored on DefectDojo",
    ...
    def update(
        ...
        **kwargs
        ...
        # Make the request
        response = Util().request_apiv2(
            "PATCH", TESTS_ID_URL, api_key, data=request_json
        )
        return response
    ...
    def _update(self):
        # Read user-supplied arguments
        parser = argparse.ArgumentParser(
            description="Update a test on DefectDojo",
        ...
        parser.add_argument("test_id", help="ID of the test to be updated")
        ...
        optional.add_argument("--title", help="Test title")

        optional.add_argument("--desc", help="Test description", metavar="DESCRIPTION")
        ...
        optional.add_argument("--version", help="Test version")
        ...
        optional.add_argument("--environment", help="Test environment")
    ...
    def _create(self):
        # Read user-supplied arguments
        parser = argparse.ArgumentParser(
            description="Create a test on DefectDojo",
        ...
        optional.add_argument(
            "--start_date",
            help="Test starting date (default = TODAY)",
        ...
        optional.add_argument(
            "--end_date",
            help="Test ending date (default = TODAY)",
            metavar="YYYY-MM-DDThh:mm[:ss[.uuuuuu]][+HH:MM|-HH:MM|Z]",
            default=datetime.now().strftime("%Y-%m-%dT%H:%M"),
        )
        ...
        **kwargs
        ...
        if env:
            ...
            if type(env) is int:
                ...
                temp_response = Util().request_apiv2(
                    "GET", API_URL + "/development_environments/", api_key
                )
