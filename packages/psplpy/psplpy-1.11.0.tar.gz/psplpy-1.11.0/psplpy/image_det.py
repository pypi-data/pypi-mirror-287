...
class TextInfo:
    def __init__(self, region: list, text: str, confidence: float):
    ...
    def __str__(self):
        return f'({self.rect}, {self.text}, {self.confidence:.4f})'
...
class TxtDet:
    def __init__(self, txt_processor: TxtProcessor = None, process_text: bool = True):
        self.txt_processor = txt_processor or TxtProcessor()
