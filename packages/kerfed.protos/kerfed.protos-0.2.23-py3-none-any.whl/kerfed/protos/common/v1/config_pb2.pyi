...
class PartConfiguration(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["color_id", b"color_id", "cots_id", b"cots_id", "expedite", b"expedite", "finish_id", b"finish_id", "material_id", b"material_id", "method_id", b"method_id", "notes", b"notes", "posts", b"posts", "quantity", b"quantity", "thickness_id", b"thickness_id"]) -> None: ...
