...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_url=None, name=None, hidden=False, pulp_last_updated=None, pulp_labels=None, base_path=None, pulp_created=None, pulp_href=None, content_guard=None, local_vars_configuration=None):  # noqa: E501
