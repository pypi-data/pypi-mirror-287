...
def write_log(text, directory=".",prefix="write_log", if_print=False):
    """
    简单写文件。
    ...
    filename = f"lyylog2/{prefix}_{current_date}.log"
    ...
    if os.isatty(sys.stdout.fileno()) and if_print:
        print(f"日志已写入到 {file_path}, text = "+text)
...
if __name__ == "__main__":
    ...
    write_log("这是写的日志")
    write_log("这是写的日志",if_print=True, prefix="这是前缀")