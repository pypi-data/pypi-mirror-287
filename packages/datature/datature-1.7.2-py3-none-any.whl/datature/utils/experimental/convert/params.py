...
class DockerParams:
    ...
    conversion_docker_image: Optional[
        str] = "nvcr.io/nvidia/tensorflow:23.04-tf2-py3"
    inference_docker_image: Optional[
        str] = "nvcr.io/nvidia/tritonserver:23.04-py3"
...
class ConversionExperimentalParams:
    ...
    sanitize_params: SanitizeParams = SanitizeParams()
