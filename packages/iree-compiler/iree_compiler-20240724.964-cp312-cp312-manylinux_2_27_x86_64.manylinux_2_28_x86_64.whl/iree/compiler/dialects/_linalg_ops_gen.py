  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_693')) else
          _ods_ir.AttrBuilder.get('anonymous_693')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_693')) else
          _ods_ir.AttrBuilder.get('anonymous_693')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class Conv2DNchwFchwOp(_ods_ir.OpView):
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        isinstance(strides, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_703')) else
          _ods_ir.AttrBuilder.get('anonymous_703')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_703')) else
          _ods_ir.AttrBuilder.get('anonymous_703')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
  ...
  def __init__(self, result_tensors, inputs, outputs, *, strides=None, dilations=None, loc=None, ip=None):
    ...
    if strides is not None: attributes["strides"] = (strides if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_731')) else
          _ods_ir.AttrBuilder.get('anonymous_731')(strides, context=_ods_context))
    if dilations is not None: attributes["dilations"] = (dilations if (
        isinstance(dilations, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('anonymous_731')) else
          _ods_ir.AttrBuilder.get('anonymous_731')(dilations, context=_ods_context))
    results.extend(result_tensors)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def winograd_filter_transform(result, filter, output, m, r, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WinogradFilterTransformOp(result=result, filter=filter, output=output, m=m, r=r, loc=loc, ip=ip))
...
def winograd_input_transform(result, input, output, m, r, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WinogradInputTransformOp(result=result, input=input, output=output, m=m, r=r, loc=loc, ip=ip))
...
def winograd_output_transform(result, value, output, m, r, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(WinogradOutputTransformOp(result=result, value=value, output=output, m=m, r=r, loc=loc, ip=ip))
