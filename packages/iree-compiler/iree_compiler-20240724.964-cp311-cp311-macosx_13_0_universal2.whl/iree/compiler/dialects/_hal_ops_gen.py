...
def allocator_allocate(result, allocator, queue_affinity, memory_types, buffer_usage, result_size, *, loc=None, ip=None) -> _ods_ir.Value:
...
def allocator_import(did_import, result, allocator, queue_affinity, memory_types, buffer_usage, source, offset, length, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def buffer_view_create(result, source_buffer, source_offset, source_length, element_type, encoding_type, shape, *, loc=None, ip=None) -> _ods_ir.Value:
...
def buffer_view_dim(result, buffer_view, index, *, loc=None, ip=None) -> _ods_ir.Value:
...
def buffer_view_element_type(result, buffer_view, *, loc=None, ip=None) -> _ods_ir.Value:
...
def buffer_view_encoding_type(result, buffer_view, *, loc=None, ip=None) -> _ods_ir.Value:
...
def buffer_view_rank(result, buffer_view, *, loc=None, ip=None) -> _ods_ir.Value:
...
def channel_create(result, device, queue_affinity, flags, id, group, rank, count, *, loc=None, ip=None) -> _ods_ir.Value:
...
def channel_rank_and_count(rank, count, channel, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def channel_split(result, channel, color, key, flags, *, loc=None, ip=None) -> _ods_ir.Value:
...
def command_buffer_create(result, device, modes, command_categories, *, binding_capacity=None, loc=None, ip=None) -> _ods_ir.Value:
...
def command_buffer_device(device, command_buffer, *, loc=None, ip=None) -> _ods_ir.Value:
...
class DescriptorSetLayoutCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, flags, bindings, *, loc=None, ip=None):
    ...
    isinstance(bindings, _ods_ir.Attribute) or
...
def descriptor_set_layout_create(result, device, flags, bindings, *, loc=None, ip=None) -> _ods_ir.Value:
...
def device_allocator(result, device, *, loc=None, ip=None) -> _ods_ir.Value:
...
def device_queue_alloca(result, device, queue_affinity, wait_fence, signal_fence, pool, memory_types, buffer_usage, result_size, *, loc=None, ip=None) -> _ods_ir.Value:
...
class DeviceQueueExecuteIndirectOp(_ods_ir.OpView):
  ...
  @builtins.property
  def wait_fence(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 2, 0)
    return self.operation.operands[start]

  @builtins.property
  def signal_fence(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 3, 0)
    return self.operation.operands[start]

  @builtins.property
  def command_buffer(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 4, 0)
    return self.operation.operands[start]

  @builtins.property
  def binding_buffers(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 5, 0)
    return self.operation.operands[start:start + pg]

  @builtins.property
  def binding_offsets(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 5, 1)
    return self.operation.operands[start:start + pg]

  @builtins.property
  def binding_lengths(self):
    start, pg = _ods_equally_sized_accessor(operation.operands, 3, 5, 2)
    return self.operation.operands[start:start + pg]
...
def device_queue_execute_indirect(device, queue_affinity, wait_fence, signal_fence, command_buffer, binding_buffers, binding_offsets, binding_lengths, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(DeviceQueueExecuteIndirectOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, command_buffer=command_buffer, binding_buffers=binding_buffers, binding_offsets=binding_offsets, binding_lengths=binding_lengths, loc=loc, ip=ip))
...
def devices_count(result, *, loc=None, ip=None) -> _ods_ir.Value:
...
def devices_get(result, index, *, loc=None, ip=None) -> _ods_ir.Value:
...
def dispatch_extern(results_, export, workload, arguments, argument_dims, result_dims, layout, targets, target_ordinals, target_objects, num_target_regions, *, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, bindings=None, tied_operands=None, loc=None, ip=None) -> _ods_ir.Value:
...
def element_type(result, type_, *, loc=None, ip=None) -> _ods_ir.Value:
...
def encoding_type(result, *, encoding=None, loc=None, ip=None) -> _ods_ir.Value:
...
def ex_file_from_memory(result, device, queue_affinity, access, buffer, offset, length, flags, *, loc=None, ip=None) -> _ods_ir.Value:
...
def executable_calculate_workgroups(workgroup_x, workgroup_y, workgroup_z, device, entry_point, workload, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_773')) else
      _ods_ir.AttrBuilder.get('anonymous_773')(function_type, context=_ods_context))
...
def executable_create(result, device, executable_target, layouts, constants, *, loc=None, ip=None) -> _ods_ir.Value:
...
def executable_export(sym_name, layout, *, sym_visibility=None, ordinal=None, workgroup_size=None, subgroup_size=None, workgroup_local_memory=None, source_locs=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableExportOp(sym_name=sym_name, layout=layout, sym_visibility=sym_visibility, ordinal=ordinal, workgroup_size=workgroup_size, subgroup_size=subgroup_size, workgroup_local_memory=workgroup_local_memory, source_locs=source_locs, loc=loc, ip=ip))
...
def executable_export_ordinal(result, entry_point, *, loc=None, ip=None) -> _ods_ir.Value:
...
def executable_lookup(result, device, executable, *, loc=None, ip=None) -> _ods_ir.Value:
...
def executable_variant(sym_name, target, *, sym_visibility=None, objects=None, sources=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ExecutableVariantOp(sym_name=sym_name, target=target, sym_visibility=sym_visibility, objects=objects, sources=sources, loc=loc, ip=ip))
...
def fence_await(status, timeout_millis, fences, *, loc=None, ip=None) -> _ods_ir.Value:
...
def fence_create(result, device, flags, *, loc=None, ip=None) -> _ods_ir.Value:
...
def fence_join(result, fences, *, loc=None, ip=None) -> _ods_ir.Value:
...
def fence_query(status, fence, *, loc=None, ip=None) -> _ods_ir.Value:
...
def instrument_memory_load(result, buffer, workgroup_key, load_value, base, indices, *, loc=None, ip=None) -> _ods_ir.Value:
...
def instrument_memory_store(result, buffer, workgroup_key, store_value, base, indices, *, loc=None, ip=None) -> _ods_ir.Value:
...
def instrument_value(result, buffer, workgroup_key, ordinal, operand, *, loc=None, ip=None) -> _ods_ir.Value:
...
def instrument_workgroup(workgroup_key, buffer, dispatch_id, *, loc=None, ip=None) -> _ods_ir.Value:
...
class InterfaceBindingSubspanOp(_ods_ir.OpView):
  ...
  def __init__(self, result, set, binding, descriptor_type, dynamic_dims, *, byte_offset=None, alignment=None, descriptor_flags=None, loc=None, ip=None):
    ...
    isinstance(set, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('IndexAttr')) else
    ...
    isinstance(descriptor_type, _ods_ir.Attribute) or
...
def interface_binding_subspan(result, set, binding, descriptor_type, dynamic_dims, *, byte_offset=None, alignment=None, descriptor_flags=None, loc=None, ip=None) -> _ods_ir.Value:
...
def interface_constant_load(result, index, *, alignment=None, values=None, loc=None, ip=None) -> _ods_ir.Value:
...
def interface_workgroup_count(result, dimension, *, loc=None, ip=None) -> _ods_ir.Value:
...
def interface_workgroup_id(result, dimension, *, loc=None, ip=None) -> _ods_ir.Value:
...
def interface_workgroup_size(result, dimension, *, loc=None, ip=None) -> _ods_ir.Value:
...
class PipelineLayoutCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, result, device, push_constants, set_layouts, *, loc=None, ip=None):
    ...
    isinstance(push_constants, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('IndexAttr')) else
...
def pipeline_layout_create(result, device, push_constants, set_layouts, *, loc=None, ip=None) -> _ods_ir.Value:
...
def pipeline_layout_lookup(result, device, layout, *, loc=None, ip=None) -> _ods_ir.Value:
...
class TensorAliasOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, source_dims, storage, *, wait_fence=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def tensor_alias(result, source, source_dims, storage, *, wait_fence=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TensorAliasOp(result=result, source=source, source_dims=source_dims, storage=storage, wait_fence=wait_fence, loc=loc, ip=ip))
...
class TensorExportOp(_ods_ir.OpView):
  ...
  def __init__(self, target, source, source_encoding, source_dims, *, name=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def tensor_export(target, source, source_encoding, source_dims, *, name=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(TensorExportOp(target=target, source=source, source_encoding=source_encoding, source_dims=source_dims, name=name, loc=loc, ip=ip))
...
def tensor_import(target, source, target_encoding, target_dims, *, wait_fence=None, name=None, loc=None, ip=None) -> _ods_ir.Value:
