...
import oneloop_client.models
from oneloop_client import rest
from oneloop_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(oneloop_client.models, klass)
