...
class AssistantsServiceApi(object):
    ...
    def assistants_service_get_internal_assistant(self, internal_assistant_name: 'str', **kwargs) -> 'V1GetInternalAssistantResponse':  # noqa: E501
        """assistants_service_get_internal_assistant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_get_internal_assistant(internal_assistant_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str internal_assistant_name: (required)
        :return: V1GetInternalAssistantResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.assistants_service_get_internal_assistant_with_http_info(internal_assistant_name, **kwargs)  # noqa: E501
        else:
            (data) = self.assistants_service_get_internal_assistant_with_http_info(internal_assistant_name, **kwargs)  # noqa: E501
            return data

    def assistants_service_get_internal_assistant_with_http_info(self, internal_assistant_name: 'str', **kwargs) -> 'V1GetInternalAssistantResponse':  # noqa: E501
        """assistants_service_get_internal_assistant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.assistants_service_get_internal_assistant_with_http_info(internal_assistant_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['internal_assistant_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method assistants_service_get_internal_assistant" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'internal_assistant_name' is set
        if ('internal_assistant_name' not in params or
                params['internal_assistant_name'] is None):
            raise ValueError("Missing the required parameter `internal_assistant_name` when calling `assistants_service_get_internal_assistant`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'internal_assistant_name' in params:
            path_params['internalAssistantName'] = params['internal_assistant_name']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/agents/{internalAssistantName}/getbyname', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='V1GetInternalAssistantResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
