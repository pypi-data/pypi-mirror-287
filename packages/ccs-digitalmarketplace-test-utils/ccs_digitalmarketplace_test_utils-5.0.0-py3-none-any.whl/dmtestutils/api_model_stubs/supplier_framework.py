...
class SupplierFrameworkStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "lotResponsesStatus": "not_required"
    }
    optional_keys = [
        ...
        ('lotResponsesStatus', 'lot_responses_status')
    ]
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get('with_lot_responses'):
            self.response_data['lotResponses'] = [
            ...
            self.response_data['lotResponsesStatus'] = kwargs.get('lot_responses_status', 'in_progress')
        else:
            self.response_data['lotResponses'] = []
