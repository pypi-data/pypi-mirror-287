...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_ceylon_checksum_func_version() != 8017:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_adminagent_broadcast() != 5239:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_adminagent_details() != 22456:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_adminagent_start() != 43415:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_adminagent_stop() != 21049:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_eventhandler_on_agent_connected() != 2829:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_messagehandler_on_message() != 4871:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_processor_run() != 45674:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workspace_run() != 17134:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workeragent_broadcast() != 48630:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workeragent_details() != 34993:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workeragent_start() != 42810:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_method_workeragent_stop() != 17928:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_constructor_adminagent_new() != 19623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_constructor_workspace_new() != 49344:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_ceylon_checksum_constructor_workeragent_new() != 16198:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_ceylon_fn_clone_adminagent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_clone_adminagent.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_free_adminagent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_free_adminagent.restype = None
_UniffiLib.uniffi_ceylon_fn_constructor_adminagent_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
...
_UniffiLib.uniffi_ceylon_fn_constructor_adminagent_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_method_adminagent_broadcast.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_adminagent_broadcast.restype = ctypes.c_uint64
_UniffiLib.uniffi_ceylon_fn_method_adminagent_details.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_method_adminagent_details.restype = _UniffiRustBuffer
_UniffiLib.uniffi_ceylon_fn_method_adminagent_start.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_adminagent_start.restype = ctypes.c_uint64
_UniffiLib.uniffi_ceylon_fn_method_adminagent_stop.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_ceylon_fn_method_adminagent_stop.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_ceylon_fn_clone_workspace.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_clone_workspace.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_free_workspace.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_free_workspace.restype = None
_UniffiLib.uniffi_ceylon_fn_constructor_workspace_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_constructor_workspace_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_method_workspace_run.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_workspace_run.restype = ctypes.c_uint64
_UniffiLib.uniffi_ceylon_fn_clone_workeragent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_clone_workeragent.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_free_workeragent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_free_workeragent.restype = None
_UniffiLib.uniffi_ceylon_fn_constructor_workeragent_new.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_constructor_workeragent_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_ceylon_fn_method_workeragent_broadcast.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_workeragent_broadcast.restype = ctypes.c_uint64
_UniffiLib.uniffi_ceylon_fn_method_workeragent_details.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_ceylon_fn_method_workeragent_details.restype = _UniffiRustBuffer
_UniffiLib.uniffi_ceylon_fn_method_workeragent_start.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_ceylon_fn_method_workeragent_start.restype = ctypes.c_uint64
_UniffiLib.uniffi_ceylon_fn_method_workeragent_stop.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_ceylon_fn_method_workeragent_stop.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_broadcast.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_broadcast.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_details.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_details.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_start.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_start.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_stop.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_adminagent_stop.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_ceylon_checksum_method_workspace_run.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workspace_run.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_broadcast.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_broadcast.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_details.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_details.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_start.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_start.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_stop.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_method_workeragent_stop.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_constructor_adminagent_new.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_constructor_adminagent_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_constructor_workspace_new.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_constructor_workspace_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_ceylon_checksum_constructor_workeragent_new.argtypes = (
)
_UniffiLib.uniffi_ceylon_checksum_constructor_workeragent_new.restype = ctypes.c_uint16
...
class AdminAgentProtocol(typing.Protocol):
    def broadcast(self, message: "bytes"):
        raise NotImplementedError
    def details(self, ):
        raise NotImplementedError
    def start(self, inputs: "bytes",workers: "typing.List[WorkerAgent]"):
        raise NotImplementedError
    def stop(self, ):
        raise NotImplementedError
...
class AdminAgent:
    ...
    def __init__(self, config: "AdminAgentConfig",on_message: "MessageHandler",processor: "Processor",on_event: "EventHandler"):
        _UniffiConverterTypeAdminAgentConfig.check_lower(config)
        ...
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_constructor_adminagent_new,
        _UniffiConverterTypeAdminAgentConfig.lower(config),
    ...
    def __del__(self):
        ...
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_free_adminagent, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_clone_adminagent, self._pointer)
    ...
    async def broadcast(self, message: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_adminagent_broadcast(
    ...
    def details(self, ) -> "AgentDetail":
        return _UniffiConverterTypeAgentDetail.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_method_adminagent_details,self._uniffi_clone_pointer(),)
        )




    async def start(self, inputs: "bytes",workers: "typing.List[WorkerAgent]") -> None:

        _UniffiConverterBytes.check_lower(inputs)
        
        _UniffiConverterSequenceTypeWorkerAgent.check_lower(workers)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_adminagent_start(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(inputs),
        _UniffiConverterSequenceTypeWorkerAgent.lower(workers)
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
            _UniffiLib.ffi_ceylon_rust_future_complete_void,
            _UniffiLib.ffi_ceylon_rust_future_free_void,
    ...
    async def stop(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_adminagent_stop(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
            _UniffiLib.ffi_ceylon_rust_future_complete_void,
...
class _UniffiConverterTypeAdminAgent:

    @staticmethod
    def lift(value: int):
        return AdminAgent._make_instance_(value)

    @staticmethod
    def check_lower(value: AdminAgent):
        if not isinstance(value, AdminAgent):
            raise TypeError("Expected AdminAgent instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: AdminAgentProtocol):
        if not isinstance(value, AdminAgent):
            raise TypeError("Expected AdminAgent instance, {} found".format(type(value).__name__))
    ...
    @classmethod
    def write(cls, value: AdminAgentProtocol, buf: _UniffiRustBuffer):
...
class MessageHandlerImpl:
    ...
    async def on_message(self, agent_id: "str",data: "bytes",time: "int") -> None:
        ...
        _UniffiConverterString.check_lower(agent_id)
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_messagehandler_on_message(
                self._uniffi_clone_pointer(), 
        _UniffiConverterString.lower(agent_id),
...
class _UniffiTraitImplMessageHandler:
    ...
    def on_message(
        ...
        def make_call():
            args = (_UniffiConverterString.lift(agent_id), _UniffiConverterBytes.lift(data), _UniffiConverterUInt64.lift(time), )
...
class WorkSpace:
    ...
    def __init__(self, config: "WorkSpaceConfig"):
        _UniffiConverterTypeWorkSpaceConfig.check_lower(config)
        
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_constructor_workspace_new,
        _UniffiConverterTypeWorkSpaceConfig.lower(config))

    def __del__(self):
        # In case of partial initialization of instances.
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_free_workspace, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_clone_workspace, self._pointer)
    ...
    async def run(self, inputs: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_workspace_run(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(inputs)
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
...
class _UniffiConverterTypeWorkSpace:

    @staticmethod
    def lift(value: int):
        return WorkSpace._make_instance_(value)

    @staticmethod
    def check_lower(value: WorkSpace):
        if not isinstance(value, WorkSpace):
            raise TypeError("Expected WorkSpace instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: WorkSpaceProtocol):
        if not isinstance(value, WorkSpace):
            raise TypeError("Expected WorkSpace instance, {} found".format(type(value).__name__))
        return value._uniffi_clone_pointer()
    ...
    @classmethod
    def write(cls, value: WorkSpaceProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))



class WorkerAgentProtocol(typing.Protocol):
    def broadcast(self, message: "bytes"):
        raise NotImplementedError
    def details(self, ):
        raise NotImplementedError
    def start(self, inputs: "bytes"):
        raise NotImplementedError
    def stop(self, ):
        raise NotImplementedError
...
class WorkerAgent:
    _pointer: ctypes.c_void_p
    def __init__(self, config: "WorkerAgentConfig",on_message: "MessageHandler",processor: "Processor"):
        _UniffiConverterTypeWorkerAgentConfig.check_lower(config)
        
        _UniffiConverterTypeMessageHandler.check_lower(on_message)
        
        _UniffiConverterTypeProcessor.check_lower(processor)
        
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_constructor_workeragent_new,
        _UniffiConverterTypeWorkerAgentConfig.lower(config),
        _UniffiConverterTypeMessageHandler.lower(on_message),
        _UniffiConverterTypeProcessor.lower(processor))
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_free_workeragent, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_clone_workeragent, self._pointer)
    ...
    async def broadcast(self, message: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_workeragent_broadcast(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(message)
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
    ...
    def details(self, ) -> "AgentDetail":
        return _UniffiConverterTypeAgentDetail.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_ceylon_fn_method_workeragent_details,self._uniffi_clone_pointer(),)
        )




    async def start(self, inputs: "bytes") -> None:

        _UniffiConverterBytes.check_lower(inputs)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_workeragent_start(
                self._uniffi_clone_pointer(), 
        _UniffiConverterBytes.lower(inputs)
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
    ...
    async def stop(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_ceylon_fn_method_workeragent_stop(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_ceylon_rust_future_poll_void,
            _UniffiLib.ffi_ceylon_rust_future_complete_void,
...
class _UniffiConverterTypeWorkerAgent:

    @staticmethod
    def lift(value: int):
        return WorkerAgent._make_instance_(value)

    @staticmethod
    def check_lower(value: WorkerAgent):
        if not isinstance(value, WorkerAgent):
            raise TypeError("Expected WorkerAgent instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: WorkerAgentProtocol):
        if not isinstance(value, WorkerAgent):
            raise TypeError("Expected WorkerAgent instance, {} found".format(type(value).__name__))
        return value._uniffi_clone_pointer()
    ...
    @classmethod
    def write(cls, value: WorkerAgentProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))
...
class AdminAgentConfig:
    ...
    def __str__(self):
        return "AdminAgentConfig(name={}, port={})".format(self.name, self.port)
...
class _UniffiConverterTypeAdminAgentConfig(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class AgentDetail:
    ...
    def __str__(self):
        return "AgentDetail(name={}, id={}, role={})".format(self.name, self.id, self.role)
...
class WorkSpaceConfig:
    name: "str"
    port: "int"
    def __init__(self, *, name: "str", port: "int" = _DEFAULT):
        self.name = name
        if port is _DEFAULT:
            self.port = 8888
        else:
    ...
    def __str__(self):
        return "WorkSpaceConfig(name={}, port={})".format(self.name, self.port)
...
class _UniffiConverterTypeWorkSpaceConfig(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
...
class WorkerAgentConfig:
    ...
    role: "str"
    admin_port: "int"
    def __init__(self, *, name: "str", work_space_id: "str", admin_peer: "str", role: "str", admin_port: "int"):
        self.name = name
    ...
    def __str__(self):
        return "WorkerAgentConfig(name={}, work_space_id={}, admin_peer={}, role={}, admin_port={})".format(self.name, self.work_space_id, self.admin_peer, self.role, self.admin_port)
    ...
    def __eq__(self, other):
        ...
        if self.role != other.role:
            return False
        if self.admin_port != other.admin_port:
            return False
        return True

class _UniffiConverterTypeWorkerAgentConfig(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return WorkerAgentConfig(
            name=_UniffiConverterString.read(buf),
            work_space_id=_UniffiConverterString.read(buf),
            admin_peer=_UniffiConverterString.read(buf),
            role=_UniffiConverterString.read(buf),
            admin_port=_UniffiConverterUInt16.read(buf),
        )

    @staticmethod
    def check_lower(value):
        _UniffiConverterString.check_lower(value.name)
        _UniffiConverterString.check_lower(value.work_space_id)
        _UniffiConverterString.check_lower(value.admin_peer)
        _UniffiConverterString.check_lower(value.role)
        _UniffiConverterUInt16.check_lower(value.admin_port)

    @staticmethod
    def write(value, buf):
        _UniffiConverterString.write(value.name, buf)
        _UniffiConverterString.write(value.work_space_id, buf)
        _UniffiConverterString.write(value.admin_peer, buf)
        _UniffiConverterString.write(value.role, buf)
        _UniffiConverterUInt16.write(value.admin_port, buf)



class _UniffiConverterSequenceTypeWorkerAgent(_UniffiConverterRustBuffer):
    @classmethod
    def check_lower(cls, value):
        for item in value:
            _UniffiConverterTypeWorkerAgent.check_lower(item)
    ...
    def write(cls, value, buf):
        ...
        buf.write_i32(items)
        for item in value:
            _UniffiConverterTypeWorkerAgent.write(item, buf)
    ...
    def read(cls, buf):
        ...
        return [
            _UniffiConverterTypeWorkerAgent.read(buf) for i in range(count)
        ]
