...
class TextToPlateMeshInput(MBaseModel):
	...
	"""
	text: str = dataclass_field(default="Example", description="The text to convert")
	insert: str = dataclass_field(default="0,0,0", description="The insert point of the text (lower left corner)")
	height: str = dataclass_field(default="1", description="The height of the text")
	color: PrintColor = dataclass_field(default_factory=PrintColor, description="The color of the text RGB, [0~255, 0~255, 0~255]")
