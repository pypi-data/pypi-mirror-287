...
class IqlQueryContainer:
    ...
    def __init__(self, query: str, db: IqlDatabase, substitutions: Dict = None):
    ...
    def execute(self, parameters: Optional[Iterable] = None) -> Tuple[Optional[DataFrame], Iterable[IqlResult]]:  # noqa: C901
        ...
        result = self.db.execute_query(query=self.query, completed_results=completed_results, parameters=parameters)  # type: ignore
