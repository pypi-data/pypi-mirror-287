...
def execute_debug(
    ...
    try:
        ...
        if ";" not in query:
            ...
            single_df, completed_results = iqc.execute(parameters=parameters)
            ...
            for i, statement in enumerate(statements):
                ...
                if (
                    ...
                    single_df, completed_results = iqc.execute()
...
def execute(
    ...
    success, single_df, completed_results = execute_debug(
        query, con, substitutions=substitutions, parameters=parameters
    )
