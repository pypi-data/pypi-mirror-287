...
def _is_numeric_index_like(indices):
    ...
    from fireducks.pandas.utils import _pd_version_under2
...
def make_scalar(obj):
    if obj is None:
        ...
        return ir.make_invalid_scalar_time_point_ns(obj.value)
        ...
        func = (
            ir.make_invalid_scalar_f64 if np.isnan(obj) else ir.make_scalar_f64
        )
        return func(obj)
