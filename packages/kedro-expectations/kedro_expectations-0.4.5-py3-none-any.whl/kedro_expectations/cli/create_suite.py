...
from kedro_expectations.utils import (dot_to_underscore, populate_new_suite,
...
def create_suite(env) -> None:
    ...
    if location_is_kedro_root_folder() and base_ge_folder_exists():
        start_suite_creation(ge_context=ge.get_context(), env=env)
    ...
    if option == 1:
        ...
        with KedroSession.create(project_path=project_path,
            ...
            if is_dataset_in_catalog(dataset_name, catalog) is True:
                ...
                ge_context.add_expectation_suite(expectation_suite_name)
