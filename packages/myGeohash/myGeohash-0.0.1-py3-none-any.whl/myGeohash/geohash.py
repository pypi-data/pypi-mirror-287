...
def neighbours(geohash):
    ...
    #                         ['n', 'ne', 'e', 'se', 's', 'sw', 'w', 'nw'])
    return {'n':n, 'ne':ne, 'e':e, 'se':se, 's':s, 'sw':sw, 'w':w, 'nw':nw}#Neighbours(n, ne, e, se, s, sw, w, nw)



def neighbours_mod(geohash):
    """
    Returns all 8 adjacent cells to specified geohash::
    ...
    # Neighbours = namedtuple('Neighbours',
    #                         ['n', 'ne', 'e', 'se', 's', 'sw', 'w', 'nw'])
    return {'nn':nn, 'nne':nne, 'nnee':nnee, 'nnw':nnw, 'nnww':nnww, 'ss':ss, 'sse':sse, 'ssee':ssee, 'ssw':ssw, 'ssww':ssww, 'ee':ee, 'een':een, 'ees':ees, 'ww':ww, 'wwn':wwn, 'wws':wws } #Neighbours(n, ne, e, se, s, sw, w, nw)
