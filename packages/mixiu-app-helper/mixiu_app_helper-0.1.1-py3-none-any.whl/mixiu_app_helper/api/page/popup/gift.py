...
class UiDailyCheckInApi(DeviceApi):
    ...
    def get_signup_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> UIObjectProxy:
        d_type = ""
        name = ""
        if self.platform == ANDROID_PLATFORM:
            d_type = "android.widget.TextView"
            name = "com.mixiu.com:id/tv_signup"
    ...
    def touch_signup_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> bool:
    ...
    def get_signup_submit_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> UIObjectProxy:
        d_type = ""
        name = ""
        if self.platform == ANDROID_PLATFORM:
            d_type = "android.widget.TextView"
            name = "com.mixiu.com:id/tv_ok"
        options = dict(d_type=d_type, name=name, text="好的")
        return get_poco_factory(poco=self.poco, options=options, loop=loop, peroid=peroid, **kwargs)

    def touch_signup_submit_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> bool:
    ...
    def get_live_leave_enter(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> UIObjectProxy:
        d_type = ""
        name = ""
        if self.platform == ANDROID_PLATFORM:
    ...
    def touch_live_leave_enter(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> bool:
    ...
    def get_close_room_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> UIObjectProxy:
        d_type = ""
        name = ""
        if self.platform == ANDROID_PLATFORM:
            d_type = "android.widget.TextView"
            name = "com.mixiu.com:id/tx_close_room"
        options = dict(d_type=d_type, name=name, text="退出房间")
        return get_poco_factory(poco=self.poco, options=options, loop=loop, peroid=peroid, **kwargs)

    def touch_close_room_button(self, loop: int = 1, peroid: float = 0.5, **kwargs) -> bool:
