...
def start_and_poll_analysis(label, model):
    try:
        ...
        poll_count = 0
        max_polls = 30  # Increased to 1 minute with 2-second intervals
        ...
        while poll_count < max_polls:
            ...
            if action_count > 0:
                ...
                pbar.n = min(average_progress, 100)  # Ensure progress doesn't exceed 100%
                pbar.refresh()
        ...
        return get_analysis_results(label)
