...
def create_parser():
    ...
    get_parser.add_argument("-a", "--action", required=True, help="Action to retrieve results for")
    ...
    list_actions_parser.add_argument("-l", "--label", help="Get actions for a specific label")
    list_actions_parser.add_argument("-s", "--status-only", action="store_true", help="Get only action statuses")
