...
class Muso:
    ...
    def __init__(self: AppType, *, name: str, version: str, description: str,
            ...
            for route in route_group.route_list:
                ...
                if route.form_data_schema:
                    operations[method]['requestBody'] = dict(
                        content={'application/x-www-form-urlencoded': dict(
    ...
    def middleware(self, middleware_type: str) -> typing.Callable:
        ...
        def decorator(func: typing.Callable) -> typing.Callable:
            ...
            self.user_middleware.insert(
                0, Middleware(BaseHTTPMiddleware, dispatch=func))
            return func
