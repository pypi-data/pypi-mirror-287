...
{
    "has_profit": false,
    "pnl": 31367403583072920325843524815556,
...
- `has_profit` true or false
- `pnl`, if `has_profit` is true, means pnl is positive，if `has_profit` is false, means pnl is negative
- `borrowing_fee`
- `funding_fee_amount`
- `claimable_amount`
