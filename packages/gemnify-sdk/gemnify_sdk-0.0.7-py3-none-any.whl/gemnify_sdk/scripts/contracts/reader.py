...
class Reader:
    ...
    #status: PositionOpen:20000 PositionClosedByUser:20001 PositionLiquidated:20002
    def get_position_by_account(self, account, market = "", status = 20000, page_index = 1, page_size = 10):
        http = HTTP(self.config)
