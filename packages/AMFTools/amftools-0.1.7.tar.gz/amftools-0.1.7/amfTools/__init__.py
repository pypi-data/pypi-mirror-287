...
class AMF:
    ...
    def pullAndWait(self, homing_mode = False)->None:
        ...
        while valvebusy or pumpbusy:
            ...
            if response[0] == 0:
                valvebusy = False
            elif homing_mode and response[0] == 144:
                valvebusy = True
            elif response[0] != 255:
            ...
            if self.typeProduct == "SPM" or self.typeProduct == "LSPOne":
                if not homing_mode or not valvebusy: # do not check pump status while the valve is not homed yet
