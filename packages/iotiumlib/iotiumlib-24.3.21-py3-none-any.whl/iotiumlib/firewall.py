...
from iotiumlib.requires.api_endpoints import FirewallGroup
...
class firewallgroup(object):
    ...
    def __init__(self, action, payload=None, filters=None, firewallgroup_id=None):
        ...
        api = FirewallGroup()
        self.uri = {
            add_fwg: api.v1_firewallgroup,
            get_fwg: api.v1_firewallgroup,
            edit_fwg: api.v1_firewallgroup_id,
            delete_fwg: api.v1_firewallgroup_id,
            get_fwg_id_fwg: api.v1_firewallgroup_id,
            getv2_fwg: api.v2_firewallgroup,
        }
