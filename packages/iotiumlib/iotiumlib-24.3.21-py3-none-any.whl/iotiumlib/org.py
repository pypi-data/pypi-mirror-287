...
from iotiumlib.requires.api_endpoints import Org
...
class org(object):
    def __init__(self, action, payload=None, org_id=None, filters=None):
        ...
        self.uri = {
            get_org: api.v1_org,
            get_org_name_org: api.v1_user_current,
            getv2_org: api.v2_org,
            add_org: api.v1_org,
            edit_org: api.v1_org_id,
            delete_org: api.v1_org_id,
            get_org_id_org: api.v1_org_id,
            policy_org: api.v1_org_id_policy,
        }
