...
from iotiumlib.requires.api_endpoints import Secret
...
class secret(object):
    ...
    def __init__(self, action, payload=None, secret_id=None, filters=None):
        ...
        api = Secret()
        self.uri = {
            add_secret: api.v1_secret,
            get_secret: api.v1_secret,
            edit_secret: api.v1_secret_id,
            delete_secret: api.v1_secret_id,
            get_secret_id_secret: api.v1_secret_id,
            getv2_secret: api.v2_secret
        }
