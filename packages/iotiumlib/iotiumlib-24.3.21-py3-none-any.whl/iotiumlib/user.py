...
from iotiumlib.requires.api_endpoints import User
...
class user(object):
    def __init__(self, action, payload=None, filters=None, user_id=None):
        ...
        api = User()
        self.uri = {
            getv2_user: api.v2_user,
            add_user: api.v1_user,
            edit_user: api.v1_user_id,
            delete_user: api.v1_user_id,
            notifications_user: api.v2_notifications
        }
    ...
    class mysubscriptions(object):
        def __init__(self, action, payload=None, filters=None, sub_id=None):
            ...
            api = User()
            self.uri = {
                getv2_sub: api.v2_mysubscriptions,
                add_sub: api.v1_mysubscriptions,
                delete_sub: api.v1_mysubscriptions_id,
            }
    ...
    class webhook(object):
        ...
        def __init__(self, action, filters=None, payload=None, webhook_id=None):
            ...
            api = User()
            self.uri = {
                add_webhook: api.v1_webhook,
                get_webhook: api.v1_webhook,
                getv2_webhook: api.v2_webhook,
                edit_webhook: api.v1_webhook_id,
                delete_webhook: api.v1_webhook_id,
                get_webhook_id_webhook: api.v1_webhook_id,
                verify_webhook: api.v1_webhook_id_verify,
                test_webhook: api.v1_webhook_id_test
            }
