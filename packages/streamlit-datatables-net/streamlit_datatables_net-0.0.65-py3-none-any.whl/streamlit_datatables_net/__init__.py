...
try:
    ...
    from .utility_functions import allow_top_navigation, get_render_function
except Exception:
    from date_formatter import python_to_luxon_format
    from utility_functions import allow_top_navigation, get_render_function
...
if not _RELEASE:
    ...
    with content_column:
        with st.container(border=True):
            ...
            js_file_path = 'renderFunctions.js'
            render_function_code = get_render_function(
                js_file_path, 'truncateText')
            props["columns"] = [
                {"data": "id", "title": "id"},
                {"data": "title", "title": "title"},
                {"data": "category", "title": "category"},
                {"data": "description", "title": "description",
                    "render": render_function_code},
            ...
            dt_click = st_datatable(None, props=props, ajax_setup=ajax_setup, ajax_reload=ajax_reload,
                                    key="ajax_table", on_select="rerun", export_file_name=filename, enable_diagnostics=False)
            st.write(dt_click)
