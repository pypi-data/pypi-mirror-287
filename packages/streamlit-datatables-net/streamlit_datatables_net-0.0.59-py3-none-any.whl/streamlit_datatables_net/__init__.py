...
def st_datatable(data: pd.DataFrame | list[dict], column_order: List[str] = None, props: Dict = None, dt_config: str = "default", class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, disabled: bool = False, enable_top_navigation: bool = False, date_format: str = None, is_datetime: bool = False, export_file_name: str = None, on_select: Optional[Union[Literal["ignore"], Literal["rerun"], Callable]] = "rerun", on_change: Optional[Callable] = None, on_click: Optional[Callable] = None, enable_diagnostics: bool = False, args: Optional[Tuple[Any, ...]] = None,
    ...
    component_value = _component_func(
        props=props, test=props, class_name=class_name, js_scripts=js_scripts, stylesheets=stylesheets, key=key, table_id=table_id, on_change=on_change, disabled=disabled, date_format=luxon_date_format, export_file_name=export_file_name, enable_diagnostics=enable_diagnostics, default=None)
                ...
                with st.echo():
                    ...
                    with dt_container:
                        ...
                        if on_select == "callable":
                            on_select = my_on_click_function
                        dt_response = st_datatable(
                            data, props=props, key="example_1b", enable_top_navigation=False, date_format="%b %d %Y", is_datetime=True, on_select=on_select)
                        st.write(dt_response)
