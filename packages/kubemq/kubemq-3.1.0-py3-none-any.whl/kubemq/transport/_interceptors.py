...
class _AuthInterceptors(
    grpc.UnaryUnaryClientInterceptor, grpc.StreamUnaryClientInterceptor, grpc.UnaryStreamClientInterceptor,
    ...
    def _intercept_call(
            self, continuation: Callable[[ClientCallDetails, Any], Any], client_call_details: ClientCallDetails,
...
class _AuthInterceptorsAsync(
    grpc.aio.UnaryUnaryClientInterceptor, grpc.aio.StreamStreamClientInterceptor, grpc.aio.UnaryStreamClientInterceptor,
