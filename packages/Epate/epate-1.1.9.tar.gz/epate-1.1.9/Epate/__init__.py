...
def login(username, password, print='no'):
    timetamp =time.time()
    login_data1 = {"identity":username,"scene":"","pid":"65edCTyg","deviceId":"","timestamp":timetamp}
    requests.post('https://open-service.codemao.cn/captcha/rule/v3',json=login_data1)
