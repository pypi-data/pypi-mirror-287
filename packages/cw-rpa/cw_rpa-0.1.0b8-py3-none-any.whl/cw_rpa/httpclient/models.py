...
class Integrations:
    """
    Enum-like class representing different integrations available within the application.

    This class defines constants for each type of external service integration supported by the application. These constants are used to manage and configure the specific behaviors, endpoints, and authentication mechanisms required for each external service.

    Attributes:
        MICROSOFT_CSP (str): Represents the integration with Microsoft Cloud Solution Provider. This integration might be used for managing subscriptions, licenses, and user accounts within the Microsoft cloud ecosystem.
    """
