    ...
    if flag:
        ...
        if workers == None:
            ...
            q4 = [
                inquirer.Confirm(
                    "assets_config",
                    message="Atualizar a pasta assets? (credentials.json*)",
                )
            ]
            ...
            q5 = [inquirer.Confirm("worker_bat", message="Criar o arquivo worker.bat?")]
...
def is_already_running(script_name):
    try:
        ...
        console.print(
            f"\nErro ao verificar se o processo já está em execução: {e}\n",
            style="bold red",
        )
