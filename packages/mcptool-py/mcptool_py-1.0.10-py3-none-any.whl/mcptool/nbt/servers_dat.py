...
class ServersDAT:
    ...
    @logger.catch
    def add_servers_dat_file(self, servers: list, vulnerable: bool = False) -> None:
        """
        Method to add a server to the servers.dat file.
        :param servers: The server to add to the servers.dat file
        :param vulnerable: True if the server is vulnerable, False otherwise
        """
        server_message: str = 'MCPTool Server' if not vulnerable else 'MCPTool - Bungee Exploit Vulnerable'
    ...
    def get_servers_dat_file_path(self) -> str:
        ...
        :return: The servers.dat file path
        """
