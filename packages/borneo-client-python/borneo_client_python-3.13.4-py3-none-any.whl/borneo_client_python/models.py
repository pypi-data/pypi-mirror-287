...
class DescribeAccountOutput:
    ...
    :param data_plane_ids: The list of data plane IDs associated with the account.
    ...
    epoch timestamp.
    :param permissions: The permission granted to the AWS IAM "Borneo Control Plane"
    role for the
    account, when the account was added to Borneo.
    """
...
class DescribeCatalogResourceOutput:
    ...
    :param snapshot: Inspection "snapshot" result, provinding a count of matched
    infotypes in
    the scanned data.
...
@dataclass(kw_only=True)
class DataType:
    """Represents a kind of data affected by the processing activity

    :param id: Identifier of the data type. Can be an UUID if it's a custom data
    type or a key
    of one of the data types that we offer
...
class CreateProcessingActivityInput:
    ...
    :param data_types: List of Data Types affected by the processing activity
