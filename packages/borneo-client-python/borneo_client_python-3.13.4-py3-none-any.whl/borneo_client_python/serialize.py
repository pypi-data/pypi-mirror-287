...
def _serialize_data_type(input: DataType, config: Config) -> dict[str, DocumentValue]:
    result: dict[str, DocumentValue] = {}
...
def _serialize_data_type_collection(
    input: list[DataType], config: Config
) -> list[DocumentValue]:
    return [_serialize_data_type(e, config) for e in input]
