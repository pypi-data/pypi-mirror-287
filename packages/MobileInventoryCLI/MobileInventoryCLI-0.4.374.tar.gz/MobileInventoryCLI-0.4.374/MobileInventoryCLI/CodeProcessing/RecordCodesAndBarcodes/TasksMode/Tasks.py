...
{Fore.light_steel_blue}ucs|update casecount shelfcount|update_casecount_shelfcount - {expo_color}update casecount and shelf count{Style.reset}'''
        while True:
            try:
...
{Fore.light_red}Enter{Style.reset} amount|+amount|-amount|a,+a,-a(advanced)|r,+r,-r(ReParseFormula) (Enter==1)'''
