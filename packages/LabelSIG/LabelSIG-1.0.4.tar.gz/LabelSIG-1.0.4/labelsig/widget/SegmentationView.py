...
from qtpy.QtWidgets import QMainWindow,QDialog,QLabel,QMessageBox,QApplication
import qtpy.QtWidgets as QtWidgets
import qtpy.QtGui as QtGui
from labelsig.widget.ImageAnnotationView_Segmentation import AdaptableLabel
from labelsig.widget.CountdownWarningView import WarningDialog
from labelsig.ui_generated.ui_segmentation_view import Ui_main
from labelsig.utils import get_parent_directory
from labelsig.utils import get_channels_comtrade,get_info_comtrade
from labelsig.utils import get_annotation_info,update_annotation_label
from labelsig.utils import get_image_from_comtrade
...
class SegmentationPage(QMainWindow, Ui_main):
    ...
    def get_temp_path(self):
        ...
        path_tmp = self.construct_path(root_labelsig, 'tmp')
        path_tmp_raw = self.construct_path(root_labelsig, 'tmp', 'raw')
        path_tmp_annotation = self.construct_path(root_labelsig, 'tmp', 'annotation')
