...
from qtpy.QtWidgets import (QApplication, QDialog, QVBoxLayout, QHBoxLayout, QCheckBox, QPushButton, QMainWindow,
                             QWidget, QLabel, QRadioButton)
from labelsig.utils import (get_parent_directory,get_channels_comtrade)
