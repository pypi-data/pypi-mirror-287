...
# Form implementation generated from reading ui file 'ui_location_view.ui'
#
...
"background-color: rgb(48, 105, 176);border-radius: 16px;")
        ...
        self.button_mark = QtWidgets.QPushButton(self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.button_mark.sizePolicy().hasHeightForWidth())
        self.button_mark.setSizePolicy(sizePolicy)
        self.button_mark.setStyleSheet("color: rgb(255, 255, 255);\n"
"font: 25pt \"Bahnschrift Condensed\";\n"
"background-color: rgb(48, 105, 176);border-radius: 16px;")
        self.button_mark.setObjectName("button_mark")
        self.gridLayout.addWidget(self.button_mark, 0, 0, 1, 1)
...
"background-color: rgb(169, 169, 197);border-radius: 16px;")
    ...
    def retranslateUi(self, main):
        ...
        self.button_mark.setText(_translate("main", "Mark"))
