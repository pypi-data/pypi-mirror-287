...
class LS(API):
    ...
    async def recv_price(self, code, state=True):
        header = {
    ...
    async def recv_index(self, code, state=True):
        header = {
            "token": self.access_token,
            "tr_type": "3"
        }
    ...
    async def recv_orderbook(self, code, state=True):
        header = {
            "token": self.access_token,
            "tr_type": "3"
        }
    ...
    async def recv_order_status(self, state=True):
        header = {
            "token": self.access_token,
            "tr_type": "1"
        }
