...
def custom_print(*args, **kwargs):
    formatted_args = [color(arg) if isinstance(arg, str) else arg for arg in args]
    built_in_print(*formatted_args, **kwargs)

# Сохраняем оригинальный print для использования внутри custom_print
built_in_print = print
print = custom_print

# Примеры использования
print('{k.Cyan}This is red text{k.RESET}')
