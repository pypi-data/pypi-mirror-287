...
class Shiny(WMLResource):
    ...
    def get_details(self, shiny_id: str | None = None, **kwargs: Any) -> dict[str, Any]:
        ...
        **Example**
        ...
        return self._get_asset_based_resource(
            shiny_id, "shiny_asset", get_required_elements
        )
    ...
    def list_revisions(
        ...
        **Example**
        ...
        shiny_resources = self._get_with_or_without_limit(
            url, limit, "List Shiny revisions", summary=None, pre_defined=None
        )["resources"]
        shiny_values = [
            (
                m["metadata"]["asset_id"],
