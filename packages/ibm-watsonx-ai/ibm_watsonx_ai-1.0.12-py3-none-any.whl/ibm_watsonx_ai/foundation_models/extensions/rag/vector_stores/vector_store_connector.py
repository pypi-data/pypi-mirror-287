...
from ibm_watsonx_ai.foundation_models.extensions.rag.vector_stores.adapters import (
    ...
    def get_elasticsearch(self) -> LangChainVectorStoreAdapter:
        ...
        if "strategy" not in parsed_params or not isinstance(
            ...
            if "model_id" in parsed_params:
                ...
                parsed_params["strategy"] = DenseVectorStrategy(
                    model_id=parsed_params.pop("query_model_id")
                )
            else:
