...
def scatter_atac(
    ...
    # scatter
    scatter_base(df, clusters, width=width, height=height, columns=columns, size=size, start_color_index=start_color_index, color_step_size=color_step_size, is_text=is_text, output=output, show=show, right=0.75)
