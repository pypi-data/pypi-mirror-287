...
def derive_all(logger, outdir, cores, panmodel, pam, report, gannots, media_filepath, minflux, biolog):
    ...
    response = strain_filler(logger, outdir, cores, panmodel, media_filepath, minflux)
    if response == 1: return 1
