...
class ProductDocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_product_documents_0_endpoint = _Endpoint(
            settings={
                'response_type': (ListProductDocumentsResponseClass,),
                'auth': [
                    'bearer'
                ...
                'operation_id': 'list_product_documents_0',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def list_product_documents_0(
        ...
        **kwargs
        ...
        >>> thread = api.list_product_documents_0(product_slug, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['product_slug'] = \
            product_slug
        return self.list_product_documents_0_endpoint.call_with_http_info(**kwargs)
