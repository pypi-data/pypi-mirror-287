...
class SearchableDocumentsApi(object):
    ...
    def list_searchable_documents(
        ...
        **kwargs
        ...
        Returns a list of searchable documents you have previously created. The searchable documents are returned in sorted order, with the oldest one appearing first. For more information about pagination, read the Pagination documentation.  # noqa: E501
