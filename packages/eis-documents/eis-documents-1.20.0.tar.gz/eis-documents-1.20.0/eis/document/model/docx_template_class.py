...
class DocxTemplateClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, code, slug, product_version_id, product_slug, description, s3_key, entity_type, filename, version_number, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, code, slug, product_version_id, product_slug, description, s3_key, entity_type, filename, version_number, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """DocxTemplateClass - a model defined in OpenAPI
