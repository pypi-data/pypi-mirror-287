...
if __name__ == '__main__':
    ...
    parser.add_argument('-ts', '--trig_sum', type=float, default=0.25,
                        help="overlapping arduino are used for each audio chunk, trig sum defines average probability among those arduino for switching into triggered state (speech state)")
    ...
    parser.add_argument('-N', '--num_steps', type=int, default=8,
                        help="nubmer of overlapping arduino to split audio chunk into (we recommend 4 or 8)")
