...
def session_analysis_audio(bucket_name, influx_client):
    ...
    across_sessions_analysis_audio()
...
def across_sessions_analysis_audio():
    ...
    plot_across_sessions_analysis_audio(session_names, apd_lst, nttc_lst, sr_lst, peq_lst)
...
def plot_across_sessions_analysis_audio(session_names, apd_lst, nttc_lst, sr_lst, peq_lst):
    ...
    fig.tight_layout()
    plt.savefig(os.path.join(visualizations_dir, 'audio_analysis_across_sessions.png'), dpi=300)
    print("Audio analysis metrics across sessions saved to 'audio_analysis_across_sessions.png'")


def plot_across_sessions_analysis_audio_interactive(session_names, apd_lst, nttc_lst, sr_lst, peq_lst):
    ...
    page.add(line1)
    page.add(line2)
    page.render(os.path.join(visualizations_dir, f'audio_analysis_across_sessions.html'))
