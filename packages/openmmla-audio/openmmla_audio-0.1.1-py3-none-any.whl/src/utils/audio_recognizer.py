...
from src.utils.audio_utils import segment_wav
from src.utils.logger_utils import get_logger
from src.utils.request_utils import request_audio_inference
...
class AudioRecognizer:
    ...
    def __init__(self, config_path, audio_db, local=False, model_path=None, onnx_model_path=None, use_onnx=False,
        ...
        if self.local and model_path:
            ...
            self.onnx_model_path = onnx_model_path if onnx_model_path else os.path.join(self.root_dir, '../models',
