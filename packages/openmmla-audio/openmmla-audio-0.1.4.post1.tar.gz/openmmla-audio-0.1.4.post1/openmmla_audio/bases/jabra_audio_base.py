...
from openmmla_audio.bases._enum import BLUE, ENDC
from openmmla_audio.bases.audio_base import AudioBase
from openmmla_audio.utils.audio_utils import resample, get_energy_level, write_frames_to_file, calculate_audio_duration
from openmmla_audio.utils.auga import normalize_rms
from openmmla_audio.utils.error_utils import RecordingError, RecognizingError
from openmmla_audio.utils.input_utils import get_bucket_name, get_name, get_mode
...
class JabraAudioBase(AudioBase):
    ...
    def __init__(self, project_dir: str = None, config_path: str = None, mode: str = 'full', local: bool = True,
