# 1 "../../c/uwapi-c/uwapi/bots.h"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 385 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../c/uwapi-c/uwapi/bots.h" 2



# 1 "../../c/uwapi-c/uwapi/common.h" 1



# 1 "/usr/bin/../lib/clang/18/include/stdbool.h" 1 3
# 5 "../../c/uwapi-c/uwapi/common.h" 2
...
# 25 "../../c/uwapi-c/uwapi/common.h"
 ...
 typedef struct UwMapInfo
 {
  ...
  uint32 maxPlayers;
               ...
               _Bool uwMapInfo(UwMapInfo *data);
 ...
 typedef struct UwOverviewExtract
 {
  ...
  uint32 count;
               ...
               _Bool uwTestVisible(float x1, float y1, float z1, float x2, float y2, float z2);
               _Bool uwTestShooting(uint32 shooterPosition, uint32 shooterProto, uint32 targetPosition, uint32 targetProto);
 ...
 typedef struct UwProtoComponent
 {
  uint32 proto;
               ...
               _Bool uwFetchProtoComponent(UwEntity *entity, UwProtoComponent *data);

 typedef struct UwOwnerComponent
 {
  uint32 force;
 } UwOwnerComponent;
               _Bool uwFetchOwnerComponent(UwEntity *entity, UwOwnerComponent *data);
 ...
 typedef struct UwControllerComponent
 {
  ...
  uint32 timestamp;
               ...
               _Bool uwFetchControllerComponent(UwEntity *entity, UwControllerComponent *data);
 ...
 typedef struct UwPositionComponent
 {
  ...
  float yaw;
               ...
               _Bool uwFetchPositionComponent(UwEntity *entity, UwPositionComponent *data);
 ...
 typedef struct UwUnitComponent
 {
  ...
  uint32 killCount;
               ...
               _Bool uwFetchUnitComponent(UwEntity *entity, UwUnitComponent *data);

 typedef struct UwLifeComponent
 {
  sint32 life;
 } UwLifeComponent;
               _Bool uwFetchLifeComponent(UwEntity *entity, UwLifeComponent *data);
 ...
 typedef struct UwMoveComponent
 {
  ...
  float yawEnd;
               ...
               _Bool uwFetchMoveComponent(UwEntity *entity, UwMoveComponent *data);

 typedef struct UwAimComponent
 {
  uint32 target;
 } UwAimComponent;
               _Bool uwFetchAimComponent(UwEntity *entity, UwAimComponent *data);

 typedef struct UwRecipeComponent
 {
  uint32 recipe;
 } UwRecipeComponent;
               _Bool uwFetchRecipeComponent(UwEntity *entity, UwRecipeComponent *data);

 typedef struct UwUpdateTimestampComponent
 {
  uint32 timestamp;
 } UwUpdateTimestampComponent;
               _Bool uwFetchUpdateTimestampComponent(UwEntity *entity, UwUpdateTimestampComponent *data);
 ...
 typedef struct UwRecipeStatisticsComponent
 {
  ...
  uint32 completed;
               ...
               _Bool uwFetchRecipeStatisticsComponent(UwEntity *entity, UwRecipeStatisticsComponent *data);
 ...
 typedef struct UwPriorityComponent
 {
  UwPriorityEnum priority;
               ...
               _Bool uwFetchPriorityComponent(UwEntity *entity, UwPriorityComponent *data);

 typedef struct UwAmountComponent
 {
  uint32 amount;
 } UwAmountComponent;
               _Bool uwFetchAmountComponent(UwEntity *entity, UwAmountComponent *data);

 typedef struct UwAttachmentComponent
 {
  uint32 target;
 } UwAttachmentComponent;
               _Bool uwFetchAttachmentComponent(UwEntity *entity, UwAttachmentComponent *data);
 ...
 typedef struct UwPlayerComponent
 {
  ...
  UwPlayerConnectionClassEnum playerConnectionClass;
               ...
               _Bool uwFetchPlayerComponent(UwEntity *entity, UwPlayerComponent *data);
 ...
 typedef struct UwForceComponent
 {
  ...
  UwForceStateFlags state;
               ...
               _Bool uwFetchForceComponent(UwEntity *entity, UwForceComponent *data);
 ...
 typedef struct UwForceDetailsComponent
 {
  ...
  uint32 startingPosition;
               ...
               _Bool uwFetchForceDetailsComponent(UwEntity *entity, UwForceDetailsComponent *data);
 ...
 typedef struct UwForeignPolicyComponent
 {
  ...
  UwForeignPolicyEnum policy;
               ...
               _Bool uwFetchForeignPolicyComponent(UwEntity *entity, UwForeignPolicyComponent *data);
 ...
 typedef struct UwDiplomacyProposalComponent
 {
  ...
  UwForeignPolicyEnum proposal;
               ...
               _Bool uwFetchDiplomacyProposalComponent(UwEntity *entity, UwDiplomacyProposalComponent *data);
# 5 "../../c/uwapi-c/uwapi/bots.h" 2
 ...
 typedef struct UwAssistConfig
 {
  ...
  _Bool retaliations;
               ...
               void uwSetConnectStartGui(_Bool enabled, const char *extraCmdParams);
               void uwSetConnectAsObserver(_Bool observer);

               _Bool uwConnectFindLan(uint64 timeoutMicroseconds);
 ...
 typedef void (*UwUpdateCallbackType)(uint32 tick, _Bool stepping);
 ...
 typedef struct UwMyPlayer
 {
  ...
  _Bool primaryController;
  _Bool admin;
 } UwMyPlayer;
               _Bool uwMyPlayer(UwMyPlayer *data);
               ...
               _Bool uwTestConstructionPlacement(uint32 constructionPrototype, uint32 position);
 ...
 typedef struct UwOrders
 {
  ...
  uint32 count;
               ...
               void uwAdminPlayerSetAdmin(uint32 player, _Bool admin);
...
# 1 "../../c/uwapi-c/uwapi/common.h"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 385 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../c/uwapi-c/uwapi/common.h" 2
