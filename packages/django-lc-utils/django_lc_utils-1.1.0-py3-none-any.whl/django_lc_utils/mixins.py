...
from los.utils.sentry import capture_exception
...
class SlightlySaferSoftDeletableQuerySetMixin:
    ...
    def unsafe_delete(self):
        ...
        # TODO: revisit this in future and have some stream setup rather than sentry exceptions
        capture_exception(
            Exception(
                "Processed a bulk soft delete operation on Model: [{}]. First object ID: [{}]".format(
                    content_type.app_labeled_name, object_ids[0]
                )
            )
        )
