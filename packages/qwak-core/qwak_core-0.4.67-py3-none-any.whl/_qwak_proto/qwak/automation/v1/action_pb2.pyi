...
class DeploymentCondition(google.protobuf.message.Message):
    ...
    DEPLOYED_BUILD_FIELD_NUMBER: builtins.int
    @property
    def build_metric(self) -> global___BuildMetricCondition: ...
    @property
    def deployed_build(self) -> global___DeployedBuildMetricCondition: ...
    def __init__(
        self,
        *,
        build_metric: global___BuildMetricCondition | None = ...,
        deployed_build: global___DeployedBuildMetricCondition | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["build_metric", b"build_metric", "condition", b"condition", "deployed_build", b"deployed_build"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_metric", b"build_metric", "condition", b"condition", "deployed_build", b"deployed_build"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["condition", b"condition"]) -> typing_extensions.Literal["build_metric", "deployed_build"] | None: ...
...
class DeployedBuildMetricCondition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["metric_name", b"metric_name", "threshold_direction", b"threshold_direction"]) -> None: ...
