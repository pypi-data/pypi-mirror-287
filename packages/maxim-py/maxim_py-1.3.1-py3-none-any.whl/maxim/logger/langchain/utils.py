...
def parse_langchain_message(message: BaseMessage):
    ...
    return {
        ...
        "message": {
            ...
            "tool_calls": message.additional_kwargs["tool_calls"] if message.additional_kwargs["tool_calls"] else None
        },
    ...
    if message.type == 'ai':
        ...
        choices.append({
            ...
            'message':  {
                ...
                'tool_calls': ai_message.tool_calls if ai_message.tool_calls else None
            },
