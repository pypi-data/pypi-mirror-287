...
def browser_type_launch_args(pytestconfig: Any) -> Dict:
    ...
    if DataProcess.isNotNull(get_system_key("headed")) == False:
        launch_options["headless"] = False
        logger.info("设置浏览器的headless为False")
    elif DataProcess.isNotNull(get_system_key("headed")) and get_system_key("headed").upper() == "ON":
        launch_options["headless"] = True
        logger.info("设置浏览器的headless为True")
    elif DataProcess.isNotNull(get_system_key("headed")) and get_system_key("headed").upper() != "ON":
        launch_options["headless"] = False
        logger.info("设置浏览器的headless为False")
