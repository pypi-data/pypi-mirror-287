...
def image_dir_to_mcap(input_dir: Path,
    ...
    if encoding == "protobuf":
        ...
        add_types.update(get_types_from_msg(IMAGE_MSG, 'custom_msgs/msg/image_msg'))
        ...
        with open(fname, "wb") as stream:
            ...
            for i, (timestamp, image) in enumerate(zip(timestamps, sorted_img_files)):
               ...
               # reencoded = typestore.serialize_cdr(patched_image_msg, msgtype)

                # Rawdata that can be passed to rosbag2.Writer.write
 #               print(get_types_from_msg(IMAGE_MSG, 'custom_msgs/msg/image_msg'))
#                serialized_msg = serialize_cdr(message, get_types_from_msg(IMAGE_MSG, 'custom_msgs/msg/image_msg'))
