...
def _parse_result(response: typing.Any,
                  codes: tuple[int],
                  error_on_404: bool = True) -> typing.Union[bool, dict, list, None]:
...
class _Project:
    ...
    def info(self, *, error_details: bool = False, **kwargs) -> typing.Optional[dict]:
        ...
        """
        resp = self._client.get("storage", **kwargs)
        return _parse_result(resp, (200,), False)
    ...
    def append_files(self,
        ...
        return _parse_result(resp, (200, 201), True)
    ...
    def append_documents(self,
        ...
        results = {document["id"]: result["status"] for document, result in zip(documents, result)}
        return results
    ...
    def get_fields(self,
        ...
        return _parse_result(resp, (200,), True)
    ...
    def get_document(self,
        ...
        resp = self._client.post(f"projects/{self.project_id}/realtime/documents/{document_id}", json=body, **kwargs)
        return _parse_result(resp, (200,), True)
