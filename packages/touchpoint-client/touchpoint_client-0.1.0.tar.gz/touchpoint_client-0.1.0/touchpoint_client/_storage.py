...
class _Storage:
    ...
    @use_error_details
    def upload(self, data: bytes | typing.BinaryIO,
               name: str,
        ...
        res = self._client.post(
            "storage/files",
            files=(
                ("parameters", (None, json.dumps(parameters, ensure_ascii=False), "application/json")),
                ("file", (name, data)),
            ),
            **kwargs,
        )
    ...
    def iterate_files(
            ...
            offset: int = 0,
            limit: int = 1000,
            sort: typing.Union[str, typing.List[str]] = "-created_date",
            **kwargs):
        """
    ...
    def get_files(
        ...
        *,
        ...
        size_gte: typing.Optional[int] = None,
        size_lte: typing.Optional[int] = None,
        created_date_gte: typing.Optional[str] = None,
        created_date_lte: typing.Optional[str] = None,
        md5_match: typing.Optional[str] = None,
        tag_like: typing.Optional[str] = None,
        error_details: bool = False,
        **kwargs,
    ):
        """
