...
__all__ = [
    "ConnectorBase", "ProjectPermissions", "AccountPermissions",
    "ProjectGetDocumentBodyHighlight", "ProjectGetDocumentBody",
    "ProjectQueryBody", "ProjectSearchBody", "ProjectAggregateBody",
]
...
class ProjectPermissions(enum.StrEnum):
    project = "project"
    users = "users"
    dpp = "dpp"
...
class AccountPermissions(enum.StrEnum):
    account = "account"
    alerts = "alerts"
...
class ProjectGetDocumentBodyHighlight:
    ...
    fetch_fields: typing.List[str] = field(default_factory=lambda: ["mono.transcript", "client.transcript", "operator.transcript"])
    query: str = ""
...
class ProjectGetDocumentBody:
    ...
    """
    fetch_fields: typing.List[str] = field(default_factory=lambda: ["created_date", "language", "file.properties","categories"])
