...
def create_default_config(config_file):
    ...
    print(f"{fc.GREEN}Created default configuration file at {config_file}{fc.RESET}")
...
def load_config():
    ...
    if config_file.exists():
        ...
        print(f"{bg.YELLOW}{fc.BLACK}WARN:{fc.YELLOW}{bg.RESET}  Configuration file not found. Creating default configuration.{fc.RESET}")
        create_default_config(config_file)
        config = load_config()  # Reload the newly created configuration
