...
Company: Newtonia
Last Update: July 22 2024 Monday 
...
def packageInfo():
    ...
    s=s+" Package Version:'1.0.1'\n"
    s=s+" Author:'A K M Aminul Islam'\n"
    s=s+" Author_Email:'aminul71bd@gmail.com'\n"
    s=s+" Company:'Newtonia'\n"
    s=s+" Last Update:'Thursday July 25 2024'\n"
    s=s+" Description:'This package creates and manages the common data structures\n"
...
# code modules 
__packageInfoDict={"version":"1.0.1","name":"pcds","md5hashes": 
