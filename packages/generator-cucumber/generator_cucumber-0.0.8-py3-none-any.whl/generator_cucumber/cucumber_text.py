...
def create_cucumber_text(**params):
    ...
    # Feature
        ...
        tags = scenario_out.find_all(["background", "scenario", "scenariooutline", "given", "when", "then", "and", "but", "rule", "examples", "group"])
        ...
        # Rule
            ...
            if soup.find("group"):
                ...
                if soup.find(["bac dkground", "scenario", "scenariooutline", "given", "when", "then", "and", "but", "rule"]):
