...
#######################################################################################
        ...
        if plot_params_in["dens_merge_sites"]:
            print("  Defect densities are merged among same species (dens_merge_sites = true)")
            print("         and plotted without [#] of defect_type in legend")
            fout1.write("  Defect densities are merged among same species (dens_merge_sites = true)\n")
