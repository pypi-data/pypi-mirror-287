...
def create_timeline(max_time, dataframe, event_details):
    ...
    plt.vlines(arrow_length + head_length, arrow_middle, arrow_middle + 20 * arrow_width, colors=(200/255,200/255,200/255))
    ...
    for i in range(1,11):
        ...
        plt.text(arrow_length + head_length, arrow_middle + arrow_width * 20 * 0.1 * i, tick_dyfi, fontsize=7, bbox=dict(facecolor='white', edgecolor=(150/255,150/255,150/255)), color=(150/255,150/255,150/255))

    plt.text(arrow_length + head_length, arrow_middle + arrow_width * 20 * 1.1, "DYFI \n Responses", fontsize=7, bbox=dict(facecolor='white', edgecolor=(150/255,150/255,150/255)), color=(150/255,150/255,150/255))
