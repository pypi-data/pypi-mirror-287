...
from .models import ArgoWorkflowRun, JobTemplate, WorkflowId
...
class WorkflowBaseClient(ABC):
    ...
    @abstractmethod
    async def _delete_workflow_artifacts(self, workflow_id: WorkflowId):
        """
        This method deletes artifacts of a workflow
        """

    @abstractmethod
    async def retry_workflow(self, workflow_id: WorkflowId, user_id: Optional[str] = None):
        """
        Retry the workflow.
        """
