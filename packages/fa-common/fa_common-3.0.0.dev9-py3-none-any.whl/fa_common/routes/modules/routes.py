...
from data_mosaic_backend.modules.models import ModuleDocument
...
@router.post("/")
async def create_new_module(new_module: Module, sku: str):
    """
    Creates a new module.
    """
    return await ModuleDocument.insert_new(new_module, sku)


@router.delete("/")
async def delete_module(name: str) -> Message:
    """
...
async def overwrite_module(name: str, update_module: Module):
    """
...
@router.put("/{name}")
async def update_name_description_module(name: str, new_name: Optional[str] = None, new_description: Optional[str] = None):
    """
...
async def update_base_version(name: str, version: ModuleVersion):
    """
...
@router.put("/{name}/new")
async def add_new_version(name: str, version: ModuleVersion):
    """
...
async def update_module_version(name: str, version_name: str, version: ModuleVersion):
    """
...
async def delete_module_version(name: str, version_name: str):
    """
