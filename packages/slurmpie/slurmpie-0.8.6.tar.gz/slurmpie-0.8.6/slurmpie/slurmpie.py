...
class Pipeline:
    ...
    def _update_job_graph(self, parent_id: Union[str, list, int], jobs: dict):
        """
        ...
        elif isinstance(parent_id, list) and parent_id[0] == -1:
            self._job_graph[parent_id[0]].extend(list(itertools.chain(*jobs.values())))
        else:
