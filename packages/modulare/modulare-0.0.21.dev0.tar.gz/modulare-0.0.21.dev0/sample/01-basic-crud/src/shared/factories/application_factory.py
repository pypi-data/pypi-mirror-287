...
from shared.decorators.route_decorator import register_routes
...
class ApplicationFactory:
    ...
    def create(cls, module_class):
        class Wrapper:
            ...
            def _register_modules(self):
                ...
                for module in modules:
                    ...
                    self._register_providers_from_module(module_instance)
                    self._register_controllers_from_module(module_instance)

            def _register_providers_from_module(self, module_instance):
                providers = getattr(module_instance, 'providers', [])
                
                for provider in providers:
                    self._resolve_and_register_provider(provider)
            ...
            def _register_providers(self):
                providers = self._instance.providers
        ...
        return Wrapper(module_class()).app
