...
from geocover_utils.downloader import RemoteFileDownloader
from geocover_utils.geometry import (
...
from geocover_utils.logger import get_logger
from geocover_utils.raster import get_tiff_list, mosaic
from geocover_utils.stac_client import STAC
...
def download_swissalti(*args, **kwargs):
    ...
    logger = get_logger("geocover_utils", level=logging.getLevelName(log_level))
