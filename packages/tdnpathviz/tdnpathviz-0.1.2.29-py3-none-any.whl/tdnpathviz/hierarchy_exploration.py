...
class ProductHierarchySelector:
    def __init__(self, dataset, product_hierarchy, max_depth=3, figure_height=600):
        """
        ...
        Args:
            ...
            figure_height (int, optional): The height of the figure in pixels. Defaults to 600.
        """
        ...
        self.columns = self.create_tiles(hierarchical_levels, 0, self.figure_height)
    ...
    def create_tiles(self, levels, base_level, figure_height, tile_margin=1):
        """
    ...
    def on_tile_click(self, tile):
        ...
        with self.output:
            ...
            self.columns = self.create_tiles(hierarchical_levels, start_level, self.figure_height)
