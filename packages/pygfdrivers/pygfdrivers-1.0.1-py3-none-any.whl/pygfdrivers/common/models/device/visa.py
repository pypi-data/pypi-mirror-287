...
class BaseVisaResourceModel(BaseModel):
    visa_conn_type: str = Field(default=None)
    visa_resource_type: str = Field(default=None)
    visa_board_num: int = Field(default=None)
    ...
    eth_lan_device_name: str = Field(default=None)
