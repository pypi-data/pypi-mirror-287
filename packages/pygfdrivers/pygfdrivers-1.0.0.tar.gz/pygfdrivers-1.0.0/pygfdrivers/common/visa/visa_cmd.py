...
from common.util.exceptions import DeviceExceptions as dev_err
from common.util.exceptions import CommandClassExceptions as cmd_err
...
class BaseVisaScopeCommand:
    def __init__(self, visa_scope: VisaScope = None) -> None:
        ...
        self.scope_model = self.scope.device_model
        self.device_model = self.scope.device_model
        ...
        self.is_mxr = self.scope.device_model == 'MXR'
