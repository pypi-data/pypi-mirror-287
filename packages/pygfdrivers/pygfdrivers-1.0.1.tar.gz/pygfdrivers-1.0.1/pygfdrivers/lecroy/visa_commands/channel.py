...
from common.util.utilities import has_setter, has_prop
from lecroy.models.channel import LecroyChannelModel, LecroyChannelDataModel
...
class LecroyChannel(BaseVisaScopeCommand):
    ...
    def fetch_ch_config(self, active_chs: List[int], ch_info: Dict[str, LecroyChannelDataModel]) -> None:
        try:
            for ch in active_chs:
                info = ch_info[str(ch)]
