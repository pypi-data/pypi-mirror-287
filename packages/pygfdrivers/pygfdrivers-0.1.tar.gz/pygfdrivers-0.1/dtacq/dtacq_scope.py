...
from common.util.utilities import has_prop

from dtacq.util.utilities import pv
from dtacq.acq400_commands.trigger import DtacqTrigger
from dtacq.acq400_commands.acquire import DtacqAcquire
from dtacq.site_modules.modules_map import modules_map
...
class DtacqScope(BaseScope):
    ...
    def connect(self):
        try:
            # Function from DTACQ to determine if ACQ2106 or some other acq400_commands
            self.carrier = factory(self.config.scope.device_conn_str)
