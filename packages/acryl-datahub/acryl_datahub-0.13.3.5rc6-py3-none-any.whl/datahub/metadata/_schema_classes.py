...
class DataProcessInstanceKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'dataProcessInstance', 'entityCategory': '_unset_', 'entityAspects': ['dataProcessInstanceInput', 'dataProcessInstanceOutput', 'dataProcessInstanceProperties', 'dataProcessInstanceRelationships', 'dataProcessInstanceRunEvent', 'status'], 'entityDoc': 'DataProcessInstance represents an instance of a datajob/jobflow run'}
...
class SchemaFieldKeyClass(_Aspect):
    ...
    ASPECT_INFO = {'keyForEntity': 'schemaField', 'entityCategory': 'core', 'entityAspects': ['schemafieldInfo', 'structuredProperties', 'forms', 'businessAttributes', 'documentation']}
