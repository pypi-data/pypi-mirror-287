...
setup(
    name='mysunnyday',  # Your package will have this name
    packages=['mysunnyday'],  # Name the package again
    ...
    author='Eseose Odion',  # Your name
    author_email='eseoseodion@yahoo.com',  # Your email
