...
def submit_uhc_claim(client, x12_request_data):
    ...
    if client.config.get("MediLink_Config", {}).get("TestMode", True):
        # TestMode is enabled, print and log the intended request body
        print("Test Mode is enabled! API Call not executed.")
        print("Intended request body:", body)
        MediLink_ConfigLoader.log("Test Mode is enabled! Simulating API response for claim submission.", level="INFO")
