...
from ...interfunc import NCD_IF, DP_IF, MIRT_IF, RCD_IF, KANCD_IF
...
class RCD(_CognitiveDiagnosisModel):
    ...
    def build(self, datahub, device: str = "cpu", if_type='dp-linear', hidden_dims: list=None,
