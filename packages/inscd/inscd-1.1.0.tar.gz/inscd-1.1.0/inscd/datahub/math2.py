...
class Math2(DataHubBase):
    def __init__(self, root: str = "./tmp", **kwargs):
        super().__init__(**kwargs)
        # download Math2 dataset from Google driver
        url = "https://drive.google.com/uc?id=1CFhs4Ym4N0gnQaHgiwIc1LKQUh6HjiEZ"
        filename = "math2_2015_full_data.zip"
