...
class Assist17(DataHubBase):
    def __init__(self, root: str = "./tmp", **kwargs):
        super().__init__(**kwargs)
        # download Assist17 dataset from Google driver
        url = "https://drive.google.com/uc?id=1LMWYb_q_bNQxrdws8o8iwqVQ42GYYM0A"
        filename = "AssistMent17_data.zip"
