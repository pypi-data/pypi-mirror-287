...
class ORCDF_EX(_Extractor, nn.Module):
    def __init__(self, student_num: int, exercise_num: int, knowledge_num: int, latent_dim: int, device,
                 dtype, gcn_layers=3, keep_prob=0.9, ssl_temp=0.8, ssl_weight=1e-2, **kwargs):
        super().__init__()
    ...
    def get_flip_graph(self):
        ...
        self.graph_dict['right_flip'], self.graph_dict['wrong_flip'] = (self.__final_graph(se_graph_right_flip, ek_graph),
