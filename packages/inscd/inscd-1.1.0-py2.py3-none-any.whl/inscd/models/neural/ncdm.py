...
class NCDM(_CognitiveDiagnosisModel):
    def __init__(self):
        ...
        Fei Wang et al. Neural Cognitive Diagnosis for Intelligent Education Systems. AAAI'20.
        """
        super().__init__()

    def build(self, datahub, hidden_dims: list = None, dropout=0.5, device="cpu", dtype=torch.float32, **kwargs):
