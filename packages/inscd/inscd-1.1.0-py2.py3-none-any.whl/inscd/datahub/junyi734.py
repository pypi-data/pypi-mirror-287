...
class Junyi734(DataHubBase):
    def __init__(self, root: str = "./tmp", **kwargs):
        super().__init__(**kwargs)
        # download Junyi734 dataset from Google driver
        url = "https://drive.google.com/uc?id=1bXn4aTE25cFD00MhARn-4xKzShbq0DEW"
        filename = "Junyi_v734_data.zip"
