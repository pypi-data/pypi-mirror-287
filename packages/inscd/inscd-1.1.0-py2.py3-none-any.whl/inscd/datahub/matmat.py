...
class Matmat(DataHubBase):
    def __init__(self, root: str = "./tmp", **kwargs):
        super().__init__(**kwargs)
        # download Matmat dataset from Google driver
        url = "https://drive.google.com/uc?id=1KQCVt5pmcA7M5lKq8-DLQQrQND2TUCPp"
        filename = "Matmat_data.zip"
