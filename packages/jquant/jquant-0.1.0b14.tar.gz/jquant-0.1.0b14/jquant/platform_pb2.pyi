...
class Order(_message.Message):
    __slots__ = ("platform", "instrument", "order_id", "state", "price", "amount", "filled_amount", "avg_price", "type", "side", "client_order_id", "created_time", "updated_time", "info", "investor", "strategy", "source", "tag")
    class State(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        UNKNOWN: _ClassVar[Order.State]
        CREATED: _ClassVar[Order.State]
        SUBMITTED: _ClassVar[Order.State]
        PARTIAL_FILLED: _ClassVar[Order.State]
        FILLED: _ClassVar[Order.State]
        CANCELED: _ClassVar[Order.State]
        REJECTED: _ClassVar[Order.State]
        EXPIRED: _ClassVar[Order.State]
    UNKNOWN: Order.State
    CREATED: Order.State
    SUBMITTED: Order.State
    PARTIAL_FILLED: Order.State
    FILLED: Order.State
    ...
    source: str
    tag: str
    def __init__(self, platform: _Optional[str] = ..., instrument: _Optional[str] = ..., order_id: _Optional[str] = ..., state: _Optional[_Union[Order.State, str]] = ..., price: _Optional[str] = ..., amount: _Optional[str] = ..., filled_amount: _Optional[str] = ..., avg_price: _Optional[str] = ..., type: _Optional[str] = ..., side: _Optional[str] = ..., client_order_id: _Optional[str] = ..., created_time: _Optional[int] = ..., updated_time: _Optional[int] = ..., info: _Optional[str] = ..., investor: _Optional[str] = ..., strategy: _Optional[str] = ..., source: _Optional[str] = ..., tag: _Optional[str] = ...) -> None: ...
...
class Position(_message.Message):
    ...
    class Side(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        NET: _ClassVar[Position.Side]
        LONG: _ClassVar[Position.Side]
        SHORT: _ClassVar[Position.Side]
    NET: Position.Side
    LONG: Position.Side
    SHORT: Position.Side
    PLATFORM_FIELD_NUMBER: _ClassVar[int]
