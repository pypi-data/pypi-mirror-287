...
class OrderState(Enum):
    ...
    UNKNOWN = pb.Order.State
    CREATED = pb.Order.CREATED
    SUBMITTED = pb.Order.SUBMITTED
    PARTIAL_FILLED = pb.Order.PARTIAL_FILLED
    FILLED = pb.Order.FILLED
    CANCELED = pb.Order.CANCELED
    REJECTED = pb.Order.REJECTED
    EXPIRED = pb.Order.EXPIRED
...
class PositionSide(Enum):
    ...
    NET = pb.Position.NET
    LONG = pb.Position.LONG
    SHORT = pb.Position.SHORT
