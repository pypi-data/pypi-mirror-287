...
class RocksetClient:
    ...
    Usage:
        rs = RocksetClient(api_key=APIKEY, host=Clusters.use1a1)
    ...
    def __init__(
        ...
        """
        Keyword Args:
            host (str, Clusters): Base url of the Rockset apiserver that should be used.
                The Clusters enum can be used instead of a string.
