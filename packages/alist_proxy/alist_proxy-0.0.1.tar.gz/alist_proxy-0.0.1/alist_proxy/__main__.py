...
def main():
    ...
    parser.add_argument("-rh", "--redis-host", default="0.0.0.0", help="redis 服务所在的主机，默认值: '0.0.0.0'")
    parser.add_argument("-rp", "--redis-port", default=6379, type=int, help="redis 服务的端口，默认值: 5245")
