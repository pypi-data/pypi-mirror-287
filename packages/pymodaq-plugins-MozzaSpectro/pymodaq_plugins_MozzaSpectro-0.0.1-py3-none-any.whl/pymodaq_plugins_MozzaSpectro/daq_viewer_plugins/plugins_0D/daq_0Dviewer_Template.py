...
from pymodaq_plugins_MozzaSpectro.src.pymodaq_plugins_MozzaSpectro.hardware.spectro import (Spectro, SpectroError,
...
class DAQ_0DViewer_MozzaSpectrometer(DAQ_Viewer_base):
    ...
    params = comon_parameters + [
        {'title': 'Serial:', 'name': 'serial', 'type': 'list', 'values': MozzaSpectro.get_serials()},
