...
setup(
    name="proompter",
    packages=["proompter"],
    install_requires=['### proompter.py', 'mocker_db==0.2.0', 'pandas==2.1.1', 'attrs==23.2.0', 'ollama==0.2.1', 'huggingface_hub==0.24.2', 'transformers==4.43.2'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="Simple wrapper around some Llm handlers.", version="0.0.0"
)
