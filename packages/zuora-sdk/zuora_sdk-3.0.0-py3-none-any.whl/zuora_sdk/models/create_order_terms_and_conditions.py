...
class CreateOrderTermsAndConditions(object):
    ...
    def __init__(self, auto_renew=None, bill_to_contact_id=None, clearing_existing_bill_to_contact=False, clearing_existing_invoice_template=False, clearing_existing_payment_term=False, clearing_existing_sequence_set=False, clearing_existing_sold_to_contact=False, invoice_separately=None, invoice_template_id=None, last_term=None, payment_term=None, renewal_setting=None, renewal_terms=None, sequence_set_id=None, sold_to_contact_id=None):  # noqa: E501
