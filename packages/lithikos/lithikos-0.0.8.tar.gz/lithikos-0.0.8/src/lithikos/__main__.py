...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog="lithikos",
        description="""Orients 3D models of stone artefacts, isolates quadrants
    ...
    parser.add_argument(
        "filenames", help="One or more files containing mesh objects in Wavefront (obj) format",
    ...
    for filename in args.filenames:
        artefact_path = pathlib.Path(filename)
