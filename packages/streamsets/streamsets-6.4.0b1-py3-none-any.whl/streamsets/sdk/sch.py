...
class ControlHub:
    ...
    def run_job_sequence(self, job_sequence):
        ...
        return self.api_client.run_job_sequence(job_sequence.id)
    ...
    def get_self_managed_deployment_install_script(self, deployment, install_mechanism='DEFAULT', java_version=None):
