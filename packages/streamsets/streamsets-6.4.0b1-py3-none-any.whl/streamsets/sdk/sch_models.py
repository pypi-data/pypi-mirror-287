...
from .constants import (
    ...
    ENGINELESS_ENGINE_ID, SDC_CONNECTIONS_BW_COMPATIBILITY, SNOWFLAKE_ENGINE_ID, SNOWFLAKE_EXECUTOR_TYPE,
    SNOWFLAKE_STAGE_RENAME_ALIASES, ST_PIPELINE_BW_COMPATIBILITY, STAGE_CONFIG_OVERRIDES, ServiceConfigurationProperty,
...
class SelfManagedDeployment(Deployment):
    ...
    def install_script(self, install_mechanism='DEFAULT', java_version=None):
        ...
        return self._control_hub.api_client.get_self_managed_deployment_install_command(
            self.deployment_id, install_mechanism, self.install_type, java_version
        ).response.text
