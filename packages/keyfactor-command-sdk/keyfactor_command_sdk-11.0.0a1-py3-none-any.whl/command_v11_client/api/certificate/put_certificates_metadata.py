...
from ...models.csscms_data_model_models_metadata_update_request import CSSCMSDataModelModelsMetadataUpdateRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    json_body: CSSCMSDataModelModelsMetadataUpdateRequest,
