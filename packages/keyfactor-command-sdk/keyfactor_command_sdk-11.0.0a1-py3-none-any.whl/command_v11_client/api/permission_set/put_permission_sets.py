...
from ...models.keyfactor_web_keyfactor_api_models_permission_sets_permission_set_update_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsPermissionSetsPermissionSetUpdateRequest,
