...
from ...models.keyfactor_web_keyfactor_api_models_orchestrators_agent_response import (
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsOrchestratorsAgentResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsOrchestratorsAgentResponse']]
    """
