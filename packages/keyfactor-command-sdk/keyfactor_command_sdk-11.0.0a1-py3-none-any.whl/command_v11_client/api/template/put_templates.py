...
from ...models.keyfactor_web_keyfactor_api_models_templates_template_update_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsTemplatesTemplateUpdateRequest,
