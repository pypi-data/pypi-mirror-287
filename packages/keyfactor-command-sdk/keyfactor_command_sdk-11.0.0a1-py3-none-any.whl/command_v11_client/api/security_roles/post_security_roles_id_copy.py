...
from ...models.keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_role_copy_request import (
...
def _get_kwargs(
    id: int,
    *,
    json_body: KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityRoleCopyRequest,
    ...
    return {
        "method": "post",
        "url": "/Security/Roles/{id}/Copy".format(
            id=id,
        ),
        "json": json_json_body,
        "headers": headers,
...
def sync_detailed(
    ...
    *,
    ...
    """Makes a copy of an existing security role.
