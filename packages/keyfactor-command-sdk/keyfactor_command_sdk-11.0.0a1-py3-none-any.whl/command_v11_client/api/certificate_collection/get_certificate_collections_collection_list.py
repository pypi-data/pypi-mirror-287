...
from ...models.keyfactor_web_keyfactor_api_models_certificate_collections_certificate_collection_list_response import (
...
def _get_kwargs(
    *,
    ...
    return {
        "method": "get",
        "url": "/CertificateCollections/CollectionList",
        "params": params,
        "headers": headers,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, List["KeyfactorWebKeyfactorApiModelsCertificateCollectionsCertificateCollectionListResponse"]]
]:
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = (
                KeyfactorWebKeyfactorApiModelsCertificateCollectionsCertificateCollectionListResponse.from_dict(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, List['KeyfactorWebKeyfactorApiModelsCertificateCollectionsCertificateCollectionListResponse']]]
    """
