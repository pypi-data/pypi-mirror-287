...
def _get_kwargs(
    *,
    ...
    show_owned_access: Union[Unset, None, bool] = False,
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsSSHUsersSshUserResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsSSHUsersSshUserResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsSSHUsersSshUserResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsSSHUsersSshUserResponse']]
    """
