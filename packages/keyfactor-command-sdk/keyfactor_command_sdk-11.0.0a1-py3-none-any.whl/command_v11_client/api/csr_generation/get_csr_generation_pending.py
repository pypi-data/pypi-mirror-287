...
from ...models.csscms_data_model_models_pending_csr_response import CSSCMSDataModelModelsPendingCSRResponse
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsPendingCSRResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsPendingCSRResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsPendingCSRResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsPendingCSRResponse']]
    """
