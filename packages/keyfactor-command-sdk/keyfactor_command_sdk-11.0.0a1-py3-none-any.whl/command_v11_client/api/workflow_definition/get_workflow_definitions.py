...
from ...models.keyfactor_web_keyfactor_api_models_workflows_definition_query_response import (
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsWorkflowsDefinitionQueryResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsWorkflowsDefinitionQueryResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsWorkflowsDefinitionQueryResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsWorkflowsDefinitionQueryResponse']]
    """
