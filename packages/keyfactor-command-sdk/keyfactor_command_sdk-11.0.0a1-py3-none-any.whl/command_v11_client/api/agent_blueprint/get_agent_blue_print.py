...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintResponse']]
    """
