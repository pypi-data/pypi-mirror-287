...
) -> Optional[Union[Any, List["KeyfactorAuditingQueryingAuditLogEntry"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorAuditingQueryingAuditLogEntry"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorAuditingQueryingAuditLogEntry']]
    """
