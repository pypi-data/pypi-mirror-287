...
from ...models.csscms_data_model_models_certificate_store_inventory import (
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/CertificateStores/{id}/Inventory".format(
            id=id,
        ),
        "params": params,
        "headers": headers,
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsCertificateStoreInventory"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsCertificateStoreInventory.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsCertificateStoreInventory"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsCertificateStoreInventory']]
    """
