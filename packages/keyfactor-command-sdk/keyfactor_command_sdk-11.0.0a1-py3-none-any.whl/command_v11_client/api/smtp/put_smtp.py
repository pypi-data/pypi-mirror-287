...
from ...models.keyfactor_web_keyfactor_api_models_smtpsmtp_request import KeyfactorWebKeyfactorApiModelsSMTPSMTPRequest
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsSMTPSMTPRequest,
