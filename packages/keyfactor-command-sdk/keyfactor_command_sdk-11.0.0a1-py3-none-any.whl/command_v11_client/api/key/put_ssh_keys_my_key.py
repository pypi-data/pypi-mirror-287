...
from ...models.csscms_data_model_models_ssh_keys_key_update_request import CSSCMSDataModelModelsSSHKeysKeyUpdateRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    json_body: CSSCMSDataModelModelsSSHKeysKeyUpdateRequest,
