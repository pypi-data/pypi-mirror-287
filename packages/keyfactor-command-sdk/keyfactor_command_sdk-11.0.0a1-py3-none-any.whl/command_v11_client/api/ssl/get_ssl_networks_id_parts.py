...
from ...models.csscms_data_model_models_ssl_display_scan_job_part import CSSCMSDataModelModelsSSLDisplayScanJobPart
...
def _get_kwargs(
    id: str,
    *,
    job_type: Union[Unset, None, KeyfactorOrchestratorsCommonEnumsSslJobType] = UNSET,
    ...
    params: Dict[str, Any] = {}
    json_job_type: Union[Unset, None, int] = UNSET
    ...
    return {
        "method": "get",
        "url": "/SSL/Networks/{id}/Parts".format(
            id=id,
        ),
        "params": params,
        "headers": headers,
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsSSLDisplayScanJobPart"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsSSLDisplayScanJobPart.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsSSLDisplayScanJobPart"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        job_type (Union[Unset, None, KeyfactorOrchestratorsCommonEnumsSslJobType]):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsSSLDisplayScanJobPart']]
    """
