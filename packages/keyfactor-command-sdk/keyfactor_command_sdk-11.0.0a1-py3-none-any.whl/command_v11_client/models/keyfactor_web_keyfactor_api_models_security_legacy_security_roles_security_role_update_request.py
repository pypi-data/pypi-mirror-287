...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityRoleUpdateRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityRoleUpdateRequest:
    """
    Attributes:
        ...
        identities (Union[Unset, None, List['CSSCMSDataModelModelsSecurityIdentitiesSecurityIdentityIdentifier']]): The
            Keyfactor identities to assign to the updated role
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_role_update_request = cls(
            id=id,
            name=name,
            description=description,
            enabled=enabled,
        ...
        return keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_role_update_request
