...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsCertificateStoresCertificateStoreResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsCertificateStoresCertificateStoreResponse:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_certificate_stores_certificate_store_response = cls(
            id=id,
        ...
        return keyfactor_web_keyfactor_api_models_certificate_stores_certificate_store_response
