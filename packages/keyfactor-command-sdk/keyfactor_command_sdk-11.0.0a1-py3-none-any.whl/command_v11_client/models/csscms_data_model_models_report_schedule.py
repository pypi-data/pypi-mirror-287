...
if TYPE_CHECKING:
    from ..models.csscms_data_model_models_report_schedule_runtime_parameters import (
...
T = TypeVar("T", bound="CSSCMSDataModelModelsReportSchedule")


@_attrs_define
class CSSCMSDataModelModelsReportSchedule:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        runtime_parameters (Union[Unset, None, CSSCMSDataModelModelsReportScheduleRuntimeParameters]):
    """
    ...
    runtime_parameters: Union[Unset, None, "CSSCMSDataModelModelsReportScheduleRuntimeParameters"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _runtime_parameters is None:
            ...
            runtime_parameters = CSSCMSDataModelModelsReportScheduleRuntimeParameters.from_dict(_runtime_parameters)

        csscms_data_model_models_report_schedule = cls(
            id=id,
        ...
        return csscms_data_model_models_report_schedule
