...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsSMTPSMTPRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsSMTPSMTPRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_smtpsmtp_request = cls(
            host=host,
            id=id,
            port=port,
        ...
        return keyfactor_web_keyfactor_api_models_smtpsmtp_request
