...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsWorkflowsSignalDefinitionResponseInputParameters")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsWorkflowsSignalDefinitionResponseInputParameters:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_workflows_signal_definition_response_input_parameters = cls()
        ...
        keyfactor_web_keyfactor_api_models_workflows_signal_definition_response_input_parameters.additional_properties = (
            additional_properties
        )
        return keyfactor_web_keyfactor_api_models_workflows_signal_definition_response_input_parameters
