...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsSMTPSMTPResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsSMTPSMTPResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_smtpsmtp_response = cls(
            host=host,
            id=id,
            port=port,
        ...
        return keyfactor_web_keyfactor_api_models_smtpsmtp_response
