...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsTemplatesTemplateCollectionRetrievalResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsTemplatesTemplateCollectionRetrievalResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_templates_template_collection_retrieval_response = cls(
            id=id,
        ...
        return keyfactor_web_keyfactor_api_models_templates_template_collection_retrieval_response
