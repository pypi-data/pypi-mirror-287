...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityIdentityResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityIdentityResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_identity_response = cls(
            id=id,
        ...
        return keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_identity_response
