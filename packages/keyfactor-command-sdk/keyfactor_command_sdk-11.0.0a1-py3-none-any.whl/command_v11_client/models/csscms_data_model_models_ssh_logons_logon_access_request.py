...
T = TypeVar("T", bound="CSSCMSDataModelModelsSSHLogonsLogonAccessRequest")


@_attrs_define
class CSSCMSDataModelModelsSSHLogonsLogonAccessRequest:
    """
    Attributes:
        logon_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        csscms_data_model_models_ssh_logons_logon_access_request = cls(
            logon_id=logon_id,
            user_ids=user_ids,
        )

        return csscms_data_model_models_ssh_logons_logon_access_request
