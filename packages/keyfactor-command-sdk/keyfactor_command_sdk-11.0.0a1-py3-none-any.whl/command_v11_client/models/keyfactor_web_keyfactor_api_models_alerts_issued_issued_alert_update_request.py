...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertUpdateRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsIssuedIssuedAlertUpdateRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_issued_issued_alert_update_request = cls(
        ...
        return keyfactor_web_keyfactor_api_models_alerts_issued_issued_alert_update_request
