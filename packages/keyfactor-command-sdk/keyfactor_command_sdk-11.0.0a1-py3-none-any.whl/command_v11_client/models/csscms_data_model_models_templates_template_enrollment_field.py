...
T = TypeVar("T", bound="CSSCMSDataModelModelsTemplatesTemplateEnrollmentField")


@_attrs_define
class CSSCMSDataModelModelsTemplatesTemplateEnrollmentField:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        csscms_data_model_models_templates_template_enrollment_field = cls(
            id=id,
            name=name,
            options=options,
            data_type=data_type,
        ...
        return csscms_data_model_models_templates_template_enrollment_field
