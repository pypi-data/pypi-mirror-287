...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsEnrollmentManagementStoreTypeRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsEnrollmentManagementStoreTypeRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_enrollment_management_store_type_request = cls(
        ...
        return keyfactor_web_keyfactor_api_models_enrollment_management_store_type_request
