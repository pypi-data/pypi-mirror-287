...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertCreationRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertCreationRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_denied_denied_alert_creation_request = cls(
        ...
        return keyfactor_web_keyfactor_api_models_alerts_denied_denied_alert_creation_request
