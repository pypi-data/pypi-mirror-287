...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsMetadataFieldMetadataFieldResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsMetadataFieldMetadataFieldResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_metadata_field_metadata_field_response = cls(
            id=id,
            name=name,
        ...
        return keyfactor_web_keyfactor_api_models_metadata_field_metadata_field_response
