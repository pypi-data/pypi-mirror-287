...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_key_rotation_key_rotation_alert_test_request = cls(
            alert_id=alert_id,
        ...
        return keyfactor_web_keyfactor_api_models_alerts_key_rotation_key_rotation_alert_test_request
