...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_pending_pending_alert_update_request = cls(
        ...
        return keyfactor_web_keyfactor_api_models_alerts_pending_pending_alert_update_request
