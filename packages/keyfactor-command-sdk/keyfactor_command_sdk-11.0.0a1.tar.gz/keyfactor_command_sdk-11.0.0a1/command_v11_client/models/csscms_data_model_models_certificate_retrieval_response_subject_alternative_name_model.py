...
T = TypeVar("T", bound="CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel")


@_attrs_define
class CSSCMSDataModelModelsCertificateRetrievalResponseSubjectAlternativeNameModel:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        csscms_data_model_models_certificate_retrieval_response_subject_alternative_name_model = cls(
            id=id,
            value=value,
            type=type,
        ...
        return csscms_data_model_models_certificate_retrieval_response_subject_alternative_name_model
