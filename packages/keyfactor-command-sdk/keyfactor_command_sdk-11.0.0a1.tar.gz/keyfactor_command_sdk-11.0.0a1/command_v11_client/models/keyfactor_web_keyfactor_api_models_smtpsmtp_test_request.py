...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsSMTPSMTPTestRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsSMTPSMTPTestRequest:
    """
    Attributes:
        ...
        relay_password (Union[Unset, None, str]):
    ...
    relay_password: Union[Unset, None, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_smtpsmtp_test_request = cls(
            host=host,
            id=id,
            port=port,
        ...
        return keyfactor_web_keyfactor_api_models_smtpsmtp_test_request
