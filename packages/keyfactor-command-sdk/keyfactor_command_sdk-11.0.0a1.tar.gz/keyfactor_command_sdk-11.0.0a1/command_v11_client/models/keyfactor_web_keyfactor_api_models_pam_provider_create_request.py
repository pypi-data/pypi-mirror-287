...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsPAMProviderCreateRequest:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_pam_provider_create_request = cls(
            name=name,
        ...
        return keyfactor_web_keyfactor_api_models_pam_provider_create_request
