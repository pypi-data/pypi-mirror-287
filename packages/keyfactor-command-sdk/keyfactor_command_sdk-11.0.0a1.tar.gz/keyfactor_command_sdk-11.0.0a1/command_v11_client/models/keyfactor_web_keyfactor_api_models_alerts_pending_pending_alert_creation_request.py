...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertCreationRequest")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsPendingPendingAlertCreationRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_pending_pending_alert_creation_request = cls(
        ...
        return keyfactor_web_keyfactor_api_models_alerts_pending_pending_alert_creation_request
