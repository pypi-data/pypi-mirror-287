...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_alerts_denied_denied_alert_definition_response = cls(
            id=id,
        ...
        return keyfactor_web_keyfactor_api_models_alerts_denied_denied_alert_definition_response
