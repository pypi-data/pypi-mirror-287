...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsTemplatesGlobalGlobalTemplateRegexResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_templates_global_global_template_regex_response = cls(
            subject_part=subject_part,
            regex=regex,
            error=error,
        )

        return keyfactor_web_keyfactor_api_models_templates_global_global_template_regex_response
