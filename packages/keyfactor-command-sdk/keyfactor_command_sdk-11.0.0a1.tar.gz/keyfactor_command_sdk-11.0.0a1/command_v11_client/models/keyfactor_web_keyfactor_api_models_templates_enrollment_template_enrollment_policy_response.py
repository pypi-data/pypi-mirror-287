...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsTemplatesEnrollmentTemplateEnrollmentPolicyResponse")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsTemplatesEnrollmentTemplateEnrollmentPolicyResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_templates_enrollment_template_enrollment_policy_response = cls(
        ...
        return keyfactor_web_keyfactor_api_models_templates_enrollment_template_enrollment_policy_response
