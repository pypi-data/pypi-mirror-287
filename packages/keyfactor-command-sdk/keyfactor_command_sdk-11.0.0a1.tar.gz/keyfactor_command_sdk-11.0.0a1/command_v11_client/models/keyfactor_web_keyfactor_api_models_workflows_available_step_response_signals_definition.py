...
T = TypeVar("T", bound="KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepResponseSignalsDefinition")


@_attrs_define
class KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepResponseSignalsDefinition:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_web_keyfactor_api_models_workflows_available_step_response_signals_definition = cls()
        ...
        keyfactor_web_keyfactor_api_models_workflows_available_step_response_signals_definition.additional_properties = (
            additional_properties
        )
        return keyfactor_web_keyfactor_api_models_workflows_available_step_response_signals_definition
