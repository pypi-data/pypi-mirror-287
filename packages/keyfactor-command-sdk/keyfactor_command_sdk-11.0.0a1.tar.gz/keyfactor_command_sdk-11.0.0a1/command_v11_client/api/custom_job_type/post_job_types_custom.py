...
from ...models.csscms_data_model_models_orchestrator_jobs_job_type_create_request import (
...
def _get_kwargs(
    *,
    json_body: CSSCMSDataModelModelsOrchestratorJobsJobTypeCreateRequest,
