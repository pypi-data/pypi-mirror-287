...
from ...models.csscms_data_model_models_orchestrator_jobs_job import CSSCMSDataModelModelsOrchestratorJobsJob
...
def _get_kwargs(
    *,
    ...
    return {
        "method": "get",
        "url": "/OrchestratorJobs/ScheduledJobs",
        "params": params,
        "headers": headers,
    }
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsOrchestratorJobsJob"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsOrchestratorJobsJob.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsOrchestratorJobsJob"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsOrchestratorJobsJob']]
    """
