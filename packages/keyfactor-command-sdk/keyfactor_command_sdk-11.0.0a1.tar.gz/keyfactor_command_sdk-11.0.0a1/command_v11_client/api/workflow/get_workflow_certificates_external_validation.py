...
from ...models.csscms_data_model_models_workflow_certificate_request_model import (
...
def _get_kwargs(
    *,
    ...
    return {
        "method": "get",
        "url": "/Workflow/Certificates/ExternalValidation",
        "params": params,
        "headers": headers,
    }
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsWorkflowCertificateRequestModel"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsWorkflowCertificateRequestModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsWorkflowCertificateRequestModel"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsWorkflowCertificateRequestModel']]
    """
