...
from ...models.keyfactor_web_keyfactor_api_models_security_legacy_security_roles_security_role_update_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsSecurityLegacySecurityRolesSecurityRoleUpdateRequest,
...
def sync_detailed(
    *,
    ...
    """Updates a security role that matches the id.
