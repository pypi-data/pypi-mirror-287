...
from ...models.keyfactor_web_keyfactor_api_models_certificate_stores_add_certificate_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsCertificateStoresAddCertificateRequest,
    ...
    return {
        "method": "post",
        "url": "/CertificateStores/Certificates/Add",
        "json": json_json_body,
        "headers": headers,
    }
