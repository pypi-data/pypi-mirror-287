...
from ...models.csscms_data_model_models_ssh_server_groups_server_group_update_request import (
...
def _get_kwargs(
    *,
    json_body: CSSCMSDataModelModelsSSHServerGroupsServerGroupUpdateRequest,
