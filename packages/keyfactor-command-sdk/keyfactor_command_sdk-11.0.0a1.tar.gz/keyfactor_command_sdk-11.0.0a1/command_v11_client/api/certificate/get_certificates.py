...
from ...models.csscms_data_model_models_certificate_retrieval_response import (
...
def _get_kwargs(
    *,
    include_revoked: Union[Unset, None, bool] = UNSET,
    include_expired: Union[Unset, None, bool] = UNSET,
    ...
    include_locations: Union[Unset, None, bool] = False,
    include_metadata: Union[Unset, None, bool] = False,
    include_has_private_key: Union[Unset, None, bool] = False,
    verbose: Union[Unset, None, int] = 0,
    ...
    params: Dict[str, Any] = {}
    params["IncludeRevoked"] = include_revoked
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsCertificateRetrievalResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsCertificateRetrievalResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsCertificateRetrievalResponse"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        include_revoked (Union[Unset, None, bool]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsCertificateRetrievalResponse']]
    """
