...
from ...models.keyfactor_web_keyfactor_api_models_security_role_claim_definitions_role_claim_definition_query_response import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    Union[Any, List["KeyfactorWebKeyfactorApiModelsSecurityRoleClaimDefinitionsRoleClaimDefinitionQueryResponse"]]
]:
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in _response_200:
            response_200_item = (
                KeyfactorWebKeyfactorApiModelsSecurityRoleClaimDefinitionsRoleClaimDefinitionQueryResponse.from_dict(
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Any, List['KeyfactorWebKeyfactorApiModelsSecurityRoleClaimDefinitionsRoleClaimDefinitionQueryResponse']]]
    """
