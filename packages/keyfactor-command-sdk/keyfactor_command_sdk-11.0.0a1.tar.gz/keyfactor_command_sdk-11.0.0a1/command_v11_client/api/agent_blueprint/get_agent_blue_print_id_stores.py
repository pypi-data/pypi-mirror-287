...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/AgentBluePrint/{id}/Stores".format(
            id=id,
        ),
        "params": params,
        "headers": headers,
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse']]
    """
