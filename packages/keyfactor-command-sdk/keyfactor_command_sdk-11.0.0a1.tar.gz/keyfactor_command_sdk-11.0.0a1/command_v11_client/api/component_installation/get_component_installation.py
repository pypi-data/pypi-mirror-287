...
from ...models.keyfactor_web_keyfactor_api_models_component_installation_component_installation_response import (
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsComponentInstallationComponentInstallationResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = (
                KeyfactorWebKeyfactorApiModelsComponentInstallationComponentInstallationResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsComponentInstallationComponentInstallationResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsComponentInstallationComponentInstallationResponse']]
    """
