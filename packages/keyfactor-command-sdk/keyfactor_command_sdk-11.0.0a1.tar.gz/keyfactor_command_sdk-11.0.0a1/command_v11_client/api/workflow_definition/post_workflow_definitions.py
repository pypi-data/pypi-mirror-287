...
from ...models.keyfactor_web_keyfactor_api_models_workflows_definition_create_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsWorkflowsDefinitionCreateRequest,
