...
from ...models.keyfactor_web_keyfactor_api_models_workflows_available_step_query_response import (
...
def _get_kwargs(
    *,
    ...
    return {
        "method": "get",
        "url": "/Workflow/Definitions/Steps",
        "params": params,
        "headers": headers,
    }
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepQueryResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepQueryResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepQueryResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsWorkflowsAvailableStepQueryResponse']]
    """
