...
from ...models.keyfactor_web_keyfactor_api_models_reports_report_schedules_report_schedule_creation_request import (
...
def _get_kwargs(
    id: int,
    *,
    json_body: KeyfactorWebKeyfactorApiModelsReportsReportSchedulesReportScheduleCreationRequest,
