...
def _get_kwargs(
    *,
    ammended_query: Union[Unset, None, str] = UNSET,
    ...
    params: Dict[str, Any] = {}
    params["AmmendedQuery"] = ammended_query
...
) -> Optional[Union[Any, List["KeyfactorWebKeyfactorApiModelsReportsCustomReportsCustomReportResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorWebKeyfactorApiModelsReportsCustomReportsCustomReportResponse.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["KeyfactorWebKeyfactorApiModelsReportsCustomReportsCustomReportResponse"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ammended_query (Union[Unset, None, str]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['KeyfactorWebKeyfactorApiModelsReportsCustomReportsCustomReportResponse']]
    """
