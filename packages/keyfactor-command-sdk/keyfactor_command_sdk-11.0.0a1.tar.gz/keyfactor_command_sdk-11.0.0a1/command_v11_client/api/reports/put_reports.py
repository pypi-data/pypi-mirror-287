...
from ...models.csscms_data_model_models_report_request_model import CSSCMSDataModelModelsReportRequestModel
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    json_body: CSSCMSDataModelModelsReportRequestModel,
