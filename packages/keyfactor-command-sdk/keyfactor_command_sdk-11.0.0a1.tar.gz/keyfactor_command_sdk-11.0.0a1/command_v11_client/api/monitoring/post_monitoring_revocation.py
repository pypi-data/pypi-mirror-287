...
from ...models.keyfactor_web_keyfactor_api_models_monitoring_revocation_monitoring_creation_request import (
...
def _get_kwargs(
    *,
    json_body: KeyfactorWebKeyfactorApiModelsMonitoringRevocationMonitoringCreationRequest,
