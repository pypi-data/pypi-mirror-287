...
from ...models.csscms_data_model_models_ssl_ssl_scan_result import CSSCMSDataModelModelsSSLSslScanResult
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsSSLSslScanResult"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsSSLSslScanResult.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsSSLSslScanResult"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsSSLSslScanResult']]
    """
