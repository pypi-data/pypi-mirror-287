...
from ...models.csscms_data_model_models_ssl_endpoint_history_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/SSL/Endpoints/{id}/History".format(
            id=id,
        ),
        "params": params,
        "headers": headers,
...
) -> Optional[Union[Any, List["CSSCMSDataModelModelsSSLEndpointHistoryResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = CSSCMSDataModelModelsSSLEndpointHistoryResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, List["CSSCMSDataModelModelsSSLEndpointHistoryResponse"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, List['CSSCMSDataModelModelsSSLEndpointHistoryResponse']]
    """
