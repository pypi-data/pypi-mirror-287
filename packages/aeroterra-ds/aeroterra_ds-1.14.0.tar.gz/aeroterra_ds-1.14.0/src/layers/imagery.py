...
from rasters.handler import join_tiffs
...
def clip_imagery(layer, bounds, crs, folder, file, size=None, delete_clips=False, quality=1, join=True, bands=None):
    """
    ...
    pixel_size_x = math.ceil(layer._lazy_properties.pixelSizeX * 1000) / 1000.0
    pixel_size_x = math.ceil(pixel_size_x / quality)
    pixel_size_y = math.ceil(layer._lazy_properties.pixelSizeY * 1000) / 1000.0
    pixel_size_y = math.ceil(pixel_size_y / quality)
