    ...
    def _create_database(self, db_name: str) -> None:
        ...
        try:
            ...
            if 'already exists' in str(e):
                ...
                logging.error(f"ProgrammingError while creating database '{db_name}': {e}")
                raise
        ...
        for file_name in os.listdir(data_directory):
            if file_name.endswith('.csv') or file_name.endswith('.xlsx'):
                ...
                try:
                    ...
                    logging.error(f"Error creating or updating table '{table_name}': {e}")

    def _create_or_update_table(self, table_name: str, file_path: str) -> None:
        """
        Create or update a table based on the data from the specified file.
        ...
        def _delete_db():
            try:
                ...
                if 'does not exist' in str(e):
                    ...
                    logging.error(f"ProgrammingError while deleting database '{self.name}': {e}")
                    raise
            except exc.OperationalError as e:
                logging.error("The 'postgres' database does not exist. Please create it or use another default database.")
                logging.error(f"OperationalError: {e}")
    ...
    def check_primary_key(self, table_name: str) -> None:
        ...
        with self.engine.connect() as con:
            try:
                ...
                logging.error(f"Error checking primary key for table '{table_name}': {e}")
                raise
    ...
    def check_foreign_keys(self, table_name: str) -> bool:
        ...
        with self.engine.connect() as con:
            try:
                ...
                logging.error(f"Error checking foreign keys for table '{table_name}': {e}")
                raise
