...
class Pipeline:
    ...
    def from_dict(obj: Any) -> 'Pipeline':
        ...
        return Pipeline(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, azure_data_factory_pipeline, pipeline_created_at, deleted_at, display_name, entity_type, entity_upstream, fivetran, force_shown, pipeline_id, informatica_mapping, is_complete, is_deleted, is_non_prod, is_production, last_ingested_at, last_modified_at, logical_id, parsed_upstream, power_bi_dataflow, source_info, spark, structure, system_contacts, system_description, system_tags, system_tag_values, pipeline_versioned_id)
