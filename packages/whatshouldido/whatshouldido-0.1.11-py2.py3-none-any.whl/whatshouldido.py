...
def process_file(repo_path, filepath):
    todolines = []
    try:
        repo = Repo(repo_path)  # Create a new Repo object for each thread
        line_num = 0
    ...
    with ThreadPoolExecutor() as executor:
        ...
        for root, dirs, files in os.walk(path):
            for filename in files:
                ...
                futures.append(executor.submit(process_file, repo_path, filepath))
