...
class StackWord():
    ...
    def shouldShow(self):
        return self.value or self.note or self.isHead() or (self.address == self.cell.address)
...
class Stack():
    ...
    def toAnsi(self, width = 50, showAddress = False, leftMargin = 32):
    ...
    def toHtml(self, showAddress = True, full = True):
        # env = Environment(
        ...
        ansi = self.toAnsi(showAddress=showAddress)

        conv = Ansi2HTMLConverter()
        html = conv.convert(ansi, full=full)
