...
var __module_copy__ = /*#__PURE__*/Object.freeze({
    __proto__: null,
    copy: copy$1,
    deepcopy: deepcopy
});

// Transcrypt'ed from Python, 2024-07-27 15:39:46
...
var main = function () {
	print ('Hello!');
	var x = ['a', 'b', 'c'];
	__call__ (print, null, 'x:', __getitem__ (x, __neg__ (1)));
	var obj = dict ({'a': 'hello'});
	print (obj ['a']);
};
{
	main ();
