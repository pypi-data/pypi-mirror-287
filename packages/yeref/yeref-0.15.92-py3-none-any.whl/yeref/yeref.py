...
async def db_chn_create_entity(db):
    ...
    try:
        ...
        cur.execute('''CREATE TABLE IF NOT EXISTS POST ( 
            ...
            POST_ISFORMAT      BOOLEAN     DEFAULT 0,
            POST_ISTAG         BOOLEAN     DEFAULT 0,
            POST_ISREACTION    BOOLEAN     DEFAULT 1,
            POST_ISPODCAST     BOOLEAN     DEFAULT 0,
...
async def create_invoice_link(BOT_TID, BOT_LC, msg_text, msg_btns, POST_LNK, BASE_D):
    result = None
    try:
    ...
    try:
        ...
        for btn in msg_btns:
            try:
                ...
                if btn['knd'] == 'payment':
                    invoice_link = await create_invoice_link(BOT_TID, BOT_LC, msg_text, msg_btns, POST_LNK, BASE_D)
