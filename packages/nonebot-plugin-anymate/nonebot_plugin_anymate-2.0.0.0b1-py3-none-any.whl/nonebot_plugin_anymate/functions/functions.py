...
async def get_info_func(args: Message = CommandArg()):
    ...
    info_result, temp = await api_client.get_info(uuid[0])
...
async def get_last_post_func(args: Message = CommandArg()):
    ...
    post_content, temp = await api_client.get_last_post(mateId, perPage)
...
async def get_search_content_func(args: Message = CommandArg()):
    ...
    if perPage > 20:
        ...
        perPage = 5
    search_result, temp = await api_client.search(args_list[0], perPage)
...
async def add_char_by_UUID_func(args: Message = CommandArg()):
    ...
    info_result, temp = await api_client.get_info(UUID)
...
async def remind_update_func(args: Message = CommandArg()):
    ...
    post_content, temp = await api_client.get_last_post(mateId)
...
async def get_explore_func(args: Message = CommandArg()):
    ...
    post_content, temp = await api_client.get_explore_post(perPage)
    data = post_content["page"]["data"]
