...
import sys
import os
print("Importing package.py")
# wtai-dt(wind turbine ai and digital twin)
“数据统计 报告 绘图
wtai-dt.datadescribe.function
wtai-dt.report.function
wtai-dt.plot.function
wtai-dt.bujian.function
”
'''
简单地剪辑视频文件！
