...
from tommytomato_utils.database_client.database_client import (
    DatabaseClient, DatabaseClientConfig
)
from tommytomato_utils.database_client.exceptions import ColumnMismatchError, DatabaseConnectionError
...
class TestDatabaseClient(unittest.TestCase):
    ...
    @patch('tommytomato_utils.database_client.database_client.create_engine')
    @patch('tommytomato_utils.database_client.database_client.DatabaseClient.reflect_schema', MagicMock())
    @patch('tommytomato_utils.database_client.database_client.DatabaseClient.test_connection', MagicMock())
