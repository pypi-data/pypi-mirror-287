...
from lqs.interface.pjm.models import EventCreateRequest


def validate(headers: dict, expected_secret: str = None):
    """
    ...
    assert type(token) == str, "Authorization header must be a string"
