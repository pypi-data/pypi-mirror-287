...
<a href="https://pypi.org/project/gradio_brm_save/" target="_blank"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/gradio_brm_save"></a>  
</div>
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["brm_save"]["members"]["__init__"], linkify=[])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["brm_save"]["events"], linkify=['Event'])
...
def predict(
    ...
    return value
```
""", elem_classes=["md-custom", "brm_save-user-fn"], header_links=True)
