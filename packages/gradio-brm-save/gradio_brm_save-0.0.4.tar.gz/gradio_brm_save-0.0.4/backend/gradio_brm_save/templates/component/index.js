...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ie("button"), a && a.c(), t = sl(), n = Ie("div"), $t(i.$$.fragment), ne(n, "class", "svelte-1lrphxw"), P(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function wl(l) {
  ...
  return {
    c() {
      e = ye("svg"), t = ye("g"), n = ye("path"), i = ye("path"), W(n, "d", "M18,6L6.087,17.913"), Q(n, "fill", "none"), Q(n, "fill-rule", "nonzero"), Q(n, "stroke-width", "2px"), W(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), W(i, "d", "M4.364,4.364L19.636,19.636"), Q(i, "fill", "none"), Q(i, "fill-rule", "nonzero"), Q(i, "stroke-width", "2px"), W(e, "width", "100%"), W(e, "height", "100%"), W(e, "viewBox", "0 0 24 24"), W(e, "version", "1.1"), W(e, "xmlns", "http://www.w3.org/2000/svg"), W(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), W(e, "xml:space", "preserve"), W(e, "stroke", "currentColor"), Q(e, "fill-rule", "evenodd"), Q(e, "clip-rule", "evenodd"), Q(e, "stroke-linecap", "round"), Q(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
let Re = wt ? () => window.performance.now() : () => Date.now(), kt = wt ? (l) => requestAnimationFrame(l) : qe;
...
function Ke(l, e, t, n) {
  if (typeof t == "number" || We(t)) {
    const i = n - t, f = (t - e) / (l.dt || 1 / 60), s = l.opts.stiffness * i, r = l.opts.damping * f, a = (s - r) * l.inv_mass, o = (f + a) * l.dt;
    return Math.abs(o) < l.opts.precision && Math.abs(i) < l.opts.precision ? n : (l.settled = !1, We(t) ? new Date(t.getTime() + o) : t + o);
  } else {
    if (Array.isArray(t))
      return t.map(
...
function Ge(l, e = {}) {
  ...
  function y(v, L = {}) {
    c = v;
    const _ = a = {};
    return l == null || L.hard || F.stiffness >= 1 && F.damping >= 1 ? (m = !0, s = Re(), o = v, t.set(l = c), Promise.resolve()) : (L.soft && (p = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), u = 0), r || (s = Re(), m = !1, r = vl((d) => {
      if (m)
        return m = !1, r = null, !1;
      u = Math.min(u + p, 1);
      const C = {
...
function Vl(l) {
  ...
  return {
    ...
    m(m, y) {
      Ml(m, e, y), G(e, t), G(t, n), G(n, i), G(n, f), G(n, s), G(n, r), G(t, a), G(a, o), G(a, c), G(a, u), G(a, p);
    },
    p(m, [y]) {
      y & /*$top*/
...
function Al(l, e, t) {
  ...
  var f = this && this.__awaiter || function(m, y, F, v) {
    ...
    return new (F || (F = Promise))(function(_, d) {
      ...
      function b(z) {
        z.done ? _(z.value) : L(z.value).then(C, V);
      }
...
class Pl extends ql {
  constructor(e) {
    super(), Ll(this, e, Al, Vl, zl, { margin: 0 });
  }
}
const {
  SvelteComponent: jl,
...
function Xl(l) {
  ...
  return {
    c() {
      e = x("div"), yt(t.$$.fragment), n = D(), i = x("span"), s = N(f), r = D(), c && c.c(), U(e, "class", "clear-status svelte-16nch4a"), U(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
      k(u, e, p), Lt(t, e, null), k(u, n, p), k(u, i, p), ce(i, s), k(u, r, p), c && c.m(u, p), a = !0;
    },
    p(u, p) {
      const m = {};
      p[0] & /*i18n*/
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && X(s, f), c && c.p && (!a || p[0] & /*$$scope*/
      536870912) && Mt(
        c,
        o,
        u,
    ...
    i(u) {
      a || (Y(t.$$.fragment, u), Y(c, u), a = !0);
    },
    o(u) {
      $(t.$$.fragment, u), $(c, u), a = !1;
    },
    d(u) {
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = D(), t = x("div"), m && m.c(), n = D(), y && y.c(), i = D(), s && s.c(), r = D(), _ && _.c(), a = be(), U(t, "class", "progress-text svelte-16nch4a"), B(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    p(d, C) {
      ...
      let V = f;
      f = L(d), f === V ? ~f && v[f].p(d, C) : (s && (Ee(), $(v[V], 1, 1, () => {
        v[V] = null;
      }), Ze()), ~f ? (s = v[f], s ? s.p(d, C) : (s = v[f] = F[f](d), s.c()), Y(s, 1), s.m(r.parentNode, r)) : s = null), /*timer*/
      d[5] ? _ && (Ee(), $(_, 1, 1, () => {
        _ = null;
      }), Ze()) : _ ? (_.p(d, C), C[0] & /*timer*/
      32 && Y(_, 1)) : (_ = ct(d), _.c(), Y(_, 1), _.m(a.parentNode, a));
    },
    i(d) {
      o || (Y(s), Y(_), o = !0);
    },
...
function et(l) {
  ...
  return {
    c() {
      e = x("div"), U(e, "class", "eta-bar svelte-16nch4a"), oe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Jl(l) {
  ...
  return {
    c() {
      e = x("div"), t = x("div"), r && r.c(), n = D(), i = x("div"), f = x("div"), U(t, "class", "progress-level-inner svelte-16nch4a"), U(f, "class", "progress-bar svelte-16nch4a"), oe(f, "width", s), U(i, "class", "progress-bar-wrap svelte-16nch4a"), U(e, "class", "progress-level svelte-16nch4a");
    },
    m(a, o) {
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = D(), s && s.c(), t = D(), r && r.c(), n = D(), a && a.c(), i = be();
    },
    m(o, c) {
  ...
  return {
    c() {
      e = x("p"), t = N(
        /*loading_text*/
        l[9]
      ), n = D(), s && s.c(), U(e, "class", "loading svelte-16nch4a");
    },
    m(r, a) {
...
function xl(l) {
  ...
  return ~(t = a(l)) && (n = r[t] = s[t](l)), {
    c() {
      e = x("div"), n && n.c(), U(e, "class", i = "wrap " + /*variant*/
      l[8] + " " + /*show_progress*/
    ...
    p(o, c) {
      let u = t;
      t = a(o), t === u ? ~t && r[t].p(o, c) : (n && (Ee(), $(r[u], 1, 1, () => {
        r[u] = null;
      }), Ze()), ~t ? (n = r[t], n ? n.p(o, c) : (n = r[t] = s[t](o), n.c()), Y(n, 1), n.m(e, null)) : n = null), (!f || c[0] & /*variant, show_progress*/
      320 && i !== (i = "wrap " + /*variant*/
      o[8] + " " + /*show_progress*/
      o[6] + " svelte-16nch4a")) && U(e, "class", i), (!f || c[0] & /*variant, show_progress, status, show_progress*/
      336) && B(e, "hide", !/*status*/
      o[4] || /*status*/
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Tl();
  let { i18n: r } = e, { eta: a = null } = e, { queue_position: o } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: m = !0 } = e, { show_progress: y = "full" } = e, { message: F = null } = e, { progress: v = null } = e, { variant: L = "default" } = e, { loading_text: _ = "Loading..." } = e, { absolute: d = !0 } = e, { translucent: C = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, j = !1, ie = 0, ee = 0, fe = null, te = null, K = 0, R = null, ae, H = null, h = !0;
  const S = () => {
    t(0, a = t(27, fe = t(19, E = null))), t(25, ie = performance.now()), t(26, ee = 0), j = !0, A();
  };
  function A() {
    requestAnimationFrame(() => {
      t(26, ee = (performance.now() - ie) / 1e3), j && A();
    });
  }
  function Z() {
    t(26, ee = 0), t(0, a = t(27, fe = t(19, E = null))), j && (j = !1);
  }
  El(() => {
    j && Z();
  });
  ...
  function le(g) {
    He[g ? "unshift" : "push"](() => {
      H = g, t(16, H), t(7, v), t(14, R), t(15, ae);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    436207617 && (a === null && t(0, a = fe), a != null && fe !== a && (t(28, te = (performance.now() - ie) / 1e3 + a), t(19, E = te.toFixed(1)), t(27, fe = a))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, K = te === null || te <= 0 || !ee ? null : Math.min(ee / te, 1)), l.$$.dirty[0] & /*progress*/
    128 && v != null && t(18, h = !1), l.$$.dirty[0] & /*progress, progress_level, progress_bar, last_progress_level*/
    114816 && (v != null ? t(14, R = v.map((g) => {
      if (g.index != null && g.length != null)
        return g.index / g.length;
      if (g.progress != null)
        return g.progress;
    })) : t(14, R = null), R ? (t(15, ae = R[R.length - 1]), H && (ae === 0 ? t(16, H.style.transition = "0", H) : t(16, H.style.transition = "150ms", H))) : t(15, ae = void 0)), l.$$.dirty[0] & /*status*/
    16 && (u === "pending" ? S() : Z()), l.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
    20979728 && z && p && (u === "pending" || u === "complete") && en(z, b), l.$$.dirty[0] & /*status, message*/
    8388624, l.$$.dirty[0] & /*timer_diff*/
    67108864 && t(20, n = ee.toFixed(1));
  }, [
    a,
    r,
    o,
...
function wn(l) {
  ...
  return {
    c() {
      s && s.c(), e = mn(), t = an("iframe"), hn(t.src, n = "https://bohrium.test.dp.tech/app/function-panel") || Pe(t, "src", n), Pe(t, "style", i = "width:" + /*width*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(h, S, A, Z) {
    function E(le) {
      return le instanceof A ? le : new A(function(ue) {
        ue(le);
      });
    }
    return new (A || (A = Promise))(function(le, ue) {
      function Le(T) {
        try {
          ge(Z.next(T));
        } catch (se) {
      ...
      function ge(T) {
        T.done ? le(T.value) : E(T.value).then(Le, g);
      }
      ge((Z = Z.apply(h, S || [])).next());
    });
  };
  let { gradio: i } = e, { label: f = "Textbox" } = e, { elem_id: s = "" } = e, { elem_classes: r = [] } = e, { visible: a = !0 } = e, { value: o } = e, { placeholder: c = "" } = e, { show_label: u } = e, { scale: p = null } = e, { min_width: m = void 0 } = e, { loading_status: y = void 0 } = e, { value_is_output: F = !1 } = e, { interactive: v } = e, { rtl: L = !1 } = e, { fileName: _ } = e, { fileContent: d } = e, { width: C } = e, { height: V } = e, { appAccessKey: b } = e, { clientName: z } = e, j, ie;
  function ee() {
    var h, S;
    let A = /* @__PURE__ */ new Map();
    document.cookie.split(";").forEach((Z) => {
      const [E, le] = Z.trim().split("=");
      A.set(E, le);
    }), j = (h = b ?? A.get("appAccessKey")) !== null && h !== void 0 ? h : "sk-cf76953ad52a471587cda01547170e09", ie = (S = z ?? A.get("clientName")) !== null && S !== void 0 ? S : "opensdk-demo--test-uuid1720691302";
  }
  function fe() {
  ...
  let K;
  const R = () => {
    K != null && K.contentWindow && _ && K.contentWindow.postMessage(
      {
        id: "1",
        type: "selectFilePath",
        data: { fileName: _ },
        headers: { accessKey: j, "x-app-key": ie }
      },
      "*"
    );
  };
    ...
    ee(), t(
      ...
      return n(this, void 0, void 0, function* () {
        ...
        if (S.type === "selectFilePath" && S.status === "succeed") {
          const A = new URL("https://openapi.test.dp.tech/openapi/v1/open/file/upload/binary");
          A.searchParams.append("path", `${S.data.dirPath}${S.data.fileName}`), S.data.projectId && A.searchParams.append("projectId", S.data.projectId);
          const Z = yield fetch(A, {
            method: "GET",
            headers: { accessKey: j, "x-app-key": ie }
          });
          if (Z.ok) {
            ...
            fetch(`${E.data.host}/api/upload/binary`, {
              ...
              t(10, o = !0), yield te(), t(10, o = void 0);
            }));
          }
        }
        S.type === "closeWindow" && (t(10, o = !1), yield te(), t(10, o = void 0)), S.type === "ready" && R();
      });
    });
  });
...
class yn extends nn {
  ...
  set fileName(e) {
    this.$$set({ fileName: e }), M();
  }
  get fileContent() {
    return this.$$.ctx[18];
  }
  set fileContent(e) {
    this.$$set({ fileContent: e }), M();
  }
  get width() {
    return this.$$.ctx[7];
  }
  ...
  set appAccessKey(e) {
    this.$$set({ appAccessKey: e }), M();
  }
  get clientName() {
    return this.$$.ctx[20];
  }
  set clientName(e) {
    this.$$set({ clientName: e }), M();
  }
}
export {
  yn as default
