...
class brm_save(FormComponent):
    ...
    # def get_ak_info_from_request(self, request: gr.Request) -> Tuple[str, str]:
    ...
    # def get_user_id(self, request: gr.Request) -> str:
    #     access_key, app_key = self.get_ak_info_from_request(request)
    #     client = OpenSDK(access_key, app_key)
    ...
    def __init__(
        ...
        *,
        ...
        self.width = width
        self.height = height
        self.appAccessKey = appAccessKey
