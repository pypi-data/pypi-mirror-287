...
>
	{#if loading_status}
		...
		/>
	{/if}
	<div style="padding: 24px;background: #f4f6fb;{visible ? '' : 'display: none;'}">
	<iframe src="https://bohrium.test.dp.tech/app/function-panel" bind:this={iframeRef} style="width:{width}px;height: {height}px;"></iframe>
	</div>
</Block>
