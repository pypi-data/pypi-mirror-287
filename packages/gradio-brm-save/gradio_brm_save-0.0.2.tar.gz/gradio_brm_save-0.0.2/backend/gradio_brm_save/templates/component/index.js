...
function wl(l) {
  ...
  return {
    c() {
      e = ye("svg"), t = ye("g"), n = ye("path"), i = ye("path"), R(n, "d", "M18,6L6.087,17.913"), Q(n, "fill", "none"), Q(n, "fill-rule", "nonzero"), Q(n, "stroke-width", "2px"), R(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), R(i, "d", "M4.364,4.364L19.636,19.636"), Q(i, "fill", "none"), Q(i, "fill-rule", "nonzero"), Q(i, "stroke-width", "2px"), R(e, "width", "100%"), R(e, "height", "100%"), R(e, "viewBox", "0 0 24 24"), R(e, "version", "1.1"), R(e, "xmlns", "http://www.w3.org/2000/svg"), R(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), R(e, "xml:space", "preserve"), R(e, "stroke", "currentColor"), Q(e, "fill-rule", "evenodd"), Q(e, "clip-rule", "evenodd"), Q(e, "stroke-linecap", "round"), Q(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
function Vl(l) {
  ...
  return {
    ...
    m(m, y) {
      Ml(m, e, y), W(e, t), W(t, n), W(n, i), W(n, f), W(n, s), W(n, r), W(t, a), W(a, o), W(a, c), W(a, u), W(a, p);
    },
    p(m, [y]) {
      y & /*$top*/
...
function Al(l, e, t) {
  ...
  var f = this && this.__awaiter || function(m, y, F, v) {
    ...
    return new (F || (F = Promise))(function(_, d) {
      ...
      function b(z) {
        z.done ? _(z.value) : L(z.value).then(C, S);
      }
...
function Xl(l) {
  ...
  return {
    c() {
      e = x("div"), yt(t.$$.fragment), n = D(), i = x("span"), s = N(f), r = D(), c && c.c(), Y(e, "class", "clear-status svelte-16nch4a"), Y(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = D(), t = x("div"), m && m.c(), n = D(), y && y.c(), i = D(), s && s.c(), r = D(), _ && _.c(), a = be(), Y(t, "class", "progress-text svelte-16nch4a"), B(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    p(d, C) {
      ...
      let S = f;
      f = L(d), f === S ? ~f && v[f].p(d, C) : (s && (Ee(), $(v[S], 1, 1, () => {
        v[S] = null;
...
function et(l) {
  ...
  return {
    c() {
      e = x("div"), Y(e, "class", "eta-bar svelte-16nch4a"), oe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Jl(l) {
  ...
  return {
    c() {
      e = x("div"), t = x("div"), r && r.c(), n = D(), i = x("div"), f = x("div"), Y(t, "class", "progress-level-inner svelte-16nch4a"), Y(f, "class", "progress-bar svelte-16nch4a"), oe(f, "width", s), Y(i, "class", "progress-bar-wrap svelte-16nch4a"), Y(e, "class", "progress-level svelte-16nch4a");
    },
    m(a, o) {
  ...
  return {
    c() {
      e = x("p"), t = N(
        /*loading_text*/
        l[9]
      ), n = D(), s && s.c(), Y(e, "class", "loading svelte-16nch4a");
    },
    m(r, a) {
...
function xl(l) {
  ...
  return ~(t = a(l)) && (n = r[t] = s[t](l)), {
    c() {
      e = x("div"), n && n.c(), Y(e, "class", i = "wrap " + /*variant*/
      l[8] + " " + /*show_progress*/
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Tl();
  let { i18n: r } = e, { eta: a = null } = e, { queue_position: o } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: m = !0 } = e, { show_progress: y = "full" } = e, { message: F = null } = e, { progress: v = null } = e, { variant: L = "default" } = e, { loading_text: _ = "Loading..." } = e, { absolute: d = !0 } = e, { translucent: C = !1 } = e, { border: S = !1 } = e, { autoscroll: b } = e, z, j = !1, ie = 0, ee = 0, fe = null, te = null, K = 0, U = null, ae, H = null, h = !0;
  const V = () => {
  ...
  function le(g) {
    He[g ? "unshift" : "push"](() => {
      H = g, t(16, H), t(7, v), t(14, U), t(15, ae);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    114816 && (v != null ? t(14, U = v.map((g) => {
      if (g.index != null && g.length != null)
        return g.index / g.length;
      if (g.progress != null)
        return g.progress;
    })) : t(14, U = null), U ? (t(15, ae = U[U.length - 1]), H && (ae === 0 ? t(16, H.style.transition = "0", H) : t(16, H.style.transition = "150ms", H))) : t(15, ae = void 0)), l.$$.dirty[0] & /*status*/
    16 && (u === "pending" ? V() : Z()), l.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(h, V, A, Z) {
    function E(le) {
  ...
  function ee() {
    ...
    document.cookie.split(";").forEach((Z) => {
      ...
      A.set(E, le);
    }), j = (h = b ?? A.get("appAccessKey")) !== null && h !== void 0 ? h : "sk-cf76953ad52a471587cda01547170e09", ie = (V = z ?? A.get("clientName")) !== null && V !== void 0 ? V : "opensdk-demo--test-uuid1720691302";
  }
  function fe() {
  ...
  bn(() => {
    ee(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: V } = h;
        if (V.type === "selectFilePath" && V.status === "succeed") {
          const A = new URL("https://openapi.test.dp.tech/openapi/v1/open/file/upload/binary");
          A.searchParams.append("path", `${V.data.dirPath}${V.data.fileName}`), V.data.projectId && A.searchParams.append("projectId", V.data.projectId);
        ...
        V.type === "closeWindow" && (t(10, o = !1), yield te(), t(10, o = void 0));
      });
    });
  });
