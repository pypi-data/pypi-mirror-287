...
from typing import Optional, Iterator, Union, Tuple, List, AsyncIterator, Literal
...
class CreateRoiMutation(BaseModel):
    ...
    class Meta:
        document = "fragment ROI on ROI {\n  id\n  image {\n    id\n  }\n  vectors\n  kind\n}\n\nmutation CreateRoi($image: ID!, $vectors: [FiveDVector!]!, $kind: RoiKind!, $entityKind: ID, $entityParent: ID) {\n  createRoi(\n    input: {image: $image, vectors: $vectors, kind: $kind, entityKind: $entityKind, entityParent: $entityParent}\n  ) {\n    ...ROI\n  }\n}"
...
async def acreate_protocol(
    name: str, experiment: ID, rath: Optional[MikroNextRath] = None
) -> Protocol:
    """CreateProtocol
    ...
    return (
        await aexecute(
            CreateProtocolMutation, {"name": name, "experiment": experiment}, rath=rath
        )
    ).create_protocol
