...
from numbers import Number
 from typing import Any, Callable, TypeVar, NewType, Union, Tuple, Optional, ForwardRef
...
class Property(property):
    ...
    def __init__(self, /,
                 ...
                 *,
                 types: Union[type, Tuple[type], None]                              = None,
                 default: Any                                                       = None,
                 readonly:  bool                                                     = False,
        ...
        self.types     = types if (types is None or (
            isinstance(types, tuple) and (
                sum([0 if isinstance(T, type) else 1 for T in types])==0)
    ...
    def __set__(self, obj: Any, val: UnknownData) -> None:
        '''Wrapper to implement the use of fset, ffix, fval, and fnrm.'''
