...
MODEL_PRICE = {
    ...
    "api-sunoai-audio": 0.1,  # file
    "api-sunoai-lyrics": 0.01,
    "api-translator": 0.0001,
    "api-voice-clone": 0.01,  # file
    "api-cogvideox": 0.1,
    ...
    # embedding
    "bge-large-zh-v1.5": 0.0001,
    "bge-large-en-v1.5": 0.0001,
    "BAAI/bge-large-zh-v1.5": 0.0001,
    "BAAI/bge-large-en-V1.5": 0.0001,
