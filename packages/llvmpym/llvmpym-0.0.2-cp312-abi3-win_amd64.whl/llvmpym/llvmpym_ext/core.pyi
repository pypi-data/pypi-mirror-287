...
class AttributeIndex(enum.Enum):
    """AttributeIndex"""
...
class Builder:
    ...
    def and(self, lhs: Value, rhs: Value, name: str) -> Value: ...

    def or(self, lhs: Value, rhs: Value, name: str) -> Value: ...
    ...
    def not(self, arg0: Value, arg1: str, /) -> Value: ...
...
class CallBase(Instruction):
    ...
    def set_param_alignment(self, index: int, align: int) -> None: ...
...
class ConstantExpr(Constant):
    ...
    @staticmethod
    def insert_element(vector: ConstantVector, index: Constant, index: Constant) -> Value: ...
...
class Context:
    ...
    def set_diagnostic_handler(self, handler: "void __cdecl(LLVMOpaqueDiagnosticInfo * __ptr64,void * __ptr64)", diagnostic_context: types.CapsuleType) -> None:
        """Set the diagnostic handler for this context."""

    def set_yield_callback(self, callback: "void __cdecl(LLVMOpaqueContext * __ptr64,void * __ptr64)", opaque_handle: types.CapsuleType) -> None:
        """Set the yield callback function for this context."""

    def parse_ir(self, memory_buffer: MemoryBuffer) -> tuple[bool, Module, str]:
        """
...
class Function(GlobalObject):
    ...
    def __init__(self, module: Module, name: str, function_type: FunctionType) -> None:
    ...
    @property
    def params(self) -> list[Argument]: ...

    @property
    def first_param(self) -> Argument | None: ...

    @property
    def last_param(self) -> Argument | None: ...

    def get_param(self, index: int) -> Argument:
        """
...
class MemoryBuffer:
    ...
    @staticmethod
    def create_with_contents_of_file(path: str) -> tuple[int, MemoryBuffer, str]: ...

    @staticmethod
    def create_with_stdin() -> tuple[int, MemoryBuffer, str]: ...

    @staticmethod
    def create_with_memory_range(input_data: str, buffer_name: str, requires_null_terminator: bool) -> MemoryBuffer: ...

    @staticmethod
    def create_with_memory_range_copy(input_data: str, buffer_name: str) -> MemoryBuffer | None: ...
...
class Module:
    ...
    @property
    def first_global(self) -> GlobalVariable | None: ...

    @property
    def last_global(self) -> GlobalVariable | None: ...
    ...
    def source_file_name(self, arg: str, /) -> None: ...
    ...
    def add_global_in_address_space(self, type: Type, name: str, address_space: int) -> GlobalVariable: ...

    def get_named_global(self, arg: str, /) -> GlobalVariable: ...

    def add_global_indirect_func(self, name: str, type: Type, addr_space: int, resolver: Constant) -> GlobalIFunc: ...
    ...
    def print_to_file(self, filename: str) -> tuple[bool, str]:
        """
...
class Value:
    ...
    def to_Argument(self) -> Value | None:
        ...
        Note if the target class is not supported in python binding, then it will return a generic PyValue type object
        """
