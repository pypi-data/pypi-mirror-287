...
from artifact.openapi_client.models.delete_all_graphs_request import DeleteAllGraphsRequest
from artifact.openapi_client.models.delete_graph_request import DeleteGraphRequest
from artifact.openapi_client.models.graph_stats import GraphStats
...
class ArtifactClient:
    ...
    def create_graph(self, name: str, indexing_interval: str = "IMMEDIATE") -> Graph:
        """Create a new graph."""
    ...
    class GraphInstance:
        ...
        def delete(self) -> None:
            """Delete a graph."""
            headers = self.artifact_client.set_auth_headers()
            response = self.artifact_client.api_instance.delete_graph(graph_id=self.graph_id, _headers=headers)
            return response