...
class GrantSchemaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The database that the schema belongs to.
        ...
        :param pulumi.Input[str] schema_name: The schema that is being granted on.
...
class GrantSchema(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[str]] = None,
            role_name: Optional[pulumi.Input[str]] = None,
            schema_name: Optional[pulumi.Input[str]] = None) -> 'GrantSchema':
        """
