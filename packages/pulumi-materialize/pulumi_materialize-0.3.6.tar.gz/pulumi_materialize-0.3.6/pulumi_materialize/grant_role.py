...
class GrantRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] member_name: The role name to add to role_name as a member.
        :param pulumi.Input[str] role_name: The role name to add member_name as a member.
...
class GrantRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            member_name: Optional[pulumi.Input[str]] = None,
            region: Optional[pulumi.Input[str]] = None,
            role_name: Optional[pulumi.Input[str]] = None) -> 'GrantRole':
        """
