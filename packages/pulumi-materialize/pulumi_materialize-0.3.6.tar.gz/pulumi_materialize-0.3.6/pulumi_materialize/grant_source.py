...
__all__ = ['GrantSourceArgs', 'GrantSource']

@pulumi.input_type
class GrantSourceArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a GrantSource resource.
        :param pulumi.Input[str] database_name: The database that the view belongs to.
        ...
        :param pulumi.Input[str] schema_name: The schema that the view being to.
        :param pulumi.Input[str] source_name: The source that is being granted on.
...
class _GrantSourceState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering GrantSource resources.
        :param pulumi.Input[str] database_name: The database that the view belongs to.
        :param pulumi.Input[str] privilege: The privilege to grant to the object.
        :param pulumi.Input[str] region: The region to use for the resource connection. If not set, the default region is used.
        :param pulumi.Input[str] role_name: The name of the role to grant privilege to.
...
class GrantSource(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GrantSourceArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GrantSourceArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GrantSourceArgs.__new__(GrantSourceArgs)
        ...
        super(GrantSource, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            role_name: Optional[pulumi.Input[str]] = None,
            schema_name: Optional[pulumi.Input[str]] = None,
            source_name: Optional[pulumi.Input[str]] = None) -> 'GrantSource':
        """
        Get an existing GrantSource resource's state with the given name, id, and optional extra
        ...
        __props__ = _GrantSourceState.__new__(_GrantSourceState)
        ...
        __props__.__dict__["schema_name"] = schema_name
        __props__.__dict__["source_name"] = source_name
        return GrantSource(resource_name, opts=opts, __props__=__props__)
