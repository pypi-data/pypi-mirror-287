...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 identify_by_name: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] identify_by_name: Use the cluster name as the Terraform resource ID instead of the internal cluster ID.
    ...
    def identify_by_name(self) -> Optional[pulumi.Input[bool]]:
        """
        Use the cluster name as the Terraform resource ID instead of the internal cluster ID.
        """
        return pulumi.get(self, "identify_by_name")

    @identify_by_name.setter
    def identify_by_name(self, value: Optional[pulumi.Input[bool]]):
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="identifyByName")
    def identify_by_name(self) -> pulumi.Output[Optional[bool]]:
        """
        Use the cluster name as the Terraform resource ID instead of the internal cluster ID.
        """
        return pulumi.get(self, "identify_by_name")
