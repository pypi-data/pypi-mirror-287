...
class SCIM2GroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: A description of the SCIM group.
        :param pulumi.Input[str] name: The name of the SCIM group.
        """
...
class SCIM2Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            description: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'SCIM2Group':
        """
