...
__all__ = ['GrantTypeArgs', 'GrantType']
...
class GrantTypeArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a GrantType resource.
        :param pulumi.Input[str] database_name: The database that the type belongs to.
        ...
        :param pulumi.Input[str] schema_name: The schema that the type being to.
        :param pulumi.Input[str] type_name: The type that is being granted on.
...
class _GrantTypeState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering GrantType resources.
        :param pulumi.Input[str] database_name: The database that the type belongs to.
        :param pulumi.Input[str] privilege: The privilege to grant to the object.
        :param pulumi.Input[str] region: The region to use for the resource connection. If not set, the default region is used.
        :param pulumi.Input[str] role_name: The name of the role to grant privilege to.
...
class GrantType(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GrantTypeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GrantTypeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GrantTypeArgs.__new__(GrantTypeArgs)
        ...
        super(GrantType, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            role_name: Optional[pulumi.Input[str]] = None,
            schema_name: Optional[pulumi.Input[str]] = None,
            type_name: Optional[pulumi.Input[str]] = None) -> 'GrantType':
        """
        Get an existing GrantType resource's state with the given name, id, and optional extra
        ...
        __props__ = _GrantTypeState.__new__(_GrantTypeState)
        ...
        __props__.__dict__["schema_name"] = schema_name
        __props__.__dict__["type_name"] = type_name
        return GrantType(resource_name, opts=opts, __props__=__props__)
