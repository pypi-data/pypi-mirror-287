...
class ConnectionKafkaArgs:
    def __init__(__self__, *,
                 ...
                 progress_topic_replication_factor: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] progress_topic_replication_factor: The replication factor to use when creating the Kafka progress topic (if the Kafka topic does not already exist).
    ...
    def progress_topic_replication_factor(self) -> Optional[pulumi.Input[int]]:
        """
    ...
    def progress_topic_replication_factor(self, value: Optional[pulumi.Input[int]]):
...
class ConnectionKafka(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="progressTopicReplicationFactor")
    def progress_topic_replication_factor(self) -> pulumi.Output[Optional[int]]:
        """
        The replication factor to use when creating the Kafka progress topic (if the Kafka topic does not already exist).
        """
        return pulumi.get(self, "progress_topic_replication_factor")
