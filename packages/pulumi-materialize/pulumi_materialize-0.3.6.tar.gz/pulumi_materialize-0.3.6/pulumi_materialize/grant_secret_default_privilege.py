...
__all__ = ['GrantSecretDefaultPrivilegeArgs', 'GrantSecretDefaultPrivilege']

@pulumi.input_type
class GrantSecretDefaultPrivilegeArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a GrantSecretDefaultPrivilege resource.
...
@pulumi.input_type
class _GrantSecretDefaultPrivilegeState:
    def __init__(__self__, *,
                 database_name: Optional[pulumi.Input[str]] = None,
        ...
        """
        Input properties used for looking up and filtering GrantSecretDefaultPrivilege resources.
        :param pulumi.Input[str] database_name: The default privilege will apply only to objects created in this database, if specified.
        :param pulumi.Input[str] grantee_name: The role name that will gain the default privilege. Use the `PUBLIC` pseudo-role to grant privileges to all roles.
        :param pulumi.Input[str] privilege: The privilege to grant to the object.
        :param pulumi.Input[str] region: The region to use for the resource connection. If not set, the default region is used.
...
class GrantSecretDefaultPrivilege(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: GrantSecretDefaultPrivilegeArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Defines default privileges that will be applied to objects created in the future. It does not affect any existing objects.
        ...
        :param str resource_name: The name of the resource.
        :param GrantSecretDefaultPrivilegeArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GrantSecretDefaultPrivilegeArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GrantSecretDefaultPrivilegeArgs.__new__(GrantSecretDefaultPrivilegeArgs)
        ...
        super(GrantSecretDefaultPrivilege, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[str]] = None,
            schema_name: Optional[pulumi.Input[str]] = None,
            target_role_name: Optional[pulumi.Input[str]] = None) -> 'GrantSecretDefaultPrivilege':
        """
        Get an existing GrantSecretDefaultPrivilege resource's state with the given name, id, and optional extra
        ...
        __props__ = _GrantSecretDefaultPrivilegeState.__new__(_GrantSecretDefaultPrivilegeState)
        ...
        __props__.__dict__["schema_name"] = schema_name
        __props__.__dict__["target_role_name"] = target_role_name
        return GrantSecretDefaultPrivilege(resource_name, opts=opts, __props__=__props__)
