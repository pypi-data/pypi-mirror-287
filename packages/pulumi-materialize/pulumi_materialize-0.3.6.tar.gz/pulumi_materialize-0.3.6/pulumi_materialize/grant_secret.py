...
class GrantSecretArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] database_name: The database that the secret belongs to.
        ...
        :param pulumi.Input[str] schema_name: The schema that the secret being to.
        :param pulumi.Input[str] secret_name: The secret that is being granted on.
...
class GrantSecret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            role_name: Optional[pulumi.Input[str]] = None,
            schema_name: Optional[pulumi.Input[str]] = None,
            secret_name: Optional[pulumi.Input[str]] = None) -> 'GrantSecret':
        """
