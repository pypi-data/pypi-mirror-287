...
REQUIRES = ["aspose-3d==24.7.0",
            "aspose-barcode-for-python-via-net==24.7",
            "aspose-cad==24.7",
            "aspose-cells-python==24.7.0",
            "aspose-diagram-python==24.7",
            "Aspose.Email-for-Python-via-NET==24.7",
            "aspose-finance==24.6",
            "aspose-html-net==24.7.0",
            "aspose-imaging-python-net==24.7.0",
            "aspose-ocr-python-net==24.6.0",
            "aspose-page==24.7.0",
            "aspose-pdf==24.7.0",
            "aspose-psd==24.6.0",
            "Aspose.Slides==24.7.0",
            "aspose-svg-net==24.7.0",
            "aspose-tasks==24.7.0",
            "aspose-tex-net==24.7.0",
            "aspose-words==24.7.0",
            "aspose-zip==24.7.0"]
