...
class CaraAPI:
    ...
    def chatfilter(self, message: str, levenshtein: int, FilteredWords, GuildID:int, ChannelID: int, AuthorID: int,
                   MessageID: int, GuildName: str, ChannelName: str, AuthorName: str, GoodWords, log:bool, OnlyASCII:bool = True, uri: str = cara_base_url):
        try:
            if log:
    ...
    def get_user(self, user_id: str, uri: str = cara_base_url):
        try:
