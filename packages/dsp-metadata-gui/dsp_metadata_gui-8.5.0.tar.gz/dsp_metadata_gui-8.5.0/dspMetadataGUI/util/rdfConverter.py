...
from rdflib.namespace import PROV, SDO, XSD
...
def validate_file(file: str) -> None:
    ...
    shacl = (
        "https://raw.githubusercontent.com/dasch-swiss/dsp-meta-svc/main/docs/services/metadata/schema-metadata.shacl"
    )
    print(file)
    conforms, result_graph, result_text = validate(data_graph=file, shacl_graph=shacl, inference="none")
    print(result_text)
    print("\n-------------\n\n")
