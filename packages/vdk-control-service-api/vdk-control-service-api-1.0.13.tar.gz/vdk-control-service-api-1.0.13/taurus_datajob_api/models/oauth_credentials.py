...
class OauthCredentials(BaseModel):
    ...
    Oauth credentials
    """
    client_id: StrictStr = Field(..., alias="clientId", description="Oauth Application Client ID")
    client_secret: StrictStr = Field(..., alias="clientSecret", description="Oauth Application Client Secret")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OauthCredentials:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OauthCredentials:
        """Create an instance of OauthCredentials from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OauthCredentials.parse_obj(obj)

        _obj = OauthCredentials.parse_obj({
