...
class OauthTeamClientId(BaseModel):
    """
    ...
    __properties = ["teamName", "clientId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OauthTeamClientId:
        """Create an instance of OauthTeamClientId from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OauthTeamClientId:
        """Create an instance of OauthTeamClientId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OauthTeamClientId.parse_obj(obj)

        _obj = OauthTeamClientId.parse_obj({
