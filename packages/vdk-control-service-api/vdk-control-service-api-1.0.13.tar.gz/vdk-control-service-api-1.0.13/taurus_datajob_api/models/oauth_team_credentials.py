...
class OauthTeamCredentials(BaseModel):
    """
    Oauth credentials for a team.
    """
    team_name: StrictStr = Field(..., alias="teamName", description="The name of the team")
    client_id: StrictStr = Field(..., alias="clientId", description="The clientID")
    client_secret: StrictStr = Field(..., alias="clientSecret", description="The clientSecret")
    __properties = ["teamName", "clientId", "clientSecret"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OauthTeamCredentials:
        """Create an instance of OauthTeamCredentials from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OauthTeamCredentials:
        """Create an instance of OauthTeamCredentials from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OauthTeamCredentials.parse_obj(obj)

        _obj = OauthTeamCredentials.parse_obj({
