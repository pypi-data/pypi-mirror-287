...
from taurus_datajob_api.models.oauth_team_client_id import OauthTeamClientId  # noqa: E501
from taurus_datajob_api.rest import ApiException

class TestOauthTeamClientId(unittest.TestCase):
    """OauthTeamClientId unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test OauthTeamClientId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OauthTeamClientId`
        """
        model = taurus_datajob_api.models.oauth_team_client_id.OauthTeamClientId()  # noqa: E501
        if include_optional :
            return OauthTeamClientId(
                team_name = '', 
                client_id = ''
            )
        else :
    ...
    def testOauthTeamClientId(self):
        """Test OauthTeamClientId"""
