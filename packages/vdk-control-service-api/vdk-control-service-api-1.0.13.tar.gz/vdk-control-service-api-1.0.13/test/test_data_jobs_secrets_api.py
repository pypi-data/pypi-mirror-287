...
from taurus_datajob_api.api.data_jobs_secrets_api import DataJobsSecretsApi  # noqa: E501
from taurus_datajob_api.rest import ApiException


class TestDataJobsSecretsApi(unittest.TestCase):
    """DataJobsSecretsApi unit test stubs"""

    def setUp(self):
        self.api = taurus_datajob_api.api.data_jobs_secrets_api.DataJobsSecretsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_client_id_get(self):
        """Test case for client_id_get

        Retrieve the OAuth client ID for a specific team identified by {team_name}. | (Stable)  # noqa: E501
        """
        pass

    def test_data_job_secrets_read(self):
        """Test case for data_job_secrets_read

        Get Data Job secrets.  # noqa: E501
        """
        pass

    def test_data_job_secrets_update(self):
        """Test case for data_job_secrets_update

        Update Data Job secrets.  # noqa: E501
        """
        pass

    def test_get_team_ids_for_client_ids(self):
        """Test case for get_team_ids_for_client_ids

        for a given list of ClientID(s) return a list of Team Ids,e.g. list of [clientId:teamId,clientId1:teamID1]  # noqa: E501
        """
        pass

    def test_oauth_credentials_get(self):
        """Test case for oauth_credentials_get

        Get the Team's Oauth Application Credentials. | (Stable)  # noqa: E501
        """
        pass

    def test_oauth_credentials_put(self):
        """Test case for oauth_credentials_put
