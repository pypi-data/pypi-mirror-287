...
from taurus_datajob_api.models.oauth_credentials import OauthCredentials  # noqa: E501
from taurus_datajob_api.rest import ApiException

class TestOauthCredentials(unittest.TestCase):
    """OauthCredentials unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `OauthCredentials`
        """
        model = taurus_datajob_api.models.oauth_credentials.OauthCredentials()  # noqa: E501
        if include_optional :
            return OauthCredentials(
                client_id = 'HDZe8w71KzzzRQkpRlicFM2UAdUsgStRGv', 
                client_secret = 'OYXIXlHE2sRuPBCXHTBHxN3rZOiBtFkrbnCpAj1YSFE3gSr5mT'
            )
        else :
            return OauthCredentials(
                client_id = 'HDZe8w71KzzzRQkpRlicFM2UAdUsgStRGv',
