...
Inter_Bold_Path = resource_filename('ENSCardMaker', 'fonts/Inter-Bold.ttf')
Inter_Reg_Path = resource_filename('ENSCardMaker', 'fonts/Inter-Regular.ttf')
...
def main():
    ...
    if avatar:
        ...
        if profile['records']['avatar'].startswith("eip155:1/"):
            ...
            font = ImageFont.truetype(Inter_Bold_Path, font_size)  # Load the desired font
    ...
    if 'name' in profile and 'address' in profile:
        ...
        font = ImageFont.truetype(Inter_Reg_Path, font_size)  # Load the desired font
    ...
    if 'description' in profile['records']:
        ...
        font_size = 16
        font = ImageFont.truetype(Inter_Reg_Path, font_size)
    ...
    watermark_font = ImageFont.truetype(Inter_Reg_Path, watermark_font_size)
