...
class TracerExtension(AppExtensionBase):
    ...
    @classmethod
    def post_invocation_app_level(cls,logger: Logger, context: Context, func_args: typing.Dict[str, object] = {}, func_ret: typing.Optional[object] = None, *args, **kwargs) -> None:
        cls.t.finish()
        print("end")
        pass
