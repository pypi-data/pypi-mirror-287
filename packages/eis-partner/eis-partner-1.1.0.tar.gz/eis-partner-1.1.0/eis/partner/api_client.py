...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = PartnerRelationsApi()
        api_instance.get_partner_relation_type  # this is an instance of the class Endpoint
        api_instance.get_partner_relation_type()  # this invokes api_instance.get_partner_relation_type.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_partner_relation_type.callable or self.callable in this class
