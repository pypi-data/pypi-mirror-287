...
REQUIRES = ["groupdocs-comparison-net==24.7",
            "groupdocs-viewer-net==24.7",
            "groupdocs-watermark-net==24.5"]
...
setup(
    ...
    "Windows", "Linux", "macOS", "Python 3.5 or later", "installation", "pip install", "upgrade package"],
