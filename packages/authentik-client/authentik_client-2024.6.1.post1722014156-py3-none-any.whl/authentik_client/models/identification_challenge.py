...
class IdentificationChallenge(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["flow_info", "component", "response_errors", "user_fields", "password_fields", "allow_show_password", "application_pre", "flow_designation", "enroll_url", "recovery_url", "passwordless_url", "primary_action", "sources", "show_source_labels"]
