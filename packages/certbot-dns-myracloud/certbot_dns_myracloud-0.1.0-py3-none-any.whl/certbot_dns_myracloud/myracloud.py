...
class _MyracloudClient(object):
    ...
    def request(self, requestMethod:str, requestUri:str, requestBody: Union[Dict[str, object]|Dict[str,int]] = {}):
        """
        ...
        if requestBody:
            reqBody = json.dumps(requestBody, separators=(',',':')).strip()
        else:
            reqBody = ''
        ...
        headers = {
            ...
            "Date": requestDate,
            "Authorization": self._auth_sign(requestDate, requestMethod, requestUri, reqBody)
        }
