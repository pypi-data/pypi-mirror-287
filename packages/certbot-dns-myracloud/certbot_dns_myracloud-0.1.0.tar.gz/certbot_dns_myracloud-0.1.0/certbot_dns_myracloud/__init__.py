"""
certbot_dns_myracloud.

-------------------

This module provides functionality to integrate Myracloud DNS with Certbot
...
- Authenticator: This class is responsible for solving the DNS-01 challenge by uploading
  the required validation token to a Myracloud DNS record.

- _MyracloudClient: This is an internal helper class that facilitates interactions
  with the Myracloud DNS API.

Note:
    The `_MyracloudClient` class is intended for internal use within this module and
...
from .myracloud import Authenticator
