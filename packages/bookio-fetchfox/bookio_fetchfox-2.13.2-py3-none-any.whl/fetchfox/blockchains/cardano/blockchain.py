...
class Cardano(Blockchain):
    ...
    def get_account_stake_address(self, account: str) -> str:
        warnings.deprecated("cardano.get_account_stake_address is deprecated, please use cardano.get_main_address instead")

        return self.get_main_address(account)

    def get_main_address(self, account: str, exception: bool = False) -> Optional[str]:
    ...
    def get_account_name(self, account: str) -> str:
        ...
        stake_address = self.get_main_address(account)
    ...
    def get_account_assets(self, account: str, collection_id: str = None) -> Iterable[HoldingDTO]:
        stake_address = self.get_main_address(account, exception=True)
