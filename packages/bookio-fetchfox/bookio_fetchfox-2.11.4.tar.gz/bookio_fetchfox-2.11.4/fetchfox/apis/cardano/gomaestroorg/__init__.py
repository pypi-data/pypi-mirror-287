...
from .assets import get_owners as get_asset_owners
...
from .policies import get_owners as get_policy_owners
...
# aliases
get_collection_assets = get_policy_assets
get_collection_owners = get_policy_owners
