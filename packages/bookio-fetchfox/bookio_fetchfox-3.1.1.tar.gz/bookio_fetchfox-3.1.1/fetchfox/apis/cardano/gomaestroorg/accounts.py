...
def get_assets(stake_address: str, policy_id: str = None, api_key: str = None, preprod: bool = False) -> Iterable[Tuple[str, int]]:
...
def get_transactions(stake_address: str, last: int = 15, api_key: str = None, preprod: bool = False) -> Iterable[dict]:
    for address in get_addresses(stake_address):
