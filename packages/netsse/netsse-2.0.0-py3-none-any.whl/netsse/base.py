...
import netsse.tools.envir_cond
...
class WaveSpectrum(Spectrum,SeaState):
    ...
    def set_from_standard(self,method='JONSWAP',gamma=3.3):
        ...
        match method:
            ...
            case 'JONSWAP':                    
                S_J = netsse.tools.envir_cond.JONSWAP_DNV(self.Tp,self.Hs,self.om[self.om>0,],self.gamma)
            ...
            case 'TMA':
                ...
                S_J = netsse.tools.envir_cond.JONSWAP_DNV(self.Tp,self.Hs,self.om[self.om>0,],self.gamma,self.depth)
