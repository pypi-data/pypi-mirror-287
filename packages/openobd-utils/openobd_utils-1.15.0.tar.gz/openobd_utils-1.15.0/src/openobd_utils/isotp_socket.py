...
from openobd import *
from .stream_handler import StreamHandler, OpenOBDStreamTimeoutException
...
class IsotpSocket:
    ...
    def request(self, payload: str, timeout: float | None = None, silent: bool = False, tries: int = 1) -> str | None:
        ...
        :param payload: the bytes to send to the vehicle.
    ...
    def _check_response_payload(payload: str) -> None:
        ...
        exception = UnknownNegativeResponseException
        if negative_response_code in negative_response_code_exceptions:
            exception = negative_response_code_exceptions[negative_response_code]
        raise exception
