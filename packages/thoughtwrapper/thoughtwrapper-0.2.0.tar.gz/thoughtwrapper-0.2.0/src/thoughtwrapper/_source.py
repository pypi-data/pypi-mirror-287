...
class Dependencies():
    ...
    def __init__(self, *args: str | os.PathLike, dynamic=False):
...
class Source(ABC):  # pylint: disable=R0903
...
class BytesSource(Source):  # pylint: disable=R0903
...
class FileSource(Source):  # pylint: disable=R0903
...
class StringSource(Source):  # pylint: disable=R0903
