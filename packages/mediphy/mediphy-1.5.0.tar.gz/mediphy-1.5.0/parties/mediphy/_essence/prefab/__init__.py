...
the_mediphy_process = str (normpath (join (this_directory, "../__bin/mediphy_1")))
	...
	return {
		...
		"sveltnetics": {
			"build_path": str (normpath (join (
				the_mix_directory, 
				"frontiers/trends/sveltenetics/build"
			)))
		},
		...
		"dictionary": {
			...
			"goodest": str (normpath (join (the_mix_directory, "____glossary/mediphy_1"))),
		}
	}