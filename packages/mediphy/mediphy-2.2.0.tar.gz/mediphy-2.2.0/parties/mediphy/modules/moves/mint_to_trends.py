...
'''
	import mediphy.modules.moves.mint_to_trends as mint_to_trends
...
import mediphy.essence as mediphy_essence
from mediphy.modules.freight.save import zip_and_save_to_gridfs

def start (
	name = ''
):
	essence_mongo = mediphy_essence.find ("mongo")
