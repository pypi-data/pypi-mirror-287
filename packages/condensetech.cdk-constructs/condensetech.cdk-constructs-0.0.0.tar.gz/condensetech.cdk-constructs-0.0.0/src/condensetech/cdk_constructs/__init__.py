...
class AuroraClusterProps:
    def __init__(
        ...
        *,
        ...
        :param cluster_name: (deprecated) The name of the cluster. If not specified, it relies on the underlying default naming.
        ...
        :param multi_az: (experimental) If the Aurora cluster is multi-AZ. Default: false
    ...
    def multi_az(self) -> typing.Optional[builtins.bool]:
        '''(experimental) If the Aurora cluster is multi-AZ.
...
class DatabaseInstanceProps:
    def __init__(
        ...
        *,
        ...
        :param instance_name: (deprecated) The name of the database instance. Default: - No name is specified.
    ...
    def instance_name(self) -> typing.Optional[builtins.str]:
        '''(deprecated) The name of the database instance.
...
class EntrypointProps:
    def __init__(
        ...
        *,
        ...
        hosted_zone_props: typing.Union[_aws_cdk_aws_route53_ceddda9d.HostedZoneAttributes, typing.Dict[builtins.str, typing.Any]],
        networking: "INetworking",
    ...
    @builtins.property
    def hosted_zone_props(self) -> _aws_cdk_aws_route53_ceddda9d.HostedZoneAttributes:
        '''(experimental) The Route 53 hosted zone attributes for the domain name.

        :stability: experimental
        '''
        result = self._values.get("hosted_zone_props")
        assert result is not None, "Required property 'hosted_zone_props' is missing"
        return typing.cast(_aws_cdk_aws_route53_ceddda9d.HostedZoneAttributes, result)
...
class AuroraCluster(
    ...
    def _database_cluster(self) -> _aws_cdk_aws_rds_ceddda9d.IDatabaseCluster:
        '''(experimental) The database cluster.

        :stability: experimental
        '''
        return typing.cast(_aws_cdk_aws_rds_ceddda9d.IDatabaseCluster, jsii.get(self, "databaseCluster"))
