...
class OpenApiValidatorTest(unittest.TestCase):
    ...
    def test_valid_openapi(self):
        validator = OpenApiValidator(openapi=self.valid_schema, handlers='tests/mocks/handlers/valid')
        validator.validate_openapi()

    def test_invalide_openapi_spec_errors(self):
        validator = OpenApiValidator(openapi=self.invalid_schema, handlers='tests/mocks/handlers/valid')
        try:
            validator.validate_openapi()
    ...
    def test_invalid_openapi_spec_ignored(self):
        validator = OpenApiValidator(openapi=self.invalid_schema, openapi_validate_spec=False, handlers='tests/mocks/handlers/valid')
        validator.validate_openapi()
        self.assertTrue(True)
    
    def test_handler_spec_passes_openapi(self):
        validator = OpenApiValidator(openapi=self.openapi_validate_request_schema_pass, handlers='tests/mocks/handlers/valid', openapi_validate_request=True)
        validator.validate_openapi()

    def test_handler_spec_route_not_in_openapi(self):
        validator = OpenApiValidator(openapi=self.openapi_validate_request_schema_route_fail_route, handlers='tests/mocks/handlers/valid', openapi_validate_request=True)
        try:
            validator.validate_openapi()
            self.assertTrue(False)
        except RuntimeError as error:
    ...
    def test_handler_spec_route_method_not_in_openapi(self):
        validator = OpenApiValidator(openapi=self.openapi_validate_request_schema_route_fail_method, handlers='tests/mocks/handlers/valid', openapi_validate_request=True)
        try:
            validator.validate_openapi()
            self.assertTrue(False)
        except RuntimeError as error:
    ...
    def test_handler_spec_fails_missing_schema_defined_in_required_body(self):
        validator = OpenApiValidator(openapi=self.missing_required_body, handlers='tests/mocks/handlers/valid')
        try:
            validator.validate_openapi()
            self.assertTrue(False)
        except RuntimeError as error:
    ...
    def test_handler_spec_fails_missing_schema_defined_in_required_response(self):
        validator = OpenApiValidator(openapi=self.missing_required_response, handlers='tests/mocks/handlers/valid')
        try:
            validator.validate_openapi()
            self.assertTrue(False)
        except RuntimeError as error:
