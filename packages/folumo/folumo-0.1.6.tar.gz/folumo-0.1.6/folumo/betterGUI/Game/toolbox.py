...
from folumo.betterGUI.screen import Element, Canvas, Main
...
class HealthBar(Element):
    def __init__(self, xy: tuple[int, int], size: tuple[int, int], max_health: int, current_health: int,
                 bar_color: tuple[int, int, int], bg_color: tuple[int, int, int]):
        super().__init__(xy)
        self.size = size
...
class Inventory(Element):
    def __init__(self, xy: tuple[int, int], size: tuple[int, int], slot_size: int, slot_color: tuple[int, int, int],
...
class DialogueBox(Element):
    def __init__(self, xy: tuple[int, int], size: tuple[int, int], text: str, font_size: int = 24,
                 text_color: tuple[int, int, int] = (0, 0, 0), bg_color: tuple[int, int, int] = (255, 255, 255)):
        super().__init__(xy)
        self.size = size
        self.text = text
...
class Timer(Element):
    def __init__(self, xy: tuple[int, int], main: Main, size: tuple[int, int], font_size: int = 24,
                 text_color: tuple[int, int, int] = (255, 255, 255), bg_color: tuple[int, int, int] = (0, 0, 0)):
        super().__init__(xy)
        self.size = size
        self.main = main
        self.font = pygame.font.Font(None, font_size)
...
class Tooltip(Element):
    def __init__(self, element: Element, text: str, font_size: int = 24, text_color: tuple[int, int, int] = (0, 0, 0),
...
class Slider(Element):
    def __init__(self, xy, size: tuple[int, int], min_value: int, max_value: int, initial_value: int,
                 bar_color: tuple[int, int, int], knob_color: tuple[int, int, int]):
        super().__init__(xy)
        self.size = size
...
class collideManager:
    ...
    def isOnGround(self, xy: tuple[int, int], hitbox: tuple[int, int, int], thisElement: Element) -> tuple[
        bool, Element | None]:
...
class Player(Element):
    def __init__(self, xy: tuple[int, int], size: tuple[int, int], color: tuple[int, int, int],
