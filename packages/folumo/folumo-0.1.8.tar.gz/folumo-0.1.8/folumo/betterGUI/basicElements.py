...
class Circle(Element):
    ...
    def render(self) -> Canvas:
        ...
        pygame.draw.circle(newCanvas.surf, self.color, (self.radius, self.radius), self.radius)
        return newCanvas
...
class Line(Element):
    ...
    def render(self) -> Canvas:
        ...
        pygame.draw.line(newCanvas.surf, self.color, self.xy, self.end_pos, self.width)
        return newCanvas


class Text(Element):
    def __init__(self, xy, text, font_name, font_size, color):
        super().__init__(xy)
        self.text = text
