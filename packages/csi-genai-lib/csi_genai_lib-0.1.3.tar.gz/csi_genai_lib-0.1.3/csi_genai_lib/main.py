...
from .Common.init import CFG, post_status_message, get_primary_ip, gethostname
from .Toolbox.sqs_init import post2queue, get_queue
...
class MainHandler:
    ...
    def __init__(self, **kwargs) -> None:
        self._sqs_message = {"R.ID": "", "event.time": datetime.now(timezone.utc).isoformat(), "R.VERSION": VERSION,
                             'R.API': '', 'C.REQ': {}, 'C.RSP': {}}
