...
class RemoteExecutionClient:
    ...
    @ws_retry("ExecutionRequests", max_retries=5)
    ...
    @ws_retry("Heartbeat", max_retries=5)
    async def send_heartbeats(self, chat_uuid: str) -> None:
        async for websocket in self.ws_connect(
    ...
    @ws_retry("SignalListener", max_retries=5)
