...
from src.shapeaxi import saxi_nets, post_process as psp, utils
from src.shapeaxi.saxi_dataset import SaxiDataset, SaxiIcoDataset, SaxiFreesurferDataset
from src.shapeaxi.saxi_transforms import TrainTransform, EvalTransform, UnitSurfTransform, RandomRotationTransform, GaussianNoisePointTransform, NormalizePointTransform, CenterTransform
...
def main(args):
    ...
    elif args.nn == 'SaxiRing' or args.nn == 'SaxiMHA':
