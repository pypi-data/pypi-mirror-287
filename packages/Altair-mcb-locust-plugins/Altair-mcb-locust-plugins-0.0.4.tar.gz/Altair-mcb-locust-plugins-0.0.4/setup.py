...
setuptools.setup(
    ...
    #packages=["locust_plugins/", "locust_plugins/listeners/", "locust_plugins/users/"],
    packages=find_packages(exclude=["examples"]),
    include_package_data=True,
    package_data={'':['locust_plugins/dashboards/*']},
    ...
    license='MIT',
    python_requires='>=3.8',
    install_requires=["locust>=2.20.0",
                      "typing-extensions"]
)
...
setup(
    ...
    long_description="""https://github.com/mcraj4u/altair-coe-locust-plugins""",
    classifiers=[
