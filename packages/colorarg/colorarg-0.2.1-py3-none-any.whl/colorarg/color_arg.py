...
class ColorMessage:
    ...
    @classmethod
    def warning(cls, text, color='yellow', nn=True):
        text = '\n' + text + '\n' if nn else text
        print(ColorFore.color_text(fore_color(color.upper()), text))

    @classmethod
    def log(cls, text, color='blue', nn=True):
        text = '\n' + text + '\n' if nn else text
        print(ColorFore.color_text(fore_color(color.upper()), text))
    
    @classmethod
    def value_error(cls, text, color='red', nn=True):
        text = '\n' + text + '\n' if nn else text
        print(ColorFore.color_text(fore_color(color.upper()), text))
        sys.exit()
...
if __name__ == "__main__":
    ...
    raise ColorMessage.value_error(text)