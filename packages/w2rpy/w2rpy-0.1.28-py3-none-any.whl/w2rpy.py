...
def pebble_count(photo_file, obj_color='yellow', obj_size_mm=190.5):    
    photo_file = r'C:/Users/lrussell/Downloads/PC8_test.jpg'
    obj_color='red'
    obj_size_mm=7.5
    ...
    sam = sam_model_registry["vit_h"](checkpoint=r"C:/Users/lrussell/downloads/sam_vit_h_4b8939.pth")
    ...
    props = regionprops_table(img, image, properties=('label', 'area', 'centroid', 'major_axis_length', 'minor_axis_length', 'intensity_mean'))
    ...
    grain_data = grain_data[grain_data.label!=nb_label]
    
    del grain_data['centroid-0']
    del grain_data['centroid-1']
    ...
    fig.savefig(photo_file.replace('.jpg','_grain_labels.png'))
