...
from vlcishared.db.postgresql import DbConnector
    ...
    def gestion_fechas_inicio(
        ...
        try:
            ...
            if result[0][1] == "f":
                ...
                date_result = self.db_connector.call_procedure(
                    'p_gf_obtenerfecha',
                    identifier,
                    param,
                    is_function=True
                )
                self.db_connector.call_procedure(
                    'p_gf_registrarestadoetl',
                    identifier,
                    'EN PROCESO',
                    is_function=True
                )
