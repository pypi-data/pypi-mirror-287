...
class ErrorObject(DataModelBase):
    ...
    payload: Optional[Union[Dict[str, Any], List[Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]]]]
    ...
    payload: Optional[Union[Dict[str, Any], List[Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]]]] = Field(
        None,
