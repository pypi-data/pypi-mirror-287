...
from pydantic import EmailStr, Field, StrictBool, StrictFloat, StrictInt, StrictStr, conint, constr
...
class ParameterScheduleResourceParameter(DataModelBase):
    ...
    ----------
    resource: StrictStr
    parameters: Dict[str, Union[StrictFloat, StrictStr, StrictBool]]
...
class TimeseriesData(DataModelBase):
    ...
    last_value: Optional[Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]]
    ...
    last_value: Optional[Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]] = Field(
