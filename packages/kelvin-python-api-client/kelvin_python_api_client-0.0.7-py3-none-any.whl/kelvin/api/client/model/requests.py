...
from .type import (
    ...
    AppManagerAppVersion,
    AppManagerResourceParameters,
...
class AppManagerAppResourcesList(DataModelBase):
    ...
    enabled_states: Optional[List[StrictBool]]
    ...
    enabled_states: Optional[List[StrictBool]] = Field(
        None,
...
class MappingItem(DataModelBase):
    ...
    Parameters
    ----------
    app: Optional[StrictStr]
    datastream: Optional[StrictStr]
...
class AppManagerAppVersionDeploy(DataModelBase):
    ...
    resource_parameters: Optional[List[AppManagerResourceParameter]]
    deployment_overrides: Optional[type.InstallManifestDeploymentDefaults]
    planner_rules: Optional[type.AppManagerAppPlannerRules]
    mappings: Optional[Mappings]

    """

    resources: List[KRNAsset] = Field(..., description="List of assets for which the application will run.")
    resource_parameters: Optional[List[AppManagerResourceParameters]] = Field(
        None, description="Resource (Asset) Parameters."
    )
    deployment_overrides: Optional[type.InstallManifestDeploymentDefaults] = None
    planner_rules: Optional[type.AppManagerAppPlannerRules] = None
    mappings: Optional[Mappings] = None


class AppManagerAppVersionQuickdeploy(DataModelBase):
    """
...
class AppManagerList(DataModelBase):
    ...
    resources: Optional[List[KRNAsset]]
    search: Optional[constr(min_length=1, max_length=64, strict=True)]
    statuses: Optional[List[enum.AppManagerAppStatus]]
    ...
    search: Optional[constr(min_length=1, max_length=64, strict=True)] = Field(
        None,
...
class AssetPropertyCreate(DataModelBase):
    ...
    title: Optional[constr(min_length=1, max_length=64, strict=True)]
    value: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]
    ...
    value: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]] = Field(
...
class ControlChangeCreate(DataModelBase):
    ...
    payload: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]
    ...
    payload: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]] = Field(
        ...,
...
class DataStreamCreate(DataModelBase):
    ...
    type: Type = Field(..., description="Specifies the technique used for generating data in the Data Stream.")
...
class ClusterSettingTelemetry(DataModelBase):
    ...
    enabled: Optional[StrictBool]
    scrape_interval: Optional[conint(ge=1, le=3600, strict=True)]
    ...
    scrape_interval: Optional[conint(ge=1, le=3600, strict=True)] = Field(
        30,
...
class ParameterValueUpdate(DataModelBase):
    ...
    Parameters
    ----------
    comment: Optional[constr(min_length=1, max_length=200, strict=True)]
    name: constr(min_length=1, max_length=64, strict=True)
    value: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]]

    """

    comment: Optional[constr(min_length=1, max_length=200, strict=True)] = Field(
        None,
    ...
    name: constr(min_length=1, max_length=64, strict=True) = Field(
        ..., description="Unique identifier name for this Parameter.", example="gas_flow_rate_max_threshold"
    )
    value: Union[StrictFloat, StrictStr, StrictBool, Dict[str, Any]] = Field(
        ...,
...
class ParametersScheduleApply(DataModelBase):
    ...
    type: TypeModel = Field(..., description="Type of the schedule action")
    source: Optional[KRN] = Field(None, description="The source of the change request (restricted to Service Accounts)")
...
class App(DataModelBase):
    ...
    version: Optional[StrictStr] = Field(None, description="The version of the application")
...
class ParametersScheduleList(DataModelBase):
    ...
    states: Optional[List[enum.ParameterScheduleState]] = None
...
class RecommendationCreate(DataModelBase):
    ...
    type: constr(min_length=1, max_length=64, strict=True) = Field(
        ..., description="The Recommendation Type `name` associated with the Recommendation.", example="decrease_speed"
    )
...
class RecommendationTypeCreate(DataModelBase):
    ...
    title: constr(min_length=1, max_length=64, strict=True) = Field(
        ..., description="Display name (`title`) of the Asset Type.", example="Decrease Speed"
    )
...
class RecommendationTypeUpdate(DataModelBase):
    ...
    title: Optional[constr(min_length=1, max_length=64, strict=True)] = Field(
        None, description="New display name (`title`) of the Recommendation Type.", example="Decrease Speed"
    )
...
class WorkloadApply(DataModelBase):
    """
    WorkloadApply object.
