...
class Agent(BaseModel):
    ...
    temperature: float = Field(default=0.7, description="The temperature for the language model")
    max_tokens: int = Field(default=4000, description="The maximum number of tokens for the language model")
