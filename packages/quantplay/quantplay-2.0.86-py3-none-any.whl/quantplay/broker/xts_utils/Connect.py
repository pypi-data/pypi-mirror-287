...
class XTSConnect(XTSCommon):
    ...
    def interactive_login(self):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("interactive_login Failed for XTS")
    ...
    def get_order_book(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_order_book Failed for XTS")
    ...
    def place_order(
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("place_order Failed for XTS")
    ...
    def place_bracketorder(
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("place_bracketorder Failed for XTS")
    ...
    def get_profile(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_profile Failed for XTS")
    ...
    def get_balance(self, clientID: str | None = None):
        ...
        try:
            ...
            return response
        except XTSDataException:
            raise BrokerException("XTS is down, please reach out to broker")
        except Exception:
            traceback.print_exc()
            raise BrokerException("get_balance Failed for XTS")
    ...
    def modify_order(
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("modify_order Failed for XTS")
    ...
    def get_trade(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_trade Failed for XTS")
    ...
    def get_holding(self, clientID: str | None = None):
        ...
        try:
            ...
            raise BrokerException("get_holding Failed for XTS")
    ...
    def get_position_daywise(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_position_daywise Failed for XTS")
    ...
    def get_position_netwise(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_position_netwise Failed for XTS")
    ...
    def cancelall_order(
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("cancelall_order Failed for XTS")
    ...
    def exit_cover_order(self, appOrderID: int, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("exit_cover_order Failed for XTS")
    ...
    def get_order_history(self, appOrderID: int, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_order_history Failed for XTS")
    ...
    def interactive_logout(self, clientID: str | None = None):
        ...
        try:
            ...
            traceback.print_exc()
            raise BrokerException("interactive_logout Failed for XTS")
    ...
    def marketdata_login(self):
        try:
            ...
            traceback.print_exc()
            raise BrokerException("marketdata_login Failed for XTS")
    ...
    def get_master(self, exchangeSegmentList: List[XTSTypes.ExchangeType]):
        try:
            ...
            traceback.print_exc()
            raise BrokerException("get_master Failed for XTS")
    ...
    def search_by_instrumentid(self, Instruments: List[XTSTypes.InstrumentType]):
        try:
            ...
            traceback.print_exc()
            raise BrokerException("search_by_instrumentid Failed for XTS")
    ...
    def search_by_scriptname(self, searchString: str):
        try:
            ...
            traceback.print_exc()
            raise BrokerException("search_by_scriptname Failed for XTS")
    ...
    def marketdata_logout(self):
        try:
            ...
            traceback.print_exc()
            raise BrokerException("Market logout Failed for XTS")
