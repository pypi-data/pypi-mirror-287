...
class TrackingApi(ApiClient):
    ...
    def create_tracking(
        ...
        """
        url = "/tracking/2024-07/trackings"
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-07/trackings/{tracking_id}"
    ...
    def delete_tracking_by_slug_tracking_number(
        ...
        **kwargs,
        ...
        """
        url = f"/tracking/2024-07/trackings/{slug}/{tracking_number}"
        params_keys = {
        ...
        return DeleteTrackingBySlugTrackingNumberResponse().from_dict(result)
    ...
    def get_tracking_by_slug_tracking_number(
        ...
        **kwargs,
        ...
        result = self._request("GET", url=url, params=params, **kwargs)
        return GetTrackingBySlugTrackingNumberResponse().from_dict(result)
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-07/trackings/{tracking_id}/mark-as-completed"
        ...
        **kwargs,
        ...
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-07/trackings/{slug}/{tracking_number}/mark-as-completed"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
        ...
        return MarkTrackingCompletedBySlugTrackingNumberResponse().from_dict(result)
        ...
        :param kwargs:
            request options:
                ...
                **verify** bool|str|SSLContext: SSL certificates (a.k.a CA bundle) used to
                    ...
                    (which will disable verification).
        """
        url = f"/tracking/2024-07/trackings/{tracking_id}/retrack"
        ...
        **kwargs,
        ...
        :param kwargs:
            ...
            query params:
                ...
                **tracking_state**: str. Additional field required by some carriers to retrieve the tracking info. The state/province of the recipient’s address. Refer to our article on  for more details.
        """
        url = f"/tracking/2024-07/trackings/{slug}/{tracking_number}/retrack"
        params_keys = {
            "tracking_account_number",
            "tracking_origin_country",
            "tracking_destination_country",
        ...
        return RetrackTrackingBySlugTrackingNumberResponse().from_dict(result)
    ...
    def update_tracking_by_slug_tracking_number(
        ...
        update_tracking_by_slug_tracking_number_request: Union[
            UpdateTrackingBySlugTrackingNumberRequest, dict
        ],
        **kwargs,
    ) -> UpdateTrackingBySlugTrackingNumberResponse:
        """
        ...
        return UpdateTrackingBySlugTrackingNumberResponse().from_dict(result)
