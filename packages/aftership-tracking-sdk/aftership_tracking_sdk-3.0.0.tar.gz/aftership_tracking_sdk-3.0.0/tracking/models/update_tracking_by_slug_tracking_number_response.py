...
from tracking.models.shipment_weight_update_tracking_by_slug_tracking_number_response import (
...
from tracking.models.aftership_estimated_delivery_date_update_tracking_by_slug_tracking_number_response import (
    AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse,
)
from tracking.models.custom_estimated_delivery_date_update_tracking_by_slug_tracking_number_response import (
    CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse,
)
from tracking.models.first_estimated_delivery_update_tracking_by_slug_tracking_number_response import (
    FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse,
)
from tracking.models.latest_estimated_delivery_update_tracking_by_slug_tracking_number_response import (
    LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse,
)
from tracking.models.next_couriers_update_tracking_by_slug_tracking_number_response import (
    NextCouriersUpdateTrackingBySlugTrackingNumberResponse,
)
from tracking.models.carbon_emissions_update_tracking_by_slug_tracking_number_response import (
    CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse,
)


class UpdateTrackingBySlugTrackingNumberResponse(BaseModel):
    """
    ...
    shipment_weight: Optional[ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse] = None
    ...
    next_couriers: Optional[List[NextCouriersUpdateTrackingBySlugTrackingNumberResponse]] = None
    ...
    carbon_emissions: Optional[CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse] = None
