...
from tracking.models.shipment_weight_get_tracking_by_slug_tracking_number_response import (
...
from tracking.models.aftership_estimated_delivery_date_get_tracking_by_slug_tracking_number_response import (
    AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse,
)
from tracking.models.custom_estimated_delivery_date_get_tracking_by_slug_tracking_number_response import (
    CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse,
)
from tracking.models.first_estimated_delivery_get_tracking_by_slug_tracking_number_response import (
    FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse,
)
from tracking.models.latest_estimated_delivery_get_tracking_by_slug_tracking_number_response import (
    LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse,
)
from tracking.models.next_couriers_get_tracking_by_slug_tracking_number_response import (
    NextCouriersGetTrackingBySlugTrackingNumberResponse,
)
from tracking.models.carbon_emissions_get_tracking_by_slug_tracking_number_response import (
    CarbonEmissionsGetTrackingBySlugTrackingNumberResponse,
)


class GetTrackingBySlugTrackingNumberResponse(BaseModel):
    """
    ...
    shipment_weight: Optional[ShipmentWeightGetTrackingBySlugTrackingNumberResponse] = None
    ...
    next_couriers: Optional[List[NextCouriersGetTrackingBySlugTrackingNumberResponse]] = None
    ...
    carbon_emissions: Optional[CarbonEmissionsGetTrackingBySlugTrackingNumberResponse] = None
