...
from tracking.models.custom_fields_update_tracking_by_slug_tracking_number_request import (
    CustomFieldsUpdateTrackingBySlugTrackingNumberRequest,
)


class UpdateTrackingBySlugTrackingNumberRequest(BaseModel):
    """
    ...
    custom_fields: Optional[CustomFieldsUpdateTrackingBySlugTrackingNumberRequest] = None
