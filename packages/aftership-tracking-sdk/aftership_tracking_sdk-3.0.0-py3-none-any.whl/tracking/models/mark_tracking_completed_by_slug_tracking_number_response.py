...
from tracking.models.shipment_weight_mark_tracking_completed_by_slug_tracking_number_response import (
...
from tracking.models.aftership_estimated_delivery_date_mark_tracking_completed_by_slug_tracking_number_response import (
    AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse,
)
from tracking.models.custom_estimated_delivery_date_mark_tracking_completed_by_slug_tracking_number_response import (
    CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse,
)
from tracking.models.first_estimated_delivery_mark_tracking_completed_by_slug_tracking_number_response import (
    FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse,
)
from tracking.models.latest_estimated_delivery_mark_tracking_completed_by_slug_tracking_number_response import (
    LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse,
)
from tracking.models.next_couriers_mark_tracking_completed_by_slug_tracking_number_response import (
    NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse,
)
from tracking.models.carbon_emissions_mark_tracking_completed_by_slug_tracking_number_response import (
    CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse,
)


class MarkTrackingCompletedBySlugTrackingNumberResponse(BaseModel):
    """
    ...
    shipment_weight: Optional[ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse] = (
        None
    )
    ...
    first_estimated_delivery: Optional[
        FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse
    ] = None
    ...
    next_couriers: Optional[List[NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse]] = (
        None
    )
    ...
    carbon_emissions: Optional[CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse] = (
        None
    )
