...
from tracking.models.shipment_weight_retrack_tracking_by_slug_tracking_number_response import (
...
from tracking.models.aftership_estimated_delivery_date_retrack_tracking_by_slug_tracking_number_response import (
    AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse,
)
from tracking.models.custom_estimated_delivery_date_retrack_tracking_by_slug_tracking_number_response import (
    CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse,
)
from tracking.models.first_estimated_delivery_retrack_tracking_by_slug_tracking_number_response import (
    FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse,
)
from tracking.models.latest_estimated_delivery_retrack_tracking_by_slug_tracking_number_response import (
    LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse,
)
from tracking.models.next_couriers_retrack_tracking_by_slug_tracking_number_response import (
    NextCouriersRetrackTrackingBySlugTrackingNumberResponse,
)
from tracking.models.carbon_emissions_retrack_tracking_by_slug_tracking_number_response import (
    CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse,
)


class RetrackTrackingBySlugTrackingNumberResponse(BaseModel):
    """
    ...
    shipment_weight: Optional[ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse] = None
    ...
    next_couriers: Optional[List[NextCouriersRetrackTrackingBySlugTrackingNumberResponse]] = None
    ...
    carbon_emissions: Optional[CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse] = None
