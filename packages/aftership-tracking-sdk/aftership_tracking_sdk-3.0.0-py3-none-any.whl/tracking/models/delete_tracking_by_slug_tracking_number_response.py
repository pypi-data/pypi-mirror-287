...
from tracking.models.shipment_weight_delete_tracking_by_slug_tracking_number_response import (
...
from tracking.models.aftership_estimated_delivery_date_delete_tracking_by_slug_tracking_number_response import (
    AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse,
)
from tracking.models.custom_estimated_delivery_date_delete_tracking_by_slug_tracking_number_response import (
    CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse,
)
from tracking.models.first_estimated_delivery_delete_tracking_by_slug_tracking_number_response import (
    FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse,
)
from tracking.models.latest_estimated_delivery_delete_tracking_by_slug_tracking_number_response import (
    LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse,
)
from tracking.models.next_couriers_delete_tracking_by_slug_tracking_number_response import (
    NextCouriersDeleteTrackingBySlugTrackingNumberResponse,
)
from tracking.models.carbon_emissions_delete_tracking_by_slug_tracking_number_response import (
    CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse,
)


class DeleteTrackingBySlugTrackingNumberResponse(BaseModel):
    """
    ...
    shipment_weight: Optional[ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse] = None
    ...
    next_couriers: Optional[List[NextCouriersDeleteTrackingBySlugTrackingNumberResponse]] = None
    ...
    carbon_emissions: Optional[CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse] = None
