...
class Web():
    def __init__(self, data:list) -> None:
        ...
        # Middle East - Year
        """victims_middle_east_year = df.filter_country(df.middle_east, victims_current_year)

        total_middle_east_victims_this_year = len(victims_middle_east_year)
        top10_middle_east_countries_year = df.get_top_x_countries(10, victims_middle_east_year)
        top10_middle_east_ransomwares_year = df.get_top_x_ransomwares(10, victims_middle_east_year)
        top10_middle_east_sectors_year = df.get_top_x_sectors(10, victims_middle_east_year)

        keywords['dash_total_victims_middle_east_this_year'] = total_middle_east_victims_this_year
        keywords['dash_top10_middle_east_countries_year_labels'] = list(top10_middle_east_countries_year.keys())
        keywords['dash_top10_middle_east_countries_year_values'] = list(top10_middle_east_countries_year.values())
        keywords['dash_top10_middle_east_ransomwares_year_labels'] = list(top10_middle_east_ransomwares_year.keys())
        keywords['dash_top10_middle_east_ransomwares_year_values'] = list(top10_middle_east_ransomwares_year.values())
        keywords['dash_top10_middle_east_sectors_year_labels'] = list(top10_middle_east_sectors_year.keys())
        keywords['dash_top10_middle_east_sectors_year_values'] = list(top10_middle_east_sectors_year.values())

        # Middle East - Victims By Month
        victims_by_middle_east_year = df.count_data_per_month(victims_middle_east_year)

        keywords['dash_victims_by_month_middle_east_year_labels'] = list(victims_by_middle_east_year.keys())[::-1]
        keywords['dash_victims_by_month_middle_east_year_values'] = list(victims_by_middle_east_year.values())[::-1]


        # Middle East - Month
        victims_middle_east_this_month = df.filter_country(df.middle_east, victims_this_month)
        victims_middle_east_last_month = df.filter_country(df.middle_east, victims_last_month)

        total_middle_east_victims_this_month = len(victims_middle_east_this_month)
        total_middle_east_victims_last_month = len(victims_middle_east_last_month)
        top10_middle_east_this_month_countries = df.get_top_x_countries(10, victims_middle_east_this_month)
        top10_middle_east_this_month_ransomwares = df.get_top_x_ransomwares(10, victims_middle_east_this_month)
        top10_middle_east_this_month_sectors = df.get_top_x_sectors(10, victims_middle_east_this_month)

        middle_east_victims_monthly_growth = self.calculate_growth_percentage(total_middle_east_victims_this_month, total_middle_east_victims_last_month)

        keywords['dash_total_middle_east_victims_this_month'] = total_middle_east_victims_this_month
        keywords['dash_total_middle_east_victims_last_month'] = total_middle_east_victims_last_month
        keywords['dash_middle_east_victims_monthly_growth'] = middle_east_victims_monthly_growth
        keywords['dash_top10_middle_east_this_month_countries_labels'] = list(top10_middle_east_this_month_countries.keys())
        keywords['dash_top10_middle_east_this_month_countries_values'] = list(top10_middle_east_this_month_countries.values())
        keywords['dash_top10_middle_east_this_month_ransomwares_labels'] = list(top10_middle_east_this_month_ransomwares.keys())
        keywords['dash_top10_middle_east_this_month_ransomwares_values'] = list(top10_middle_east_this_month_ransomwares.values())
        keywords['dash_top10_middle_east_this_month_sectors_labels'] = list(top10_middle_east_this_month_sectors.keys())
        keywords['dash_top10_middle_east_this_month_sectors_values'] = list(top10_middle_east_this_month_sectors.values()) """
        ...
        #Timer(5, webbrowser.open('http://127.0.0.1:5000/')).start()
