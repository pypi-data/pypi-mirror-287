...
# 
(kCommandNone, kCommandNeedSave, kCommandRunInBackground, kCommandDocumentOnly) = (0x00, 0x01, 0x02, 0x04)
# PsCommandType
(kCommandBase, kCommandMakeAccessible, kCommandAutofix, kCommandLast) = (0, 1, 2, 3)
...
class Pdfix(_PdfixBase):
    ...
    def GetTags(self, _version: int) -> int: 
        global PdfixLib
