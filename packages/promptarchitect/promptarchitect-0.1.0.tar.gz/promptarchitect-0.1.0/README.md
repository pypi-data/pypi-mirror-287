...
## About Engineered Prompts PromptCraft
...
To install PromptCraft, simply use pip:
...
Below is an example of how to use the EngineeredPrompt class from the PromptCraft module:

```python

from promptcraft import EngineeredPrompt
