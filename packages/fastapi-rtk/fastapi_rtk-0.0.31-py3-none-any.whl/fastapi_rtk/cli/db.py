...
def callback(
    ...
    """
    FastAPI DB CLI - The [bold]fastapi db[/bold] command line app. 😎

    Manage your [bold]FastAPI[/bold] databases easily with init, migrate, upgrade, with the power of Alembic.
    """
