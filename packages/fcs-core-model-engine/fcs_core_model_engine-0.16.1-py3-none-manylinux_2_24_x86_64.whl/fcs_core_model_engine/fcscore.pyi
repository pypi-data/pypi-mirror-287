...
class Target3DElementType(enum.Enum):
	...
	"""
    TRIA: Target3DElementType
    QUAD: Target3DElementType
...
class MasterMesh:
    ...
    @staticmethod
    def add_node(mesh_component_id: int, x: float, y: float, z: float) -> int:
        """
    ...
    def delete_nodes(
          ...
          removed_orphaned_node_ids: list[int]) -> bool:
        """
    ...
    @staticmethod
    def add_element(mesh_component_id: int, spec_elem_type: SpecificElementType, node_ids: list[int]) -> int:
        """
        ...
        :return: Newly placed element's ID, or -1 if failed.
        """
        ...
...
class MeshReference(Mesh):
	...
	def get_mesh_reference_type(self) -> ComponentMeshType: ...
...
class ModelItemInstance:
    ...
    def get_stored_entity_type(self) -> object: ...
