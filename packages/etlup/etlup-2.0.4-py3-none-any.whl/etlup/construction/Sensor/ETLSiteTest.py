...
from .data_models import ETLSite

class ETLSiteTestV0(bm.ConstructionBaseV0):
    model_config = ConfigDict(json_schema_extra={
        'examples': [
            {
                "component": "TYL4U001",
                "type": "ETL Sensor Site Test",
                "measurement_date": "2023-01-01T12:00:00+01:00",
                "location": "FBK",
                "user_created": "fsiviero",
                "data": {
                    "etl_leakage_current_uA": 158.176,
                    "etl_breakdown_voltage_V": 282.0,
                    "etl_category": "BAD", 
                    "etl_gain_category": "C",
    ...
    type: Literal['ETL Sensor Site Test']
    version: Literal["0.0"]
    component: str
    data: ETLSite.ETLSiteV0
    ...
    def html_display(cls, display_data: dict):
        fig = cls.plot(
            ...
            display_data['etl_leakage_current_uA'],
            display_data['etl_breakdown_voltage_V'],
            display_data['etl_category']
        )
