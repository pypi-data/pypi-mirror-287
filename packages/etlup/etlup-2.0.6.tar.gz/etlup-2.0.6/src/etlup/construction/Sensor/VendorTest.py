...
from .data_models import Vendor

class VendorTestV0(bm.ConstructionBaseV0):
    model_config = ConfigDict(json_schema_extra={
        ...
        'module_types': [],
        'description': 'Tests results on LGAD Sensors coming from the Vendor for IV curves as well as breakdown voltage and leakage current'
    })

    type: Literal['Sensor Vendor Test']
    version: Literal["0.0"]
    component: str
    data: Vendor.VendorV0
