...
class MLDockerizer:
    def __init__(self, project_path, entry_point):
...
"""
    ...
    def dockerize(self):
        ...
        print("Build: docker build -t your-ml-project .")
        print(f"Run: docker run your-ml-project")
...
def main():
    ...
    parser.add_argument("--entry-point", default="main.py", help="Entry point Python script (default: main.py)")
    args = parser.parse_args()

    dockerizer = MLDockerizer(args.project_path, args.entry_point)
