...
Refer to the Terraform Registry for docs: [`snowflake_secondary_database`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.0/docs/resources/secondary_database).
'''
...
class SecondaryDatabase(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing SecondaryDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.0/docs/resources/secondary_database#import import section} in the documentation of this resource for the id to use
    ...
    def as_replica_of(self, value: builtins.str) -> None:
        ...
        jsii.set(self, "asReplicaOf", value)
