...
class DateTime(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["time_offset", b"time_offset", "time_zone", b"time_zone", "utc_offset", b"utc_offset"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["day", b"day", "hours", b"hours", "minutes", b"minutes", "month", b"month", "nanos", b"nanos", "seconds", b"seconds", "time_offset", b"time_offset", "time_zone", b"time_zone", "utc_offset", b"utc_offset", "year", b"year"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["time_offset", b"time_offset"]) -> typing.Literal["utc_offset", "time_zone"] | None: ...
