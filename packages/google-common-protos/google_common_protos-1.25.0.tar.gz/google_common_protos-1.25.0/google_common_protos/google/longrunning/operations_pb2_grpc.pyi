...
class OperationsServicer(metaclass=abc.ABCMeta):
    ...
    ) -> typing.Union[google.longrunning.operations_pb2.ListOperationsResponse, collections.abc.Awaitable[google.longrunning.operations_pb2.ListOperationsResponse]]:
        """Lists operations that match the specified filter in the request. If the
        server doesn't support this method, it returns `UNIMPLEMENTED`.
    ...
    def GetOperation(
        ...
        context: _ServicerContext,
    ) -> typing.Union[google.longrunning.operations_pb2.Operation, collections.abc.Awaitable[google.longrunning.operations_pb2.Operation]]:
        """Gets the latest state of a long-running operation.  Clients can use this
        method to poll the operation result at intervals as recommended by the API
        service.
        """
...
def add_OperationsServicer_to_server(servicer: OperationsServicer, server: typing.Union[grpc.Server, grpc.aio.Server]) -> None: ...
