...
class ListOperationsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["filter", b"filter", "name", b"name", "page_size", b"page_size", "page_token", b"page_token"]) -> None: ...
...
class WaitOperationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["name", b"name", "timeout", b"timeout"]) -> None: ...
...
class OperationInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["metadata_type", b"metadata_type", "response_type", b"response_type"]) -> None: ...
