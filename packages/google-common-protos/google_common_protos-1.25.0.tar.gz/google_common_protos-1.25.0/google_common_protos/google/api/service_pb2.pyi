...
class Service(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        endpoints: collections.abc.Iterable[google.api.endpoint_pb2.Endpoint] | None = ...,
        control: google.api.control_pb2.Control | None = ...,
        logs: collections.abc.Iterable[google.api.log_pb2.LogDescriptor] | None = ...,
        metrics: collections.abc.Iterable[google.api.metric_pb2.MetricDescriptor] | None = ...,
        monitored_resources: collections.abc.Iterable[google.api.monitored_resource_pb2.MonitoredResourceDescriptor] | None = ...,
        ...
        system_parameters: google.api.system_parameter_pb2.SystemParameters | None = ...,
    ...
    def HasField(self, field_name: typing.Literal["authentication", b"authentication", "backend", b"backend", "billing", b"billing", "config_version", b"config_version", "context", b"context", "control", b"control", "documentation", b"documentation", "http", b"http", "logging", b"logging", "monitoring", b"monitoring", "publishing", b"publishing", "quota", b"quota", "source_info", b"source_info", "system_parameters", b"system_parameters", "usage", b"usage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["apis", b"apis", "authentication", b"authentication", "backend", b"backend", "billing", b"billing", "config_version", b"config_version", "context", b"context", "control", b"control", "documentation", b"documentation", "endpoints", b"endpoints", "enums", b"enums", "http", b"http", "id", b"id", "logging", b"logging", "logs", b"logs", "metrics", b"metrics", "monitored_resources", b"monitored_resources", "monitoring", b"monitoring", "name", b"name", "producer_project_id", b"producer_project_id", "publishing", b"publishing", "quota", b"quota", "source_info", b"source_info", "system_parameters", b"system_parameters", "title", b"title", "types", b"types", "usage", b"usage"]) -> None: ...
