...
class Authentication(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["providers", b"providers", "rules", b"rules"]) -> None: ...
...
class AuthenticationRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["oauth", b"oauth"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["allow_without_credential", b"allow_without_credential", "oauth", b"oauth", "requirements", b"requirements", "selector", b"selector"]) -> None: ...
...
class JwtLocation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["cookie", b"cookie", "header", b"header", "in", b"in", "query", b"query"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["cookie", b"cookie", "header", b"header", "in", b"in", "query", b"query", "value_prefix", b"value_prefix"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["in", b"in"]) -> typing.Literal["header", "query", "cookie"] | None: ...
...
class AuthProvider(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audiences", b"audiences", "authorization_url", b"authorization_url", "id", b"id", "issuer", b"issuer", "jwks_uri", b"jwks_uri", "jwt_locations", b"jwt_locations"]) -> None: ...
...
class OAuthRequirements(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["canonical_scopes", b"canonical_scopes"]) -> None: ...
...
class AuthRequirement(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["audiences", b"audiences", "provider_id", b"provider_id"]) -> None: ...
