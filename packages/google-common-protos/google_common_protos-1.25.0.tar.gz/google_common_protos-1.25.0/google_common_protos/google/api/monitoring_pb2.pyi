...
class Monitoring(google.protobuf.message.Message):
    ...
    class MonitoringDestination(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["metrics", b"metrics", "monitored_resource", b"monitored_resource"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        producer_destinations: collections.abc.Iterable[global___Monitoring.MonitoringDestination] | None = ...,
        consumer_destinations: collections.abc.Iterable[global___Monitoring.MonitoringDestination] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["consumer_destinations", b"consumer_destinations", "producer_destinations", b"producer_destinations"]) -> None: ...
