...
class ConfigChange(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["advices", b"advices", "change_type", b"change_type", "element", b"element", "new_value", b"new_value", "old_value", b"old_value"]) -> None: ...
