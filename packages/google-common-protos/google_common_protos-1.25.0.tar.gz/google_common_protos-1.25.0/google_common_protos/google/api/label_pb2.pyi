...
class LabelDescriptor(google.protobuf.message.Message):
    ...
    class _ValueTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[LabelDescriptor._ValueType.ValueType], builtins.type):
    ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "key", b"key", "value_type", b"value_type"]) -> None: ...
