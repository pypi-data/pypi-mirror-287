...
class Logging(google.protobuf.message.Message):
    ...
    class LoggingDestination(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["logs", b"logs", "monitored_resource", b"monitored_resource"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        producer_destinations: collections.abc.Iterable[global___Logging.LoggingDestination] | None = ...,
        consumer_destinations: collections.abc.Iterable[global___Logging.LoggingDestination] | None = ...,
    ) -> None: ...
