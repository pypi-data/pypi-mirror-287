...
class Quota(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["limits", b"limits", "metric_rules", b"metric_rules"]) -> None: ...
...
class MetricRule(google.protobuf.message.Message):
    ...
    """
    @property
    def metric_costs(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.int]:
    ...
    def ClearField(self, field_name: typing.Literal["metric_costs", b"metric_costs", "selector", b"selector"]) -> None: ...
...
class QuotaLimit(google.protobuf.message.Message):
    ...
    * "1/min/{project}" for quota per minute per project.
    ...
    def ClearField(self, field_name: typing.Literal["default_limit", b"default_limit", "description", b"description", "display_name", b"display_name", "duration", b"duration", "free_tier", b"free_tier", "max_limit", b"max_limit", "metric", b"metric", "name", b"name", "unit", b"unit", "values", b"values"]) -> None: ...
