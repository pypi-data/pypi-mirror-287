...
class Usage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["producer_notification_channel", b"producer_notification_channel", "requirements", b"requirements", "rules", b"rules"]) -> None: ...
...
class UsageRule(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["allow_unregistered_calls", b"allow_unregistered_calls", "selector", b"selector", "skip_service_control", b"skip_service_control"]) -> None: ...
