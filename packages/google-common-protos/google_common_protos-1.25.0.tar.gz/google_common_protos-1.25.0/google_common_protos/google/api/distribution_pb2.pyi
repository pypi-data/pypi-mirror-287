...
class Distribution(google.protobuf.message.Message):
    ...
    class BucketOptions(google.protobuf.message.Message):
        ...
        class Linear(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["num_finite_buckets", b"num_finite_buckets", "offset", b"offset", "width", b"width"]) -> None: ...
        ...
        class Exponential(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["growth_factor", b"growth_factor", "num_finite_buckets", b"num_finite_buckets", "scale", b"scale"]) -> None: ...
        ...
        class Explicit(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["bounds", b"bounds"]) -> None: ...
        ...
        def __init__(
            self,
            *,
            linear_buckets: global___Distribution.BucketOptions.Linear | None = ...,
            exponential_buckets: global___Distribution.BucketOptions.Exponential | None = ...,
            explicit_buckets: global___Distribution.BucketOptions.Explicit | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["explicit_buckets", b"explicit_buckets", "exponential_buckets", b"exponential_buckets", "linear_buckets", b"linear_buckets", "options", b"options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["explicit_buckets", b"explicit_buckets", "exponential_buckets", b"exponential_buckets", "linear_buckets", b"linear_buckets", "options", b"options"]) -> None: ...
        def WhichOneof(self, oneof_group: typing.Literal["options", b"options"]) -> typing.Literal["linear_buckets", "exponential_buckets", "explicit_buckets"] | None: ...
    ...
    class Exemplar(google.protobuf.message.Message):
        ...
        def __init__(
            ...
            *,
            ...
            attachments: collections.abc.Iterable[google.protobuf.any_pb2.Any] | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["timestamp", b"timestamp"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["attachments", b"attachments", "timestamp", b"timestamp", "value", b"value"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        mean: builtins.float = ...,
        sum_of_squared_deviation: builtins.float = ...,
        range: global___Distribution.Range | None = ...,
        bucket_options: global___Distribution.BucketOptions | None = ...,
        bucket_counts: collections.abc.Iterable[builtins.int] | None = ...,
        exemplars: collections.abc.Iterable[global___Distribution.Exemplar] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["bucket_options", b"bucket_options", "range", b"range"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["bucket_counts", b"bucket_counts", "bucket_options", b"bucket_options", "count", b"count", "exemplars", b"exemplars", "mean", b"mean", "range", b"range", "sum_of_squared_deviation", b"sum_of_squared_deviation"]) -> None: ...
