...
class HttpRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["body", b"body", "headers", b"headers", "method", b"method", "uri", b"uri"]) -> None: ...
...
class HttpResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["body", b"body", "headers", b"headers", "reason", b"reason", "status", b"status"]) -> None: ...
