...
from promptquality.types.chains.customized_scorer import CustomizedChainPollScorer
...
class GalileoPromptCallback(BaseCallbackHandler):
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.customized_scorers = customized_scorers
    ...
    def on_tool_start(
        ...
        **kwargs: Any,
        ...
        self.mark_step_start(run_id, serialized, node_input=input_str, node_name=serialized.get("name"), **kwargs)
    ...
    def on_chain_start(
        ...
        **kwargs: Any,
        ...
        # Inputs can be an Agent object on some chains
            ...
            node_input = {key: value for key, value in inputs.dict().items() if value and isinstance(value, Stringable)}
        else:
    ...
    def on_chain_end(
        ...
        if isinstance(outputs, str):
            ...
            node_output = outputs
        elif isinstance(outputs, BaseModel):
            node_output = outputs.model_dump()
        elif isinstance(outputs, BaseModelV1):
    ...
    def add_targets(self, targets: List[str]) -> None:
        ...
        for root_id, target in zip(self.root_nodes, targets):
    ...
    def finish(self) -> None:
        ...
        chain_run(
            ...
            customized_scorers=self.customized_scorers,
