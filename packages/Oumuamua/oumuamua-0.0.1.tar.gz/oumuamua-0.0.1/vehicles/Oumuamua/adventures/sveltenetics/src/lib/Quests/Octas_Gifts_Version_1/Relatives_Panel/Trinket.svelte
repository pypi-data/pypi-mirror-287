...
/*
	import Octas_Gifts_Version_1_Relatives_Panel from '$lib/Quests/Octas_Gifts_Version_1/Relatives_Panel/Trinket.svelte'
*/
...
//
//
import UT_Fields from './Leaves/Unsigned_Transaction_Fields/Trinket.svelte';
import Unsigned_Transaction_Signature_Trinket from './Leaves/Unsigned_Transaction_Signature/Trinket.svelte';
import Unsigned_Transaction_Trinket from './Leaves/Unsigned_Transaction/Trinket.svelte';
import Transaction_Signature_Trinket from './Leaves/Transaction_Signature/Trinket.svelte'
