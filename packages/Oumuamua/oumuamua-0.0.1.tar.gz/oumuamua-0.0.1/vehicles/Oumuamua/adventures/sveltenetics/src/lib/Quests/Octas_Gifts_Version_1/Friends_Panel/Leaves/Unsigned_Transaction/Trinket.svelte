...
>
	...
	>
		...
		<p>A transaction ask requires <b>an unsigned transaction</b> + <b>a transaction signature</b>.</p>
			...
			{#if current_format === 0}
				...
				<pre
					...
					style="
						...
						color: inherit;
					"
				>{ freight.unsigned_transaction.Aptos_object_fiberized }</pre>
				...
				>
					...
					<p
						...
						style="
							...
							border-radius: 4px;
						"
					>{ freight.unsigned_transaction.hexadecimal_string }</p>
					...
					>
						<button 
							...
							use:clipboard={ freight.unsigned_transaction.hexadecimal_string }
