...
import Address_Qualities_Trinket from '$lib/trinkets/Consensus/Address_Qualities/Trinket.svelte'
//
import Input_Error_Message from '$lib/Quests/Octas_Gifts_Version_1/Trinkets/Input_Error_Message.svelte'
//
import { 
	refresh_truck, 
	retrieve_truck, 
...
const on_change_origin_address = ({
	...
	freight.fields.address_hexadecimal_string = address_hexadecimal_string;
}


let address_trinket = ""
const on_prepare = () => {
	address_trinket.change_address_hexadecimal_string ("1234")
}
				...
				<tbody>
					...
					<tr>
						<td>							
							...
							>1 APT = 1e8 Octas</p>
							<p 
								style="padding: 0 0 10px; text-align: center"
							>
								<b>Actual Amount of Octas</b>
								<span>is calculated from the input provided and is the number that is added to the transaction.<span>
							</p>
