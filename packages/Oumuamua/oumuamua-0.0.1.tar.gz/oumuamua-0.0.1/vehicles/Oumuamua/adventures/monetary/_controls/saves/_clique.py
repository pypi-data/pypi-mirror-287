...
import Oumuamua.mixes.procedure as procedure
#
#
import click
import rich
...
def monetary_saves_clique ():
	...
	'''
		itinerary:
			[ ] Oumuamua_1 adventures monetary saves export --version 2
	...
	'''
		Oumuamua_1 adventures monetary saves import --version 2 --drop
	'''
