...
##            settings.set_azure_tenant_id('74efa022-e6d6-42ad-bc15-edc76c525bdf')
    ...
    def read_csv_config(self):
        ...
        self.required_properties_dict, self.unrequired_properties_list = pm.combine_required_properties(self.get_config_value_list("Model", "RequiredProperties", ""), [self.required_properties_override], self.default_data_type)
