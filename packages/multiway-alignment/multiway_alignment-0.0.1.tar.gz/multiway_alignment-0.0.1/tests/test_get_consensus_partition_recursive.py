...
class TestGetConsensusPartitionRecursive(unittest.TestCase):
    """
    Test functionality of consensus.get_consensus_partition_recursive()
    ------------
    Example
    ------------
    >>> python3 -m unittest -v tests.test_get_consensus_partition_recursive
    """
    ...
    def test_on_empty(self):
        ...
        self.assertIsInstance(
            _res0,
            dict,
            f"""get_consensus_partition_recursive should return a dictionary, but returned {type(_res0)}""",
        )
        self.assertEqual(
            _res0,
            dict(),
            f"""get_consensus_partition_recursive called on empty dataframe should return an empty dictionary,
            but returned {_res0}""",
        )

    def test_on_one_layer(self):
        """
        get_consensus_partition_recursive returns a dictionary, and returns all the nodes
        """
        ...
        self.assertNotEqual(
            _res0,
            dict(),
            f"""get_consensus_partition_recursive called on non-empty dataframe should return a non-empty dictionary,
            but returned {_res0}""",
        )
        ...
        self.assertDictEqual(
            _res0,
            _expected0,
            f"""get_consensus_partition_recursive called on non-empty dataframe should return
        ...
        self.assertSetEqual(
            set(_all_nodes),
            set(_returned_nodes),
            """get_consensus_partition_recursive called on non-empty dataframe should return all nodes""",
        )
    ...
    def test_on_two_layers_0(self):
        ...
        self.assertNotEqual(
            _res0,
            dict(),
            f"""get_consensus_partition_recursive called on non-empty dataframe should return a
        ...
        self.assertDictEqual(
            _res0,
            _expected0,
            f"""get_consensus_partition_recursive called on non-empty dataframe should return the expected non-empty
