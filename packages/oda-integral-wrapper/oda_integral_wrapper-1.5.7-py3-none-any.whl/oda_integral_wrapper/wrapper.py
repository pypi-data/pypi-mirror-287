...
class INTEGRALwrapper(object):
    ...
    @staticmethod
    def get_catalog_from_web(isdc_general_catalog = 'http://isdcarc.isdc.unige.ch/arc/rev_3/cat/hec/gnrl_refr_cat_0043.fits'):
        import cdci_data_analysis.analysis.catalog
        ...
        oda_catalog = cdci_data_analysis.analysis.catalog.BasicCatalog( [ss.strip() for ss in isdc_sources['NAME'][mask]], 
    ...
    def get_catalog_from_dict(api_cat):
        ...
        oda_catalog = cdci_data_analysis.analysis.catalog.BasicCatalog.from_table(oda_catalog_table)
        return oda_catalog
