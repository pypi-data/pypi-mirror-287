...
-   player_client: Clients to extract video data from. The main clients
    ...
    web_creator); and mediaconnect, mweb, android_producer,
    android_testsuite, android_vr, web_safari, web_embedded, tv and
    tv_embedded with no variants. By default, ios,web is used, but
    tv_embedded and _creator variants are added as required for
