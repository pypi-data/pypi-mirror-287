...
def _run_server(port: int, dev_mode: bool, no_open: bool, no_copy_demo_data: bool, initial_page="", host: str = "127.0.0.1"):
...
@click.option("--host", default="127.0.0.1", help="Host to run the server on -- use 0.0.0.0 if you want "
