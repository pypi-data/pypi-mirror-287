...
# from ai_tools_z.yolo.yolo_results保存 import SAVE_YOLO_RESULTS


class AutoLabeling:
    def __init__(self,
                 yolo_weight_path: str =
                 "/Users/zhangxuewei/Documents/GitHub/myLib/ai_tools_z/ai_tools_z/yolo/weights/yolov10m.pt",
                 device='cpu'):
...
#     model_root = Path("/Users/zhangxuewei/Documents/GitHub/myLib/ai_tools_z/ai_tools_z/yolo/weights")
#     # model_name = "yolov8s"
#     model_name = "yolov10m"
#
#     # 加载预训练的 YOLOv8 模型，
...
if __name__ == '__main__':
    ...
    auto_labeling = AutoLabeling(
        yolo_weight_path="/ai_tools_z/yolo/weights/yolov10m.pt",
        device='cpu')
