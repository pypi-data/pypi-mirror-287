...
setup(
    ...
    install_requires=['### package_auto_assembler.py', 'stdlib-list', 'requests', 'click', 'attrs>=22.2.0', 'mkdocs==1.6.0', 'nbconvert', 'nbconvert==7.16.4', 'numpy==1.26.0', 'pandas==2.1.1', 'nbformat', 'pyyaml', 'pip_audit==2.7.3'],
    ...
    author="Kyrylo Mordan", author_email="parachute.repo@gmail.com", description="A tool to automate package creation within ci based on just .py and optionally .ipynb file.", keywords="['python', 'packaging']", version="0.4.0"
)
