...
_INDOX_DEFAULT_COLLECTION_NAME = "indox"
...
def _get_embedding_collection_store(
    ...
    class CollectionStore(BaseModel):
        ...
        __tablename__ = "indox_pg_collection"
    ...
    if use_jsonb:
        ...
        class EmbeddingStore(BaseModel):
            ...
            __tablename__ = "indox_pg_embedding"
...
class PGVectorSetup(VectorStore):
    ...
    **DEPRECATED**: This class is pending deprecation and will likely receive
        ...
        `indox_postgres` as `PGVector`. Please use that class instead.
    ...
    Args:
        ...
        embedding_function: Any embedding function implementing
            `indox.embeddings.base.Embeddings` interface.
        ...
        collection_name: The name of the collection to use. (default: indox)
    ...
    def _create_filter_clause(self, filters: Any) -> Any:
        """Convert Indox IR filter representation to matching SQLAlchemy clauses.
