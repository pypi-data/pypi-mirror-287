...
class Enso(KaitaiStruct):
    ...
    :field ttc_tx_power: ax25_frame.payload.ax25_info.ttc_tx_power
    ...
    class Ax25InfoData(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ttc_tx_power = self._io.read_u2le()
        ...
        def eps_ttc_mcu_volt_val(self):
            if hasattr(self, '_m_eps_ttc_mcu_volt_val'):
                return self._m_eps_ttc_mcu_volt_val if hasattr(self, '_m_eps_ttc_mcu_volt_val') else None
        ...
        def eps_ttc_tx_cur_max_val(self):
            if hasattr(self, '_m_eps_ttc_tx_cur_max_val'):
                return self._m_eps_ttc_tx_cur_max_val if hasattr(self, '_m_eps_ttc_tx_cur_max_val') else None
        ...
        def ttc_rssi_last_packet_val(self):
            if hasattr(self, '_m_ttc_rssi_last_packet_val'):
                return self._m_ttc_rssi_last_packet_val if hasattr(self, '_m_ttc_rssi_last_packet_val') else None
        ...
        def eps_charge_cur_val(self):
            if hasattr(self, '_m_eps_charge_cur_val'):
                return self._m_eps_charge_cur_val if hasattr(self, '_m_eps_charge_cur_val') else None
        ...
        def eps_max_charge_cur_val(self):
            if hasattr(self, '_m_eps_max_charge_cur_val'):
                return self._m_eps_max_charge_cur_val if hasattr(self, '_m_eps_max_charge_cur_val') else None
        ...
        def eps_ttc_tx_cur_val(self):
            if hasattr(self, '_m_eps_ttc_tx_cur_val'):
                return self._m_eps_ttc_tx_cur_val if hasattr(self, '_m_eps_ttc_tx_cur_val') else None
        ...
        def temperature_val(self):
            if hasattr(self, '_m_temperature_val'):
                return self._m_temperature_val if hasattr(self, '_m_temperature_val') else None

            self._m_temperature_val = ((self.temperature * 0.0625) if self.temperature <= 4095 else ((self.temperature + 57344) * 0.0625))
            return self._m_temperature_val if hasattr(self, '_m_temperature_val') else None

        @property
        def eps_ttc_volt_val(self):
            if hasattr(self, '_m_eps_ttc_volt_val'):
                return self._m_eps_ttc_volt_val if hasattr(self, '_m_eps_ttc_volt_val') else None
        ...
        def eps_ref_volt_val(self):
            if hasattr(self, '_m_eps_ref_volt_val'):
                return self._m_eps_ref_volt_val if hasattr(self, '_m_eps_ref_volt_val') else None
        ...
        def eps_bat_volt_max_val(self):
            if hasattr(self, '_m_eps_bat_volt_max_val'):
                return self._m_eps_bat_volt_max_val if hasattr(self, '_m_eps_bat_volt_max_val') else None
        ...
        def eps_mos2_volt_val(self):
            if hasattr(self, '_m_eps_mos2_volt_val'):
                return self._m_eps_mos2_volt_val if hasattr(self, '_m_eps_mos2_volt_val') else None
        ...
        def eps_bat_volt_min_val(self):
            if hasattr(self, '_m_eps_bat_volt_min_val'):
                return self._m_eps_bat_volt_min_val if hasattr(self, '_m_eps_bat_volt_min_val') else None
        ...
        def eps_bat_volt_avg_val(self):
            if hasattr(self, '_m_eps_bat_volt_avg_val'):
                return self._m_eps_bat_volt_avg_val if hasattr(self, '_m_eps_bat_volt_avg_val') else None
        ...
        def eps_pl_cur_val(self):
            if hasattr(self, '_m_eps_pl_cur_val'):
                return self._m_eps_pl_cur_val if hasattr(self, '_m_eps_pl_cur_val') else None
        ...
        def eps_obdh_volt_val(self):
            if hasattr(self, '_m_eps_obdh_volt_val'):
                return self._m_eps_obdh_volt_val if hasattr(self, '_m_eps_obdh_volt_val') else None
        ...
        def eps_bat_volt_val(self):
            if hasattr(self, '_m_eps_bat_volt_val'):
                return self._m_eps_bat_volt_val if hasattr(self, '_m_eps_bat_volt_val') else None
        ...
        def eps_mos1_volt_val(self):
            if hasattr(self, '_m_eps_mos1_volt_val'):
                return self._m_eps_mos1_volt_val if hasattr(self, '_m_eps_mos1_volt_val') else None
        ...
        def eps_mos3_volt_val(self):
            if hasattr(self, '_m_eps_mos3_volt_val'):
                return self._m_eps_mos3_volt_val if hasattr(self, '_m_eps_mos3_volt_val') else None
        ...
        def ttc_freq_dev_last_packet_val(self):
            if hasattr(self, '_m_ttc_freq_dev_last_packet_val'):
                return self._m_ttc_freq_dev_last_packet_val if hasattr(self, '_m_ttc_freq_dev_last_packet_val') else None
        ...
        def eps_avg_charge_cur_val(self):
            if hasattr(self, '_m_eps_avg_charge_cur_val'):
                return self._m_eps_avg_charge_cur_val if hasattr(self, '_m_eps_avg_charge_cur_val') else None
        ...
        def eps_pl_volt_val(self):
            if hasattr(self, '_m_eps_pl_volt_val'):
                return self._m_eps_pl_volt_val if hasattr(self, '_m_eps_pl_volt_val') else None
