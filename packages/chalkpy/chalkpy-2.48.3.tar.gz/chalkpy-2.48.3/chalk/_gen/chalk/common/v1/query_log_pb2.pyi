...
class VersionedQueryName(_message.Message):
    ...
    def __init__(
        self, query_name: _Optional[str] = ..., query_name_version: _Optional[str] = ...
    ) -> None: ...
...
class QueryLogFilters(_message.Message):
    ...
    operation_kind: _containers.RepeatedScalarFieldContainer[
        _operation_kind_pb2.OperationKind
    ]
    ...
    query_status: _containers.RepeatedScalarFieldContainer[
        _query_status_pb2.QueryStatus
    ]
    def __init__(
        self,
        operation_id: _Optional[_Iterable[str]] = ...,
        operation_kind: _Optional[
            _Iterable[_Union[_operation_kind_pb2.OperationKind, str]]
        ] = ...,
        ...
        query_status: _Optional[
            _Iterable[_Union[_query_status_pb2.QueryStatus, str]]
        ] = ...,
    ) -> None: ...
...
class GetQueryLogEntriesRequest(_message.Message):
    ...
    def __init__(
        self,
        query_timestamp_lower_bound_inclusive: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        query_timestamp_upper_bound_exclusive: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
...
class QueryLogEntry(_message.Message):
    ...
    def __init__(
        ...
        execution_started_at: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
        execution_finished_at: _Optional[
            _Union[_timestamp_pb2.Timestamp, _Mapping]
        ] = ...,
