...
class Graph(_message.Message):
    ...
    database_sources: _containers.RepeatedCompositeFieldContainer[
        _sources_pb2.DatabaseSource
    ]
    stream_sources: _containers.RepeatedCompositeFieldContainer[
        _sources_pb2.StreamSource
    ]
    ...
    def __init__(
        ...
        database_sources: _Optional[
            _Iterable[_Union[_sources_pb2.DatabaseSource, _Mapping]]
        ] = ...,
        stream_sources: _Optional[
            _Iterable[_Union[_sources_pb2.StreamSource, _Mapping]]
        ] = ...,
...
class NamedQuery(_message.Message):
    ...
    class StalenessEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...,
        ) -> None: ...
...
class FeatureSet(_message.Message):
    ...
    def __init__(
        ...
        max_staleness_duration: _Optional[
...
class DataFrameType(_message.Message):
    ...
    def __init__(
        ...
        required_columns: _Optional[
            _Iterable[_Union[FeatureReference, _Mapping]]
        ] = ...,
        optional_columns: _Optional[
            _Iterable[_Union[FeatureReference, _Mapping]]
        ] = ...,
...
class GroupByFeatureType(_message.Message):
    ...
    window_durations: _containers.RepeatedCompositeFieldContainer[
    ...
    def __init__(
        ...
        window_durations: _Optional[
            _Iterable[_Union[_duration_pb2.Duration, _Mapping]]
        ] = ...,
...
class Resolver(_message.Message):
    ...
    data_sources: _containers.RepeatedCompositeFieldContainer[
        _sources_pb2.DatabaseSourceReference
    ]
    machine_type: str
    tags: _containers.RepeatedScalarFieldContainer[str]
    owner: str
    ...
    def __init__(
        ...
        is_generator: bool = ...,
        data_sources: _Optional[
            _Iterable[_Union[_sources_pb2.DatabaseSourceReference, _Mapping]]
        ] = ...,
...
class SinkResolver(_message.Message):
    ...
    def __init__(
        ...
        upsert: bool = ...,
        stream_source: _Optional[
            _Union[_sources_pb2.StreamSourceReference, _Mapping]
        ] = ...,
        database_source: _Optional[
            _Union[_sources_pb2.DatabaseSourceReference, _Mapping]
        ] = ...,
        machine_type: _Optional[str] = ...,
        doc: _Optional[str] = ...,
        owner: _Optional[str] = ...,
...
class ParseInfo(_message.Message):
    ...
    def __init__(
        ...
        parse_function_input_type: _Optional[
            _Union[_arrow_pb2.ArrowType, _Mapping]
        ] = ...,
        parse_function_output_type: _Optional[
            _Union[_arrow_pb2.ArrowType, _Mapping]
        ] = ...,
        is_parse_function_output_optional: bool = ...,
    ) -> None: ...
...
class StreamResolverParam(_message.Message):
    ...
    def __init__(
        ...
        message_window: _Optional[
            _Union[StreamResolverParamMessageWindow, _Mapping]
        ] = ...,
        state: _Optional[_Union[ResolverState, _Mapping]] = ...,
    ) -> None: ...
...
class VersionInfo(_message.Message):
    ...
    maximum: int
    def __init__(
        self, default: _Optional[int] = ..., maximum: _Optional[int] = ...
    ) -> None: ...
