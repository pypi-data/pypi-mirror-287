...
class Column(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        relation: _Optional[_Union[ColumnRelation, _Mapping]] = ...,
    ) -> None: ...
...
class PlaceholderNode(_message.Message):
    ...
    def __init__(
        self,
        id: _Optional[str] = ...,
        data_type: _Optional[_Union[_arrow_pb2.ArrowType, _Mapping]] = ...,
    ) -> None: ...
...
class LogicalExprList(_message.Message):
    ...
    def __init__(
        self, expr: _Optional[_Iterable[_Union[LogicalExprNode, _Mapping]]] = ...
    ) -> None: ...
...
class GroupingSetNode(_message.Message):
    ...
    def __init__(
        self, expr: _Optional[_Iterable[_Union[LogicalExprList, _Mapping]]] = ...
    ) -> None: ...
...
class NamedStructField(_message.Message):
    ...
    def __init__(
        self, name: _Optional[_Union[_arrow_pb2.ScalarValue, _Mapping]] = ...
    ) -> None: ...
...
class ListIndex(_message.Message):
    ...
    key: LogicalExprNode
    def __init__(
        self, key: _Optional[_Union[LogicalExprNode, _Mapping]] = ...
    ) -> None: ...
...
class IsNull(_message.Message):
    ...
    expr: LogicalExprNode
    def __init__(
        self, expr: _Optional[_Union[LogicalExprNode, _Mapping]] = ...
    ) -> None: ...
...
class PartialTableReference(_message.Message):
    ...
    table: str
    def __init__(
        self, schema: _Optional[str] = ..., table: _Optional[str] = ...
    ) -> None: ...
...
class BinaryExprNode(_message.Message):
    ...
    def __init__(
        self,
        operands: _Optional[_Iterable[_Union[LogicalExprNode, _Mapping]]] = ...,
        op: _Optional[str] = ...,
    ) -> None: ...
...
class AggregateUDFExprNode(_message.Message):
    ...
    class KwargsEntry(_message.Message):
        ...
        def __init__(
            self,
            key: _Optional[str] = ...,
            value: _Optional[_Union[LogicalExprNode, _Mapping]] = ...,
        ) -> None: ...
