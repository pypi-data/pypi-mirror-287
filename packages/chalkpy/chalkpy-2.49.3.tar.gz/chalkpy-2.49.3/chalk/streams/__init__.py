...
from chalk.streams._windows import Windowed, get_duration_secs, get_name_with_duration, group_by_windowed, windowed
...
def stream(
    *,
    ...
    keys
        ...
        See more at https://docs.chalk.ai/docs/aggregations#keys
    timestamp
        An optional string specifying an input attribute as the timestamp used for windowed aggregations.
        See more at https://docs.chalk.ai/docs/aggregations#custom-event-timestamping
