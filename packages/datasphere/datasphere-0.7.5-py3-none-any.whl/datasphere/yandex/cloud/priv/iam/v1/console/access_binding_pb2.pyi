...
class AccessBindingSubject(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["federation", b"federation", "group", b"group"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["email", b"email", "family_name", b"family_name", "federation", b"federation", "given_name", b"given_name", "group", b"group", "locale", b"locale", "name", b"name", "phone_number", b"phone_number", "picture", b"picture", "picture_data", b"picture_data", "preferred_username", b"preferred_username", "service_account_folder_id", b"service_account_folder_id", "sub", b"sub", "sub_type", b"sub_type", "zoneinfo", b"zoneinfo"]) -> None: ...
...
class Federation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "is_global", b"is_global", "name", b"name"]) -> None: ...
...
class Group(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["is_explicit", b"is_explicit", "is_public", b"is_public"]) -> None: ...
