...
class Federation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "is_global", b"is_global", "name", b"name", "organization", b"organization"]) -> None: ...
...
class YandexClaims(google.protobuf.message.Message):
    ...
    class Domain(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["domain", b"domain", "domid", b"domid", "hosted", b"hosted"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["avatar_id", b"avatar_id", "domain", b"domain", "email", b"email", "karma", b"karma", "login", b"login", "login_id", b"login_id", "passport_uid", b"passport_uid", "phones", b"phones", "staff_login", b"staff_login", "two_factor_authentication_enabled", b"two_factor_authentication_enabled"]) -> None: ...
...
class Group(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["group_id", b"group_id", "group_name", b"group_name"]) -> None: ...
