...
from bespokelabs-python-client.models.http_validation_error import HTTPValidationError
    ...
    def make_instance(self, include_optional) -> HTTPValidationError:
        ...
        if include_optional:
            return HTTPValidationError(
                detail = [
                    bespokelabs-python-client.models.validation_error.ValidationError(
                        loc = [
                            null
                            ], 
                        msg = '', 
