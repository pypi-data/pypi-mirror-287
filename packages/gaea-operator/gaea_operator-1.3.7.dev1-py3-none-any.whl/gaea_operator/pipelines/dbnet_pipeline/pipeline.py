    ...
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/paddlepaddle:1.3.7-dev1"),
    ...
    def __call__(self,
        ...
        train_params = {"skip": self.train_skip,
                        ...
                        "advanced_parameters": '{"Global.epoch_num":"1",'
                                               ...
                                               '"Train.dataset.loader.num_workers":"1",'
                                               '"eval_height":"640",'
                                               '"eval_width":"640",'
        ...
        train = ContainerStep(name=Train.name(),
                              ...
                              command=f'sleep 100000 && cd /root && '
...
if __name__ == "__main__":
    ...
    npu_ppl = pipeline(
        ...
        train_accelerator="Atlas310",
        eval_accelerator="Atlas310",
        windmill_ak="a1a9069e2b154b2aa1a83ed12316d163",
        windmill_sk="eefac23d2660404e93855197ce60efb3",
        windmill_endpoint="http://10.27.240.5:8340",
        experiment_kind="Aim",
