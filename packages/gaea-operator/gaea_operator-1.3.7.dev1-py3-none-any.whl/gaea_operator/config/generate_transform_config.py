...
ACCELERATOR_LIST = ["t4", "v100", "a100", "a800", "a10", "r200", "atlas310"]
...
def gen_input_shape(model_name, width, height, max_batch_size):
    ...
    input_shape = {}
    if 'ppyoloe' in model_name or 'convnext' in model_name or 'repvit' in model_name or 'resnet' in model_name:
