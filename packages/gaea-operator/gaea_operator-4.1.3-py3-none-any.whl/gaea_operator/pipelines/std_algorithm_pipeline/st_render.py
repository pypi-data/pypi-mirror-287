...
def train_part(config,
    ...
    advance_param = render_st_advanced_parameters("train", train_advance_parameters)
    ...
    is_ok = ok_train_dataset and ok_eval_dataset and ok_flavour and ok_model and ok_model_store and compute_ok
...
def transform_part(config,
    ...
    advance_param = render_st_advanced_parameters("transform",
                                                  transform_advance_parameters,
                                                  train_advance_parameters)
...
def get_parts(config, basic_parameter):
    ...
    eval_parameter, eval_ok = eval_part(basic_parameter["workspace_id"],
                                        ...
                                        basic_parameter["pipeline_category"])
    trans_parameter = transform_part(config,
                                     basic_parameter["workspace_id"],
                                     basic_parameter["project_name"],
...
def main():
    ...
    is_ok = basic_ok and train_ok and eval_ok and package_ok
...
def transform_eval_part(dataset_name,
                        compute_name,
                        flavour,
                        accelerator,
                        workspace_id,
