...
def pipeline(extra_fs_name: str = "vistudio",
    ...
    data_mining = ContainerStep(name="datamining",
                                ...
                                command=f'cd /root && '
                                        f'export LD_LIBRARY_PATH=/opt/conda/envs/data/lib:$LD_LIBRARY_PATH && '
                                        f'export PYTHONPATH=$PYTHONPATH:/opt/conda/envs/data/lib/python311.zip:/opt'
                                        f'/conda/envs/data/lib/python3.11:/opt/conda/envs/data/lib/python3.11/lib'
                                        f'-dynload:/opt/conda/envs/data/lib/python3.11/site-packages:/usr/local/lib'
                                        f'/python3.8/dist-packages &&'
                                        f'/opt/conda/envs/data/bin/python3 -m '
