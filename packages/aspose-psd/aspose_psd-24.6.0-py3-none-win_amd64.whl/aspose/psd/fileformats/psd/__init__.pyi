...
class PsdColorPalette(aspose.psd.IPsdColorPalette):
    ...
    @overload
    @staticmethod
    def copy_palette(color_palette : aspose.psd.IColorPaletteuse_compact_palette : bool) -> aspose.psd.fileformats.psd.PsdColorPalette:
        '''Copies the palette.
...
class FontBaseline:
    ...
    @classmethod
    @property
    def NONE(cls) -> FontBaseline:
        '''No baseline value'''
        ...
    
    @classmethod
    @property
    def SUPERSCRIPT(cls) -> FontBaseline:
        '''Superscript baseline.'''
        ...
    
    @classmethod
    @property
    def SUBSCRIPT(cls) -> FontBaseline:
        '''Subscript baseline.'''
        ...
...
class FontCaps:
    ...
    @classmethod
    @property
    def NONE(cls) -> FontCaps:
        '''No font caps value.'''
        ...
    
    @classmethod
    @property
    def SMALL_CAPS(cls) -> FontCaps:
        '''The small caps.'''
        ...
    
    @classmethod
    @property
    def ALL_CAPS(cls) -> FontCaps:
        '''The all caps.'''
        ...
...
class JustificationMode:
    ...
    @classmethod
    @property
    def LEFT(cls) -> JustificationMode:
        '''The left align text.'''
        ...
    
    @classmethod
    @property
    def RIGHT(cls) -> JustificationMode:
        '''The right align text.'''
        ...
    
    @classmethod
    @property
    def CENTER(cls) -> JustificationMode:
        '''The center text.'''
        ...
...
class LeadingType:
    ...
    @classmethod
    @property
    def BOTTOM_TO_BOTTOM(cls) -> LeadingType:
        '''The bottom-to-bottom leading.'''
        ...
    
    @classmethod
    @property
    def TOP_TO_TOP(cls) -> LeadingType:
...
class PsdVersion:
    ...
    @classmethod
    @property
    def PSD(cls) -> PsdVersion:
        '''The default PSD version.'''
        ...
    
    @classmethod
    @property
    def PSB(cls) -> PsdVersion:
        '''The PSB version.'''
        ...
