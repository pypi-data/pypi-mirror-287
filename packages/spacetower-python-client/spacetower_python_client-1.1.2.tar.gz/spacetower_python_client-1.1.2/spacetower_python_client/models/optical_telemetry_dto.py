...
class OpticalTelemetryDto(BaseModel):
    """
    OpticalTelemetryDto
    """ # noqa: E501
    ...
    measurements: List[List[Union[StrictFloat, StrictInt]]] = Field(description="Array of double: azimuth, elevation. Units: [deg], [deg]")
    __properties: ClassVar[List[str]] = ["azimuthStandardDeviation", "dates", "elevationStandardDeviation", "groundStationId", "id", "measurements"]
