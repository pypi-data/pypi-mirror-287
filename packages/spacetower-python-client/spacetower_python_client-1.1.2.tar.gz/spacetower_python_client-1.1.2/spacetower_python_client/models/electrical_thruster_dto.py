...
class ElectricalThrusterDto(BaseModel):
    """
    ...
    stand_by_power: Union[StrictFloat, StrictInt] = Field(description="Units: [W]", alias="standByPower")
    ...
    thruster_power: Union[StrictFloat, StrictInt] = Field(description="Units: [W]", alias="thrusterPower")
    ...
    warm_up_power: Union[StrictFloat, StrictInt] = Field(description="Units: [W]", alias="warmUpPower")
    __properties: ClassVar[List[str]] = ["id", "impulse", "maximumThrustDuration", "propellantMass", "standByPower", "thrust", "thrusterAxisInSatelliteFrame", "thrusterIsp", "thrusterPower", "thrusterTotalMass", "warmUpDuration", "warmUpPower"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "thrusterPower": obj.get("thrusterPower"),
