...
class StationVisibilityEventsRequestDto(BaseModel):
    """
    StationVisibilityEventsRequestDto
    """ # noqa: E501
    ground_station_ids: List[StrictStr] = Field(description="The station's UUID", alias="groundStationIDs")
    id: Optional[StrictStr] = None
    start_date: Optional[StrictStr] = Field(default=None, description="UTC date", alias="startDate")
    __properties: ClassVar[List[str]] = ["groundStationIDs", "id", "startDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groundStationIDs": obj.get("groundStationIDs"),
            "id": obj.get("id"),
