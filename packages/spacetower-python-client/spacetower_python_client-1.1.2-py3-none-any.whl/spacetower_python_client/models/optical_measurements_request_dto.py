...
class OpticalMeasurementsRequestDto(BaseModel):
    """
    ...
    ground_station_id: StrictStr = Field(description="The UUID of the observation station", alias="groundStationId")
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["azimuthStandardDeviation", "elevationStandardDeviation", "generationStep", "groundStationId", "id"]
