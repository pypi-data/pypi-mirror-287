...
class reader(object):
    ...
    def generic(self, df_fpn, df_sep='\t', skiprows=None, header=None, index_col=0, is_utf8=False):
        """
    ...
    def excel(self, df_fpn, sheet_name='Sheet1', header=None, index_col=0, is_utf8=False):
        """
