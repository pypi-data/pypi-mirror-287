...
class MaitaiAsync:
    def __init__(
        ...
        *,
        ...
        self.chat = AsyncChat(self.client, client_params)
...
class AsyncCompletions:
    ...
    async def create(
        ...
        *,
        ...
        tools: Union[Iterable[Union[openai_chat_types.ChatCompletionToolParam, ToolFunction]], openai.NotGiven] = openai.NOT_GIVEN, top_logprobs: Union[Optional[int], openai.NotGiven] = openai.NOT_GIVEN,
...
async def _process_inference_stream_async(stream: AsyncIterable[InferenceStreamResponse]) -> AsyncIterable[MaitaiChunk]:
