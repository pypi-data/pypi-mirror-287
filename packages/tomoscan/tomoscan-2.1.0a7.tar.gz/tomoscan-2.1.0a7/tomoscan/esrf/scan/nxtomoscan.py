...
class NXtomoScan(TomoScanBase):
    ...
    @property
    def splitted_flat_serie(self) -> dict | None:
...
class XRD3DFrame(TomoFrame):
    ...
    def __init__(
        ...
        index: int,
        url: DataUrl | None = None,
        image_key: ImageKey | int | None = None,
        rotation_angle: float | None = None,
        is_control_proj: bool = False,
        x_translation: float | None = None,
        y_translation: float | None = None,
        z_translation: float | None = None,
        rocking: float | None = None,
        base_tilt: float | None = None,
    ):
        super().__init__(
            index=index,
            url=url,
    ...
    @property
    def rocking(self) -> float | None:
        return self._rocking

    @property
    def base_tilt(self) -> float | None:
        return self._base_tilt
