...
def enc(afx2):
    ...
    'p': "uia", 'q': "una27", 'r': "ioa7", 's': "br4wt4", 't': "br46ba", 
    ...
    'P': 'df8g', 'Q': 'jdf8k', 'R': 'sfkl', 'S': 'jkf73', 'T': 'klfi3a', 
    'U': 'vsk7dfj', 'V': 'djhf93jd', 'W': 'ncad4', 'X': 'kdc3m', 
    'Y': 'lakwj', 'Z': 'klne',
    ' ': 'jhefuis'
}

    def crc(input_string, char_mapping):
        result = []
...
def dec(afx):
    ...
    rcs = {v: k for k, v in char_Small.items()}
    ...
    encoded_string = afx
    decoded_string = decode_string(encoded_string, rcs)
...
The RPS() function is a classic game of Rock, Paper, Scissors. 
This timeless game is a great way to settle simple disputes or just have some fun.
