...
class ColoredDigraphVertex:
    def __eq__(self, arg0: ColoredDigraphVertex) -> bool:
        ...
    def __hash__(self) -> int:
        ...
...
class DenseNautyGraph:
    ...
    def __init__(self, arg0: int) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: VertexColoredDigraph) -> None:
        ...
...
class Digraph:
    ...
    def get_targets(self, arg0: int) -> typing.Iterator:
        ...
    def get_vertices(self) -> list[DigraphVertex]:
        ...
    def reset(self) -> None:
        ...
class DigraphEdge:
    ...
    def get_target(self) -> int:
        ...
class DigraphVertex:
    def __eq__(self, arg0: DigraphVertex) -> bool:
        ...
    def __hash__(self) -> int:
        ...
    def get_index(self) -> int:
...
class FaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLFactories, aag: IAAG, ssg: SuccessorStateGenerator, options: FaithfulAbstractionOptions = ...) -> FaithfulAbstraction | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IAAG, SuccessorStateGenerator]], options: FaithfulAbstractionsOptions = ...) -> list[FaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
...
class FaithfulAbstractionOptions:
    ...
    def __init__(self, mark_true_goal_literals: bool = False, use_unit_cost_one: bool = True, remove_if_unsolvable: bool = True, compute_complete_abstraction_mapping: bool = False, max_num_states: int = 4294967295, timeout_ms: int = 4294967295, pruning_strategy: ObjectGraphPruningStrategyEnum = ...) -> None:
        ...
...
class GlobalFaithfulAbstraction:
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IAAG, SuccessorStateGenerator]], options: FaithfulAbstractionsOptions = ...) -> list[GlobalFaithfulAbstraction]:
        ...
    def __str__(self) -> str:
        ...
    def get_aag(self) -> IAAG:
        ...
    @typing.overload
    def get_abstract_state_index(self, concrete_state: State) -> int:
        ...
    @typing.overload
    def get_abstract_state_index(self, global_state_index: int) -> int:
        ...
...
class GroundedAAG(IAAG):
    ...
    def __init__(self, arg0: Problem, arg1: PDDLFactories, arg2: IGroundedAAGEventHandler) -> None:
        ...
class IAAG:
    def compute_applicable_actions(self, arg0: State) -> GroundActionList:
        ...
...
class State:
    ...
    def literal_holds(self, arg0: DerivedGroundLiteral) -> bool:
        ...
    @typing.overload
    def literals_hold(self, arg0: FluentGroundLiteralList) -> bool:
        ...
    @typing.overload
    def literals_hold(self, arg0: DerivedGroundLiteralList) -> bool:
        ...
    @typing.overload
    def superset_of(self, arg0: FluentGroundAtomList) -> bool:
        ...
    @typing.overload
    def superset_of(self, arg0: DerivedGroundAtomList) -> bool:
        ...
...
class StateSpace:
    ...
    @staticmethod
    @typing.overload
    def create(problem: Problem, factories: PDDLFactories, aag: IAAG, ssg: SuccessorStateGenerator, options: StateSpaceOptions = ...) -> StateSpace | None:
        ...
    @staticmethod
    @typing.overload
    ...
    @staticmethod
    @typing.overload
    def create(memories: list[tuple[Problem, PDDLFactories, IAAG, SuccessorStateGenerator]], options: StateSpacesOptions = ...) -> list[StateSpace]:
        ...
    def __str__(self) -> str:
        ...
...
class SuccessorStateGenerator:
    ...
    def get_or_create_initial_state(self) -> State:
        ...
    def get_or_create_state(self, arg0: FluentGroundAtomList) -> State:
        ...
...
class VertexColoredDigraph:
    ...
    def add_undirected_edge(self, arg0: int, arg1: int) -> tuple[int, int]:
        ...
    def add_vertex(self, arg0: int) -> int:
        ...
    def get_backward_edges(self, arg0: int) -> typing.Iterator:
        ...
    def get_edges(self) -> list[DigraphEdge]:
    ...
    def get_targets(self, arg0: int) -> typing.Iterator:
        ...
    def get_vertices(self) -> list[ColoredDigraphVertex]:
        ...
    def reset(self) -> None:
        ...
    def to_string(self, arg0: ColorFunction) -> str:
        ...
def compute_sorted_vertex_colors(vertex_colored_graph: VertexColoredDigraph) -> list[int]:
    ...
def compute_vertex_colors(vertex_colored_graph: VertexColoredDigraph) -> list[int]:
    ...
def create_object_graph(color_function: ProblemColorFunction, pddl_factories: PDDLFactories, problem: Problem, state: State, state_index: int = 0, mark_true_goal_literals: bool = False, pruning_strategy: ObjectGraphPruningStrategy = ...) -> VertexColoredDigraph:
    """
