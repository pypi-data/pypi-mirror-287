...
This module is directly copied from https://github.com/slacgismo/solar-data-tools/blob/main/solardatatools/data_handler.py

It contains a class for managing a data processing pipeline
