...
def ask(d: Dict) -> None:
    print(bold(__('Welcome to the openpyweb MVC Framework %s Start File Structure.' %
    ...
    if 'path' in d:
        ...
        d['step'] = do_prompt(__('Do you want to create file openpyweb in this directory  (y/n)'),
                              'n', boolean)
