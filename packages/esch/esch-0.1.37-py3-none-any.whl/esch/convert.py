...
library = Path("~/desk/esch/library.bib").expanduser()  # temporary hard coded
templates = Path("~/desk/esch/templates").expanduser()  # temporary hard coded
filters = Path("~/desk/esch/filters").expanduser()  # temporary hard coded
