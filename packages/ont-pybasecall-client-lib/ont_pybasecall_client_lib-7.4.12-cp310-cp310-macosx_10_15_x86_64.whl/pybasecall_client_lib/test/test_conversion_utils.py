...
class TestConversionUtils(unittest.TestCase):
    ...
    def test_02_dict_to_readholder(self):
        ...
        self.assertTrue("scaling_override" in result)
        self.assertEqual(True, result["scaling_override"])
        self.assertTrue("scaling_override_median" in result)
        self.assertAlmostEqual(3.5, result["scaling_override_median"], 4)
        self.assertTrue("scaling_override_med_abs_dev" in result)
        self.assertAlmostEqual(4.5, result["scaling_override_med_abs_dev"], 4)
