...
from abc import ABC
from typing import List, Dict, Set, Any, Tuple, Type, Optional, TypeVar, cast
...
from sapiopylib.rest.utils.recordmodel.RecordModelWrapper import WrappedType, RecordModelWrapperUtil, \
...
class RecordModelRelationshipManager(RecordModelManagerBase):
    ...
    def load_forward_side_links(self, records: list[PyRecordModel | AbstractRecordModel], field_name: str) -> None:
        ...
        if not records:
            return
        root_records = RecordModelWrapperUtil.unwrap_list(records)
    ...
    def load_parents(self, records: list[PyRecordModel | AbstractRecordModel], parent_type_name: str) -> None:
        ...
        """
        root_records: list[PyRecordModel] = RecordModelWrapperUtil.unwrap_list(records)
