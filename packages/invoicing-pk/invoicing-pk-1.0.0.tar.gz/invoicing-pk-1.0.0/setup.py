...
setup(
  name = 'invoicing-pk',         #* Your package will have this name
  ...
  description = 'This package by (Faran Ahmed Swati), can be used to convert Excel invoices to PDF invoices.',    # Short description of your library
  author = 'Faran Ahmed',                   # Your name
  author_email = 'faran69ahmad@gmail.com',  # Your email
  url = 'https://website.com',              # Homepage of your library (e.g. github or your website)
