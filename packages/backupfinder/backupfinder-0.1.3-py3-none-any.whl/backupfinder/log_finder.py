...
log_names = [
    "access", "error", "debug", "info", "warn", "warning", "fatal", "security",
    "auth", "application", "system", "webserver", "app", "server", "request",
    "response", "transaction", "event", "service", "audit",
]
...
def generate_log_wordlist(url, output_file="custom_logfinder.txt"):
    ...
    print(f"List of potential log files saved to {output_file} with {len(all_combinations)} entries")
