...
class BaseTectonObject:
    ...
    def validate(self) -> None:
        """Method is deprecated and will be removed in a future version. As of Tecton "
        "version 1.0 objects are validated upon object creation, so validate() is unnecessary.
        """
        # TODO(TEC-19865): revisit what to do with this function as part of schema validation
        logger.warning(
            "The validate() method is deprecated and will be removed in a future version. As of Tecton "
            "version 1.0 objects are validated upon object creation, so validate() is unnecessary."
        )
