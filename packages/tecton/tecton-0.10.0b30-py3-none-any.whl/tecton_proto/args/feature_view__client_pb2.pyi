...
class Attribute(_message.Message):
    __slots__ = ["column", "column_dtype"]
    COLUMN_DTYPE_FIELD_NUMBER: ClassVar[int]
    COLUMN_FIELD_NUMBER: ClassVar[int]
    column: str
    column_dtype: _data_type__client_pb2.DataType
    def __init__(self, column: Optional[str] = ..., column_dtype: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ...) -> None: ...
...
class Inference(_message.Message):
    ...
    model: str
    name: str
    def __init__(self, input_columns: Optional[Iterable[Union[_schema__client_pb2.Column, Mapping]]] = ..., name: Optional[str] = ..., model: Optional[str] = ...) -> None: ...
...
class PromptArgs(_message.Message):
    __slots__ = ["attributes", "environments"]
    ATTRIBUTES_FIELD_NUMBER: ClassVar[int]
    ENVIRONMENTS_FIELD_NUMBER: ClassVar[int]
    attributes: _containers.RepeatedCompositeFieldContainer[Attribute]
    environments: str
    def __init__(self, environments: Optional[str] = ..., attributes: Optional[Iterable[Union[Attribute, Mapping]]] = ...) -> None: ...
