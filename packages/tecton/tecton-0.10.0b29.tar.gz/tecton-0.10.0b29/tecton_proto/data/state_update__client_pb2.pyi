...
class PlanIntegrationTestConfig(_message.Message):
    __slots__ = ["auto_apply_upon_test_success"]
    AUTO_APPLY_UPON_TEST_SUCCESS_FIELD_NUMBER: ClassVar[int]
    auto_apply_upon_test_success: bool
    def __init__(self, auto_apply_upon_test_success: bool = ...) -> None: ...
...
class SuccessfulPlanOutput(_message.Message):
    __slots__ = ["apply_warnings", "json_output", "num_fcos_changed", "num_warnings", "string_output", "test_summaries"]
    ...
    def __init__(self, string_output: Optional[str] = ..., json_output: Optional[str] = ..., apply_warnings: Optional[str] = ..., num_fcos_changed: Optional[int] = ..., num_warnings: Optional[int] = ..., test_summaries: Optional[Iterable[Union[PlanIntegrationTestSummary, Mapping]]] = ...) -> None: ...
