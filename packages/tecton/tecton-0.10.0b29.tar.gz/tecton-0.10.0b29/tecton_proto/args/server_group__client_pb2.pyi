...
class ServerGroupArgs(_message.Message):
    __slots__ = ["autoscaling_enabled", "desired_nodes", "info", "max_nodes", "min_nodes", "options", "prevent_destroy", "server_group_id", "server_group_type", "transform_server_group_args"]
