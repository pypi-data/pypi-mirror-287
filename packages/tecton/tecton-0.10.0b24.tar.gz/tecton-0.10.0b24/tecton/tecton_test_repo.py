...
class TestRepo:
    ...
    def _get_fco(self, name: str, fcoType: type) -> Optional[BaseTectonObject]:
    ...
    def get_feature_view(self, name) -> FeatureView:
        ...
        Raises:
            Exception: If the FeatureView is not found in the repository.
        """
    ...
    def get_feature_service(self, name) -> FeatureService:
        ...
        Raises:
            Exception: If the FeatureService is not found in the repository.
        """
        return self._get_fco(name, FeatureService)

    def get_data_source(self, name) -> FeatureService:
        """
        ...
        Raises:
            Exception: If the DataSource is not found in the repository.
        """
