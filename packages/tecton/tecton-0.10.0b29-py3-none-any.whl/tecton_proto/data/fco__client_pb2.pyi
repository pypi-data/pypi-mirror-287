...
class Fco(_message.Message):
    __slots__ = ["entity", "feature_service", "feature_view", "transformation", "virtual_data_source"]
    ...
    def __init__(self, virtual_data_source: Optional[Union[_virtual_data_source__client_pb2.VirtualDataSource, Mapping]] = ..., entity: Optional[Union[_entity__client_pb2.Entity, Mapping]] = ..., feature_view: Optional[Union[_feature_view__client_pb2.FeatureView, Mapping]] = ..., feature_service: Optional[Union[_feature_service__client_pb2.FeatureService, Mapping]] = ..., transformation: Optional[Union[_transformation__client_pb2.Transformation, Mapping]] = ...) -> None: ...
