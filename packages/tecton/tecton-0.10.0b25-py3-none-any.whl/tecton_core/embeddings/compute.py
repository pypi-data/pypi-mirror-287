...
def _custom_model_path(model_name: str, s3_path: str) -> str:
    return retrieve_custom_model_artifacts(model_name, s3_path)
...
def _get_execution_info(
    ...
    if isinstance(inference_config, CustomModelConfig):
        ...
        inference_func_configs = [
            custom_model.CustomModelInferenceFuncConfig.create(
                model_dir=_custom_model_path(
                    inference_config.model_artifact.model_name, inference_config.model_artifact.storage_path
                ),
                cuda_device=cuda_device,
        ...
        output_field = pyarrow.field(
            ...
            custom_model._TECTON_TYPE_TO_ARROW_TYPE[inference_config.output_column.dtype],
        )
