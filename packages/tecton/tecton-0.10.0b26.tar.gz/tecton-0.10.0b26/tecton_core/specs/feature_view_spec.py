...
class Inference:
    ...
    # TODO(jiadong): Connect this with MDS to get registered model artifact.
    @classmethod
    def from_args_proto(cls, _: feature_view__args_pb2.Inference) -> "Inference":
        msg = "`from_args_proto` for `Inference` has not been implemented yet"
...
class MaterializedFeatureViewSpec(FeatureViewSpec):
    ...
    def from_args_proto(
        ...
        return cls(
            ...
            aggregate_features=aggregate_features,
            embedding_features=embedding_features,
            # TODO(jiadong): Support local dev for Inference feature.
            inference_features=(),
            slide_interval_string=slide_interval_string,
