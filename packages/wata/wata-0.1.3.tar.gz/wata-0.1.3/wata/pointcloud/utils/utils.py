...
def save_pcd(points, save_path, fields=None, npdtype=None, type='binary'):
    ...
    if npdtype is None:
        ...
        assert len(npdtype) == fields_num, "The length of <npdtype> should be consistent with the number of columns in the pcd."
    ...
    if fields is None:
        ...
        assert len(fields) == fields_num, "The length of <fields> should be consistent with the number of columns in the pcd."
        fields = ' '.join(fields)
