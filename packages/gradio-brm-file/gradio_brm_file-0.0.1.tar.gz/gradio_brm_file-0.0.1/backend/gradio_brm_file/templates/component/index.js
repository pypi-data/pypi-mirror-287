...
function Jt(l, e, t) {
  let { $$slots: n = {}, $$scope: i } = e, { height: f = void 0 } = e, { width: s = void 0 } = e, { elem_id: r = "" } = e, { elem_classes: o = [] } = e, { variant: a = "solid" } = e, { border_mode: c = "base" } = e, { padding: u = !0 } = e, { type: p = "normal" } = e, { test_id: m = void 0 } = e, { explicit_call: y = !1 } = e, { container: C = !0 } = e, { visible: q = !0 } = e, { allow_overflow: L = !0 } = e, { scale: d = null } = e, { min_width: _ = 0 } = e, v = p === "fieldset" ? "fieldset" : "div";
  const V = (b) => {
    if (b !== void 0) {
      if (typeof b == "number")
        return b + "px";
  ...
  return l.$$set = (b) => {
    "height" in b && t(0, f = b.height), "width" in b && t(1, s = b.width), "elem_id" in b && t(2, r = b.elem_id), "elem_classes" in b && t(3, o = b.elem_classes), "variant" in b && t(4, a = b.variant), "border_mode" in b && t(5, c = b.border_mode), "padding" in b && t(6, u = b.padding), "type" in b && t(16, p = b.type), "test_id" in b && t(7, m = b.test_id), "explicit_call" in b && t(8, y = b.explicit_call), "container" in b && t(9, C = b.container), "visible" in b && t(10, q = b.visible), "allow_overflow" in b && t(11, L = b.allow_overflow), "scale" in b && t(12, d = b.scale), "min_width" in b && t(13, _ = b.min_width), "$$scope" in b && t(17, i = b.$$scope);
  }, [
    f,
    s,
    r,
...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = je("button"), o && o.c(), t = sl(), n = je("div"), $t(i.$$.fragment), te(n, "class", "svelte-1lrphxw"), S(
        n,
        "small",
        /*size*/
        l[4] === "small"
    ...
    m(a, c) {
      gt(a, e, c), o && o.m(e, null), Ze(e, t), Ze(e, n), nl(i, n, null), f = !0, s || (r = ll(
        e,
        "click",
        /*click_handler*/
        l[14]
    ...
    p(a, [c]) {
      /*show_label*/
      a[2] ? o ? o.p(a, c) : (o = Te(a), o.c(), o.m(e, t)) : o && (o.d(1), o = null), (!f || c & /*size*/
      16) && S(
        n,
        "small",
        /*size*/
...
function wl(l) {
  ...
  return {
    c() {
      e = ye("svg"), t = ye("g"), n = ye("path"), i = ye("path"), W(n, "d", "M18,6L6.087,17.913"), J(n, "fill", "none"), J(n, "fill-rule", "nonzero"), J(n, "stroke-width", "2px"), W(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), W(i, "d", "M4.364,4.364L19.636,19.636"), J(i, "fill", "none"), J(i, "fill-rule", "nonzero"), J(i, "stroke-width", "2px"), W(e, "width", "100%"), W(e, "height", "100%"), W(e, "viewBox", "0 0 24 24"), W(e, "version", "1.1"), W(e, "xmlns", "http://www.w3.org/2000/svg"), W(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), W(e, "xml:space", "preserve"), W(e, "stroke", "currentColor"), J(e, "fill-rule", "evenodd"), J(e, "clip-rule", "evenodd"), J(e, "stroke-linecap", "round"), J(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
let Re = wt ? () => window.performance.now() : () => Date.now(), kt = wt ? (l) => requestAnimationFrame(l) : Fe;
...
function ql(l, e = Fe) {
  ...
  function s(r, o = Fe) {
    const a = [r, o];
    return n.add(a), n.size === 1 && (t = e(i, f) || Fe), r(l), () => {
...
function Ie(l, e, t, n) {
  if (typeof t == "number" || Xe(t)) {
    const i = n - t, f = (t - e) / (l.dt || 1 / 60), s = l.opts.stiffness * i, r = l.opts.damping * f, o = (s - r) * l.inv_mass, a = (f + o) * l.dt;
    return Math.abs(a) < l.opts.precision && Math.abs(i) < l.opts.precision ? n : (l.settled = !1, Xe(t) ? new Date(t.getTime() + a) : t + a);
  } else {
    if (Array.isArray(t))
      return t.map(
        (i, f) => Ie(l, e[f], t[f], n[f])
      );
    if (typeof t == "object") {
      const i = {};
      for (const f in t)
...
function Ye(l, e = {}) {
  ...
  let s, r, o, a = l, c = l, u = 1, p = 0, m = !1;
  function y(q, L = {}) {
    c = q;
    const d = o = {};
    return l == null || L.hard || C.stiffness >= 1 && C.damping >= 1 ? (m = !0, s = Re(), a = q, t.set(l = c), Promise.resolve()) : (L.soft && (p = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), u = 0), r || (s = Re(), m = !1, r = vl((_) => {
      if (m)
        return m = !1, r = null, !1;
      u = Math.min(u + p, 1);
      const v = {
...
function Kl(l) {
  ...
  return {
    ...
    m(m, y) {
      Nl(m, e, y), R(e, t), R(t, n), R(n, i), R(n, f), R(n, s), R(n, r), R(t, o), R(o, a), R(o, c), R(o, u), R(o, p);
    },
    p(m, [y]) {
      y & /*$top*/
...
function Sl(l, e, t) {
  let n, i;
  var f = this && this.__awaiter || function(m, y, C, q) {
    function L(d) {
      return d instanceof C ? d : new C(function(_) {
        _(d);
      });
    }
    return new (C || (C = Promise))(function(d, _) {
      function v(z) {
        try {
          b(q.next(z));
        } catch (Z) {
...
const {
  ...
  transition_out: U,
  update_slot_base: Nt
} = window.__gradio__svelte__internal, { tick: Bl } = window.__gradio__svelte__internal, { onDestroy: El } = window.__gradio__svelte__internal, { createEventDispatcher: Dl } = window.__gradio__svelte__internal, Pl = (l) => ({}), Qe = (l) => ({}), Tl = (l) => ({}), Ue = (l) => ({});
function xe(l, e, t) {
  const n = l.slice();
...
function Wl(l) {
  ...
  return {
    c() {
      e = Q("div"), yt(t.$$.fragment), n = E(), i = Q("span"), s = M(f), r = E(), c && c.c(), G(e, "class", "clear-status svelte-16nch4a"), G(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
    ...
    p(u, p) {
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && D(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = E(), t = Q("div"), m && m.c(), n = E(), y && y.c(), i = E(), s && s.c(), r = E(), d && d.c(), o = be(), G(t, "class", "progress-text svelte-16nch4a"), B(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    m(_, v) {
      c && c.m(_, v), k(_, e, v), k(_, t, v), m && m.m(t, null), ce(t, n), y && y.m(t, null), k(_, i, v), ~f && q[f].m(_, v), k(_, r, v), d && d.m(_, v), k(_, o, v), a = !0;
    },
    p(_, v) {
      /*variant*/
      _[8] === "default" && /*show_eta_bar*/
      _[18] && /*show_progress*/
      _[6] === "full" ? c ? c.p(_, v) : (c = et(_), c.c(), c.m(e.parentNode, e)) : c && (c.d(1), c = null), p === (p = u(_)) && m ? m.p(_, v) : (m && m.d(1), m = p && p(_), m && (m.c(), m.m(t, n))), /*timer*/
      ...
      let V = f;
      f = L(_), f === V ? ~f && q[f].p(_, v) : (s && (Ee(), U(q[V], 1, 1, () => {
        q[V] = null;
      }), Be()), ~f ? (s = q[f], s ? s.p(_, v) : (s = q[f] = C[f](_), s.c()), Y(s, 1), s.m(r.parentNode, r)) : s = null), /*timer*/
      _[5] ? d && (Ee(), U(d, 1, 1, () => {
        d = null;
    ...
    d(_) {
      _ && (w(e), w(t), w(i), w(r), w(o)), c && c.d(_), m && m.d(), y && y.d(), ~f && q[f].d(_), d && d.d(_);
    }
  };
}
function et(l) {
  ...
  return {
    c() {
      e = Q("div"), G(e, "class", "eta-bar svelte-16nch4a"), se(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function tt(l) {
  ...
  function r(c, u) {
    return (
      /*p*/
      c[41].length != null ? Hl : Ol
    );
  }
  let o = r(l), a = o(l);
  return {
    c() {
      a.c(), e = E(), n = M(t), i = M(" | "), s = M(f);
    },
    m(c, u) {
...
function Ql(l) {
  ...
  return {
    c() {
      e = Q("div"), t = Q("div"), r && r.c(), n = E(), i = Q("div"), f = Q("div"), G(t, "class", "progress-level-inner svelte-16nch4a"), G(f, "class", "progress-bar svelte-16nch4a"), se(f, "width", s), G(i, "class", "progress-bar-wrap svelte-16nch4a"), G(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = E(), s && s.c(), t = E(), r && r.c(), n = E(), o && o.c(), i = be();
    },
    m(a, c) {
  ...
  return {
    c() {
      e = Q("p"), t = M(
        /*loading_text*/
        l[9]
      ), n = E(), s && s.c(), G(e, "class", "loading svelte-16nch4a");
    },
    m(r, o) {
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      ...
      l[8] + " " + /*show_progress*/
      l[6] + " svelte-16nch4a"), B(e, "hide", !/*status*/
      l[4] || /*status*/
    ...
    p(a, c) {
      let u = t;
      t = o(a), t === u ? ~t && r[t].p(a, c) : (n && (Ee(), U(r[u], 1, 1, () => {
        r[u] = null;
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: m = !0 } = e, { show_progress: y = "full" } = e, { message: C = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, Z = !1, oe = 0, x = 0, le = null, ne = null, j = 0, P = null, ae, O = null, h = !0;
  const K = () => {
    t(0, o = t(27, le = t(19, ie = null))), t(25, oe = performance.now()), t(26, x = 0), Z = !0, T();
  };
  function T() {
    requestAnimationFrame(() => {
      t(26, x = (performance.now() - oe) / 1e3), Z && T();
    });
  }
  function $() {
    t(26, x = 0), t(0, o = t(27, le = t(19, ie = null))), Z && (Z = !1);
  }
  El(() => {
    Z && $();
  });
  ...
  function ee(g) {
    Je[g ? "unshift" : "push"](() => {
      O = g, t(16, O), t(7, q), t(14, P), t(15, ae);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    "i18n" in g && t(1, r = g.i18n), "eta" in g && t(0, o = g.eta), "queue_position" in g && t(2, a = g.queue_position), "queue_size" in g && t(3, c = g.queue_size), "status" in g && t(4, u = g.status), "scroll_to_output" in g && t(22, p = g.scroll_to_output), "timer" in g && t(5, m = g.timer), "show_progress" in g && t(6, y = g.show_progress), "message" in g && t(23, C = g.message), "progress" in g && t(7, q = g.progress), "variant" in g && t(8, L = g.variant), "loading_text" in g && t(9, d = g.loading_text), "absolute" in g && t(10, _ = g.absolute), "translucent" in g && t(11, v = g.translucent), "border" in g && t(12, V = g.border), "autoscroll" in g && t(24, b = g.autoscroll), "$$scope" in g && t(29, f = g.$$scope);
  }, l.$$.update = () => {
    l.$$.dirty[0] & /*eta, old_eta, timer_start, eta_from_start*/
    436207617 && (o === null && t(0, o = le), o != null && le !== o && (t(28, ne = (performance.now() - oe) / 1e3 + o), t(19, ie = ne.toFixed(1)), t(27, le = o))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, j = ne === null || ne <= 0 || !x ? null : Math.min(x / ne, 1)), l.$$.dirty[0] & /*progress*/
    128 && q != null && t(18, h = !1), l.$$.dirty[0] & /*progress, progress_level, progress_bar, last_progress_level*/
    114816 && (q != null ? t(14, P = q.map((g) => {
      if (g.index != null && g.length != null)
        return g.index / g.length;
      if (g.progress != null)
        return g.progress;
    })) : t(14, P = null), P ? (t(15, ae = P[P.length - 1]), O && (ae === 0 ? t(16, O.style.transition = "0", O) : t(16, O.style.transition = "150ms", O))) : t(15, ae = void 0)), l.$$.dirty[0] & /*status*/
    16 && (u === "pending" ? K() : $()), l.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
...
function wn(l) {
  ...
  return {
    c() {
      s && s.c(), e = mn(), t = an("iframe"), hn(t.src, n = "https://bohrium.test.dp.tech/app/function-panel") || Ae(t, "src", n), Ae(t, "style", i = "width:" + /*width*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(h, K, T, $) {
    function ie(ee) {
      return ee instanceof T ? ee : new T(function(ue) {
        ue(ee);
      });
    }
    return new (T || (T = Promise))(function(ee, ue) {
      function Le(I) {
        try {
          ge($.next(I));
        } catch (fe) {
      ...
      function ge(I) {
        I.done ? ee(I.value) : ie(I.value).then(Le, g);
      }
      ge(($ = $.apply(h, K || [])).next());
    });
  };
  let { gradio: i } = e, { label: f = "Textbox" } = e, { elem_id: s = "" } = e, { elem_classes: r = [] } = e, { visible: o = !0 } = e, { value: a = "" } = e, { placeholder: c = "" } = e, { show_label: u } = e, { scale: p = null } = e, { min_width: m = void 0 } = e, { loading_status: y = void 0 } = e, { value_is_output: C = !1 } = e, { interactive: q } = e, { rtl: L = !1 } = e, { width: d } = e, { height: _ } = e, { accept: v } = e, { appKey: V } = e, { appAccessKey: b } = e, { clientName: z } = e, Z, oe;
  function x() {
    var h, K;
    let T = /* @__PURE__ */ new Map();
    document.cookie.split(";").forEach(($) => {
      const [ie, ee] = $.trim().split("=");
      T.set(ie, ee);
    }), Z = (h = b ?? T.get("appAccessKey")) !== null && h !== void 0 ? h : "sk-cf76953ad52a471587cda01547170e09", oe = (K = z ?? T.get("clientName")) !== null && K !== void 0 ? K : "opensdk-demo--test-uuid1720691302";
  }
  function le() {
    i.dispatch("change"), C || i.dispatch("input");
  }
  function ne() {
  ...
  let j;
  const P = () => {
    V && (j != null && j.contentWindow) && j.contentWindow.postMessage(
      {
        id: "1",
        type: "selectFromBohrium",
        data: { accept: v, appKey: V },
        headers: { accessKey: Z, "x-app-key": oe }
      },
      "*"
    );
  };
  bn(() => {
    x(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = h;
        console.log(K), K.type === "selectFromBohrium" && K.status === "succeed" && t(10, a = K.data.url), K.type === "closeWindow" && ne(), K.type === "ready" && console.log("ready");
      });
    });
  });
  ...
  return l.$$set = (h) => {
    "gradio" in h && t(0, i = h.gradio), "label" in h && t(11, f = h.label), "elem_id" in h && t(1, s = h.elem_id), "elem_classes" in h && t(2, r = h.elem_classes), "visible" in h && t(3, o = h.visible), "value" in h && t(10, a = h.value), "placeholder" in h && t(12, c = h.placeholder), "show_label" in h && t(13, u = h.show_label), "scale" in h && t(4, p = h.scale), "min_width" in h && t(5, m = h.min_width), "loading_status" in h && t(6, y = h.loading_status), "value_is_output" in h && t(14, C = h.value_is_output), "interactive" in h && t(15, q = h.interactive), "rtl" in h && t(16, L = h.rtl), "width" in h && t(7, d = h.width), "height" in h && t(8, _ = h.height), "accept" in h && t(17, v = h.accept), "appKey" in h && t(18, V = h.appKey), "appAccessKey" in h && t(19, b = h.appAccessKey), "clientName" in h && t(20, z = h.clientName);
  }, l.$$.update = () => {
    l.$$.dirty[0] & /*value*/
    1024 && a === null && t(10, a = ""), l.$$.dirty[0] & /*value*/
    1024 && le(), l.$$.dirty[0] & /*accept*/
    131072 && P(), l.$$.dirty[0] & /*appKey*/
    262144 && P();
  }, [
    i,
    s,
