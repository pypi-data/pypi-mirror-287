...
function wl(l) {
  ...
  return {
    c() {
      e = ye("svg"), t = ye("g"), n = ye("path"), i = ye("path"), T(n, "d", "M18,6L6.087,17.913"), H(n, "fill", "none"), H(n, "fill-rule", "nonzero"), H(n, "stroke-width", "2px"), T(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), T(i, "d", "M4.364,4.364L19.636,19.636"), H(i, "fill", "none"), H(i, "fill-rule", "nonzero"), H(i, "stroke-width", "2px"), T(e, "width", "100%"), T(e, "height", "100%"), T(e, "viewBox", "0 0 24 24"), T(e, "version", "1.1"), T(e, "xmlns", "http://www.w3.org/2000/svg"), T(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), T(e, "xml:space", "preserve"), T(e, "stroke", "currentColor"), H(e, "fill-rule", "evenodd"), H(e, "clip-rule", "evenodd"), H(e, "stroke-linecap", "round"), H(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
function Tl(l) {
  ...
  return {
    c() {
      e = J("div"), yt(t.$$.fragment), n = D(), i = J("span"), s = M(f), r = D(), c && c.c(), G(e, "class", "clear-status svelte-16nch4a"), G(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = D(), t = J("div"), h && h.c(), n = D(), y && y.c(), i = D(), s && s.c(), r = D(), d && d.c(), o = be(), G(t, "class", "progress-text svelte-16nch4a"), E(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    p(_, v) {
      ...
      let V = f;
      f = L(_), f === V ? ~f && q[f].p(_, v) : (s && (Ee(), Q(q[V], 1, 1, () => {
        q[V] = null;
...
function et(l) {
  ...
  return {
    c() {
      e = J("div"), G(e, "class", "eta-bar svelte-16nch4a"), fe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Jl(l) {
  ...
  return {
    c() {
      e = J("div"), t = J("div"), r && r.c(), n = D(), i = J("div"), f = J("div"), G(t, "class", "progress-level-inner svelte-16nch4a"), G(f, "class", "progress-bar svelte-16nch4a"), fe(f, "width", s), G(i, "class", "progress-bar-wrap svelte-16nch4a"), G(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      e = J("div"), n && n.c(), G(e, "class", i = "wrap " + /*variant*/
      l[8] + " " + /*show_progress*/
    ...
    p(a, c) {
      let u = t;
      t = o(a), t === u ? ~t && r[t].p(a, c) : (n && (Ee(), Q(r[u], 1, 1, () => {
        r[u] = null;
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: F = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, S = !1, x = 0, $ = 0, le = null, ne = null, A = 0, j = null, se, O = null, m = !0;
  const K = () => {
...
function pn(l, e, t) {
  ...
  bn(() => {
    $(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = decodeURIComponent(K.data.url)), A.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
