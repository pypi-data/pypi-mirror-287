...
function Ot(l) {
  ...
  return {
    c() {
      ...
      l[13]}px, 100%))`), I(e, "border-width", "var(--block-border-width)");
    },
    m(o, a) {
...
function Jt(l, e, t) {
  ...
  return l.$$set = (b) => {
    "height" in b && t(0, f = b.height), "width" in b && t(1, s = b.width), "elem_id" in b && t(2, r = b.elem_id), "elem_classes" in b && t(3, o = b.elem_classes), "variant" in b && t(4, a = b.variant), "border_mode" in b && t(5, c = b.border_mode), "padding" in b && t(6, u = b.padding), "type" in b && t(16, p = b.type), "test_id" in b && t(7, h = b.test_id), "explicit_call" in b && t(8, y = b.explicit_call), "container" in b && t(9, C = b.container), "visible" in b && t(10, q = b.visible), "allow_overflow" in b && t(11, L = b.allow_overflow), "scale" in b && t(12, d = b.scale), "min_width" in b && t(13, _ = b.min_width), "$$scope" in b && t(17, i = b.$$scope);
  }, [
    f,
    s,
    r,
...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ze("button"), o && o.c(), t = sl(), n = Ze("div"), $t(i.$$.fragment), te(n, "class", "svelte-1lrphxw"), S(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function ul(l, e, t) {
  let n, { Icon: i } = e, { label: f = "" } = e, { show_label: s = !1 } = e, { pending: r = !1 } = e, { size: o = "small" } = e, { padded: a = !0 } = e, { highlight: c = !1 } = e, { disabled: u = !1 } = e, { hasPopup: p = !1 } = e, { color: h = "var(--block-label-text-color)" } = e, { transparent: y = !1 } = e, { background: C = "var(--background-fill-primary)" } = e, { offset: q = 0 } = e;
  function L(d) {
    xt.call(this, l, d);
  }
  return l.$$set = (d) => {
...
function Ye(l, e = {}) {
  ...
  function y(q, L = {}) {
    c = q;
    const d = o = {};
    return l == null || L.hard || C.stiffness >= 1 && C.damping >= 1 ? (h = !0, s = Re(), a = q, t.set(l = c), Promise.resolve()) : (L.soft && (p = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), u = 0), r || (s = Re(), h = !1, r = vl((_) => {
      if (h)
        return h = !1, r = null, !1;
      u = Math.min(u + p, 1);
      const v = {
...
function Kl(l) {
  ...
  return {
    ...
    m(h, y) {
      Nl(h, e, y), R(e, t), R(t, n), R(n, i), R(n, f), R(n, s), R(n, r), R(t, o), R(o, a), R(o, c), R(o, u), R(o, p);
    },
    p(h, [y]) {
      y & /*$top*/
...
function Sl(l, e, t) {
  let n, i;
  var f = this && this.__awaiter || function(h, y, C, q) {
    function L(d) {
...
function Wl(l) {
  ...
  return {
    c() {
      e = Q("div"), yt(t.$$.fragment), n = P(), i = Q("span"), s = M(f), r = P(), c && c.c(), G(e, "class", "clear-status svelte-16nch4a"), G(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
    ...
    p(u, p) {
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && T(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = P(), t = Q("div"), h && h.c(), n = P(), y && y.c(), i = P(), s && s.c(), r = P(), d && d.c(), o = be(), G(t, "class", "progress-text svelte-16nch4a"), D(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
...
function Ql(l) {
  ...
  return {
    c() {
      e = Q("div"), t = Q("div"), r && r.c(), n = P(), i = Q("div"), f = Q("div"), G(t, "class", "progress-level-inner svelte-16nch4a"), G(f, "class", "progress-bar svelte-16nch4a"), se(f, "width", s), G(i, "class", "progress-bar-wrap svelte-16nch4a"), G(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = P(), s && s.c(), t = P(), r && r.c(), n = P(), o && o.c(), i = be();
    },
    m(a, c) {
  ...
  return {
    c() {
      e = Q("p"), t = M(
        /*loading_text*/
        l[9]
      ), n = P(), s && s.c(), G(e, "class", "loading svelte-16nch4a");
    },
    m(r, o) {
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      ...
      l[8] + " " + /*show_progress*/
      l[6] + " svelte-16nch4a"), D(e, "hide", !/*status*/
      l[4] || /*status*/
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: C = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, Z = !1, oe = 0, x = 0, le = null, ne = null, j = 0, B = null, ae, O = null, m = !0;
  const K = () => {
    t(0, o = t(27, le = t(19, ie = null))), t(25, oe = performance.now()), t(26, x = 0), Z = !0, A();
  };
  function A() {
    requestAnimationFrame(() => {
      t(26, x = (performance.now() - oe) / 1e3), Z && A();
    });
  }
  function $() {
  ...
  function ee(g) {
    Je[g ? "unshift" : "push"](() => {
      O = g, t(16, O), t(7, q), t(14, B), t(15, ae);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    114816 && (q != null ? t(14, B = q.map((g) => {
      if (g.index != null && g.length != null)
        return g.index / g.length;
      if (g.progress != null)
        return g.progress;
    })) : t(14, B = null), B ? (t(15, ae = B[B.length - 1]), O && (ae === 0 ? t(16, O.style.transition = "0", O) : t(16, O.style.transition = "150ms", O))) : t(15, ae = void 0)), l.$$.dirty[0] & /*status*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(m, K, A, $) {
    function ie(ee) {
      return ee instanceof A ? ee : new A(function(ue) {
        ue(ee);
      });
    }
    return new (A || (A = Promise))(function(ee, ue) {
      function Le(E) {
        try {
          ge($.next(E));
        } catch (fe) {
  ...
  function x() {
    ...
    document.cookie.split(";").forEach(($) => {
      ...
      A.set(ie, ee);
    }), Z = (m = b ?? A.get("appAccessKey")) !== null && m !== void 0 ? m : "sk-cf76953ad52a471587cda01547170e09", oe = (K = z ?? A.get("clientName")) !== null && K !== void 0 ? K : "opensdk-demo--test-uuid1720691302";
  }
  function le() {
  ...
  const B = () => {
    var m, K;
    const A = (K = (m = window.location.search.match(/deploymentId=([^&]*)/)) === null || m === void 0 ? void 0 : m[1]) !== null && K !== void 0 ? K : "";
  ...
  bn(() => {
    x(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && t(10, a = K.data.url), K.type === "closeWindow" && ne(), K.type === "ready" && B();
      });
    });
  });
  ...
  return l.$$set = (m) => {
    "gradio" in m && t(0, i = m.gradio), "label" in m && t(11, f = m.label), "elem_id" in m && t(1, s = m.elem_id), "elem_classes" in m && t(2, r = m.elem_classes), "visible" in m && t(3, o = m.visible), "value" in m && t(10, a = m.value), "placeholder" in m && t(12, c = m.placeholder), "show_label" in m && t(13, u = m.show_label), "scale" in m && t(4, p = m.scale), "min_width" in m && t(5, h = m.min_width), "loading_status" in m && t(6, y = m.loading_status), "value_is_output" in m && t(14, C = m.value_is_output), "interactive" in m && t(15, q = m.interactive), "rtl" in m && t(16, L = m.rtl), "width" in m && t(7, d = m.width), "height" in m && t(8, _ = m.height), "accept" in m && t(17, v = m.accept), "appKey" in m && t(18, V = m.appKey), "appAccessKey" in m && t(19, b = m.appAccessKey), "clientName" in m && t(20, z = m.clientName);
  }, l.$$.update = () => {
    l.$$.dirty[0] & /*value*/
    1024 && a === null && t(10, a = ""), l.$$.dirty[0] & /*value*/
    1024 && le(), l.$$.dirty[0] & /*accept*/
    131072 && B(), l.$$.dirty[0] & /*appKey*/
    262144 && B();
  }, [
    i,
    s,
