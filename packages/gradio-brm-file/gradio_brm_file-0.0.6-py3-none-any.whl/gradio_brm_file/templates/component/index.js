...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ze("button"), o && o.c(), t = sl(), n = Ze("div"), $t(i.$$.fragment), te(n, "class", "svelte-1lrphxw"), I(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function wl(l) {
  ...
  return {
    c() {
      e = ye("svg"), t = ye("g"), n = ye("path"), i = ye("path"), T(n, "d", "M18,6L6.087,17.913"), J(n, "fill", "none"), J(n, "fill-rule", "nonzero"), J(n, "stroke-width", "2px"), T(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), T(i, "d", "M4.364,4.364L19.636,19.636"), J(i, "fill", "none"), J(i, "fill-rule", "nonzero"), J(i, "stroke-width", "2px"), T(e, "width", "100%"), T(e, "height", "100%"), T(e, "viewBox", "0 0 24 24"), T(e, "version", "1.1"), T(e, "xmlns", "http://www.w3.org/2000/svg"), T(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), T(e, "xml:space", "preserve"), T(e, "stroke", "currentColor"), J(e, "fill-rule", "evenodd"), J(e, "clip-rule", "evenodd"), J(e, "stroke-linecap", "round"), J(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
const {
  ...
  transition_out: U,
  update_slot_base: Nt
} = window.__gradio__svelte__internal, { tick: Bl } = window.__gradio__svelte__internal, { onDestroy: El } = window.__gradio__svelte__internal, { createEventDispatcher: Dl } = window.__gradio__svelte__internal, Pl = (l) => ({}), Qe = (l) => ({}), Wl = (l) => ({}), Ue = (l) => ({});
function xe(l, e, t) {
  const n = l.slice();
...
function Tl(l) {
  ...
  return {
    c() {
      e = Q("div"), yt(t.$$.fragment), n = D(), i = Q("span"), s = M(f), r = D(), c && c.c(), G(e, "class", "clear-status svelte-16nch4a"), G(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
      k(u, e, p), Lt(t, e, null), k(u, n, p), k(u, i, p), re(i, s), k(u, r, p), c && c.m(u, p), o = !0;
    },
    p(u, p) {
      const h = {};
      p[0] & /*i18n*/
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && P(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = D(), t = Q("div"), h && h.c(), n = D(), y && y.c(), i = D(), s && s.c(), r = D(), d && d.c(), o = be(), G(t, "class", "progress-text svelte-16nch4a"), E(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    m(_, v) {
      c && c.m(_, v), k(_, e, v), k(_, t, v), h && h.m(t, null), re(t, n), y && y.m(t, null), k(_, i, v), ~f && q[f].m(_, v), k(_, r, v), d && d.m(_, v), k(_, o, v), a = !0;
    },
    p(_, v) {
      /*variant*/
...
function et(l) {
  ...
  return {
    c() {
      e = Q("div"), G(e, "class", "eta-bar svelte-16nch4a"), fe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Ql(l) {
  ...
  return {
    c() {
      e = Q("div"), t = Q("div"), r && r.c(), n = D(), i = Q("div"), f = Q("div"), G(t, "class", "progress-level-inner svelte-16nch4a"), G(f, "class", "progress-bar svelte-16nch4a"), fe(f, "width", s), G(i, "class", "progress-bar-wrap svelte-16nch4a"), G(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
      k(o, e, a), re(e, t), r && r.m(t, null), re(e, n), re(e, i), re(i, f), l[31](f);
    },
    p(o, a) {
      /*progress*/
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = D(), s && s.c(), t = D(), r && r.c(), n = D(), o && o.c(), i = be();
    },
    m(a, c) {
  ...
  return {
    c() {
      e = Q("p"), t = M(
        /*loading_text*/
        l[9]
      ), n = D(), s && s.c(), G(e, "class", "loading svelte-16nch4a");
    },
    m(r, o) {
      k(r, e, o), re(e, t), k(r, n, o), s && s.m(r, o), i = !0;
    },
    p(r, o) {
      (!i || o[0] & /*loading_text*/
      512) && P(
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      ...
      l[8] + " " + /*show_progress*/
      l[6] + " svelte-16nch4a"), E(e, "hide", !/*status*/
      l[4] || /*status*/
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: C = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, S = !1, x = 0, $ = 0, le = null, ne = null, A = 0, j = null, se, O = null, m = !0;
  const K = () => {
    t(0, o = t(27, le = t(19, ce = null))), t(25, x = performance.now()), t(26, $ = 0), S = !0, W();
  };
  function W() {
    requestAnimationFrame(() => {
      t(26, $ = (performance.now() - x) / 1e3), S && W();
    });
  }
  function ee() {
    t(26, $ = 0), t(0, o = t(27, le = t(19, ce = null))), S && (S = !1);
  }
  El(() => {
    S && ee();
  });
  ...
  function oe(g) {
    Je[g ? "unshift" : "push"](() => {
      O = g, t(16, O), t(7, q), t(14, j), t(15, se);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    436207617 && (o === null && t(0, o = le), o != null && le !== o && (t(28, ne = (performance.now() - x) / 1e3 + o), t(19, ce = ne.toFixed(1)), t(27, le = o))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, A = ne === null || ne <= 0 || !$ ? null : Math.min($ / ne, 1)), l.$$.dirty[0] & /*progress*/
    128 && q != null && t(18, m = !1), l.$$.dirty[0] & /*progress, progress_level, progress_bar, last_progress_level*/
    114816 && (q != null ? t(14, j = q.map((g) => {
      if (g.index != null && g.length != null)
        return g.index / g.length;
      if (g.progress != null)
        return g.progress;
    })) : t(14, j = null), j ? (t(15, se = j[j.length - 1]), O && (se === 0 ? t(16, O.style.transition = "0", O) : t(16, O.style.transition = "150ms", O))) : t(15, se = void 0)), l.$$.dirty[0] & /*status*/
    16 && (u === "pending" ? K() : ee()), l.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(m, K, W, ee) {
    function ce(oe) {
      return oe instanceof W ? oe : new W(function(ue) {
        ue(oe);
      });
    }
    return new (W || (W = Promise))(function(oe, ue) {
      function Le(B) {
        try {
          ge(ee.next(B));
        } catch (ie) {
  ...
  const j = () => {
    var m, K;
    const W = (K = (m = window.location.search.match(/deploymentId=([^&]*)/)) === null || m === void 0 ? void 0 : m[1]) !== null && K !== void 0 ? K : "";
    V && (A != null && A.contentWindow) && A.contentWindow.postMessage(
      {
        ...
        headers: { accessKey: S, "x-app-key": x }
      },
      "*"
    );
  };
  bn(() => {
    $(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = K.data.url), A.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
          ...
          "*"
        )), K.type === "closeWindow" && (ne(), A.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
  ...
  const se = () => i.dispatch("clear_status", y);
  function O(m) {
    sn[m ? "unshift" : "push"](() => {
      A = m, t(9, A);
    });
