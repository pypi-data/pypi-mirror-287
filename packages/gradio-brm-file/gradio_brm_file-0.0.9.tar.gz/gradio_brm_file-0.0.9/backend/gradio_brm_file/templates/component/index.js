...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ze("button"), o && o.c(), t = sl(), n = Ze("div"), $t(i.$$.fragment), ne(n, "class", "svelte-1lrphxw"), Z(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = T(), t = $("div"), h && h.c(), n = T(), y && y.c(), i = T(), s && s.c(), r = T(), d && d.c(), o = be(), H(t, "class", "progress-text svelte-16nch4a"), W(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
...
function et(l) {
  ...
  return {
    c() {
      e = $("div"), H(e, "class", "eta-bar svelte-16nch4a"), oe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Jl(l) {
  ...
  return {
    c() {
      e = $("div"), t = $("div"), r && r.c(), n = T(), i = $("div"), f = $("div"), H(t, "class", "progress-level-inner svelte-16nch4a"), H(f, "class", "progress-bar svelte-16nch4a"), oe(f, "width", s), H(i, "class", "progress-bar-wrap svelte-16nch4a"), H(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      ...
      l[8] + " " + /*show_progress*/
      l[6] + " svelte-16nch4a"), W(e, "hide", !/*status*/
      l[4] || /*status*/
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: F = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, A = !1, te = 0, le = 0, ie = null, fe = null, I = 0, j = null, ae, J = null, m = !0;
  const K = () => {
    t(0, o = t(27, ie = t(19, X = null))), t(25, te = performance.now()), t(26, le = 0), A = !0, S();
  };
  function S() {
    requestAnimationFrame(() => {
      t(26, le = (performance.now() - te) / 1e3), A && S();
    });
  }
  function B() {
    t(26, le = 0), t(0, o = t(27, ie = t(19, X = null))), A && (A = !1);
  }
  El(() => {
    A && B();
  });
  ...
  function D(g) {
    He[g ? "unshift" : "push"](() => {
      J = g, t(16, J), t(7, q), t(14, j), t(15, ae);
    });
  }
  const ue = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    436207617 && (o === null && t(0, o = ie), o != null && ie !== o && (t(28, fe = (performance.now() - te) / 1e3 + o), t(19, X = fe.toFixed(1)), t(27, ie = o))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, I = fe === null || fe <= 0 || !le ? null : Math.min(le / fe, 1)), l.$$.dirty[0] & /*progress*/
    ...
    114816 && (q != null ? t(14, j = q.map((g) => {
      ...
      if (g.progress != null)
        return g.progress;
    })) : t(14, j = null), j ? (t(15, ae = j[j.length - 1]), J && (ae === 0 ? t(16, J.style.transition = "0", J) : t(16, J.style.transition = "150ms", J))) : t(15, ae = void 0)), l.$$.dirty[0] & /*status*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(m, K, S, B) {
    function X(D) {
      return D instanceof S ? D : new S(function(ue) {
        ue(D);
      });
    }
    return new (S || (S = Promise))(function(D, ue) {
      function Le(P) {
        try {
          ge(B.next(P));
        } catch (se) {
  ...
  const j = () => {
    var m, K, S, B;
    const X = (K = (m = window.location.search.match(/deploymentId=([^&]*)/)) === null || m === void 0 ? void 0 : m[1]) !== null && K !== void 0 ? K : "", D = (B = (S = window.location.search.match(/scene=([^&]*)/)) === null || S === void 0 ? void 0 : S[1]) !== null && B !== void 0 ? B : "";
    V && (I != null && I.contentWindow) && I.contentWindow.postMessage(
      {
        id: "1",
        ...
        data: {
          accept: v,
          appKey: V,
          deploymentId: X ? +X : void 0,
          scene: D || void 0,
          directory: !1
        },
        headers: { accessKey: A, "x-app-key": te }
      },
      "*"
    );
  };
  bn(() => {
    le(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = decodeURIComponent(K.data.url)), I.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
          ...
          "*"
        )), K.type === "closeWindow" && (fe(), I.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
