...
function wl(l) {
  ...
  return {
    c() {
      e = ve("svg"), t = ve("g"), n = ve("path"), i = ve("path"), Y(n, "d", "M18,6L6.087,17.913"), x(n, "fill", "none"), x(n, "fill-rule", "nonzero"), x(n, "stroke-width", "2px"), Y(t, "transform", "matrix(1.14096,-0.140958,-0.140958,1.14096,-0.0559523,0.0559523)"), Y(i, "d", "M4.364,4.364L19.636,19.636"), x(i, "fill", "none"), x(i, "fill-rule", "nonzero"), x(i, "stroke-width", "2px"), Y(e, "width", "100%"), Y(e, "height", "100%"), Y(e, "viewBox", "0 0 24 24"), Y(e, "version", "1.1"), Y(e, "xmlns", "http://www.w3.org/2000/svg"), Y(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), Y(e, "xml:space", "preserve"), Y(e, "stroke", "currentColor"), x(e, "fill-rule", "evenodd"), x(e, "clip-rule", "evenodd"), x(e, "stroke-linecap", "round"), x(e, "stroke-linejoin", "round");
    },
    m(f, s) {
...
function Ye(l, e = {}) {
  ...
  function y(q, L = {}) {
    c = q;
    const d = o = {};
    return l == null || L.hard || F.stiffness >= 1 && F.damping >= 1 ? (h = !0, s = Re(), a = q, t.set(l = c), Promise.resolve()) : (L.soft && (p = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), u = 0), r || (s = Re(), h = !1, r = vl((_) => {
      if (h)
        return h = !1, r = null, !1;
      u = Math.min(u + p, 1);
      const v = {
...
function Kl(l) {
  ...
  return {
    c() {
      ...
      l[2][0] + "px, " + /*$bottom*/
      l[2][1] + "px)"), C(t, "viewBox", "-1200 -1200 3000 3000"), C(t, "fill", "none"), C(t, "xmlns", "http://www.w3.org/2000/svg"), C(t, "class", "svelte-43sxxs"), C(e, "class", "svelte-43sxxs"), Ue(
        e,
        "margin",
        /*margin*/
        l[0]
    ...
    m(h, y) {
      Nl(h, e, y), G(e, t), G(t, n), G(n, i), G(n, f), G(n, s), G(n, r), G(t, o), G(o, a), G(o, c), G(o, u), G(o, p);
    },
    p(h, [y]) {
      y & /*$top*/
...
function Tl(l) {
  ...
  return {
    c() {
      e = $("div"), yt(t.$$.fragment), n = R(), i = $("span"), s = M(f), r = R(), c && c.c(), H(e, "class", "clear-status svelte-16nch4a"), H(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
    ...
    p(u, p) {
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && X(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function Rl(l) {
  ...
  return {
    c() {
      c && c.c(), e = R(), t = $("div"), h && h.c(), n = R(), y && y.c(), i = R(), s && s.c(), r = R(), d && d.c(), o = be(), H(t, "class", "progress-text svelte-16nch4a"), T(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    m(_, v) {
      c && c.m(_, v), k(_, e, v), k(_, t, v), h && h.m(t, null), ue(t, n), y && y.m(t, null), k(_, i, v), ~f && q[f].m(_, v), k(_, r, v), d && d.m(_, v), k(_, o, v), a = !0;
    },
    p(_, v) {
      /*variant*/
      ...
      let V = f;
      f = L(_), f === V ? ~f && q[f].p(_, v) : (s && (Ee(), ee(q[V], 1, 1, () => {
        q[V] = null;
      }), Be()), ~f ? (s = q[f], s ? s.p(_, v) : (s = q[f] = F[f](_), s.c()), U(s, 1), s.m(r.parentNode, r)) : s = null), /*timer*/
      _[5] ? d && (Ee(), ee(d, 1, 1, () => {
        d = null;
      }), Be()) : d ? (d.p(_, v), v[0] & /*timer*/
      32 && U(d, 1)) : (d = ct(_), d.c(), U(d, 1), d.m(o.parentNode, o));
    },
    i(_) {
      a || (U(s), U(d), a = !0);
    },
...
function tt(l) {
  ...
  function r(c, u) {
    return (
      /*p*/
      c[41].length != null ? Ul : Ol
    );
  }
  let o = r(l), a = o(l);
  return {
    c() {
      a.c(), e = R(), n = M(t), i = M(" | "), s = M(f);
    },
    m(c, u) {
...
function Jl(l) {
  ...
  return {
    c() {
      e = $("div"), t = $("div"), r && r.c(), n = R(), i = $("div"), f = $("div"), H(t, "class", "progress-level-inner svelte-16nch4a"), H(f, "class", "progress-bar svelte-16nch4a"), ae(f, "width", s), H(i, "class", "progress-bar-wrap svelte-16nch4a"), H(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = R(), s && s.c(), t = R(), r && r.c(), n = R(), o && o.c(), i = be();
    },
    m(a, c) {
  ...
  return {
    c() {
      e = $("p"), t = M(
        /*loading_text*/
        l[9]
      ), n = R(), s && s.c(), H(e, "class", "loading svelte-16nch4a");
    },
    m(r, o) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    ...
    p(a, c) {
      ...
      t = o(a), t === u ? ~t && r[t].p(a, c) : (n && (Ee(), ee(r[u], 1, 1, () => {
        r[u] = null;
      }), Be()), ~t ? (n = r[t], n ? n.p(a, c) : (n = r[t] = s[t](a), n.c()), U(n, 1), n.m(e, null)) : n = null), (!f || c[0] & /*variant, show_progress*/
...
function wn(l) {
  ...
  return {
    ...
    p(r, o) {
      ...
      64 && pe(s, 1)) : (s = dt(r), s.c(), pe(s, 1), s.m(e.parentNode, e)) : s && (un(), Le(s, 1, 1, () => {
        s = null;
...
function pn(l, e, t) {
  ...
  bn(() => {
    le(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = decodeURIComponent(K.data.url).replaceAll(" ", "%20")), Z.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
