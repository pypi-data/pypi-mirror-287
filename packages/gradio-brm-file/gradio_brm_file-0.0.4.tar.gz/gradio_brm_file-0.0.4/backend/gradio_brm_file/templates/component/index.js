...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ze("button"), o && o.c(), t = sl(), n = Ze("div"), $t(i.$$.fragment), le(n, "class", "svelte-1lrphxw"), I(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function Tl(l) {
  ...
  return {
    ...
    p(u, p) {
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && W(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function et(l) {
  ...
  return {
    c() {
      e = Q("div"), G(e, "class", "eta-bar svelte-16nch4a"), oe(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
...
function Ql(l) {
  ...
  return {
    c() {
      e = Q("div"), t = Q("div"), r && r.c(), n = P(), i = Q("div"), f = Q("div"), G(t, "class", "progress-level-inner svelte-16nch4a"), G(f, "class", "progress-bar svelte-16nch4a"), oe(f, "width", s), G(i, "class", "progress-bar-wrap svelte-16nch4a"), G(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
...
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: C = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: d = "Loading..." } = e, { absolute: _ = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, S = !1, x = 0, $ = 0, ne = null, ie = null, A = 0, B = null, ae, O = null, m = !0;
  const K = () => {
    t(0, o = t(27, ne = t(19, fe = null))), t(25, x = performance.now()), t(26, $ = 0), S = !0, Z();
  };
  function Z() {
    requestAnimationFrame(() => {
      t(26, $ = (performance.now() - x) / 1e3), S && Z();
    });
  }
  function ee() {
    t(26, $ = 0), t(0, o = t(27, ne = t(19, fe = null))), S && (S = !1);
  }
  El(() => {
    S && ee();
  });
  ...
  return l.$$set = (g) => {
    ...
    436207617 && (o === null && t(0, o = ne), o != null && ne !== o && (t(28, ie = (performance.now() - x) / 1e3 + o), t(19, fe = ie.toFixed(1)), t(27, ne = o))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, A = ie === null || ie <= 0 || !$ ? null : Math.min($ / ie, 1)), l.$$.dirty[0] & /*progress*/
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(m, K, Z, ee) {
    function fe(te) {
      return te instanceof Z ? te : new Z(function(ue) {
        ue(te);
      });
    }
    return new (Z || (Z = Promise))(function(te, ue) {
      function Le(E) {
        try {
          ge(ee.next(E));
        } catch (se) {
      ...
      function ge(E) {
        E.done ? te(E.value) : fe(E.value).then(Le, g);
      }
  ...
  function $() {
    ...
    document.cookie.split(";").forEach((ee) => {
      const [fe, te] = ee.trim().split("=");
      Z.set(fe, te);
    }), S = (m = b ?? Z.get("appAccessKey")) !== null && m !== void 0 ? m : "sk-cf76953ad52a471587cda01547170e09", x = (K = z ?? Z.get("clientName")) !== null && K !== void 0 ? K : "opensdk-demo--test-uuid1720691302";
  }
  function ne() {
  ...
  const B = () => {
    var m, K;
    const Z = (K = (m = window.location.search.match(/deploymentId=([^&]*)/)) === null || m === void 0 ? void 0 : m[1]) !== null && K !== void 0 ? K : "";
    ...
    $(), t(
      ...
      return n(this, void 0, void 0, function* () {
        ...
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = K.data.url), A.contentWindow.postMessage(
          ...
          "*"
        )), K.type === "closeWindow" && (ie(), A.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
