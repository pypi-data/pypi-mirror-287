...
function cl(l) {
  ...
  l[0]({}), {
    c() {
      e = Ze("button"), o && o.c(), t = sl(), n = Ze("div"), $t(i.$$.fragment), ne(n, "class", "svelte-1lrphxw"), j(
        n,
        "small",
        /*size*/
        l[4] === "small"
...
function ul(l, e, t) {
  ...
  return l.$$set = (_) => {
    "Icon" in _ && t(0, i = _.Icon), "label" in _ && t(1, f = _.label), "show_label" in _ && t(2, s = _.show_label), "pending" in _ && t(3, r = _.pending), "size" in _ && t(4, o = _.size), "padded" in _ && t(5, a = _.padded), "highlight" in _ && t(6, c = _.highlight), "disabled" in _ && t(7, u = _.disabled), "hasPopup" in _ && t(8, p = _.hasPopup), "color" in _ && t(13, h = _.color), "transparent" in _ && t(9, y = _.transparent), "background" in _ && t(10, F = _.background), "offset" in _ && t(11, q = _.offset);
  }, l.$$.update = () => {
...
let Te = wt ? () => window.performance.now() : () => Date.now(), kt = wt ? (l) => requestAnimationFrame(l) : Fe;
...
function Xe(l, e = {}) {
  ...
  function y(q, L = {}) {
    c = q;
    const _ = o = {};
    return l == null || L.hard || F.stiffness >= 1 && F.damping >= 1 ? (h = !0, s = Te(), a = q, t.set(l = c), Promise.resolve()) : (L.soft && (p = 1 / ((L.soft === !0 ? 0.5 : +L.soft) * 60), u = 0), r || (s = Te(), h = !1, r = vl((d) => {
      if (h)
        return h = !1, r = null, !1;
      u = Math.min(u + p, 1);
      const v = {
      ...
      return s = d, a = l, t.set(l = V), v.settled && (r = null), !v.settled;
    })), new Promise((d) => {
      r.promise.then(() => {
        _ === o && d();
      });
...
function Kl(l) {
  ...
  return {
    ...
    m(h, y) {
      Nl(h, e, y), Y(e, t), Y(t, n), Y(n, i), Y(n, f), Y(n, s), Y(n, r), Y(t, o), Y(o, a), Y(o, c), Y(o, u), Y(o, p);
    },
    p(h, [y]) {
      y & /*$top*/
      2 && qe(n, "transform", "translate(" + /*$top*/
      h[1][0] + "px, " + /*$top*/
      h[1][1] + "px)"), y & /*$bottom*/
      4 && qe(o, "transform", "translate(" + /*$bottom*/
      h[2][0] + "px, " + /*$bottom*/
      h[2][1] + "px)"), y & /*margin*/
      1 && Oe(
        e,
...
function Sl(l, e, t) {
  ...
  var f = this && this.__awaiter || function(h, y, F, q) {
    ...
    return new (F || (F = Promise))(function(_, d) {
      ...
      function b(z) {
        z.done ? _(z.value) : L(z.value).then(v, V);
      }
...
function Rl(l) {
  ...
  return {
    c() {
      e = $("div"), yt(t.$$.fragment), n = T(), i = $("span"), s = M(f), r = T(), c && c.c(), H(e, "class", "clear-status svelte-16nch4a"), H(i, "class", "error svelte-16nch4a");
    },
    m(u, p) {
      k(u, e, p), Lt(t, e, null), k(u, n, p), k(u, i, p), ue(i, s), k(u, r, p), c && c.m(u, p), o = !0;
    },
    p(u, p) {
      const h = {};
      p[0] & /*i18n*/
      ...
      2) && f !== (f = /*i18n*/
      u[1]("common.error") + "") && U(s, f), c && c.p && (!o || p[0] & /*$$scope*/
      536870912) && Nt(
        c,
        a,
        u,
...
function Tl(l) {
  ...
  return {
    c() {
      c && c.c(), e = T(), t = $("div"), h && h.c(), n = T(), y && y.c(), i = T(), s && s.c(), r = T(), _ && _.c(), o = be(), H(t, "class", "progress-text svelte-16nch4a"), R(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    m(d, v) {
      c && c.m(d, v), k(d, e, v), k(d, t, v), h && h.m(t, null), ue(t, n), y && y.m(t, null), k(d, i, v), ~f && q[f].m(d, v), k(d, r, v), _ && _.m(d, v), k(d, o, v), a = !0;
    },
    p(d, v) {
      /*variant*/
      d[8] === "default" && /*show_eta_bar*/
      d[18] && /*show_progress*/
      d[6] === "full" ? c ? c.p(d, v) : (c = et(d), c.c(), c.m(e.parentNode, e)) : c && (c.d(1), c = null), p === (p = u(d)) && h ? h.p(d, v) : (h && h.d(1), h = p && p(d), h && (h.c(), h.m(t, n))), /*timer*/
      d[5] ? y ? y.p(d, v) : (y = nt(d), y.c(), y.m(t, null)) : y && (y.d(1), y = null), (!a || v[0] & /*variant*/
      256) && R(
        t,
        "meta-text-center",
        /*variant*/
      ...
      let V = f;
      f = L(d), f === V ? ~f && q[f].p(d, v) : (s && (Ee(), ee(q[V], 1, 1, () => {
        q[V] = null;
      }), Be()), ~f ? (s = q[f], s ? s.p(d, v) : (s = q[f] = F[f](d), s.c()), O(s, 1), s.m(r.parentNode, r)) : s = null), /*timer*/
      d[5] ? _ && (Ee(), ee(_, 1, 1, () => {
        _ = null;
      }), Be()) : _ ? (_.p(d, v), v[0] & /*timer*/
      32 && O(_, 1)) : (_ = ct(d), _.c(), O(_, 1), _.m(o.parentNode, o));
    },
    i(d) {
      a || (O(s), O(_), a = !0);
    },
    ...
    d(d) {
      d && (w(e), w(t), w(i), w(r), w(o)), c && c.d(d), h && h.d(), y && y.d(), ~f && q[f].d(d), _ && _.d(d);
    }
  };
}
function et(l) {
  ...
  return {
    c() {
      e = $("div"), H(e, "class", "eta-bar svelte-16nch4a"), ae(e, "transform", t);
    },
    m(n, i) {
      k(n, e, i);
    },
    p(n, i) {
      ...
      (n[17] || 0) * 100 - 100}%)`) && ae(e, "transform", t);
    },
    d(n) {
      n && w(e);
    }
...
function Jl(l) {
  ...
  return {
    c() {
      e = $("div"), t = $("div"), r && r.c(), n = T(), i = $("div"), f = $("div"), H(t, "class", "progress-level-inner svelte-16nch4a"), H(f, "class", "progress-bar svelte-16nch4a"), ae(f, "width", s), H(i, "class", "progress-bar-wrap svelte-16nch4a"), H(e, "class", "progress-level svelte-16nch4a");
    },
    m(o, a) {
      k(o, e, a), ue(e, t), r && r.m(t, null), ue(e, n), ue(e, i), ue(i, f), l[31](f);
    },
    p(o, a) {
      /*progress*/
      o[7] != null ? r ? r.p(o, a) : (r = it(o), r.c(), r.m(t, null)) : r && (r.d(1), r = null), a[0] & /*last_progress_level*/
      32768 && s !== (s = `${/*last_progress_level*/
      o[15] * 100}%`) && ae(f, "width", s);
    },
    i: De,
    o: De,
    d(o) {
...
function ft(l) {
  ...
  return {
    c() {
      f && f.c(), e = T(), s && s.c(), t = T(), r && r.c(), n = T(), o && o.c(), i = be();
    },
    m(a, c) {
  ...
  return {
    c() {
      e = $("p"), t = M(
        /*loading_text*/
        l[9]
      ), n = T(), s && s.c(), H(e, "class", "loading svelte-16nch4a");
    },
    m(r, o) {
      k(r, e, o), ue(e, t), k(r, n, o), s && s.m(r, o), i = !0;
    },
    p(r, o) {
      (!i || o[0] & /*loading_text*/
      512) && U(
...
function xl(l) {
  ...
  return ~(t = o(l)) && (n = r[t] = s[t](l)), {
    c() {
      e = $("div"), n && n.c(), H(e, "class", i = "wrap " + /*variant*/
      l[8] + " " + /*show_progress*/
      l[6] + " svelte-16nch4a"), R(e, "hide", !/*status*/
      l[4] || /*status*/
    ...
    p(a, c) {
      let u = t;
      t = o(a), t === u ? ~t && r[t].p(a, c) : (n && (Ee(), ee(r[u], 1, 1, () => {
        r[u] = null;
      }), Be()), ~t ? (n = r[t], n ? n.p(a, c) : (n = r[t] = s[t](a), n.c()), O(n, 1), n.m(e, null)) : n = null), (!f || c[0] & /*variant, show_progress*/
      320 && i !== (i = "wrap " + /*variant*/
      a[8] + " " + /*show_progress*/
      a[6] + " svelte-16nch4a")) && H(e, "class", i), (!f || c[0] & /*variant, show_progress, status, show_progress*/
      336) && R(e, "hide", !/*status*/
      a[4] || /*status*/
  ...
  return $l(this, arguments, void 0, function* (e, t = !0) {
    if (!(window.__gradio_mode__ === "website" || window.__gradio_mode__ !== "app" && t !== !0)) {
      ...
      yield Bl(), requestAnimationFrame(() => {
        ...
        window.scrollTo({ top: n[0] - 20, behavior: "smooth" }), Se = !1, Ce = [];
      });
    }
  });
}
function tn(l, e, t) {
  ...
  this && this.__awaiter;
  const s = Dl();
  let { i18n: r } = e, { eta: o = null } = e, { queue_position: a } = e, { queue_size: c } = e, { status: u } = e, { scroll_to_output: p = !1 } = e, { timer: h = !0 } = e, { show_progress: y = "full" } = e, { message: F = null } = e, { progress: q = null } = e, { variant: L = "default" } = e, { loading_text: _ = "Loading..." } = e, { absolute: d = !0 } = e, { translucent: v = !1 } = e, { border: V = !1 } = e, { autoscroll: b } = e, z, I = !1, te = 0, le = 0, ie = null, fe = null, Z = 0, B = null, re, J = null, m = !0;
  const K = () => {
    t(0, o = t(27, ie = t(19, E = null))), t(25, te = performance.now()), t(26, le = 0), I = !0, S();
  };
  function S() {
    requestAnimationFrame(() => {
      t(26, le = (performance.now() - te) / 1e3), I && S();
    });
  }
  function A() {
    t(26, le = 0), t(0, o = t(27, ie = t(19, E = null))), I && (I = !1);
  }
  El(() => {
    I && A();
  });
  ...
  function P(g) {
    He[g ? "unshift" : "push"](() => {
      J = g, t(16, J), t(7, q), t(14, B), t(15, re);
    });
  }
  const se = () => {
    s("clear_status");
  ...
  return l.$$set = (g) => {
    ...
    436207617 && (o === null && t(0, o = ie), o != null && ie !== o && (t(28, fe = (performance.now() - te) / 1e3 + o), t(19, E = fe.toFixed(1)), t(27, ie = o))), l.$$.dirty[0] & /*eta_from_start, timer_diff*/
    335544320 && t(17, Z = fe === null || fe <= 0 || !le ? null : Math.min(le / fe, 1)), l.$$.dirty[0] & /*progress*/
    ...
    114816 && (q != null ? t(14, B = q.map((g) => {
      ...
      if (g.progress != null)
        return g.progress;
    })) : t(14, B = null), B ? (t(15, re = B[B.length - 1]), J && (re === 0 ? t(16, J.style.transition = "0", J) : t(16, J.style.transition = "150ms", J))) : t(15, re = void 0)), l.$$.dirty[0] & /*status*/
    16 && (u === "pending" ? K() : A()), l.$$.dirty[0] & /*el, scroll_to_output, status, autoscroll*/
    20979728 && z && p && (u === "pending" || u === "complete") && en(z, b), l.$$.dirty[0] & /*status, message*/
    8388624, l.$$.dirty[0] & /*timer_diff*/
    67108864 && t(20, n = le.toFixed(1));
  }, [
    o,
    r,
    a,
...
function wn(l) {
  ...
  return {
    ...
    m(r, o) {
      s && s.m(r, o), dt(r, e, o), dt(r, t, o), l[22](t), f = !0;
    },
    p(r, o) {
      /*loading_status*/
      r[6] ? s ? (s.p(r, o), o[0] & /*loading_status*/
      64 && pe(s, 1)) : (s = _t(r), s.c(), pe(s, 1), s.m(e.parentNode, e)) : s && (un(), Le(s, 1, 1, () => {
        s = null;
...
function pn(l, e, t) {
  var n = this && this.__awaiter || function(m, K, S, A) {
    function E(P) {
      return P instanceof S ? P : new S(function(se) {
        se(P);
      });
    }
    return new (S || (S = Promise))(function(P, se) {
      function ge(W) {
        try {
          we(A.next(W));
        } catch (oe) {
      ...
      function we(W) {
        W.done ? P(W.value) : E(W.value).then(ge, g);
      }
      we((A = A.apply(m, K || [])).next());
    });
  };
  let { gradio: i } = e, { label: f = "Textbox" } = e, { elem_id: s = "" } = e, { elem_classes: r = [] } = e, { visible: o = !0 } = e, { value: a = "" } = e, { placeholder: c = "" } = e, { show_label: u } = e, { scale: p = null } = e, { min_width: h = void 0 } = e, { loading_status: y = void 0 } = e, { value_is_output: F = !1 } = e, { interactive: q } = e, { rtl: L = !1 } = e, { width: _ } = e, { height: d } = e, { accept: v } = e, { appKey: V } = e, { appAccessKey: b } = e, { clientName: z } = e, I, te;
  function le() {
    var m, K, S, A;
    let E = /* @__PURE__ */ new Map();
    document.cookie.split(";").forEach((P) => {
      const [se, ge] = P.trim().split("=");
      E.set(se, ge);
    }), I = (K = (m = b ?? E.get("appAccessKey")) !== null && m !== void 0 ? m : "sk-3fa4e645488f42b6ab2c130d4a44b0ad") !== null && K !== void 0 ? K : "sk-cf76953ad52a471587cda01547170e09", te = (A = (S = z ?? E.get("clientName")) !== null && S !== void 0 ? S : "brm-file-uuid1722309865") !== null && A !== void 0 ? A : "opensdk-demo--test-uuid1720691302";
  }
  function ie() {
  ...
  const B = () => {
    var m, K, S, A;
    const E = (K = (m = window.location.search.match(/deploymentId=([^&]*)/)) === null || m === void 0 ? void 0 : m[1]) !== null && K !== void 0 ? K : "", P = (A = (S = window.location.search.match(/mode=([^&]*)/)) === null || S === void 0 ? void 0 : S[1]) !== null && A !== void 0 ? A : "";
    V && (Z != null && Z.contentWindow) && Z.contentWindow.postMessage(
      {
        id: "1",
        ...
        data: {
          accept: v,
          appKey: V,
          deploymentId: E ? +E : void 0,
          scene: P || void 0,
          directory: !1
        },
        headers: { accessKey: I, "x-app-key": te }
      },
      "*"
    );
  };
  bn(() => {
    le(), t(
      ...
      return n(this, void 0, void 0, function* () {
        const { data: K } = m;
        K.type === "selectFromBohrium" && K.status === "succeed" && (t(10, a = encodeURI(decodeURIComponent(K.data.url))), Z.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
          ...
          "*"
        )), K.type === "closeWindow" && (fe(), Z.contentWindow.postMessage(
          {
            id: "1",
            type: "clear",
            data: {},
  ...
  const re = () => i.dispatch("clear_status", y);
  function J(m) {
    sn[m ? "unshift" : "push"](() => {
      Z = m, t(9, Z);
    });
  ...
  return l.$$set = (m) => {
    "gradio" in m && t(0, i = m.gradio), "label" in m && t(11, f = m.label), "elem_id" in m && t(1, s = m.elem_id), "elem_classes" in m && t(2, r = m.elem_classes), "visible" in m && t(3, o = m.visible), "value" in m && t(10, a = m.value), "placeholder" in m && t(12, c = m.placeholder), "show_label" in m && t(13, u = m.show_label), "scale" in m && t(4, p = m.scale), "min_width" in m && t(5, h = m.min_width), "loading_status" in m && t(6, y = m.loading_status), "value_is_output" in m && t(14, F = m.value_is_output), "interactive" in m && t(15, q = m.interactive), "rtl" in m && t(16, L = m.rtl), "width" in m && t(7, _ = m.width), "height" in m && t(8, d = m.height), "accept" in m && t(17, v = m.accept), "appKey" in m && t(18, V = m.appKey), "appAccessKey" in m && t(19, b = m.appAccessKey), "clientName" in m && t(20, z = m.clientName);
  }, l.$$.update = () => {
    l.$$.dirty[0] & /*value*/
    1024 && a === null && t(10, a = ""), l.$$.dirty[0] & /*value*/
    1024 && ie(), l.$$.dirty[0] & /*accept*/
    131072 && B(), l.$$.dirty[0] & /*appKey*/
    262144 && B(), l.$$.dirty[0] & /*visible*/
    8 && B();
  }, [
    i,
    s,
