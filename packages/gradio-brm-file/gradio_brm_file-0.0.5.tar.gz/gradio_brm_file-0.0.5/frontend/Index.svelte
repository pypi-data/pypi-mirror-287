...
>
	{#if loading_status}
		...
		/>
	{/if}
	<iframe src="https://bohrium.uat.dp.tech/app/function-panel" bind:this={iframeRef} style="width:{width}px;height: {height}px;padding: 24px;background: #ffffff;{visible ? '' : 'display: none;'}"></iframe>
</Block>
