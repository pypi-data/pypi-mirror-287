...
#
#  $ bin/test -s nuclia.plone -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src nuclia.plone.testing.NUCLIA_PLONE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/nuclia/plone/tests/robot/test_example.robot
#
