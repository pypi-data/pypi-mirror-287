...
class HttpClient:
    ...
    def post_json(self, url: str, payload, headers: dict[str, str] = {}):
        headers["content-type"] = "application/json"
        return self.make_post_request(url, headers, json.dumps(payload))

    def make_get_request(self, url: str, headers: dict[str, str] = {}):
        return self._make_request(url, "GET", headers)

    def make_put_request(self, url: str, headers: dict[str, str] = {}, payload=None):
        return self._make_request(url, "PUT", headers, payload)

    def make_post_request(self, url: str, headers: dict[str, str] = {}, payload=None):
        return self._make_request(url, "POST", headers, payload)

    def download_file(self, url: str, path: Path, headers: dict[str, str] = {}):
    ...
    def upload_file(self, url: str, path: Path, headers: dict[str, str] = {}):
    ...
    def _make_request(
        self, url: str, method: str, headers: dict[str, str] = {}, payload=None
    ):
...
if __name__ == "__main__":
    ...
    # Basic example to test downloading
    url = sys.argv[1]
    ...
    client = HttpClient()
    client.download_file(url, path, headers)
