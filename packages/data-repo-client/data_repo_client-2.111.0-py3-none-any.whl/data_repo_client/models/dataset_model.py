...
class DatasetModel(object):
    ...
    openapi_types = {
        ...
        'snapshot_builder_settings': 'SnapshotBuilderSettings'
    }
    ...
    def __init__(self, id=None, name=None, description=None, default_profile_id=None, data_project=None, default_snapshot_id=None, schema=None, created_date=None, storage=None, secure_monitoring_enabled=False, phs_id=None, access_information=None, cloud_platform=None, self_hosted=False, properties=None, ingest_service_account=None, predictable_file_ids=False, tags=None, resource_locks=None, snapshot_builder_settings=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._snapshot_builder_settings = None
        ...
        if snapshot_builder_settings is not None:
            self.snapshot_builder_settings = snapshot_builder_settings
    ...
    @property
    def snapshot_builder_settings(self):
        """Gets the snapshot_builder_settings of this DatasetModel.  # noqa: E501


        :return: The snapshot_builder_settings of this DatasetModel.  # noqa: E501
        :rtype: SnapshotBuilderSettings
        """
        return self._snapshot_builder_settings

    @snapshot_builder_settings.setter
    def snapshot_builder_settings(self, snapshot_builder_settings):
        """Sets the snapshot_builder_settings of this DatasetModel.


        :param snapshot_builder_settings: The snapshot_builder_settings of this DatasetModel.  # noqa: E501
        :type: SnapshotBuilderSettings
        """

        self._snapshot_builder_settings = snapshot_builder_settings
