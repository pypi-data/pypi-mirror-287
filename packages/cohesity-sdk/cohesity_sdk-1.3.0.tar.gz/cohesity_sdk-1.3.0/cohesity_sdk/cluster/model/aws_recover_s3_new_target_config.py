...
class AwsRecoverS3NewTargetConfig(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'bucket': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, bucket, region, source, *args, **kwargs):  # noqa: E501
        """AwsRecoverS3NewTargetConfig - a model defined in OpenAPI
