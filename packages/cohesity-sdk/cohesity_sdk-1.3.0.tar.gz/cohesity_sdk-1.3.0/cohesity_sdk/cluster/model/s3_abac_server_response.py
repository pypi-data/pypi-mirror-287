...
class S3AbacServerResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, base_path, ca_bundle, certificate, hostname, id, port, *args, **kwargs):  # noqa: E501
        """S3AbacServerResponse - a model defined in OpenAPI
