...
class AwsPostgresMetadata(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """AwsPostgresMetadata - a model defined in OpenAPI

        Args:

        Keyword Args:
            metadata_type (str, none_type): Specifies the type of metadata being sent in the request.. defaults to "Credentials", must be one of ["Credentials", ]  # noqa: E501
