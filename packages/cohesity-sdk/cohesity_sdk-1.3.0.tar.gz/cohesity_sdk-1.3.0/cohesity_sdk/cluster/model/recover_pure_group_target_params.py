...
class RecoverPureGroupTargetParams(ModelNormal):
    ...
    def __init__(self, recover_to_new_source, *args, **kwargs):  # noqa: E501
        """RecoverPureGroupTargetParams - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            new_source_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the new destination Source configuration parameters where the Pure group will be recovered. This is mandatory if recoverToNewSource is set to true.. [optional]  # noqa: E501
            original_source_config ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): Specifies the Source configuration if Pure group is being recovered to Original Source. If not specified, all the configuration parameters will be retained.. [optional]  # noqa: E501
