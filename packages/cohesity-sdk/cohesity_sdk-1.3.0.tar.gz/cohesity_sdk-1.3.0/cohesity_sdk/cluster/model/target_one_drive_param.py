...
class TargetOneDriveParam(ModelNormal):
    ...
    def __init__(self, target_folder_path, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            id (int, none_type): Specifies the id of the target onedrive. Atleast one of id or primarySMTPAddress need to be defined. In case both id and primarySMTPAddress are defined then id takes precedence.. [optional]  # noqa: E501
            ...
            primary_smtp_address (str, none_type): Specifies the primary SMTP address of the target onedrive. Atleast one of id or primarySMTPAddress needs to be defined. In case both id and primarySMTPAddress are defined then id takes precedence.. [optional]  # noqa: E501
        """
