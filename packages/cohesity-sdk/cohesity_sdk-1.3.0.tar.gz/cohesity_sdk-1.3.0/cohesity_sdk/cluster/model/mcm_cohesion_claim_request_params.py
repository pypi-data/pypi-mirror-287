...
class McmCohesionClaimRequestParams(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, appliance_id, appliance_name, claim_token, cluster_id, cluster_incarnation_id, *args, **kwargs):  # noqa: E501
        """McmCohesionClaimRequestParams - a model defined in OpenAPI
