...
class UdaObjectProtectionUpdateRequestParams(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'objects': ([UdaObjectProtectionObjectParams],),  # noqa: E501
    ...
    def __init__(self, objects, *args, **kwargs):  # noqa: E501
        """UdaObjectProtectionUpdateRequestParams - a model defined in OpenAPI

        Args:
            objects ([UdaObjectProtectionObjectParams]): Specifies the objects to be included in the Object Protection.
        ...
        Keyword Args:
            ...
            concurrency (int, none_type): Specifies the maximum number of concurrent IO Streams thatwill be created to exchange data with the cluster. If not specified, the default value is taken as 1.. [optional] if omitted the server will use the default value of 1  # noqa: E501
