...
class RecoverAzureSqlParams(ModelNormal):
    ...
    def __init__(self, snapshots, *args, **kwargs):  # noqa: E501
        """RecoverAzureSqlParams - a model defined in OpenAPI

        Args:
            snapshots ([RecoverAzureSqlSnapshotParams], none_type): Specifies the details of the azure sql objects to be recovered.
