...
def parse_args():
    ...
    parser.add_argument('-o', '--output_folder', help='Path to the output folder. Default folder is ./results/', default="./results/")
...
def empathi(input_file, name, models_folder="models", only_embeddings=False, output_folder="results", mode="all", custom=False):
