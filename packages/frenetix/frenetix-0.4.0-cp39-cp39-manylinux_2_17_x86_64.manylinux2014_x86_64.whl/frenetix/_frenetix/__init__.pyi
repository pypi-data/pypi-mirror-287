...
class TrajectorySample:
    ...
    @property
    def boundary_harm(self) -> Optional[float]: ...

    @boundary_harm.setter
    def boundary_harm(self, arg: float, /) -> None: ...

    @property
    def _ego_risk(self) -> Optional[float]: ...

    @_ego_risk.setter
    def _ego_risk(self, arg: float, /) -> None: ...

    @property
    def _obst_risk(self) -> Optional[float]: ...
