...
class CertMgr(object):
    ...
    @staticmethod
    def certificate_user(cert_file: str, key_file: str, username: str = None, email: str = None):
        ...
        cert_file_name = f"{subject}_cert.pem"
        print(f"Writing certificate file {cert_file_name}")
        with open(cert_file_name, 'w') as f:
            f.write(cert_pem)

        key_file_name = f"{subject}_key.pem"
        print(f"Writing key file {key_file_name}")
