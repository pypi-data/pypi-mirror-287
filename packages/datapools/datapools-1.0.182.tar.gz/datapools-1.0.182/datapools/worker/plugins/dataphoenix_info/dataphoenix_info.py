...
class DataPhoenixInfoPlugin(BasePlugin):
    ...
    async def study(self, task: StudyUrlTask, __timeout: Optional[int] = None) -> List[BaseTag]:
    ...
    async def _process_single_page(self, url):
        ...
        priority_timestamp = await BasePlugin.parse_html_time_tag(self.page, ".gh-post-info__date")
