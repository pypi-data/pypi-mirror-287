...
class GameManager:
    def __init__(self, game_world_id: str, repository: GameRepository):
        ...
        self.game_world = self.repository.load_game_world(game_world_id) or GameWorld(id=game_world_id)
    ...
    def get_game_state(self) -> Dict[str, Any]:
        ...
        state['objects'] = {
            obj_id: self.get_object(obj_id).model_dump() for obj_id in self.game_world.object_ids
        }
        return state
    ...
    def list_objects(self, object_type: str = None) -> str:
        ...
        filtered_objects = objects if object_type is None else [obj for obj in objects if obj.type == object_type]
