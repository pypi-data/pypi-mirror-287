...
ax1.text(0.01, 0.95, f"gstemp: r-squared = {r_value1**2:.2f}, p-value = {p_value1:.2f}, intercept = {intercept1:.2f}, slope = {slope1:.2f}", transform=ax1.transAxes, fontsize=8)
ax2.text(0.01, 0.85, f"tsi: r-squared = {r_value2**2:.2f}, p-value = {p_value2:.2f}, intercept = {intercept2:.2f}, slope = {slope2:.2f}", transform=ax2.transAxes, fontsize=8)
