...
The functionalities will return a dataframe, which then can be saved into a csv file. The data collection command contains the following parameters:
- mode : str
...
predictions = analyze.analyze(url='URL of the article', task='outcome')
```
...
```python
from wide_analysis import analyze
predictions = analyze.analyze(url='URL of the article', task='policy')
```
...
```python
from wide_analysis import analyze
predictions = analyze.analyze(url='URL of the article', task='sentiment')
```
...
```python
from wide_analysis import analyze
predictions = analyze.analyze(url='URL of the article', task='offensive')
```
