...
class OAuth2Client:
    def __init__(
        ...
        """OAuth2Client handles authorization code grant flow for 33rd party oauth2 apps"""
    ...
    def _request_token(
        ...
        try:
            response = requests.post(self.token_url, request_args, headers=headers)
    ...
    def authenticate(
        ...
        if port:
            ...
            # We can validate if the callback URL is valid by opening the URL: 403 = invalid, 400 = valid
            try:
