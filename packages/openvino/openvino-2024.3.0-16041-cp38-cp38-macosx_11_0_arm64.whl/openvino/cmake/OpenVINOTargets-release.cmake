...
set_target_properties(openvino::frontend::onnx PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_onnx_frontend.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_onnx_frontend.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::onnx )
list(APPEND _cmake_import_check_files_for_openvino::frontend::onnx "${_IMPORT_PREFIX}/openvino/libs/libopenvino_onnx_frontend.2430.dylib" )
...
set_target_properties(openvino::frontend::pytorch PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_pytorch_frontend.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_pytorch_frontend.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::pytorch )
list(APPEND _cmake_import_check_files_for_openvino::frontend::pytorch "${_IMPORT_PREFIX}/openvino/libs/libopenvino_pytorch_frontend.2430.dylib" )
...
set_target_properties(openvino::frontend::tensorflow PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_frontend.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_tensorflow_frontend.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::tensorflow )
list(APPEND _cmake_import_check_files_for_openvino::frontend::tensorflow "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_frontend.2430.dylib" )
...
set_target_properties(openvino::frontend::tensorflow_lite PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_lite_frontend.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_tensorflow_lite_frontend.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::tensorflow_lite )
list(APPEND _cmake_import_check_files_for_openvino::frontend::tensorflow_lite "${_IMPORT_PREFIX}/openvino/libs/libopenvino_tensorflow_lite_frontend.2430.dylib" )
...
set_target_properties(openvino::frontend::paddle PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_paddle_frontend.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_paddle_frontend.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::frontend::paddle )
list(APPEND _cmake_import_check_files_for_openvino::frontend::paddle "${_IMPORT_PREFIX}/openvino/libs/libopenvino_paddle_frontend.2430.dylib" )
...
set_target_properties(openvino::runtime PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::runtime )
list(APPEND _cmake_import_check_files_for_openvino::runtime "${_IMPORT_PREFIX}/openvino/libs/libopenvino.2430.dylib" )
...
set_target_properties(openvino::runtime::c PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/openvino/libs/libopenvino_c.2430.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libopenvino_c.2430.dylib"
  )

list(APPEND _cmake_import_check_targets openvino::runtime::c )
list(APPEND _cmake_import_check_files_for_openvino::runtime::c "${_IMPORT_PREFIX}/openvino/libs/libopenvino_c.2430.dylib" )
