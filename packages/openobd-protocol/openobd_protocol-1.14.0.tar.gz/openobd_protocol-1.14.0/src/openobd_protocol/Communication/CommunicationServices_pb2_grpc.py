...
from openobd_protocol.Communication.Messages import BusConfiguration_pb2 as openobd__protocol_dot_Communication_dot_Messages_dot_BusConfiguration__pb2
...
class busStub(object):
    ...
    def __init__(self, channel):
        ...
        self.configureBus = channel.stream_unary(
                '/openOBD.v1.bus/configureBus',
                request_serializer=openobd__protocol_dot_Communication_dot_Messages_dot_BusConfiguration__pb2.BusConfiguration.SerializeToString,
                response_deserializer=openobd__protocol_dot_Messages_dot_Empty__pb2.EmptyMessage.FromString,
                )


class busServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_busServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'configureBus': grpc.stream_unary_rpc_method_handler(
                    servicer.configureBus,
                    request_deserializer=openobd__protocol_dot_Communication_dot_Messages_dot_BusConfiguration__pb2.BusConfiguration.FromString,
                    response_serializer=openobd__protocol_dot_Messages_dot_Empty__pb2.EmptyMessage.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'openOBD.v1.bus', rpc_method_handlers)
...
class bus(object):
    ...
    def configureBus(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/openOBD.v1.bus/configureBus',
            openobd__protocol_dot_Communication_dot_Messages_dot_BusConfiguration__pb2.BusConfiguration.SerializeToString,
