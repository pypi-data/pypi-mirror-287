...
COMPUTE_FUNCTION_MAPPER = {
    ("distance-matrix"): calculate_cosine_distance,
    ("distance-cross-matrix"): calculate_bar_S_matrix,
    ("cointegration-matrix"): calculate_shifted_cosine_similarity,
    ("percentile"): percentile_calculation,
    ("pca"): pca_from_scratch,
