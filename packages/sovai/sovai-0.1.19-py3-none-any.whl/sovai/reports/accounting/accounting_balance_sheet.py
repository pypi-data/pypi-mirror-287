...
def generate_analyst_commentary(html_output):
    """
    Generates a concise analyst commentary based on given financial analysis.

    Parameters:
    - html_output (str): HTML content containing financial analysis.
    - api_key (str): The OpenAI API key for authentication.

    Returns:
    - str: Analyst commentary in HTML format.
    """
    ...
    messages = [
        {
            "role": "system",
            "content": "You are a financial analyst. Given a detailed financial analysis, provide a concise commentary discussing the company's liquidity, capital structure, revenue growth, and profitability. Highlight any notable strengths, weaknesses, or areas for improvement. Very importantly highlight the type of financial activity you are seeing there are thousands of descriptions, like growing, deep investment, relying on cash cow etc. The commentary should be written with each paragraph wrapped in <p> tags. Don't give standard feeback be very holistic showing a deep professorial and scholarly understanding of the financial patterns and nuances.",
        },
        {
            "role": "user",
            "content": f"Here is the financial analysis: \n\n{html_output}\n\nProvide your commentary.",
        },
    ]
    ...
    analyst_commentary = response.choices[0].message.content.strip()
