...
def nowcast_data(df_signal, selected_tickers=None, selected_feature=None):
    global df_signal_global
...
def nowcast_plot(df_signal):
    ...
    def store_predictions(selected_feature, selected_tickers):
        output = nowcast_data(df_signal, selected_tickers, selected_feature)
