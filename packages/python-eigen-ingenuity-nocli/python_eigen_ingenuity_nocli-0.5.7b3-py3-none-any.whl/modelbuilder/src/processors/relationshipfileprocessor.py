                    ...
                    for relationship in relationships:
                        for relation in relationship.split(':'):
                            if relation:
                                ...
                                new_labels = [from_labels, to_labels, relation, list(from_node)[0], list(to_node)[0], calculated_properties]
                                query_data = [list(from_node.values())[0], list(to_node.values())[0], explicit_properties, calculated_properties, time_now]
        ...
        for from_to_labels, updates in query_dictionary.items():
            ...
            while batch_num <= num_batches:
                ...
                while this_size < batch_size:
                    ...
                    if self.add_system_properties:
                        update_properties[self.update_time_property] = update[4]
