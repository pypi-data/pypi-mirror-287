                    ...
                    if key_compare_result:
                        if is_break == False:
                            ...
                            if count == end:
                                is_break = True
                            count += 1
                    return matching_state,matching_location
                ...
                def exec(matching_level):
                    ...
                    if matching_level > 0:
                        ...
                        def mode(key,_key,_value):
                            ...
                            state_1,location_1 = matching_key(key,_key)
                            if not state_1 and next:
                                state_2,location_2 = matching_value(key,_value)
                        ...
                        def mode(key,_key,_value):
                            ...
                            state_1,state_2 = False,False
                            location_1,location_2 = {},{}
                            state_1,location_1 = matching_value(key,_value)
                            if not state_1 and next:
                                state_2,location_2 = matching_key(key,_key)
                            if state_1 or state_2:
                                matching_num += 1
                                if state_1:
                                    results.append([state_1,location_1])
