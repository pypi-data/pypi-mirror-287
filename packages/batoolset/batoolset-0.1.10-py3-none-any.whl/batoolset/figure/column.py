...
# logger
# from batoolset.figure import fig_tools
from batoolset.figure.alignment import alignLeft, setToWidth2, updateBoudingRect, packY, packX, _brute_force_find_height, \
    _brute_force_find_width
from batoolset.figure.fig_tools import get_master_bounds2, get_common_scaling_factor
...
class Column(Rect2D):
    ...
    def __truediv__(self, other):
        # from batoolset.figure.panel import Panel
