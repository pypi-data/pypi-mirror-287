...
from batoolset.utils.loadlist import smart_TA_list,loadlist
...
def query_db_and_get_results(db_path, SQL_command_to_run):
    ...
    from batoolset.ta.database.sql import TAsql  # Import the required module
...
def table_exists_in_db(db_path, table_name):
    ...
    #     True
    """
    from batoolset.ta.database.sql import TAsql
    db = None
    exists = False
    try:
        db = TAsql(db_path)
