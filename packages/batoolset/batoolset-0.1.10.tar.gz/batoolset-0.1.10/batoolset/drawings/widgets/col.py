...
from batoolset.figure.row import Row  # KEEP Really required to avoid circular imports
logger = TA_logger()
...
class col(Rect2D):
    ...
    def __add__(self, other):
        from batoolset.figure.row import Row  # KEEP Really required to avoid circular imports # TODO is that still true ?
