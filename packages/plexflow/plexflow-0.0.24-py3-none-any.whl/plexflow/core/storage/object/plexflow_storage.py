...
class PlexflowObjectStore:
    ...
    def __init__(self, run_id: str, host: str = 'localhost', port: int = 6379, db: int = 0, default_ttl: int = 3600, root_key: Union[str, Path] = "@plexflow"):
        ...
        self.bucket_store = RedisObjectStore(host=host, port=port, db=db, default_ttl=default_ttl)
