...
class TransformServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateConfiguration = channel.unary_unary(
                ...
                request_serializer=tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationRequest.SerializeToString,
                response_deserializer=tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationResponse.FromString,
                )
...
def add_TransformServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateConfiguration': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationRequest.FromString,
                    response_serializer=tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationResponse.SerializeToString,
            ),
    }
...
class TransformService(object):
    ...
    def UpdateConfiguration(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/tecton_proto.feature_server.transform.TransformService/UpdateConfiguration',
            tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationRequest.SerializeToString,
            tecton__proto_dot_feature__server_dot_transform_dot_transform__service__pb2.UpdateConfigurationResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
