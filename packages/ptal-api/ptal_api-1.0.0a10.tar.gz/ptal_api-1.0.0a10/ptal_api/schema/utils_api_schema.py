...
class Mutation(sgqlc.types.Type):
    __schema__ = utils_api_schema
    __field_names__ = ('add_alias_to_concept_internal', 'get_or_add_account_internal', 'get_or_add_platform_internal', 'get_or_add_concept_internal', 'get_or_add_concept_new_internal', 'update_document_facts_internal')
