...
from .stdcell import stdcellcanvas, StdCellLambdaFactory
...
_stdlib = _lbry.RoutingGaugeLibrary(
    name="sg13g2_io_stdcells", tech=tech, routinggauge=stdcellcanvas.routinggauge
)
_stdfab = StdCellLambdaFactory(lib=_stdlib, name_prefix="sg13g2_io_")
